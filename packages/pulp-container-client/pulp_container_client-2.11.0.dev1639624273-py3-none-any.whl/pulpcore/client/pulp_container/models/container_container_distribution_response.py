...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, pulp_labels=None, base_path=None, pulp_href=None, content_guard=None, repository=None, pulp_created=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
