...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, name=None, versions_href=None, retain_repo_versions=None, latest_version_href=None, description=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
