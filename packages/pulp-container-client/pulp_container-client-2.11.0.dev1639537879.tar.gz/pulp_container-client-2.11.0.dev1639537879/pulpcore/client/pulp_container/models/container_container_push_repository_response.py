...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, pulp_href=None, name=None, pulp_labels=None, pulp_created=None, retain_repo_versions=None, description=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
