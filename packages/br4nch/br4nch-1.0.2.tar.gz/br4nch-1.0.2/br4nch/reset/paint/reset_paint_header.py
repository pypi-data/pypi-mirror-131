...
from br4nch.utility.utility_librarian import branches, paint_header
from br4nch.utility.utility_handler import InstanceStringError, NotExistingBranchError


def arguments(branch):
    """
    - Gets the arguments and parses them to the 'reset_paint_header' function.
    """
    reset_paint_header(branch)


def reset_paint_header(argument_branch):
    """
    Lists:
