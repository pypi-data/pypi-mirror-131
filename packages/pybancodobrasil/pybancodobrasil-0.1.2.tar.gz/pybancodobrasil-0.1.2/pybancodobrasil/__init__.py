            ...
            table2Json: (table) => {
                ...
                for (var i = 1; i < table.rows.length; i++) {
                    ...
                    for (var j = 0; j < tableRow.cells.length; j++) {
                        rowData.push([...tableRow.cells[j].children].map(i=>i.innerText));
                    }
                    data.push(rowData);
                }
                return data;
                ...
                try {
                    ...
                    req.onreadystatechange = function () {
                        if (req.readyState == 4) {
                            ...
                            const tables = $(req.responseText).find('table').toArray()
                            let values = [];
                            ...
                            window.pybancodobrasil.faturas.cartoes[cartao].push(values)
                            if ((ind + 1) < len) {
