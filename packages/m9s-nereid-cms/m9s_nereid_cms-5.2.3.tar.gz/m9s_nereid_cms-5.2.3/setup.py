...
name = 'm9s_nereid_cms'
download_url = 'https://gitlab.com/m9s/nereid_cms.git'
local_version = []
...
setup(name=name,
    version=version,
    description='Tryton Nereid Cms Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/nereid_cms.git',
        },
    keywords='',
    package_dir={'trytond.modules.nereid_cms': '.'},
    packages=(
        ['trytond.modules.nereid_cms'] +
        ['trytond.modules.nereid_cms.%s' % p for p in find_packages()]
        ),
    package_data={
