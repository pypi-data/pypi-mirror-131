"""Модуль окна со статистикой пользователей"""
...
class StatWindow(QDialog):
    """
    Ксласс - окно со статистикой пользователей
    """
    ...
    def create_stat_model(self):
        """
        Метод заполняет таблицу статистикой сообщений
        """
        # Список записей из базы
        stat_list = self.database.message_history()

        # Объект модели данных:
        list_stat = QStandardItemModel()
        list_stat.setHorizontalHeaderLabels(
        ...
        for row in stat_list:
            ...
            list_stat.appendRow([user, last_seen, sent, recvd])
        self.stat_table.setModel(list_stat)
