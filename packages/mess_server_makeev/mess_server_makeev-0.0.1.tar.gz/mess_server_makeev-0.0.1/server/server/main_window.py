"""Модуль главного окна интерфейса"""
...
class MainWindow(QMainWindow):
    ...
    def create_users_model(self):
        ...
        list_active = QStandardItemModel()
        list_active.setHorizontalHeaderLabels(
        ...
        for row in list_users:
            ...
            list_active.appendRow([user, ip, port, time])
        self.active_clients_table.setModel(list_active)
