"""
Classes for constructing the different representations available in nnpackage. This encompasses SchNet [#schnet4]_,
...
from nnpackage.representation.schnet import SchNet, SchNetInteraction
from nnpackage.representation.hdnn import (
    BehlerSFBlock,
    StandardizeSF,
    SymmetryFunctions,
)
