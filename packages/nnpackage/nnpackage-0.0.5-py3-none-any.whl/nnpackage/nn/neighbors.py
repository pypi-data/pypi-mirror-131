...
def atom_distances(
    ...
    if neighbor_mask is not None:
        ...
        # root derivative at 0) This way is necessary, as gradients do not
        # work with inplace operations, such as e.g. -> distances[mask==0] = 0.0
    ...
    if return_vecs:
        ...
        if normalize_vecs: dist_vec = dist_vec / tmp_distances[:, :, :, None]
        return distances, dist_vec

    return distances  # !!! Before only distances was here !!! # TODO: Potential bug
...
def triple_distances(
    ...
    # + 1e-9 to avoid division by zero  # TODO: Potential bug
