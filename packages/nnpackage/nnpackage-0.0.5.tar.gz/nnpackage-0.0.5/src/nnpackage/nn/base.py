...
from nnpackage.nn.initializers import zeros_initializer
...
class GetItem(nn.Module):
    """Extraction layer to get an item from nnpackage dictionary of input tensors.

    Args:
        key (str): Property to be extracted from Schnnpackage input tensors.
...
class Aggregate(nn.Module):
    ...
    def forward(self, input, mask=None):
        ...
        """
        # mask input
        if mask is not None: input = input * mask[..., None]
