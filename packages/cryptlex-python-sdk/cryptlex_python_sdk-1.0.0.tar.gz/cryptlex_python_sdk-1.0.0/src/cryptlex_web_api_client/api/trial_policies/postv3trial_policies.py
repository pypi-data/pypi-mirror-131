...
from ...models.postv_3_trial_policies_json_body import Postv3TrialPoliciesJsonBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: Postv3TrialPoliciesJsonBody,
) -> Dict[str, Any]:
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HttpErrorResponseDto, TrialPolicyDto]]:
    if response.status_code == 201:
        response_201 = TrialPolicyDto.from_dict(response.json())
