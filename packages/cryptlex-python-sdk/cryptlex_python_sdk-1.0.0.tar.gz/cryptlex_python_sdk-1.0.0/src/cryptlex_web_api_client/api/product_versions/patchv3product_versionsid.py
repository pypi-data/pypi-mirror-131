...
from ...models.product_version_request_model import ProductVersionRequestModel
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ProductVersionRequestModel,
) -> Dict[str, Any]:
    url = "{}/v3/product-versions/{id}".format(client.base_url, id=id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HttpErrorResponseDto, ProductVersionDto]]:
    if response.status_code == 200:
        response_200 = ProductVersionDto.from_dict(response.json())
