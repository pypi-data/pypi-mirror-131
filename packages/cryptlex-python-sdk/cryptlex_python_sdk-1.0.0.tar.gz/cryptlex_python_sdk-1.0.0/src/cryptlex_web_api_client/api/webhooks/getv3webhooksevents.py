...
from ...models.getv_3_webhooksevents_response_200 import Getv3WebhookseventsResponse200
...
def _get_kwargs(
    *,
    ...
    url = "{}/v3/webhooks/events".format(client.base_url)
...
) -> Optional[Union[Getv3WebhookseventsResponse200, HttpErrorResponseDto]]:
    if response.status_code == 200:
        response_200 = Getv3WebhookseventsResponse200.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[Getv3WebhookseventsResponse200, HttpErrorResponseDto]]:
    return Response(
