...
from ...models.postv_3_accountsidsaml_configuration_json_body import Postv3AccountsidsamlConfigurationJsonBody
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: Postv3AccountsidsamlConfigurationJsonBody,
) -> Dict[str, Any]:
