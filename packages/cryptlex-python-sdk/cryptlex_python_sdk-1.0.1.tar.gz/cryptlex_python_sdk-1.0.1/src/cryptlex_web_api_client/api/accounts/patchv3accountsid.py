...
from ...models.account_update_request_model import AccountUpdateRequestModel
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: AccountUpdateRequestModel,
) -> Dict[str, Any]:
    url = "{}/v3/accounts/{id}".format(client.base_url, id=id)
