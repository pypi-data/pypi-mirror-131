...
from ...models.webhook_request_model import WebhookRequestModel
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: WebhookRequestModel,
) -> Dict[str, Any]:
    url = "{}/v3/webhooks/{id}".format(client.base_url, id=id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HttpErrorResponseDto, WebhookDto]]:
    if response.status_code == 200:
        response_200 = WebhookDto.from_dict(response.json())
