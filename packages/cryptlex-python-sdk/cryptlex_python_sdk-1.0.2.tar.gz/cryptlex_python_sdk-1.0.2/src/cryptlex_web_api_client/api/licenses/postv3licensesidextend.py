...
from ...models.postv_3_licensesidextend_json_body import Postv3LicensesidextendJsonBody
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: Postv3LicensesidextendJsonBody,
) -> Dict[str, Any]:
    url = "{}/v3/licenses/{id}/extend".format(client.base_url, id=id)
