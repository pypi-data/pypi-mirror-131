...
from ...models.activations_by_country_dto import ActivationsByCountryDto
...
def _get_kwargs(
    *,
    ...
    url = "{}/v3/analytics/trial-activations/geo-location".format(client.base_url)
...
) -> Optional[Union[HttpErrorResponseDto, List[ActivationsByCountryDto]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ActivationsByCountryDto.from_dict(response_200_item_data)
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[HttpErrorResponseDto, List[ActivationsByCountryDto]]]:
    return Response(
