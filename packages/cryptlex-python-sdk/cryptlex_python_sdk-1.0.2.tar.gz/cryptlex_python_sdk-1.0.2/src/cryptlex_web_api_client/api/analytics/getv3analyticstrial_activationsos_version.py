...
from ...models.activations_by_os_version_dto import ActivationsByOsVersionDto
...
def _get_kwargs(
    *,
    ...
    url = "{}/v3/analytics/trial-activations/os-version".format(client.base_url)
...
) -> Optional[Union[HttpErrorResponseDto, List[ActivationsByOsVersionDto]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ActivationsByOsVersionDto.from_dict(response_200_item_data)
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[HttpErrorResponseDto, List[ActivationsByOsVersionDto]]]:
    return Response(
...
def sync(
    *,
    ...
    """Retrieve trial activations by OS version."""
