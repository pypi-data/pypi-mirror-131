...
from ...models.postv_3_personal_access_tokens_json_body import Postv3PersonalAccessTokensJsonBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: Postv3PersonalAccessTokensJsonBody,
) -> Dict[str, Any]:
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[AccessTokenDto, HttpErrorResponseDto]]:
    if response.status_code == 201:
        response_201 = AccessTokenDto.from_dict(response.json())
