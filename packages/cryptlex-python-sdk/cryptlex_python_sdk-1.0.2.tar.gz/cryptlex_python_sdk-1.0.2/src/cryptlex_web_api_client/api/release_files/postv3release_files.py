...
from ...models.postv_3_release_files_json_body import Postv3ReleaseFilesJsonBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: Postv3ReleaseFilesJsonBody,
) -> Dict[str, Any]:
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HttpErrorResponseDto, ReleaseDto]]:
    if response.status_code == 201:
        response_201 = ReleaseDto.from_dict(response.json())
