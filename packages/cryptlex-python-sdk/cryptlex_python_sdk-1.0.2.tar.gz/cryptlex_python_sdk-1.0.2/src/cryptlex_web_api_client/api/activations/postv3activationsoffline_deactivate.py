...
from ...models.postv_3_activationsoffline_deactivate_json_body import Postv3ActivationsofflineDeactivateJsonBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: Postv3ActivationsofflineDeactivateJsonBody,
) -> Dict[str, Any]:
    url = "{}/v3/activations/offline-deactivate".format(client.base_url)
