...
from ...models.activation_request_model import ActivationRequestModel
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ActivationRequestModel,
) -> Dict[str, Any]:
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ActivationTokenDto, HttpErrorResponseDto]]:
    if response.status_code == 200:
        response_200 = ActivationTokenDto.from_dict(response.json())
