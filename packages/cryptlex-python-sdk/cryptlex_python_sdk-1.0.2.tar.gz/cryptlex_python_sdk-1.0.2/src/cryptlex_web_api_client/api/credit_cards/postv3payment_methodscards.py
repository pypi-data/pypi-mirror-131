...
from ...models.postv_3_payment_methodscards_json_body import Postv3PaymentMethodscardsJsonBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: Postv3PaymentMethodscardsJsonBody,
) -> Dict[str, Any]:
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[CreditCardDto, HttpErrorResponseDto]]:
    if response.status_code == 201:
        response_201 = CreditCardDto.from_dict(response.json())
