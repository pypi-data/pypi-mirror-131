...
from ...models.getv_3_product_versions_name_type_1 import Getv3ProductVersionsNameType1
...
def _get_kwargs(
    *,
    ...
    name: Union[Getv3ProductVersionsNameType1, None, Unset, str] = UNSET,
    ...
    if isinstance(name, Unset):
        ...
        json_name = None
    elif isinstance(name, Getv3ProductVersionsNameType1):
        json_name = UNSET
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HttpErrorResponseDto, List[ProductVersionDto]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ProductVersionDto.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[Union[HttpErrorResponseDto, List[ProductVersionDto]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    name: Union[Getv3ProductVersionsNameType1, None, Unset, str] = UNSET,
    query: Union[Unset, None, str] = UNSET,
) -> Response[Union[HttpErrorResponseDto, List[ProductVersionDto]]]:
    kwargs = _get_kwargs(
        client=client,
        page=page,
        limit=limit,
...
def sync(
    *,
    ...
    name: Union[Getv3ProductVersionsNameType1, None, Unset, str] = UNSET,
    query: Union[Unset, None, str] = UNSET,
) -> Optional[Union[HttpErrorResponseDto, List[ProductVersionDto]]]:
