...
def _get_kwargs(
    *,
    ...
    url = "{}/v3/me/licenses".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HttpErrorResponseDto, List[UserLicenseDto]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = UserLicenseDto.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[Union[HttpErrorResponseDto, List[UserLicenseDto]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    release_id: Union[Unset, None, str] = UNSET,
    query: Union[Unset, None, str] = UNSET,
) -> Response[Union[HttpErrorResponseDto, List[UserLicenseDto]]]:
    kwargs = _get_kwargs(
        client=client,
        page=page,
        limit=limit,
...
def sync(
    *,
    ...
    release_id: Union[Unset, None, str] = UNSET,
    query: Union[Unset, None, str] = UNSET,
) -> Optional[Union[HttpErrorResponseDto, List[UserLicenseDto]]]:
