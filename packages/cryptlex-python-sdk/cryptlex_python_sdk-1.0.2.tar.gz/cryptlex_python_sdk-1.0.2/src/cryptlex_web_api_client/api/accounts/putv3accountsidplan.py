...
from ...models.plan_update_request_model import PlanUpdateRequestModel
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PlanUpdateRequestModel,
) -> Dict[str, Any]:
    url = "{}/v3/accounts/{id}/plan".format(client.base_url, id=id)
