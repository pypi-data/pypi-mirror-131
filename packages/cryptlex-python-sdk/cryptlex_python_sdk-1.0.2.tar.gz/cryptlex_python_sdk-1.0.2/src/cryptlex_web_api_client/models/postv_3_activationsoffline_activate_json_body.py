...
T = TypeVar("T", bound="Postv3ActivationsofflineActivateJsonBody")


@attr.s(auto_attribs=True)
class Postv3ActivationsofflineActivateJsonBody:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        postv_3_activationsoffline_activate_json_body = cls(
            offline_request=offline_request,
            response_validity=response_validity,
            license_id=license_id,
        )

        postv_3_activationsoffline_activate_json_body.additional_properties = d
        return postv_3_activationsoffline_activate_json_body
