...
setup(
    ...
    version='v0.0.7-alpha',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/GitMarco27/GitMarco/archive/refs/tags/v0.0.7-alpha.tar.gz',  # I explain this later on
