...
def release(changelog: Dict[str, dict],
            new_version: str = None,
            sections: bool = False) -> Optional[str]:
    """
    ...
    if not new_version:
        metadata['semantic_version'] = bump(new_release,
        ...
        compare = semantic_order((new_version, metadata['semantic_version']),
    ...
    changelog.update({'unreleased': _unreleased(sections),
