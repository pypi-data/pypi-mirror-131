...
from .exceptions import ChangelogDoesNotExistError, InvalidSemanticVersion, VersionDoesNotExistError
from ._changelog import (release, from_dict, to_dict, _unreleased,
                         actual_version, from_semantic, from_release)
from ._versioning import (get_bump_type, is_semantic, bump, bump_major,
...
class ChangelogUtils:
    ...
    def get_new_release_version(self, release_type: str = "suggest") -> str:
        ...
        if release_type == 'major':
            ...
            semantic_version = bump(self.data['unreleased'],
                                    semantic_version)
