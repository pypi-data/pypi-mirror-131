...
class testing_class():
    ...
    def test(self):
        ...
        for pth_index in range(len(self.model_list)):
            ...
            if '.pth' in aaa:
                ...
                for N in range(len(self.img_list)):
                    name_list, noise_img, coordinate_list,test_im_name = test_preprocess_chooseOne(self, N)
                    # print(len(name_list))
                    prev_time = time.time()
                    ...
                    del denoise_img
                    print('\033[1;31mDisplaying the denoise file -----> \033[0m')
        ...
        print('Test finished. Save all model to disk.')
