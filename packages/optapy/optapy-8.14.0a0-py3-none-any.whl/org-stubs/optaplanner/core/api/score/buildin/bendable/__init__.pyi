...
class BendableScore(org.optaplanner.core.api.score.AbstractBendableScore['BendableScore']):
    """
    public final class BendableScore extends :class:`~org.optaplanner.core.api.score.AbstractBendableScore`<:class:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore`>
    
        This :class:`~org.optaplanner.core.api.score.Score` is based on n levels of int constraints. The number of levels is
        bendable at configuration time.
    
        This class is immutable.
    
        The :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore.getHardLevelsSize` and
        :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore.getSoftLevelsSize` must be the same as in the
        :class:`~org.optaplanner.core.impl.score.buildin.bendable.BendableScoreDefinition` used.
    ...
    def add(self, bendableScore: 'BendableScore') -> 'BendableScore':
        """
            ...
            Parameters:
                addend (:class:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore`): value to be added to this Score
    ...
    def divide(self, double: float) -> 'BendableScore':
        """
            ...
            :meth:`~org.optaplanner.core.api.score.buildin.bendable.https:.docs.oracle.com.javase.8.docs.api.java.lang.Math.html?is`).
    ...
    def equals(self, object: typing.Any) -> bool:
        """
            ...
            Overrides:
                ...
                meth:`~org.optaplanner.core.api.score.buildin.bendable.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object.html?is` in
                class :class:`~org.optaplanner.core.api.score.buildin.bendable.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object?is`
    ...
    def getHardOrSoftScore(self, int: int) -> int:
        """
            ...
            Parameters:
                level (int): :code:`0 <= level <` :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore.getLevelsSize`
    ...
    def getHardScore(self, int: int) -> int:
        """
            ...
            Parameters:
                hardLevel (int): :code:`0 <= hardLevel <` :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore.getHardLevelsSize`. The
    ...
    def getSoftScore(self, int: int) -> int:
        """
            ...
            Parameters:
                softLevel (int): :code:`0 <= softLevel <` :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore.getSoftLevelsSize`. The
                    :code:`scoreLevel` is :code:`hardLevel` for hard levels and :code:`softLevel + hardLevelSize` for soft levels.
    ...
    def negate(self) -> 'BendableScore':
        ...
        ...
    @staticmethod
    def of(intArray: typing.List[int], intArray2: typing.List[int]) -> 'BendableScore':
        """
            Creates a new :class:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore`.
        
            Parameters:
                hardScores (int[]): never null, never change that array afterwards: it must be immutable
                softScores (int[]): never null, never change that array afterwards: it must be immutable
    ...
    def ofSoft(int: int, int2: int, int3: int, int4: int) -> 'BendableScore':
        ...
        ...
    @staticmethod
    def ofUninitialized(int: int, intArray: typing.List[int], intArray2: typing.List[int]) -> 'BendableScore':
        """
            Creates a new :class:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore`.
    ...
    def parseScore(string: str) -> 'BendableScore':
        """
            ...
            Parameters:
                scoreString (:class:`~org.optaplanner.core.api.score.buildin.bendable.https:.docs.oracle.com.javase.8.docs.api.java.lang.String?is`): never null
    ...
    def subtract(self, bendableScore: 'BendableScore') -> 'BendableScore':
        """
            ...
            Parameters:
                subtrahend (:class:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore`): value to be subtracted from this Score
    ...
    def toShortString(self) -> str:
        """
            ...
            Like
            :meth:`~org.optaplanner.core.api.score.buildin.bendable.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object.html?is`,
...
class BendableScoreHolder(org.optaplanner.core.api.score.holder.ScoreHolder[BendableScore]):
    """
    public interface BendableScoreHolder extends :class:`~org.optaplanner.core.api.score.holder.ScoreHolder`<:class:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore`>
    
    
        Also see:
            :class:`~org.optaplanner.core.api.score.buildin.bendable.BendableScore`
    """
    def addHardConstraintMatch(self, ruleContext: org.kie.api.runtime.rule.RuleContext, int: int, int2: int) -> None:
        """
            ...
            Parameters:
                ...
                hardLevel (int): :code:`0 <= hardLevel <` :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScoreHolder.getHardLevelsSize`.
                    The :code:`scoreLevel` is :code:`hardLevel` for hard levels and :code:`softLevel + hardLevelSize` for soft levels.
                weight (int): higher is better, negative for a penalty, positive for a reward
        
        
        """
        ...
    def addMultiConstraintMatch(self, ruleContext: org.kie.api.runtime.rule.RuleContext, intArray: typing.List[int], intArray2: typing.List[int]) -> None:
        """
        
            Parameters:
                kcontext (org.kie.api.runtime.rule.RuleContext): never null, the magic variable in DRL
                hardWeights (int[]): never null, array of length
                    :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScoreHolder.getHardLevelsSize`
                softWeights (int[]): never null, array of length
                    :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScoreHolder.getSoftLevelsSize`
    ...
    def addSoftConstraintMatch(self, ruleContext: org.kie.api.runtime.rule.RuleContext, int: int, int2: int) -> None:
        """
            ...
            Parameters:
                kcontext (org.kie.api.runtime.rule.RuleContext): never null, the magic variable in DRL
                softLevel (int): :code:`0 <= softLevel <` :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScoreHolder.getSoftLevelsSize`.
                    The :code:`scoreLevel` is :code:`hardLevel` for hard levels and :code:`softLevel + hardLevelSize` for soft levels.
                weight (int): higher is better, negative for a penalty, positive for a reward
    ...
    def penalize(self, ruleContext: org.kie.api.runtime.rule.RuleContext, int: int) -> None:
        """
            ...
            :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScoreHolder.penalize`.
        
            Parameters:
                kcontext (org.kie.api.runtime.rule.RuleContext): never null, the magic variable in DRL
                hardWeightsMultiplier (int[]): elements at least 0
                softWeightsMultiplier (int[]): elements at least 0
        
        
        """
        ...
    @typing.overload
    def penalize(self, ruleContext: org.kie.api.runtime.rule.RuleContext, intArray: typing.List[int], intArray2: typing.List[int]) -> None: ...
    @typing.overload
    ...
    def reward(self, ruleContext: org.kie.api.runtime.rule.RuleContext, int: int) -> None:
        """
            ...
            :meth:`~org.optaplanner.core.api.score.buildin.bendable.BendableScoreHolder.reward`.
        ...
        ...
    @typing.overload
    def reward(self, ruleContext: org.kie.api.runtime.rule.RuleContext, intArray: typing.List[int], intArray2: typing.List[int]) -> None: ...
    @typing.overload
