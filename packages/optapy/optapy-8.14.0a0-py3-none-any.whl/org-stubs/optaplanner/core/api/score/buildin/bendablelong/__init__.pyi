...
class BendableLongScore(org.optaplanner.core.api.score.AbstractBendableScore['BendableLongScore']):
    """
    public final class BendableLongScore extends :class:`~org.optaplanner.core.api.score.AbstractBendableScore`<:class:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore`>
    
        This :class:`~org.optaplanner.core.api.score.Score` is based on n levels of long constraints. The number of levels is
        bendable at configuration time.
    
        This class is immutable.
    
        The :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore.getHardLevelsSize` and
        :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore.getSoftLevelsSize` must be the same as in
        the :class:`~org.optaplanner.core.impl.score.buildin.bendablelong.BendableLongScoreDefinition` used.
    ...
    def add(self, bendableLongScore: 'BendableLongScore') -> 'BendableLongScore':
        """
            ...
            Parameters:
                addend (:class:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore`): value to be added to this Score
    ...
    def divide(self, double: float) -> 'BendableLongScore':
        """
            ...
            :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.https:.docs.oracle.com.javase.8.docs.api.java.lang.Math.html?is`).
    ...
    def equals(self, object: typing.Any) -> bool:
        """
            ...
            Overrides:
                ...
                meth:`~org.optaplanner.core.api.score.buildin.bendablelong.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object.html?is` in
                class :class:`~org.optaplanner.core.api.score.buildin.bendablelong.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object?is`
    ...
    def getHardOrSoftScore(self, int: int) -> int:
        """
            ...
            Parameters:
                index (int): :code:`0 <= index <` :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore.getLevelsSize`
    ...
    def getHardScore(self, int: int) -> int:
        """
            ...
            Parameters:
                index (int): :code:`0 <= index <` :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore.getHardLevelsSize`
        ...
        """
        ...
    def getHardScores(self) -> typing.List[int]:
        """
    ...
    def getSoftScore(self, int: int) -> int:
        """
            ...
            Parameters:
                index (int): :code:`0 <= index <` :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore.getSoftLevelsSize`
        ...
        """
        ...
    def getSoftScores(self) -> typing.List[int]:
        """
    ...
    def negate(self) -> 'BendableLongScore':
        ...
        ...
    @staticmethod
    def of(longArray: typing.List[int], longArray2: typing.List[int]) -> 'BendableLongScore':
        """
            Creates a new :class:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore`.
        
            Parameters:
                hardScores (long[]): never null, never change that array afterwards: it must be immutable
                softScores (long[]): never null, never change that array afterwards: it must be immutable
    ...
    def ofSoft(int: int, int2: int, int3: int, long: int) -> 'BendableLongScore':
        ...
        ...
    @staticmethod
    def ofUninitialized(int: int, longArray: typing.List[int], longArray2: typing.List[int]) -> 'BendableLongScore':
        """
            Creates a new :class:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore`.
    ...
    def parseScore(string: str) -> 'BendableLongScore':
        """
            ...
            Parameters:
                scoreString (:class:`~org.optaplanner.core.api.score.buildin.bendablelong.https:.docs.oracle.com.javase.8.docs.api.java.lang.String?is`): never null
    ...
    def subtract(self, bendableLongScore: 'BendableLongScore') -> 'BendableLongScore':
        """
            ...
            Parameters:
                subtrahend (:class:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore`): value to be subtracted from this Score
    ...
    def toLevelNumbers(self) -> typing.List[java.lang.Number]:
        """
            ...
            Also see:
                :meth:`~org.optaplanner.core.impl.score.definition.ScoreDefinition.fromLevelNumbers`
    ...
    def toShortString(self) -> str:
        """
            ...
            Like
            :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object.html?is`,
...
class BendableLongScoreHolder(org.optaplanner.core.api.score.holder.ScoreHolder[BendableLongScore]):
    """
    public interface BendableLongScoreHolder extends :class:`~org.optaplanner.core.api.score.holder.ScoreHolder`<:class:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore`>
    
    
        Also see:
            :class:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScore`
    """
    def addHardConstraintMatch(self, ruleContext: org.kie.api.runtime.rule.RuleContext, int: int, long: int) -> None:
        """
            ...
            Parameters:
                ...
                hardLevel (int): :code:`0 <= hardLevel <`
                    :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScoreHolder.getHardLevelsSize`. The
        ...
        """
        ...
    def addMultiConstraintMatch(self, ruleContext: org.kie.api.runtime.rule.RuleContext, longArray: typing.List[int], longArray2: typing.List[int]) -> None:
        """
        
            Parameters:
                kcontext (org.kie.api.runtime.rule.RuleContext): never null, the magic variable in DRL
                hardWeights (long[]): never null, array of length
                    :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScoreHolder.getHardLevelsSize`
                softWeights (long[]): never null, array of length
                    :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScoreHolder.getSoftLevelsSize`
        ...
        """
            ...
            Parameters:
                ...
                softLevel (int): :code:`0 <= softLevel <`
                    :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScoreHolder.getSoftLevelsSize`. The
                    :code:`scoreLevel` is :code:`hardLevel` for hard levels and :code:`softLevel + hardLevelSize` for soft levels.
                weight (long): higher is better, negative for a penalty, positive for a reward
    ...
    def penalize(self, ruleContext: org.kie.api.runtime.rule.RuleContext, long: int) -> None:
        """
            ...
            :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScoreHolder.penalize`.
        
            Parameters:
                kcontext (org.kie.api.runtime.rule.RuleContext): never null, the magic variable in DRL
                hardWeightsMultiplier (long[]): elements at least 0
                softWeightsMultiplier (long[]): elements at least 0
        
        
        """
        ...
    @typing.overload
    def penalize(self, ruleContext: org.kie.api.runtime.rule.RuleContext, longArray: typing.List[int], longArray2: typing.List[int]) -> None: ...
    @typing.overload
    ...
    def reward(self, ruleContext: org.kie.api.runtime.rule.RuleContext, long: int) -> None:
        """
            ...
            :meth:`~org.optaplanner.core.api.score.buildin.bendablelong.BendableLongScoreHolder.reward`.
        ...
        ...
    @typing.overload
    def reward(self, ruleContext: org.kie.api.runtime.rule.RuleContext, longArray: typing.List[int], longArray2: typing.List[int]) -> None: ...
    @typing.overload
