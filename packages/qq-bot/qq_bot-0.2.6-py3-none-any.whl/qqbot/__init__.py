...
from qqbot.model.guild_member import GuildMembersPager
...
def listen_events(t_token: Token, is_sandbox, *handlers: Handler):
    """
    注册并监听频道相关事件
...
class APIBase:
    ...
    def __init__(self, token: Token, is_sandbox):
        """
        API初始化信息
...
class GuildRoleAPI(APIBase):
    ...
    def guild_roles(self, guild_id) -> GuildRoles:
        """
        获取频道身份组列表
    ...
    def guild_role_create(
        self, guild_id, role_info: RoleUpdateInfo
    ) -> RoleUpdateResult:
        """
        创建频道身份组
    ...
    def guild_role_update(
        self, guild_id, role_id, role_info: RoleUpdateInfo
    ) -> RoleUpdateResult:
        """
        修改频道身份组
    ...
    def guild_role_delete(self, guild_id, role_id) -> bool:
        """
        删除频道身份组
    ...
    def guild_role_member_add(
        self, guild_id, role_id, user_id, role_req: RoleMemberRequest = None
    ) -> bool:
        """
        增加频道身份组成员
...
class GuildMemberAPI(APIBase):
    ...
    def guild_member(self, guild_id, user_id) -> Member:
        """
        获取频道指定成员
    ...
    def guild_members(
        self, guild_id, guild_member_pager: GuildMembersPager
    ) -> [Member]:
        """
        获取成员列表，需要申请接口权限
...
class ChannelAPI(APIBase):
    ...
    def channels(self, guild_id) -> [Channel]:
        """
        获取频道下的子频道列表
...
class ChannelPermissionsAPI(APIBase):
    ...
    def channel_permissions(self, channel_id, user_id) -> ChannelPermissions:
        """
        获取指定子频道的权限
    ...
    def channel_permissions_update(
...
class MessageAPI(APIBase):
    ...
    def message(self, channel_id, message_id) -> Message:
        """
        获取指定消息
    ...
    def post_message(self, channel_id, message_send: MessageSendRequest) -> Message:
        """
        发送消息
    ...
    def create_direct_message_guild(
    ...
    def post_direct_message(
        self, guild_id, message_send: MessageSendRequest
    ) -> Message:
        """
        发送私信

        :param d_msg: 创建私信频道成功后返回的对象 DirectMessageGuild
...
class AudioAPI(APIBase):
    ...
    def post_audio(self, channel_id, audio_control: AudioControl) -> AudioControl:
        """
        音频控制
        ...
        return json.loads(response.content, object_hook=AudioControl)
