...
from seeq.spy.workbooks._worksheet import AnalysisWorkstep
...
class Report(Annotation):
    ...
    def get_embedded_content_html(self, display, date_range=None, size='medium', shape='rectangle', width=None,
                                  height=None, scale=1.0, selector=''):
        # type: (AnalysisWorkstep, Optional[DateRange], str, str, Optional[int], Optional[int], float, str) -> str
