...
def plotting(table, ranked, annotlist):
    if ranked == False:
        ...
        for i in annotlist:
            fig.add_annotation(x=max_val, y=i, text="This value is calculated by doubling the next greatest numerical value that we could compute.",
...
def main():
    ...
    plotting(resulttable, ranked=args.ranked, annotlist=annotlist)
