...
class BaseMiddleware(RoutesMixin):
    ...
    PYTHON_DEPRECATION_MSG = (
        "[Contrast Security] [DEPRECATION] Agent version 5.0.0 will drop support for Python {}.{} in December 2021. "
    ...
    def __init__(self):
        ...
        if sys.version_info[0:2] <= (3, 6):
            self.log_deprecation(
                self.PYTHON_DEPRECATION_MSG.format(
