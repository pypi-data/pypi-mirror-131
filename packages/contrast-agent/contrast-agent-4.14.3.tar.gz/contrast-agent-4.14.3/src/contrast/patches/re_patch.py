...
def build_group_hook(original_func, patch_policy, propagator):
    ...
    group_hook.__name__ = six.ensure_str(patch_policy.method_name)
    return group_hook
...
def build_sub_hook(original_func, policy_node):
    ...
    sub_hook.__name__ = six.ensure_str(policy_node.method_name)
    return sub_hook
...
def build_re_assess_hook(original_func, patch_policy):
    ...
    assess_hook.__name__ = six.ensure_str(original_func.__name__)
    return assess_hook
...
def build_re_pattern_redos_hook(original_func, _):
    ...
    redos_hook.__name__ = six.ensure_str(method_name)
    return redos_hook
