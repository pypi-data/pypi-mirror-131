...
def patch_pathlib(pathlib_module):
    ...
    # TODO: PYT-1456 This seems like a problem that wrapt would solve better
    for attr_name, attr in accessor.__dict__.items():
        underlying = (
            # This case handles PY35 and PY36
            attr.__func__.__wrapped__
            if is_wrapped_staticmethod(attr)
            # This case handles PY37
            else attr
        )

        patch = patch_manager.get_patch(underlying)
