...
PRIVATE_SASS_DOMAIN = "contrastsecurity.com"
PRIVATE_SASS_TEAMSERVER_TYPE = "SAAS_CUSTOM"

TESTING_TEAMSERVER_NAMES = ["darpa"]
...
class AgentConfig(object):
    ...
    def teamserver_type(self):
        ...
        return (
            PRIVATE_SASS_TEAMSERVER_TYPE
            if PRIVATE_SASS_DOMAIN in url
            else DEFAULT_TEAMSERVER_TYPE
        )
