...
class Spider:
    ...
    # --------------------api工具--------------------
    __china_api = 'https://view.inews.qq.com/g2/getOnsInfo?name=disease_h5&callback=jQuery351003082652963114918_1639808143071&_=1639808143072'
    __world_api = 'https://view.inews.qq.com/g2/getOnsInfo?name=disease_foreign&callback=jQuery351003082652963114918_1639808143075&_=1639808143076'
    __headers = {
    ...
    @staticmethod
    def _get_api(**kwargs):
        text: str = requests.get(url=kwargs['url'], headers=kwargs['headers']).text
        text: str = re.search(r'.*\((.*?)\)', text).group(1)
        data: str = json.loads(text)['data']
...
class Nation:
    ...
    def searchProvince(self, *args):
        ...
        provinces = Spider._parseProvince(data=self.__data) if self.name != '中国' else Spider._parseProvince_china(data=self.__data)
