...
def run(
    ...
    if item == "ATMO":
        ...
        P_low, T_low = R13a_Pressure_and_Temperature.Temp_Pre(N_data, T_BC_low, Nn,\
            bend_radius, i_neut_upp, i_Surface, kB, G, m_bar, M_Mars,refractivity)
        P_med, T_med = R13a_Pressure_and_Temperature.Temp_Pre(N_data, T_BC_med, Nn,\
            bend_radius, i_neut_upp, i_Surface, kB, G, m_bar, M_Mars,refractivity)
        P_upp, T_upp = R13a_Pressure_and_Temperature.Temp_Pre(N_data, T_BC_upp, Nn,\
            bend_radius, i_neut_upp, i_Surface, kB, G, m_bar, M_Mars,refractivity)
