from src.regtag.reg.numbers import re_num_list
from src.regtag.reg.numberscales import re_number_scale_list
from src.regtag.reg.date import re_date_list
from src.regtag.reg.id import re_id_list
from src.regtag.reg.oov import format_word, vi_dict
import re
...
def tagging_number(txt, debug=True):
    txt_tag = ['O'] * len(txt)
...
if __name__ == "__main__":
    ...
    print(input_text)
    tags = tagging_number(input_text)
    for p_i in list(zip(list(input_text), tags)):
        print(p_i)
