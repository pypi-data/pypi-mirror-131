...
if os.path.isfile('parse_file.py'):
    ...
    from plot_basics import PlotUlgBasics
    from plot_sysid import PlotUlgSysid
    from plot_mixer import PlotUlgMixer
else:
    from toopazo_ulg.parse_file import UlgParser
    from toopazo_ulg.plot_basics import PlotUlgBasics
    from toopazo_ulg.plot_sysid import PlotUlgSysid
    from toopazo_ulg.plot_mixer import PlotUlgMixer
...
class PlotUlgLog:
    def __init__(self, bdir, log_num, time_win,
        ...
        self.ulg_plot_basics = PlotUlgBasics(
            self.logdir, self.tmpdir, self.plotdir)

        self.ulg_plot_sysid = PlotUlgSysid(
            self.logdir, self.tmpdir, self.plotdir)

        self.ulg_plot_mixer = PlotUlgMixer(
            self.logdir, self.tmpdir, self.plotdir)
