...
class PlotUlgBasics:
    ...
    def nwindow_hover_vel(self, ulgfile, closefig):
        ...
        ilast = nmax - window + 1
        x_window = x[0:ilast+1]
        fcost = PlotUlgBasics.nwindow_fcost
    ...
    def pos_vel(self, ulgfile, time_win):
        ...
        df_pv = UlgParser.get_pandas_dataframe_from_csv_file(tmpdir, ulgfile, csvname)
    ...
    def rpy_angles(self, ulgfile, time_win):
        ...
        df_att = UlgParser.get_pandas_dataframe_from_csv_file(tmpdir, ulgfile, csvname)
        ...
        df_attsp = UlgParser.get_pandas_dataframe_from_csv_file(tmpdir, ulgfile, csvname)
    ...
    def pqr_angvel(self, ulgfile, time_win):
        ...
        df_angvel = UlgParser.get_pandas_dataframe_from_csv_file(tmpdir, ulgfile, csvname)
        ...
        df_angvelsp = UlgParser.get_pandas_dataframe_from_csv_file(tmpdir, ulgfile, csvname)
    ...
    def man_ctrl(self, ulgfile, time_win):
        ...
        df_sticks = UlgParser.get_pandas_dataframe_from_csv_file(tmpdir, ulgfile, csvname)
        ...
        df_switches = UlgParser.get_pandas_dataframe_from_csv_file(tmpdir, ulgfile, csvname)
    ...
    def ctrl_alloc(self, ulgfile, time_win):
        ...
        df_in = UlgParser.get_pandas_dataframe_from_csv_file(tmpdir, ulgfile, csvname)
        ...
        df_out = UlgParser.get_pandas_dataframe_from_csv_file(tmpdir, ulgfile, csvname)
