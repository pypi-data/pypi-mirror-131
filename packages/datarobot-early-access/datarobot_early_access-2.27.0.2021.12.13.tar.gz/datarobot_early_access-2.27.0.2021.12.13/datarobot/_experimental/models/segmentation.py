...
class Segment(APIObject):
    ...
    is_in_modeling_stage : bool
        Whether the segment is in modeling stage
    """
    ...
    _converter = t.Dict(
        {
            t.Key("project_id", optional=True): t.String | t.Null,
            t.Key("segment"): t.String,
            t.Key("is_in_modeling_stage", optional=True): t.Bool | t.Null,
        }
    ).ignore_extra("*")

    def __init__(self, project_id=None, segment=None, is_in_modeling_stage=None):
        self.project_id = project_id
        self.segment = segment
        self.is_in_modeling_stage = is_in_modeling_stage
