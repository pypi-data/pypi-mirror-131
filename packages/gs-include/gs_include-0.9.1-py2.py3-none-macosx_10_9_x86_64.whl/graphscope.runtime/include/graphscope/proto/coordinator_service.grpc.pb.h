...
class CoordinatorService final {
 public:
  ...
  class WithCallbackMethod_RunStep : public BaseClass {
   ...
   public:
    WithCallbackMethod_RunStep() {
      ::grpc::Service::MarkMethodCallback(2,
          new ::grpc::internal::CallbackUnaryHandler< ::gs::rpc::RunStepRequest, ::gs::rpc::RunStepResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::gs::rpc::RunStepRequest* request, ::gs::rpc::RunStepResponse* response) { return this->RunStep(context, request, response); }));}
    void SetMessageAllocatorFor_RunStep(
        ::grpc::MessageAllocator< ::gs::rpc::RunStepRequest, ::gs::rpc::RunStepResponse>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* RunStep(
      ::grpc::CallbackServerContext* /*context*/, const ::gs::rpc::RunStepRequest* /*request*/, ::gs::rpc::RunStepResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_ConnectSession<WithCallbackMethod_HeartBeat<WithCallbackMethod_RunStep<WithCallbackMethod_FetchLogs<WithCallbackMethod_CloseSession<Service > > > > > CallbackService;
