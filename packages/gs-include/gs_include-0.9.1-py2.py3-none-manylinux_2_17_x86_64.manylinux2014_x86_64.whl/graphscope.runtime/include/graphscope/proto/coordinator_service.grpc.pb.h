...
//
//
#ifndef GRPC_proto_2fcoordinator_5fservice_2eproto__INCLUDED
#define GRPC_proto_2fcoordinator_5fservice_2eproto__INCLUDED

#include "proto/coordinator_service.pb.h"
 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status RunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest& request, ::gs::rpc::RunStepResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::gs::rpc::RunStepResponse>> AsyncRunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::gs::rpc::RunStepResponse>>(AsyncRunStepRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::gs::rpc::RunStepResponse>> PrepareAsyncRunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::gs::rpc::RunStepResponse>>(PrepareAsyncRunStepRaw(context, request, cq));
    }
    // Fetch engine logs.
    ...
    class experimental_async_interface {
     public:
      ...
      #endif
      // Drives the graph computation.
      virtual void RunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest* request, ::gs::rpc::RunStepResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void RunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest* request, ::gs::rpc::RunStepResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void RunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest* request, ::gs::rpc::RunStepResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // Fetch engine logs.
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::gs::rpc::RunStepResponse>* AsyncRunStepRaw(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::gs::rpc::RunStepResponse>* PrepareAsyncRunStepRaw(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status RunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest& request, ::gs::rpc::RunStepResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::gs::rpc::RunStepResponse>> AsyncRunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::gs::rpc::RunStepResponse>>(AsyncRunStepRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::gs::rpc::RunStepResponse>> PrepareAsyncRunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::gs::rpc::RunStepResponse>>(PrepareAsyncRunStepRaw(context, request, cq));
    }
    ...
    class experimental_async final :
     ...
     public:
      ...
      #endif
      void RunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest* request, ::gs::rpc::RunStepResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void RunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest* request, ::gs::rpc::RunStepResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void RunStep(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest* request, ::gs::rpc::RunStepResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::gs::rpc::RunStepResponse>* AsyncRunStepRaw(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::gs::rpc::RunStepResponse>* PrepareAsyncRunStepRaw(::grpc::ClientContext* context, const ::gs::rpc::RunStepRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // Drives the graph computation.
    virtual ::grpc::Status RunStep(::grpc::ServerContext* context, const ::gs::rpc::RunStepRequest* request, ::gs::rpc::RunStepResponse* response);
    // Fetch engine logs.
  ...
  class WithAsyncMethod_RunStep : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status RunStep(::grpc::ServerContext* /*context*/, const ::gs::rpc::RunStepRequest* /*request*/, ::gs::rpc::RunStepResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestRunStep(::grpc::ServerContext* context, ::gs::rpc::RunStepRequest* request, ::grpc::ServerAsyncResponseWriter< ::gs::rpc::RunStepResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  typedef WithAsyncMethod_ConnectSession<WithAsyncMethod_HeartBeat<WithAsyncMethod_RunStep<WithAsyncMethod_FetchLogs<WithAsyncMethod_CloseSession<Service > > > > > AsyncService;
  template <class BaseClass>
  ...
  class ExperimentalWithCallbackMethod_RunStep : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_RunStep() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(2,
          new ::grpc::internal::CallbackUnaryHandler< ::gs::rpc::RunStepRequest, ::gs::rpc::RunStepResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::gs::rpc::RunStepRequest* request, ::gs::rpc::RunStepResponse* response) { return this->RunStep(context, request, response); }));}
    void SetMessageAllocatorFor_RunStep(
        ::grpc::experimental::MessageAllocator< ::gs::rpc::RunStepRequest, ::gs::rpc::RunStepResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(2);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(2);
    #endif
      static_cast<::grpc::internal::CallbackUnaryHandler< ::gs::rpc::RunStepRequest, ::gs::rpc::RunStepResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* RunStep(
      ::grpc::CallbackServerContext* /*context*/, const ::gs::rpc::RunStepRequest* /*request*/, ::gs::rpc::RunStepResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* RunStep(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::gs::rpc::RunStepRequest* /*request*/, ::gs::rpc::RunStepResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_ConnectSession<ExperimentalWithCallbackMethod_HeartBeat<ExperimentalWithCallbackMethod_RunStep<ExperimentalWithCallbackMethod_FetchLogs<ExperimentalWithCallbackMethod_CloseSession<Service > > > > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_ConnectSession<ExperimentalWithCallbackMethod_HeartBeat<ExperimentalWithCallbackMethod_RunStep<ExperimentalWithCallbackMethod_FetchLogs<ExperimentalWithCallbackMethod_CloseSession<Service > > > > > ExperimentalCallbackService;
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_RunStep() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::internal::StreamedUnaryHandler<
          ::gs::rpc::RunStepRequest, ::gs::rpc::RunStepResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::gs::rpc::RunStepRequest, ::gs::rpc::RunStepResponse>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedRunStep(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::gs::rpc::RunStepRequest,::gs::rpc::RunStepResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_ConnectSession<WithStreamedUnaryMethod_HeartBeat<WithStreamedUnaryMethod_RunStep<WithStreamedUnaryMethod_CloseSession<Service > > > > StreamedUnaryService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_ConnectSession<WithStreamedUnaryMethod_HeartBeat<WithStreamedUnaryMethod_RunStep<WithSplitStreamingMethod_FetchLogs<WithStreamedUnaryMethod_CloseSession<Service > > > > > StreamedService;
};
...
#endif  // GRPC_proto_2fcoordinator_5fservice_2eproto__INCLUDED
