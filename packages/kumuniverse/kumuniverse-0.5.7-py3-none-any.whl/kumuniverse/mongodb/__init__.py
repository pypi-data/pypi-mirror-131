...
class Mongo:
    def __init__(
        ...
        uri = "mongodb+srv://%s:%s@%s/?authSource=$external&authMechanism=MONGODB-AWS&retryWrites=true&w=majority&readConcernLevel=majority&readPreference=secondaryPreferred" % (
            access_key_id,
            secret_access_key,
            cluster,
        )
