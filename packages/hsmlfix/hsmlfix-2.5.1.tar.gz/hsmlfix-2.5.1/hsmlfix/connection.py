...
from hsmlfix.decorators import connected, not_connected
from hsml import client
from hsmlfix.core import model_api, model_registry_api
...
class Connection:
    ...
    def connection(
        ...
        """Connection factory method, accessible through `hsmlfix.connection()`."""
        return cls(
            host,
            port,
            project,
