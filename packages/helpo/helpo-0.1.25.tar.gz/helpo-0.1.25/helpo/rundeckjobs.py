    ...
    def hcloud_web_solutions(
        ...
        if deployment_action == "apply":
            ...
            self.run_command(["terraform", "destroy", "-input=false", "-auto-approve"], cwd=config_dir_location,
                             check=True)
            self.terraform_cloud_workspace(deployment_action, fqdn, datacenter, organization, terraform_cloud_token,
                                           auto_apply, execution_mode, deployment_environment, terraform_code_dir)
