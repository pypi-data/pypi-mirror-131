...
class TestProtocol(SDKBaseTest):
    ...
    def test___init__(self):
        ...
        self.assertEqual([], tested.compute_on_change_types)
        self.assertEqual([], tested.responds_to_event_types)
        self.assertEqual([], tested.identifiers)
        self.assertEqual('', tested.title)
        self.assertEqual('', tested.description)
        self.assertEqual('', tested.information)
    ...
    def test_references(self):
        ...
        self.assertEqual(expected, tested.references)
...
class TestClinicalQualityMeasure(SDKBaseTest):
    ...
    def test___init__(self):
        ...
        self.assertEqual(['HEALTH_MAINTENANCE'], tested.responds_to_event_types)
        ...
        self.assertEqual(datetime.today().strftime(fmt), tested.timeframe.end.strftime(fmt))

        self.assertEqual(datetime.today().strftime(fmt), tested.now.strftime(fmt))
    ...
    def test_impacted_by_changes(self):
        ...
        tested.compute_on_change_types = [
            'change_X',
            'change_B',
            'change_C',
        ]
    ...
    def test_screening_interval_context(self):
        ...
        cqm = CQMWithDefaultDisplayInterval(patient=patient)
        cqm.default_display_interval_in_days = 30
...
class TestProcedures(SDKBaseTest):
    ...
    def test_get_protocols(self):
        ...
        result = get_protocols(get_protocols_unittest)
        self.assertEqual(2, len(result))
    ...
    def test_protocols_for_patient(self):
        patient = self.load_patient('full')
        protocols = get_protocols(get_protocols_unittest)
