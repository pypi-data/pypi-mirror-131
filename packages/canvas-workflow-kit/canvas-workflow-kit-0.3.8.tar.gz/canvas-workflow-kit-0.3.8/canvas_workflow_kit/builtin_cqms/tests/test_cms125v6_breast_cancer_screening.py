...
class TestClinicalQualityMeasure125v6(SDKBaseTest):
    ...
    def test_description(self):
        ...
        self.assertEqual(expected, ClinicalQualityMeasure125v6.description)

    def test_information(self):
        expected = 'https://ecqi.healthit.gov/ecqm/measures/cms125v6'
        self.assertEqual(expected, ClinicalQualityMeasure125v6.information)

    def test_enabled(self):
        self.assertTrue(ClinicalQualityMeasure125v6.enabled())

    def test_revision(self):
        self.assertEqual('2002-02-12v1', ClinicalQualityMeasure125v6.revision())

    def test_change_types(self):
        result = ClinicalQualityMeasure125v6.compute_on_change_types
        expected = [
            'protocol_override',
            'condition',
            'imaging_report',
