...
class TestCcp004v1(SDKBaseTest):
    ...
    def test_description(self):
        ...
        self.assertEqual(expected, Ccp004v1.description)

    def test_information(self):
        expected = 'https://canvas-medical.zendesk.com/hc/en-us'
        self.assertEqual(expected, Ccp004v1.information)

    def test_change_types(self):
        result = Ccp004v1.compute_on_change_types
        expected = ['condition']
        self.assertEqual(expected, result)

    def test_revision(self):
        self.assertEqual('2020-04-02v1', Ccp004v1.revision())
    ...
    @patch(
        'protocols.builtin_cqms.ccp004v1_diabetes.Ccp004v1.date_of_diagnosis',
        new_callable=PropertyMock)
    @patch('protocols.builtin_cqms.ccp004v1_diabetes.Ccp004v1.in_numerator')
    @patch('protocols.builtin_cqms.ccp004v1_diabetes.Ccp004v1.in_denominator')
