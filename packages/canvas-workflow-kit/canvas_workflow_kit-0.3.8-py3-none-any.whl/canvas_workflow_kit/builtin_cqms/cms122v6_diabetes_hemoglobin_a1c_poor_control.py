...
from workflow_sdk_loader.builtin_cqms.diabetes_quality_measure import DiabetesQualityMeasure
...
class ClinicalQualityMeasure122v6(ExternallyAwareClinicalQualityMeasure, DiabetesQualityMeasure):
    ...
    More information: https://ecqi.healthit.gov/ecqm/measures/cms122v6
    """
    ...
    class Meta:
        ...
        information = 'https://ecqi.healthit.gov/ecqm/measures/cms122v6'
