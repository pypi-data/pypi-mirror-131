...
class TestCcp002v1(SDKBaseTest):
    ...
    def test_description(self):
        ...
        self.assertEqual(expected, Ccp002v1.description)

    def test_information(self):
        expected = ('https://canvas-medical.zendesk.com/hc/en-us/articles/360059327893')
        self.assertEqual(expected, Ccp002v1.information)

    def test_change_types(self):
        result = Ccp002v1.compute_on_change_types
        expected = ['condition', 'interview', 'patient']
        self.assertEqual(expected, result)

    def test_revision(self):
        self.assertEqual('2020-03-24v1', Ccp002v1.revision())
    ...
    def test_in_initial_population(self):
        with patch('protocols.builtin_cqms.ccp002v1_high_risk_outreach.arrow.now') as now:
    ...
    @patch(
        'protocols.builtin_cqms.ccp002v1_high_risk_outreach.Ccp002v1.high_risk_conditions',
        new_callable=PropertyMock)
    @patch(
        'protocols.builtin_cqms.ccp002v1_high_risk_outreach.Ccp002v1.date_of_first_questionnaire',
        new_callable=PropertyMock)
    @patch('protocols.builtin_cqms.ccp002v1_high_risk_outreach.Ccp002v1.in_numerator')
    @patch('protocols.builtin_cqms.ccp002v1_high_risk_outreach.Ccp002v1.in_denominator')
    @patch('protocols.builtin_cqms.ccp002v1_high_risk_outreach.arrow.now')
