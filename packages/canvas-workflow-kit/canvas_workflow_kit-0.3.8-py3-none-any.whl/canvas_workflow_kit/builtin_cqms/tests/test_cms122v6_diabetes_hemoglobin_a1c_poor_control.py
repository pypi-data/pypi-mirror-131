...
class ClinicalQualityMeasure122v6Test(SDKBaseTest):
    ...
    def test_description(self):
        ...
        self.assertEqual(expected, ClinicalQualityMeasure122v6.description)

    def test_information(self):
        expected = 'https://ecqi.healthit.gov/ecqm/measures/cms122v6'
        self.assertEqual(expected, ClinicalQualityMeasure122v6.information)

    def test_enabled(self):
        self.assertTrue(ClinicalQualityMeasure122v6.enabled())

    def test_revision(self):
        self.assertEqual('2019-02-12v1', ClinicalQualityMeasure122v6.revision())

    def test_change_types(self):
        result = ClinicalQualityMeasure122v6.compute_on_change_types
        expected = [
            'protocol_override',
            'condition',
            'lab_report',
