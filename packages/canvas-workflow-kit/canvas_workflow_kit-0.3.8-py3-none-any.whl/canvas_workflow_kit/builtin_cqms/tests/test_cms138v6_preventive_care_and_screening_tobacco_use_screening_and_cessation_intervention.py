...
class TestClinicalQualityMeasure138v6(SDKBaseTest):
    ...
    def test_description(self):
        ...
        self.assertEqual(expected, ClinicalQualityMeasure138v6.description)

    def test_information(self):
        expected = 'https://ecqi.healthit.gov/ecqm/measures/cms138v6'
        self.assertEqual(expected, ClinicalQualityMeasure138v6.information)

    def test_revision(self):
        self.assertEqual('2019-04-03v1', ClinicalQualityMeasure138v6.revision())

    def test_change_types(self):
        result = ClinicalQualityMeasure138v6.compute_on_change_types
        expected = [
            'protocol_override',
            'billing_line_item',
            'instruction',
