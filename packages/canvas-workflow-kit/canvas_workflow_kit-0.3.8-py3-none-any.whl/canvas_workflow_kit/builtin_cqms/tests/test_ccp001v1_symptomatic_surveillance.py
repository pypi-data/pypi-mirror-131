...
class TestCcp001v1(SDKBaseTest):
    ...
    def test_description(self):
        ...
        self.assertEqual(expected, Ccp001v1.description)
    ...
    def test_information(self):
        ...
        self.assertEqual(expected, Ccp001v1.information)

    def test_change_types(self):
        result = Ccp001v1.compute_on_change_types
        expected = ['interview']
        self.assertEqual(expected, result)

    def test_revision(self):
        self.assertEqual('2020-04-03v1', Ccp001v1.revision())
    ...
    @patch(
        'protocols.builtin_cqms.ccp001v1_symptomatic_surveillance.Ccp001v1.anchor_time',
    ...
    @patch(
        'protocols.builtin_cqms.ccp001v1_symptomatic_surveillance.Ccp001v1.interview',
        new_callable=PropertyMock)
    @patch(
        'protocols.builtin_cqms.ccp001v1_symptomatic_surveillance.Ccp001v1.anchor_time',
        new_callable=PropertyMock)
    ...
    @patch('protocols.builtin_cqms.ccp001v1_symptomatic_surveillance.arrow.utcnow')
    @patch(
        'protocols.builtin_cqms.ccp001v1_symptomatic_surveillance.Ccp001v1.anchor_time',
        new_callable=PropertyMock)
