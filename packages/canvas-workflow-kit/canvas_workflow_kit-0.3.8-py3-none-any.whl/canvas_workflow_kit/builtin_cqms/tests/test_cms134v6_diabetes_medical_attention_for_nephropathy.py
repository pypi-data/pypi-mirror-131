...
class ClinicalQualityMeasure134v6Test(SDKBaseTest):
    ...
    def test_description(self):
        ...
        self.assertEqual(expected, ClinicalQualityMeasure134v6.description)

    def test_information(self):
        expected = 'https://ecqi.healthit.gov/ecqm/measures/cms134v6'
        self.assertEqual(expected, ClinicalQualityMeasure134v6.information)

    def test_revision(self):
        self.assertEqual('2019-02-12v1', ClinicalQualityMeasure134v6.revision())

    def test_change_types(self):
        result = ClinicalQualityMeasure134v6.compute_on_change_types
        expected = [
            'protocol_override',
            'condition',
            'instruction',
