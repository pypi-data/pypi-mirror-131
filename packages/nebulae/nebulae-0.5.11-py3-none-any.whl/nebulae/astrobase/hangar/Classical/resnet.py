...
class Resnet_V2_50(dock.Craft):
    def __init__(self, in_shape=None, scope='RESNET_V2_50'):
...
class Resnet_V2_101(dock.Craft):
    def __init__(self, in_shape=None, scope='RESNET_V2_101'):
...
class Resnet_V2_152(dock.Craft):
    def __init__(self, in_shape=None, scope='RESNET_V2_152'):
