...
class GraphModel(object):
    def __init__(self, Elements=None, Nodes=None, NodePropertySets=None, ElemPropertySets=None, MiscPropertySets=None ):
        ...
        self.NodePropertySets = NodePropertySets
        self.ElemPropertySets = ElemPropertySets
        self.MiscPropertySets = MiscPropertySets
        print('>>> Init of GraphModel', Elements, Nodes, NodePropertySets, ElemPropertySets, MiscPropertySets)
        # Dynamics
        self.Modes   = []
        self.Motions = []
