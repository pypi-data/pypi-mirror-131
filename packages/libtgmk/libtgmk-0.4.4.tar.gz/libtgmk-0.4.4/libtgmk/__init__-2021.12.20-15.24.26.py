...
'''
LIBrary implementing TGMK (Tebi-Gibi-Mebi-Kibi), a human-readable lossless case-insensitive 1024-base integer representation
...
5. EXCEPTIONS
    ...
    • ValueError if argument of tgmk2int or tgmk2tgmk is a str but is not a correct
      TGMK literal
