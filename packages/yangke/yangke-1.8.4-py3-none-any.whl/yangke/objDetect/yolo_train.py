...
wdir = 'weights' + os.sep
last = getSettings('aiTrain.save.lastModelFile')  # 最后一个迭代步的模型权值
best = getSettings('aiTrain.save.bestModelFile')  # 最有的模型权值
...
if __name__ == '__main__':
    ...
    opt.update(getSettings('aiTrain.opt'))  # 使用配置文件中参数更新配置参数
