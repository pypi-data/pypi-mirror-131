import pyltp
from ..base import getSettings, getAbsPath
...
def dependency_parsing(text):
    ...
    roles_list = [["%s:(%d,%d)" % (arg.name, arg.range.start, arg.range.end) for arg in rol.arguments] for rol in
                  rols]
