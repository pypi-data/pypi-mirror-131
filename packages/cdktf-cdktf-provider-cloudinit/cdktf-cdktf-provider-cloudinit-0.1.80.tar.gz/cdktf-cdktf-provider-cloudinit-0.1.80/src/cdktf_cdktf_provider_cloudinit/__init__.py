...
This project is explicitly not tracking the Terraform cloudinit Provider version 1:1. In fact, it always tracks `latest` of `~> 2.2.0` with every release. If there scenarios where you explicitly have to pin your provider version, you can do so by generating the [provider constructs manually](https://cdk.tf/imports).
...
class Config(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        part: typing.Sequence["ConfigPart"],
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param part: part block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/r/config.html#part Config#part}
        :param base64_encode: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/r/config.html#base64_encode Config#base64_encode}.
        :param boundary: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/r/config.html#boundary Config#boundary}.
        :param gzip: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/r/config.html#gzip Config#gzip}.
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    def part_input(self) -> typing.Optional[typing.List["ConfigPart"]]:
        return typing.cast(typing.Optional[typing.List["ConfigPart"]], jsii.get(self, "partInput"))
    ...
    def part(self) -> typing.List["ConfigPart"]:
        return typing.cast(typing.List["ConfigPart"], jsii.get(self, "part"))

    @part.setter
    def part(self, value: typing.List["ConfigPart"]) -> None:
...
class ConfigConfig(cdktf.TerraformMetaArguments):
    ...
    def part(self) -> typing.List["ConfigPart"]:
        ...
        return typing.cast(typing.List["ConfigPart"], result)
...
class ConfigPart:
    def __init__(
        ...
        *,
        ...
        '''
        :param content: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/r/config.html#content Config#content}.
        :param content_type: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/r/config.html#content_type Config#content_type}.
        :param filename: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/r/config.html#filename Config#filename}.
        :param merge_type: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/r/config.html#merge_type Config#merge_type}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
            "content": content,
        }
...
class DataCloudinitConfig(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        part: typing.Sequence["DataCloudinitConfigPart"],
        base64_encode: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        boundary: typing.Optional[builtins.str] = None,
        gzip: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
        count: typing.Optional[typing.Union[jsii.Number, cdktf.IResolvable]] = None,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param part: part block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/d/config.html#part DataCloudinitConfig#part}
        :param base64_encode: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/d/config.html#base64_encode DataCloudinitConfig#base64_encode}.
        :param boundary: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/d/config.html#boundary DataCloudinitConfig#boundary}.
        :param gzip: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/d/config.html#gzip DataCloudinitConfig#gzip}.
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="partInput")
    def part_input(self) -> typing.Optional[typing.List["DataCloudinitConfigPart"]]:
        return typing.cast(typing.Optional[typing.List["DataCloudinitConfigPart"]], jsii.get(self, "partInput"))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="part")
    def part(self) -> typing.List["DataCloudinitConfigPart"]:
        return typing.cast(typing.List["DataCloudinitConfigPart"], jsii.get(self, "part"))

    @part.setter
    def part(self, value: typing.List["DataCloudinitConfigPart"]) -> None:
        jsii.set(self, "part", value)
...
class DataCloudinitConfigConfig(cdktf.TerraformMetaArguments):
    ...
    def part(self) -> typing.List["DataCloudinitConfigPart"]:
        ...
        result = self._values.get("part")
        assert result is not None, "Required property 'part' is missing"
        return typing.cast(typing.List["DataCloudinitConfigPart"], result)
...
class DataCloudinitConfigPart:
    def __init__(
        ...
        *,
        ...
        '''
        :param content: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/d/config.html#content DataCloudinitConfig#content}.
        :param content_type: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/d/config.html#content_type DataCloudinitConfig#content_type}.
        :param filename: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/d/config.html#filename DataCloudinitConfig#filename}.
        :param merge_type: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudinit/d/config.html#merge_type DataCloudinitConfig#merge_type}.
        '''
        self._values: typing.Dict[str, typing.Any] = {
            "content": content,
        }
