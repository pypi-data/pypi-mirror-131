...
model1 = EP.BaseEP(problem_obj1, epoch=100, pop_size=50, bout_size=0.05)
model1.solve()

model2 = EP.BaseEP(problem_dict4, epoch=100, pop_size=50, bout_size=0.05)
model2.solve()
...
model3 = EP.BaseEP(problem_dict1, epoch=100, pop_size=50, bout_size=0.05, termination=termination_obj1)
model3.solve()
...
model5 = EP.BaseEP(problem_dict1, epoch=100, pop_size=50, bout_size=0.05)
model5.solve(mode='sequential')  # Default

model6 = EP.BaseEP(problem_dict1, epoch=100, pop_size=50, bout_size=0.05)
model6.solve(mode='thread')

if __name__ == "__main__":
    model7 = EP.BaseEP(problem_dict1, epoch=100, pop_size=50, pc=0.85, pm=0.15,
...
model8 = EP.BaseEP(problem_dict1, epoch=100, pop_size=50, bout_size=0.05)
model8.solve()
...
model9 = EP.BaseEP(problem_obj9, epoch=100, pop_size=50, bout_size=0.05)
model9.solve()
...
problem_obj10 = Problem(problem_dict9)
model10 = EP.LevyEP(problem_obj9, epoch=100, pop_size=50, bout_size=0.05)
model10.solve()
