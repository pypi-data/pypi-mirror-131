...
model1 = ES.BaseES(problem_obj1, epoch=100, pop_size=50, n_child=0.75)
model1.solve()

model2 = ES.BaseES(problem_dict4, epoch=100, pop_size=50, n_child=0.75)
model2.solve()
...
model3 = ES.BaseES(problem_dict1, epoch=100, pop_size=50, n_child=0.75, termination=termination_obj1)
model3.solve()
...
model5 = ES.BaseES(problem_dict1, epoch=100, pop_size=50, n_child=0.75)
model5.solve(mode='sequential')  # Default

model6 = ES.BaseES(problem_dict1, epoch=100, pop_size=50, n_child=0.75)
model6.solve(mode='thread')

if __name__ == "__main__":
    model7 = ES.BaseES(problem_dict1, epoch=100, pop_size=50, pc=0.85, pm=0.15,
...
model8 = ES.BaseES(problem_dict1, epoch=100, pop_size=50, n_child=0.75)
model8.solve()
...
model9 = ES.BaseES(problem_obj9, epoch=100, pop_size=50, n_child=0.75)
model9.solve()
...
model10 = ES.LevyES(problem_obj9, epoch=100, pop_size=50, n_child=0.75)
model10.solve()
