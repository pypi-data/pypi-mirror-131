...
model1 = GSKA.OriginalGSKA(problem_obj1, epoch=100, pop_size=50, pb=0.1, kf=0.5, kr=0.9, k=5)
model1.solve()

model2 = GSKA.OriginalGSKA(problem_dict4, epoch=100, pop_size=50, pb=0.1, kf=0.5, kr=0.9, k=5)
model2.solve()
...
model3 = GSKA.OriginalGSKA(problem_dict1, epoch=100, pop_size=50, pb=0.1, kf=0.5, kr=0.9, k=5, termination=termination_obj1)
model3.solve()
...
model5 = GSKA.OriginalGSKA(problem_dict1, epoch=100, pop_size=50, pb=0.1, kf=0.5, kr=0.9, k=5)
model5.solve(mode='sequential')  # Default

model6 = GSKA.OriginalGSKA(problem_dict1, epoch=100, pop_size=50, pb=0.1, kf=0.5, kr=0.9, k=5)
model6.solve(mode='thread')

if __name__ == "__main__":
    model7 = GSKA.OriginalGSKA(problem_dict1, epoch=100, pop_size=50, pb=0.1, kf=0.5, kr=0.9, k=5)
...
model8 = GSKA.OriginalGSKA(problem_dict1, epoch=100, pop_size=50, pb=0.1, kf=0.5, kr=0.9, k=5)
model8.solve()
...
model9 = GSKA.OriginalGSKA(problem_obj9, epoch=100, pop_size=50, pb=0.1, kf=0.5, kr=0.9, k=5)
model9.solve()
...
model10 = GSKA.BaseGSKA(problem_obj9, epoch=100, pop_size=50, pb=0.1, kr=0.7)
model10.solve()
