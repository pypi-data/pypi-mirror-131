...
### Your parameter problem can be an instane of Problem class or just dict like below
model1 = EO.BaseEO(problem_obj1, epoch=100, pop_size=50)
model1.solve()

model2 = EO.BaseEO(problem_dict4, epoch=100, pop_size=50)
model2.solve()
...
model3 = EO.BaseEO(problem_dict1, epoch=100, pop_size=50, termination=termination_obj1)
model3.solve()
...
model5 = EO.BaseEO(problem_dict1, epoch=100, pop_size=50)
model5.solve(mode='sequential')  # Default

model6 = EO.BaseEO(problem_dict1, epoch=100, pop_size=50)
model6.solve(mode='thread')

if __name__ == "__main__":
    model7 = EO.BaseEO(problem_dict1, epoch=100, pop_size=50)
...
model8 = EO.BaseEO(problem_dict1, epoch=100, pop_size=50)
model8.solve()
...
model9 = EO.BaseEO(problem_obj9, epoch=100, pop_size=50)
model9.solve()
...
model10 = EO.AdaptiveEO(problem_obj9, epoch=100, pop_size=50)
model10.solve()

model11 = EO.ModifiedEO(problem_obj9, epoch=100, pop_size=50)
model11.solve()

model12 = EO.LevyEO(problem_obj9, epoch=100, pop_size=50)
model12.solve()
