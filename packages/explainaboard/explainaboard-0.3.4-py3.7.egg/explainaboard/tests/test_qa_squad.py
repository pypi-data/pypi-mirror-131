...
class TestNER(unittest.TestCase):
    ...
    def test_generate_system_analysis(self):
        ...
        loader = get_loader(TaskType.qa_squad, Source.local_filesystem, FileType.json, path_data)
        data = loader.load()

        metadata = {"task_name": TaskType.qa_squad,
                    "dataset_name":"squad",
                    "metric_names": ["f1_score_qa","exact_match_qa"]}

        processor = get_processor(TaskType.qa_squad, metadata, data)
