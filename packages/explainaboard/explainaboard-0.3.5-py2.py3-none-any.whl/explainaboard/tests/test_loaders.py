...
class QASquadLoader(TestCase):
    def test_load_json(self):
        loader = get_loader(TaskType.qa_squad, Source.local_filesystem, FileType.json,
...
class SummSquadLoader(TestCase):
    def test_load_json(self):
        loader = get_loader(TaskType.text_summarization, Source.local_filesystem, FileType.tsv,
