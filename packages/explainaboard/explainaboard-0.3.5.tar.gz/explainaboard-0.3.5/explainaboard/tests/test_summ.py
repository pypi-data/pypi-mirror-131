...
class TestNER(unittest.TestCase):
    ...
    def test_generate_system_analysis(self):
        ...
        loader = get_loader(TaskType.text_summarization, Source.local_filesystem, FileType.tsv, path_data)
        data = loader.load()

        metadata = {"task_name": TaskType.text_summarization,
                    "dataset_name":"cnndm",
                    "metric_names": ["bleu"]}

        processor = get_processor(TaskType.text_summarization, metadata, data)
