...
def package(args: Namespace) -> None:
    ...
    feature_definitions: List[str] = args.feature_definitions
...
def add_features(args: Namespace) -> None:
    ...
    new_fdl_files: List[str] = args.feature_definitions
