...
class ForwardMessages(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["from_peer", "id", "random_id", "to_peer", "silent", "background", "with_my_score", "drop_author", "drop_media_captions", "schedule_date", "send_as"]
    ...
    def read(b: BytesIO, *args: Any) -> "ForwardMessages":
        ...
        return ForwardMessages(from_peer=from_peer, id=id, random_id=random_id, to_peer=to_peer, silent=silent, background=background, with_my_score=with_my_score, drop_author=drop_author, drop_media_captions=drop_media_captions, schedule_date=schedule_date, send_as=send_as)
