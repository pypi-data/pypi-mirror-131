...
**fao56** could always use more documentation, whether as
part of the official **fao56** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `fao56` for local
development.

1. Fork the `fao56` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/fao56.git
...
.. _issues: https://gitlab.com/b326/fao56/issues
