...
def build_list_welding_source_types_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/iot/welding/sourcetypes')
...
def build_list_electrical_data_configs_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/iot/welding')
...
def build_delete_welding_iot_config_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    # Construct URL
    url = kwargs.pop("template_url", '/iot/welding/{typeId}/{id}')
