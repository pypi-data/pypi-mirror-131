...
def build_upsert_workorder_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/erp/workorders')
...
def build_check_resource_status_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/erp/workorders/resources/{id}/status')
...
def build_start_workorder_operation_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/erp/workorders/{id}/operations/{operation}/start')
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
...
def build_stop_workorder_operation_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/erp/workorders/{id}/operations/{operation}/stop')
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
        "operation": _SERIALIZER.url("operation", operation, 'int'),
    }
...
def build_list_active_workorder_operations_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/erp/workorders/activeworkorderoperations')
...
def build_delete_workorder_operation_event_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    # Construct URL
    url = kwargs.pop("template_url", '/erp/workorders/{id}/operations/{operation}/events/{eventId}')
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
        "operation": _SERIALIZER.url("operation", operation, 'int'),
...
class WorkordersOperations(object):
        ...
        **kwargs  # type: Any
        ...
        if content_type.split(";")[0] in ['application/json', 'text/json']:
            ...
            raise ValueError(
                ...
                "['application/json', 'text/json', 'application/*+json']".format(content_type)
            )
    ...
    @distributed_trace
    def delete_workorder_operation_event(
        self,
        id,  # type: str
        operation,  # type: int
        event_id,  # type: str
