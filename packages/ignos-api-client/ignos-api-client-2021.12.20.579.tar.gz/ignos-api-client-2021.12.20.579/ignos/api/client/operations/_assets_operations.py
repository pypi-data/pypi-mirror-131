...
def build_list_assets_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/assets')

    # Construct parameters
    query_parameters = kwargs.pop("params", {})  # type: Dict[str, Any]
    if external_idprefix is not None:
        query_parameters['externalIdprefix'] = _SERIALIZER.query("external_idprefix", external_idprefix, 'str')
    if name is not None:
...
def build_search_assets_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/assets/search')
...
def build_get_asset_by_id_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/assets/{id}')
...
def build_get_asset_structure_by_id_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/assets/{id}/structure')
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'long'),
    }
