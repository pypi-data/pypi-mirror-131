...
def build_list_electrical_source_types_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/iot/electrical/sourcetypes')
...
def build_list_electrical_data_configs_request(
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/iot/electrical')
...
def build_delete_electrical_iot_config_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    # Construct URL
    url = kwargs.pop("template_url", '/iot/electrical/{typeId}/{id}')
...
class ElectricalOperations(object):
    ...
    @distributed_trace
    def delete_electrical_iot_config(
        self,
        type_id,  # type: str
        id,  # type: str
        **kwargs  # type: Any
