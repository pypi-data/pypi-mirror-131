...
from typing import List, Union, BinaryIO, Tuple, ByteString
...
#
#
# def prepare_base_state(base_url: str, solve: bool, directory: str = None) -> Tuple[ByteString, List[Issue]]:
