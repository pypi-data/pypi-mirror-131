...
def list_all_pkg():
    for name in sys.modules.keys():
        logger.info(f"Found pacakge: {name}")
...
def get_package_file_content(base, filename, do_debug=True):
