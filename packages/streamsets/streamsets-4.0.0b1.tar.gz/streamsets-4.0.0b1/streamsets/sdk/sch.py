...
class ControlHub:
    ...
    def set_default_write_protection_policy(self, protection_policy):
        ...
        Raises:
            UnsupportedMethodError: Only supported on ControlHub version 3.14.0+.
        """
        if Version(self.version) < Version('3.14.0'):
            raise UnsupportedMethodError('Method not supported for ControlHub version below 3.14.0')
