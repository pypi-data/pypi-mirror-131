...
class DeploymentStatus(DataclassDictMixIn):
    """DeploymentStatus is the most recently observed status of the Deployment.
      ...
      * **readyReplicas** ``int`` - *(optional)* readyReplicas is the number of pods targeted by this Deployment with a Ready
        Condition.
...
class ReplicaSetStatus(DataclassDictMixIn):
    """ReplicaSetStatus represents the current status of a ReplicaSet.
      ...
      * **observedGeneration** ``int`` - *(optional)* ObservedGeneration reflects the generation of the most recently observed
        ReplicaSet.
      * **readyReplicas** ``int`` - *(optional)* readyReplicas is the number of pods targeted by this ReplicaSet with a Ready
        Condition.
    """
    replicas: 'int'
    availableReplicas: 'int' = None
...
@dataclass
class StatefulSetPersistentVolumeClaimRetentionPolicy(DataclassDictMixIn):
    """StatefulSetPersistentVolumeClaimRetentionPolicy describes the policy used for
      ...
      * **whenDeleted** ``str`` - *(optional)* WhenDeleted specifies what happens to PVCs created from StatefulSet
      ...
      * **whenScaled** ``str`` - *(optional)* WhenScaled specifies what happens to PVCs created from StatefulSet
...
class StatefulSetSpec(DataclassDictMixIn):
    """A StatefulSetSpec is the specification of a StatefulSet.
      ...
      * **podManagementPolicy** ``str`` - *(optional)* podManagementPolicy controls how pods are created during initial scale up,
        ...
        and strictly decreasing order on scale down, progressing only when the
    ...
    template: 'core_v1.PodTemplateSpec'
    minReadySeconds: 'int' = None
    persistentVolumeClaimRetentionPolicy: 'StatefulSetPersistentVolumeClaimRetentionPolicy' = None
...
class StatefulSetStatus(DataclassDictMixIn):
    """StatefulSetStatus represents the current state of a StatefulSet.
      ...
      * **availableReplicas** ``int`` - Total number of available pods (ready for at least minReadySeconds) targeted
      ...
      * **readyReplicas** ``int`` - *(optional)* readyReplicas is the number of pods created for this StatefulSet with a Ready
        Condition.
