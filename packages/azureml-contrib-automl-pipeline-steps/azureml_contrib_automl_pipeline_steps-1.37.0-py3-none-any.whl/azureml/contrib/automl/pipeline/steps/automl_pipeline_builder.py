...
class AutoMLPipelineBuilder:
    ...
    def get_many_models_train_steps(
        ...
        vm_size = experiment.workspace.compute_targets.get(compute_name).vm_size

        supported_vmsizes = experiment.workspace.compute_targets.get(compute_name).\
            supported_vmsizes(experiment.workspace)
