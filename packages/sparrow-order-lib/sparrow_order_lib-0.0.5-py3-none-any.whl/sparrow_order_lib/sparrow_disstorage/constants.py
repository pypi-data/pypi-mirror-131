"""
    常量
"""
from ..core.utils import InmulableDict, InmulableList
...
class InventoryDetailResult(object):
    ...
    CHECKED_RESULT_MAP = InmulableDict({
        PROFIT: "盘盈",
        LOSS: "盘亏",
        BALANCE: "盘平",
        DISLOCATION: "库内差异"
    ...
    DEALED_MESSAGE_MAP = InmulableDict({
        PROFIT: "核销盘盈差异",
        LOSS: "核销盘亏差异",
...
class InventoryHelpStatus:
    ...
    InventoryHelpStatusShowDict = InmulableDict({
        PENDING: "待盘点",
        ACCESSED: "待盘点",
        CHECKING: "盘点中",
        COMPLETED: "盘点完成",
    ...
    # 盘点中的状态
    CHECKING_STATUS = InmulableList([ACCESSED, CHECKING])
