...
class SevenHelper:
    ...
    @classmethod
    def get_telephone_code(cls, _user_id, _third_auth_id, _auth_channel, telephone):
        """
        获取手机验证码
        :param user_id:
        :param third_auth_id:
        ...
        key = RedisKeyType.PhoneCode.value + str(telephone)
    ...
    @classmethod
    def check_telephone_code(cls, _user_id, _third_auth_id, telephone, result_code):
        """
        检查手机验证码
        :param user_id:
        :param third_auth_id:
