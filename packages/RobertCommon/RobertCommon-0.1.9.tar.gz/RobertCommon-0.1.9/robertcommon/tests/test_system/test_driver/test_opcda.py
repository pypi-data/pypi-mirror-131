...
def test_case():
    #配置项
    dict_config = {
                        'server': 'KingView.View.1',          #server Matrikon.OPC.Simulation.1 KingView.View.1 Kepware.KEPServerEX.V5
                        'host': '192.168.1.184:8804',                  #'host': '192.168.1.36:8804',
                        'enabled': True,
                        'group': f'opcda1',
                        'action': '',       #
                        'read_limit': 50,
...
def test():
    dict_config = {
        ...
        'host': '192.168.1.36:8804',  # 'host': '192.168.1.36:8804', 192.168.2.131:8810
        'enabled': True,
