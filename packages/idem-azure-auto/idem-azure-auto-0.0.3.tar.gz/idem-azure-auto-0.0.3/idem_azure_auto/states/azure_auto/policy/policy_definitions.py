...
async def present(
    hub, ctx, name: str, policy_definition_name: str, parameters: dict = {}
) -> StateReturn:
    r"""
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_present:
              azure_auto.policy.policy_definitions.present:
                - name: value
    ...
    response_get = await hub.exec.request.json.get(
        ctx,
        url=f"https://management.azure.com/subscriptions/{subscription_id}/providers/Microsoft.Authorization/policyDefinitions/{policy_definition_name}?api-version=2021-06-01",
        success_codes=[200],
    ...
    if not response_get["result"]:
        if ctx.get("test", False):
            return StateReturn(
                name=name,
                result=True,
                comment="Would create azure.policy.policy_definitions",
            )
        ...
        if response_get["status"] == 404:
            ...
            hub.log.debug(
                f"Could not get Policy Definitions {response_get['comment']} {response_get['ret']}"
            )
            return StateReturn(
                name=name,
                result=False,
    ...
    # No update operation on Policy Definitions since Azure does not have PATCH api on Policy Definitions
    return StateReturn(
        name=name,
        result=True,
...
async def absent(hub, ctx, name: str, policy_definition_name: str) -> StateReturn:
    r"""
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              azure_auto.policy.policy_definitions.absent:
                - name: value
                - policy_definition_name: value
    """
    ...
    if response_get["result"]:
        if ctx.get("test", False):
            return StateReturn(
                name=name,
                result=True,
                comment="Would delete azure.policy.policy_definitions",
            )
        ...
        if not response_delete["result"]:
            hub.log.debug(
                f"Could not delete Policy Definitions {response_delete['comment']} {response_delete['ret']}"
            )
            return StateReturn(
                name=name,
                result=False,
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            $ idem describe azure_auto.policy.policy_definitions
    """

    result = {}
    subscription_id = ctx.acct.subscription_id
    uri_parameters = OrderedDict({"policyDefinitions": "policy_definition_name"})
    try:
        async for page_result in hub.tool.azure.request.paginate(
            ...
            if resource_list:
                for resource in resource_list:
                    ...
                    result[resource["id"]] = {
                        f"azure.policy.policy_definitions.present": uri_parameter_values
                        + [{"parameters": resource}]
                    }
    except ValueError as e:
        raise DescribeError(f"Error on describing Policy Definitions: {str(e)}")
    return result
