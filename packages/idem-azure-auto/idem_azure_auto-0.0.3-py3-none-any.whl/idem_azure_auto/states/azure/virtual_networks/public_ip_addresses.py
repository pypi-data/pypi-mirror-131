...
async def present(
    ...
    **Autogenerated function**
    ...
    response_get = await hub.exec.request.json.get(
        ctx,
        url=f"https://management.azure.com/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/publicIPAddresses/{public_ip_address_name}?api-version=2021-03-01",
        success_codes=[200],
    ...
    **Autogenerated function**
    ...
    try:
        async for page_result in hub.tool.azure.request.paginate(
            ctx,
            url=f"https://management.azure.com/subscriptions/{subscription_id}/providers/Microsoft.Network/publicIPAddresses?api-version=2021-03-01",
            success_codes=[200],
            headers=ctx.acct.headers,
        ):
        ...
        raise DescribeError(f"Error on describing Public IP Addresses: {str(e)}")
    return result
