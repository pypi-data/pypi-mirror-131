...
async def present(
    ...
    **Autogenerated function**
    ...
    response_get = await hub.exec.request.json.get(
        ctx,
        url=f"https://management.azure.com/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Compute/virtualMachines/{vm_name}?api-version=2021-07-01",
        success_codes=[200],
...
async def absent(
    hub, ctx, name: str, resource_group_name: str, vm_name: str
) -> StateReturn:
    r"""
    **Autogenerated function**
    ...
    **Autogenerated function**
    ...
    try:
        async for page_result in hub.tool.azure.request.paginate(
            ctx,
            url=f"https://management.azure.com/subscriptions/{subscription_id}/providers/Microsoft.Compute/virtualMachines?api-version=2021-07-01",
            success_codes=[200],
            headers=ctx.acct.headers,
        ):
        ...
        raise DescribeError(f"Error on describing Virtual Machines: {str(e)}")
    return result
