def parse(hub, resource_spec: dict, shared_function_data: dict):
    ...
    present_parameters["parameters"] = {
        "required": False,
        "default": dict(),
        "target_type": "mapping",
        "target": "kwargs",
        "param_type": "dict",
        "doc": "API request payload parameters",
    }
    present_parameters["force_update"] = {
        "required": False,
        "default": False,
        "target_type": "mapping",
        "target": "kwargs",
        "param_type": "bool",
        "doc": "If PUT operation should be used instead of PATCH operation during resource update.",
    }
    present = {
