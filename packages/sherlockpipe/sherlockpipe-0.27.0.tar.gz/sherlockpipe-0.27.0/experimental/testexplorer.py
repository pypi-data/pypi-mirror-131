...
with elapsed_timer() as elapsed:
    ...
    sherlock.explore_object("TIC 166184426", input_lc_file="Gaia DR2 6113245033656232448.csv", sectors=38,
                            auto_detrend_periodic_signals=False, smooth=False, cadence=120)
