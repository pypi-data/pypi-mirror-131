...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\nDsystemathics/apis/services/daily_analytics/v1/daily_volatility.proto\x12-systemathics.apis.services.daily_analytics.v1\x1a\x31systemathics/apis/type/shared/v1/identifier.proto\x1a\x32systemathics/apis/type/shared/v1/constraints.proto\x1a-systemathics/apis/type/shared/v1/status.proto\"\xb2\x01\n\x16\x44\x61ilyVolatilityRequest\x12@\n\nidentifier\x18\x01 \x01(\x0b\x32,.systemathics.apis.type.shared.v1.Identifier\x12\x42\n\x0b\x63onstraints\x18\x02 \x01(\x0b\x32-.systemathics.apis.type.shared.v1.Constraints\x12\x12\n\nadjustment\x18\x03 \x01(\x08\"b\n\x17\x44\x61ilyVolatilityResponse\x12\r\n\x05value\x18\x01 \x01(\x01\x12\x38\n\x06status\x18\x02 \x01(\x0b\x32(.systemathics.apis.type.shared.v1.Status2\xbb\x01\n\x16\x44\x61ilyVolatilityService\x12\xa0\x01\n\x0f\x44\x61ilyVolatility\x12\x45.systemathics.apis.services.daily_analytics.v1.DailyVolatilityRequest\x1a\x46.systemathics.apis.services.daily_analytics.v1.DailyVolatilityResponseb\x06proto3'
  ,
  dependencies=[systemathics_dot_apis_dot_type_dot_shared_dot_v1_dot_identifier__pb2.DESCRIPTOR,systemathics_dot_apis_dot_type_dot_shared_dot_v1_dot_constraints__pb2.DESCRIPTOR,systemathics_dot_apis_dot_type_dot_shared_dot_v1_dot_status__pb2.DESCRIPTOR,])
...
_DAILYVOLATILITYRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='systemathics.apis.services.daily_analytics.v1.DailyVolatilityResponse.status', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DAILYVOLATILITYRESPONSE.fields_by_name['status'].message_type = systemathics_dot_apis_dot_type_dot_shared_dot_v1_dot_status__pb2._STATUS
