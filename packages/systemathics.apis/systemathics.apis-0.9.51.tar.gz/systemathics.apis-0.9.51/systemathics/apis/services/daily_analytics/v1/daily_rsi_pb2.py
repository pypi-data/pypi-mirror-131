...
_DAILYRSIRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='systemathics.apis.services.daily_analytics.v1.DailyRsiResponse.status', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DAILYRSIRESPONSE.fields_by_name['status'].message_type = systemathics_dot_apis_dot_type_dot_shared_dot_v1_dot_status__pb2._STATUS
