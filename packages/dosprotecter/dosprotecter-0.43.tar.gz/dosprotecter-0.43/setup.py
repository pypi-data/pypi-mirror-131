...
setup(
  ...
  author_email = 'noamfranco2@gmail.com',      # Type in your E-Mail
  url = 'https://github.com/noamfranco/dosProtecter',   # Provide either the link to your github or to your website
