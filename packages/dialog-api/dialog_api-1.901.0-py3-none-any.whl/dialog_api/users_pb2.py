...
_REQUESTLOADUSERDATA_CLAIM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\212\3520\t\n\007visible', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bot', full_name='dialog.RequestLoadUserData.Claim.bot', index=5,
...
_REQUESTLOADUSERDATA_CLAIM.oneofs_by_name['kind'].fields.append(
  _REQUESTLOADUSERDATA_CLAIM.fields_by_name['bot'])
_REQUESTLOADUSERDATA_CLAIM.fields_by_name['bot'].containing_oneof = _REQUESTLOADUSERDATA_CLAIM.oneofs_by_name['kind']
...
_REQUESTLOADUSERDATA_CLAIM.fields_by_name['bot']._options = None
