...
class InstallerApi(object):
    ...
    def download_infra_env_discovery_image(self, infra_env_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str infra_env_id: The infra-env whose image should be downloaded. (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def download_infra_env_discovery_image_headers(self, infra_env_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str infra_env_id: The infra-env whose image headers should be retrieved. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
