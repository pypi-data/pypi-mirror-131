...
class DataFrame(object):
    ...
    # TODO(TEC-7013): Our doc will try to add this and fail on type checking if we
    # name it to_snowflake even without the annotation.
    # Need to fix this before pushing to customers.
    def _to_snowflake(self) -> "snowflake.snowpark.DataFrame":
