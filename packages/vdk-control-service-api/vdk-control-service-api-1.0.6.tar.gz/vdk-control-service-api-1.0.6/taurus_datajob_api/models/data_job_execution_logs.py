...
class DataJobExecutionLogs(object):
    ...
    def __init__(self, logs=None, local_vars_configuration=None):  # noqa: E501
        """DataJobExecutionLogs - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def logs(self):
        """Gets the logs of this DataJobExecutionLogs.  # noqa: E501

        The logs of the data job execution.  # noqa: E501

        :return: The logs of this DataJobExecutionLogs.  # noqa: E501
        :rtype: str
        """
        return self._logs
    ...
    @logs.setter
    def logs(self, logs):
        """Sets the logs of this DataJobExecutionLogs.

        The logs of the data job execution.  # noqa: E501

        :param logs: The logs of this DataJobExecutionLogs.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataJobExecutionLogs):
            return False
