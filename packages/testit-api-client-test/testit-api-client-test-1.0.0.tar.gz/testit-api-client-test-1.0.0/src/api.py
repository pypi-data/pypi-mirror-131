...
class Api(object):
    ...
    def link_autotest(self, autotest_id, workitem_id):
        ...
        if response.status_code == 204:
            ...
            print(f"Link autoTest with workItems error: {response.status_code}")
    ...
    def get_autotest(self, external_id, project_id):
        ...
        if response.status_code != 200:
            print(f"Get autoTest error: {response.status_code}")
    ...
    def update_autotest(self, json):
        ...
        if response.status_code == 204:
            ...
            print(f"Update autoTest error: {response.status_code}")
    ...
    def create_testrun(self, json):
        ...
        if response.status_code != 201:
            print(f"Create testRun error: {response.status_code}")
    ...
    def get_testrun(self, testrun_id):
        ...
        if response.status_code != 200:
            print(f"Get testRun error: {response.status_code}")
    ...
    def set_results_for_testrun(self, testrun_id, json):
        ...
        if response.status_code == 200:
            ...
            print(f"Set results error: {response.status_code}")
    ...
    def testrun_activity(self, testrun_id, action):
        ...
        if response.status_code == 204:
            ...
            print(f"TestRun {action} error: {response.status_code}")
    ...
    def load_attachment(self, file):
        ...
        if response.status_code == 201:
            ...
            print(f"Attachment {file.name} error: {response.status_code}")
