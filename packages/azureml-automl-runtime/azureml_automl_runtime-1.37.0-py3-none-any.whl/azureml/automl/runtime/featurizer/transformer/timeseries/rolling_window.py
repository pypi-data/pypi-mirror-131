...
class RollingWindow(AzureMLForecastTransformerBase, OriginTimeMixin, _GrainBasedStatefulTransformer):
    """
    ...
    def __init__(self, window_size: Union[int, str, pd.DateOffset],
