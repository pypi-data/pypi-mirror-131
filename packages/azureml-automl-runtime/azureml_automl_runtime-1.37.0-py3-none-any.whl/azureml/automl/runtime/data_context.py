...
class TransformedDataContext(BaseDataContext):
    ...
    def _load_from_cache(self):
        ...
        self.dataset_categoricals_dict = retrieve_data_list.get('dataset_categoricals_dict')
        self.learner_columns_mapping = retrieve_data_list.get('learner_columns_mapping')
