...
FORECASTING_VALIDATE_TABLE = 'forecast_validate_table'
FORECASTING_TRAIN_TABLE = 'forecast_train_table'
...
FORECASTING_NONSCALAR_SET = {
    ...
    FORECASTING_VALIDATE_TABLE,
    FORECASTING_TRAIN_TABLE
}
...
FORECASTING_OBJECTIVES = {
    ...
    FORECASTING_MAPE: NA,
    FORECASTING_VALIDATE_TABLE: NA,
    FORECASTING_TRAIN_TABLE: NA
