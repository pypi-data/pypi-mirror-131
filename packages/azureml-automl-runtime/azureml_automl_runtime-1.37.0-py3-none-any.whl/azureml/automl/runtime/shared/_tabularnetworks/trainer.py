...
class NNTrainerBase(BaseEstimator):
    ...
    def _update_problem_info(self, problem_info):
        ...
        if (
            problem_info is not None and
            problem_info.gpu_training_param_dict is not None and
            problem_info.gpu_training_param_dict.get("processing_unit_type", "cpu") == "gpu" and
        ...
        if (
            problem_info is not None and
            hasattr(problem_info, "runtime_constraints") and
            problem_info.runtime_constraints['wall_time_in_s'] is not None
        ):
