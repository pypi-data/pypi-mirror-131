...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _TESTS = [
        {
            ...
            'info_dict': {
                ...
                'description': 'test chars:  "\'/\\ä↭𝕐\ntest URL: https://github.com/rg3/nextdl/issues/1892\n\nThis is a test video for nextdl.\n\nFor more information, contact phihag@phihag.de .',
    ...
    _formats = {
        ...
        '138': {'ext': 'mp4', 'format_note': 'DASH video', 'vcodec': 'h264'},  # Height can vary (https://github.com/ytdl-org/nextdl/issues/4559)
...
class YoutubeSearchURLIE(YoutubeSearchIE):
    ...
    _TESTS = [{
        'url': 'https://www.youtube.com/results?baz=bar&search_query=nextdl+test+video&filters=video&lclk=video',
        'playlist_mincount': 5,
        'info_dict': {
            'title': 'nextdl test video',
        }
    }, {
