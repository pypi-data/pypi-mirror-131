...
class EightTracksIE(InfoExtractor):
    ...
    _TEST = {
        'name': 'EightTracks',
        'url': 'http://8tracks.com/ytdl/nextdl-test-tracks-a',
        'info_dict': {
            'id': '1336550',
            'display_id': 'nextdl-test-tracks-a',
            'description': "test chars:  \"'/\\ä↭",
            'title': "nextdl test tracks \"'/\\ä↭<>",
        },
        'playlist': [
            {
                ...
                'info_dict': {
                    'id': '11885610',
                    'ext': 'm4a',
                    'title': "youtue-dl project<>\"' - nextdl test track 1 \"'/\\\u00e4\u21ad",
                    'uploader_id': 'ytdl'
                }
            },
            {
                ...
                'info_dict': {
                    'id': '11885608',
                    'ext': 'm4a',
                    'title': "nextdl project - nextdl test track 2 \"'/\\\u00e4\u21ad",
                    'uploader_id': 'ytdl'
                }
            },
            {
                ...
                'info_dict': {
                    'id': '11885679',
                    'ext': 'm4a',
                    'title': "nextdl project as well - nextdl test track 3 \"'/\\\u00e4\u21ad",
                    'uploader_id': 'ytdl'
                }
            },
            {
                ...
                'info_dict': {
                    'id': '11885680',
                    'ext': 'm4a',
                    'title': "nextdl project as well - nextdl test track 4 \"'/\\\u00e4\u21ad",
                    'uploader_id': 'ytdl'
                }
            },
            {
                ...
                'info_dict': {
                    'id': '11885682',
                    'ext': 'm4a',
                    'title': "PH - nextdl test track 5 \"'/\\\u00e4\u21ad",
                    'uploader_id': 'ytdl'
                }
            },
            {
                ...
                'info_dict': {
                    'id': '11885683',
                    'ext': 'm4a',
                    'title': "PH - nextdl test track 6 \"'/\\\u00e4\u21ad",
                    'uploader_id': 'ytdl'
                }
            },
            {
                ...
                'info_dict': {
                    'id': '11885684',
                    'ext': 'm4a',
                    'title': "phihag - nextdl test track 7 \"'/\\\u00e4\u21ad",
                    'uploader_id': 'ytdl'
                }
            },
            {
                ...
                'info_dict': {
                    'id': '11885685',
                    'ext': 'm4a',
                    'title': "phihag - nextdl test track 8 \"'/\\\u00e4\u21ad",
                    'uploader_id': 'ytdl'
                }
            }
        ]
