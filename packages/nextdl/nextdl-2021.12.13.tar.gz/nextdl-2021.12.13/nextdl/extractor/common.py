...
class InfoExtractor(object):
    ...
    passed to the nextdl. The nextdl processes this
    ...
    webpage_url:    The URL to the video webpage, if given to nextdl it
                    should allow to get the same result again. (It will be set
                    by nextdl if it's missing)
    ...
    def _parse_f4m_formats(self, manifest, manifest_url, video_id, preference=None, f4m_id=None,
        ...
        # currently nextdl cannot decode the playerVerificationChallenge as Akamai uses Adobe Alchemy
