...
class TestUtil(unittest.TestCase):
    ...
    def test_expand_path(self):
        ...
        compat_setenv('nextdl_EXPATH_PATH', 'expanded')
        self.assertEqual(expand_path(env('nextdl_EXPATH_PATH')), 'expanded')
        self.assertEqual(expand_path(env('HOME')), compat_getenv('HOME'))
        self.assertEqual(expand_path('~'), compat_getenv('HOME'))
        self.assertEqual(
            expand_path('~/%s' % env('nextdl_EXPATH_PATH')),
...
'''
    ...
    def test_rot47(self):
        self.assertEqual(rot47('nextdl'), r'J@FEF36\5=')
        self.assertEqual(rot47('nextdl'), r'*~&%&qt\s{')
