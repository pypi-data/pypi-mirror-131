...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, total_timeout=None, headers=None, pulp_created=None, url=None, client_cert=None, tls_validation=None, sock_connect_timeout=None, name=None, max_retries=None, download_concurrency=None, proxy_url=None, sock_read_timeout=None, ca_cert=None, pulp_last_updated=None, rate_limit=None, pulp_labels=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
