...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, total_timeout=None, headers=None, url=None, proxy_username=None, client_cert=None, tls_validation=None, sock_connect_timeout=None, name=None, max_retries=None, password=None, download_concurrency=None, proxy_url=None, sock_read_timeout=None, proxy_password=None, ca_cert=None, username=None, rate_limit=None, pulp_labels=None, client_key=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
