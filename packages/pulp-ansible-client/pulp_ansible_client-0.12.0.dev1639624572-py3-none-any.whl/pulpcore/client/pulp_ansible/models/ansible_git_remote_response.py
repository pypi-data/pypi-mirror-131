...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, ca_cert=None, headers=None, name=None, tls_validation=None, sock_read_timeout=None, proxy_url=None, max_retries=None, sock_connect_timeout=None, client_cert=None, pulp_labels=None, pulp_href=None, rate_limit=None, download_concurrency=None, pulp_last_updated=None, pulp_created=None, url=None, total_timeout=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
