...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, ca_cert=None, headers=None, client_key=None, name=None, tls_validation=None, proxy_password=None, sock_read_timeout=None, proxy_url=None, max_retries=None, sock_connect_timeout=None, client_cert=None, pulp_labels=None, rate_limit=None, proxy_username=None, username=None, download_concurrency=None, url=None, total_timeout=None, connect_timeout=None, password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
