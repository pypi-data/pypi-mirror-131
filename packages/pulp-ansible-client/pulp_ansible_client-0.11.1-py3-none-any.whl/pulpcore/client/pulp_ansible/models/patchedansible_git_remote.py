...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, proxy_url=None, max_retries=None, connect_timeout=None, tls_validation=None, username=None, rate_limit=None, client_key=None, client_cert=None, sock_connect_timeout=None, download_concurrency=None, pulp_labels=None, proxy_password=None, headers=None, sock_read_timeout=None, name=None, url=None, total_timeout=None, ca_cert=None, password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
