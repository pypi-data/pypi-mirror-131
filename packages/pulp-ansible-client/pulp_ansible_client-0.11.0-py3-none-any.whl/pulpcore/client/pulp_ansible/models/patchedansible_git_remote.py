...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, sock_read_timeout=None, pulp_labels=None, client_cert=None, rate_limit=None, username=None, total_timeout=None, password=None, client_key=None, proxy_url=None, tls_validation=None, max_retries=None, name=None, ca_cert=None, proxy_password=None, connect_timeout=None, headers=None, sock_connect_timeout=None, url=None, proxy_username=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
