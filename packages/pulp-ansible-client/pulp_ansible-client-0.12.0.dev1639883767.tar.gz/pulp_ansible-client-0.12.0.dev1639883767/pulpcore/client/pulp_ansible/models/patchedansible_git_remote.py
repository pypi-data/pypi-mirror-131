...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, sock_connect_timeout=None, download_concurrency=None, client_cert=None, pulp_labels=None, client_key=None, password=None, max_retries=None, tls_validation=None, sock_read_timeout=None, headers=None, connect_timeout=None, proxy_username=None, proxy_url=None, rate_limit=None, name=None, username=None, proxy_password=None, total_timeout=None, ca_cert=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
