...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, sock_connect_timeout=None, download_concurrency=None, client_cert=None, pulp_labels=None, max_retries=None, tls_validation=None, sock_read_timeout=None, headers=None, connect_timeout=None, pulp_created=None, proxy_url=None, rate_limit=None, pulp_last_updated=None, name=None, total_timeout=None, ca_cert=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
