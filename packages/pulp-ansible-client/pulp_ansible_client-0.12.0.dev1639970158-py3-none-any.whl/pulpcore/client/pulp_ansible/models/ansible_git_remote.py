...
class AnsibleGitRemote(object):
    ...
    def __init__(self, sock_read_timeout=None, tls_validation=None, proxy_username=None, total_timeout=None, client_key=None, password=None, name=None, max_retries=None, sock_connect_timeout=None, username=None, proxy_url=None, client_cert=None, ca_cert=None, pulp_labels=None, headers=None, connect_timeout=None, url=None, proxy_password=None, download_concurrency=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
