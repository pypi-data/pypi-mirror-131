...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_read_timeout=None, pulp_created=None, tls_validation=None, total_timeout=None, pulp_last_updated=None, pulp_href=None, name=None, max_retries=None, sock_connect_timeout=None, proxy_url=None, client_cert=None, ca_cert=None, pulp_labels=None, headers=None, connect_timeout=None, url=None, download_concurrency=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
