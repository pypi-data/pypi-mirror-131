...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_read_timeout=None, pulp_labels=None, client_cert=None, pulp_href=None, rate_limit=None, total_timeout=None, pulp_last_updated=None, proxy_url=None, tls_validation=None, max_retries=None, name=None, ca_cert=None, connect_timeout=None, headers=None, sock_connect_timeout=None, pulp_created=None, url=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
