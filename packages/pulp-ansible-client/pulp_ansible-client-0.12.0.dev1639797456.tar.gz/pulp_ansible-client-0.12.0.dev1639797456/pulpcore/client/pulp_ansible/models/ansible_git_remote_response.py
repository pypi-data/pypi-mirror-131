...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, download_concurrency=None, url=None, sock_connect_timeout=None, sock_read_timeout=None, pulp_last_updated=None, pulp_created=None, tls_validation=None, proxy_url=None, pulp_href=None, total_timeout=None, rate_limit=None, pulp_labels=None, connect_timeout=None, headers=None, max_retries=None, client_cert=None, ca_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
