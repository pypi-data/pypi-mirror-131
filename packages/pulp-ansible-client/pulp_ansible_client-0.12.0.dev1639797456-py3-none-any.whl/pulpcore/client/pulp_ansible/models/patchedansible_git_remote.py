...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, name=None, username=None, download_concurrency=None, url=None, sock_connect_timeout=None, sock_read_timeout=None, client_key=None, tls_validation=None, proxy_url=None, proxy_username=None, total_timeout=None, rate_limit=None, pulp_labels=None, proxy_password=None, connect_timeout=None, headers=None, password=None, max_retries=None, client_cert=None, ca_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
