...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, max_retries=None, pulp_href=None, connect_timeout=None, tls_validation=None, rate_limit=None, client_cert=None, sock_connect_timeout=None, download_concurrency=None, pulp_labels=None, headers=None, sock_read_timeout=None, name=None, pulp_last_updated=None, url=None, total_timeout=None, pulp_created=None, ca_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
