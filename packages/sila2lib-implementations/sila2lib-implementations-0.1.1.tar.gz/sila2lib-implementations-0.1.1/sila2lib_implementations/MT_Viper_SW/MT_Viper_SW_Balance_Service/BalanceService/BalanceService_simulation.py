...
:file:    BalanceService_simulation.py
:authors: Lukas Bromig

:date: (creation)          2021-04-09T13:29:06.659935
:date: (last modification) 2021-04-09T13:29:06.659935
...
import random       # used instead of numpy for simulated values and random response selection

# import SiLA2 library
import sila2lib.framework.SiLAFramework_pb2 as silaFW_pb2

# import gRPC modules for this feature
from sila2lib_implementations.MT_Viper_SW.MT_Viper_SW_Balance_Service.BalanceService.gRPC import BalanceService_pb2 as BalanceService_pb2
# from sila2lib_implementations.MT_Viper_SW.MT_Viper_SW_Balance_Service.BalanceService.gRPC import BalanceService_pb2_grpc as BalanceService_pb2_grpc

# import default arguments
from sila2lib_implementations.MT_Viper_SW.MT_Viper_SW_Balance_Service.BalanceService.BalanceService_default_arguments import default_dict

# import SiLA Defined Error factories
from sila2lib_implementations.MT_Viper_SW.MT_Viper_SW_Balance_Service.BalanceService.BalanceService_defined_errors import generate_def_error_OverloadError, generate_def_error_UnderloadError, generate_def_error_InternalError, generate_def_error_LogicalError
from sila2lib.error_handling.server_err import SiLAExecutionError


# noinspection PyPep8Naming,PyUnusedLocal
class BalanceServiceSimulation:
    """
    Implementation of the *Balance Service* in *Simulation* mode
    ...
    def Zero(self, request, context: grpc.ServicerContext) \
        ...
        possible_responses = ['Z A', 'Z I', 'Z +', 'Z -']

        command = f'Z\r\n'

        read = possible_responses[random.randint(0, 3)]
    ...
    def ZeroImmediate(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.Success (Success): Zero setting successfully performed. Gross, net and tare = 0.
            request.IsStable (Is Stable): Zero setting successfully performed under stable/non-stable conditions (True/False).
        """
        ...
        read = possible_responses[random.randint(0, 4)]
        ...
        if return_value is None:
            return_value = BalanceService_pb2.ZeroImmediate_Responses(
                **default_dict['ZeroImmediate_Responses']
                #Success=silaFW_pb2.Boolean(value=False), IsStable=silaFW_pb2.Boolean(value=False)
            )
    ...
    def Tare(self, request, context: grpc.ServicerContext) \
        ...
        tare_value = round(random.uniform(1, 10), 2)
        unit = 'g'
        possible_responses = [f'T S {tare_value} {unit}', 'T I', 'T L', 'T +', 'T -']
    ...
    def WeightValueOnChange_Result(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            ...
            request.IsStable (Is Stable): The returned value is stable/non-stable (True/False).
        """
        ...
        # TODO:
        #   Add implementation of Simulation for command WeightValueOnChange here and write the resulting response
        #   in return_value
        ...
        if return_value is None:
            return_value = BalanceService_pb2.WeightValueOnChange_Responses(
                **default_dict['WeightValueOnChange_Responses']
                # WeightValue=silaFW_pb2.Real(value=1.0), IsStable=silaFW_pb2.Boolean(value=False)
            )
    ...
    def PresetTareWeight(self, request, context: grpc.ServicerContext) \
        ...
        possible_responses = [f'TA A {tare_preset_value} {unit}', 'TA I', 'TA L']
        unit_conversion_dict = {'mg': 10 ** -3, 'g': 10 ** 0, 'kg': 10 ** 3, 't': 10 ** 6}

        read = possible_responses[random.randint(0, 2)]
    ...
    def ClearTareValue(self, request, context: grpc.ServicerContext) \
        ...
        possible_responses = [f'TAC A', 'TAC I', 'TAC L']  # Manual says 'T L' instead of 'TAC L'?
    ...
    def TareImmediately(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            ...
            request.IsStable (Is Stable): The tare was performed under stable/non-stable weight conditions (True/False).
        """
        ...
        tare_value = round(random.uniform(1, 10), 2)
        unit = 'g'
        possible_responses = [f'TI S {tare_value} {unit}', 'TI I', 'TI L', 'TI +', 'TI -']
        unit_conversion_dict = {'mg': 10 ** -3, 'g': 10 ** 0, 'kg': 10 ** 3, 't': 10 ** 6}
        command = f'TI\r\n'
        ...
        if return_value is None:
            return_value = BalanceService_pb2.TareImmediately_Responses(
                **default_dict['TareImmediately_Responses']
                # TareWeightValue=silaFW_pb2.Real(value=1.0), IsStable=silaFW_pb2.Boolean(value=False)
            )
    ...
    def Get_StableWeightValue(self, request, context: grpc.ServicerContext) \
        ...
        tare_value = round(random.uniform(1, 10), 2)
        unit = 'g'
        possible_responses = [f'S S {tare_value} {unit}', 'S I', 'S +', 'S -']
        unit_conversion_dict = {'mg': 10 ** -3, 'g': 10 ** 0, 'kg': 10 ** 3, 't': 10 ** 6}
        command = f'S\r\n'
    ...
    def Get_ImmediateWeightValue(self, request, context: grpc.ServicerContext) \
        ...
        tare_value = round(random.uniform(1, 10), 2)
        unit = 'g'
        possible_responses = [f'S S {tare_value} {unit}', f'S D {tare_value} {unit}', 'S I', 'S L', 'S +', 'S -']
        unit_conversion_dict = {'mg': 10 ** -3, 'g': 10 ** 0, 'kg': 10 ** 3, 't': 10 ** 6}
        command = f'SI\r\n'

        read = possible_responses[random.randint(0, 5)]
        ...
        if 'S S' in read:
            ...
            value = float(tmp[-2]) * unit_conversion_dict[unit]
            par_dict = {
                'ImmediateWeightValue': BalanceService_pb2.DataType_StableWeightResponse(
                    StableWeightResponse=BalanceService_pb2.DataType_StableWeightResponse.StableWeightResponse_Struct(
        ...
        if return_value is None:
            return_value = BalanceService_pb2.Get_ImmediateWeightValue_Responses(
                **default_dict['Get_ImmediateWeightValue_Responses']
                # ImmediateWeightValue=pb2.DataType_StableWeightResponse(a)
            )
    ...
    def Subscribe_CurrentWeightValue(self, request, context: grpc.ServicerContext) \
        ...
        while True:
            try:
                ...
                # S L, S +, S - not implemented in FDL file yet
                possible_responses = [f'S S {tare_value} {unit}', f'S D {tare_value} {unit}', 'S I', 'S +', 'S -'] #'S L'
                unit_conversion_dict = {'mg': 10 ** -3, 'g': 10 ** 0, 'kg': 10 ** 3, 't': 10 ** 6}
                command = f'SIR\r\n'
                ...
                if 'S S' in read:
                    ...
                    value = float(tmp[-2]) * unit_conversion_dict[unit]
                    par_dict = {
                        'CurrentWeightValue': BalanceService_pb2.DataType_StableWeightResponse(
                    StableWeightResponse=BalanceService_pb2.DataType_StableWeightResponse.StableWeightResponse_Struct(
                        WeightValue=silaFW_pb2.Real(value=value),
                        IsStable=silaFW_pb2.Boolean(value=True))
                    )
            ...
            if return_value is None:
                return_value = BalanceService_pb2.Subscribe_CurrentWeightValue_Responses(
                    **default_dict['Subscribe_CurrentWeightValue_Responses']
                	# CurrentWeightValue=pb2.DataType_StableWeightResponse(a)
                )
    ...
    def Get_TareWeightValue(self, request, context: grpc.ServicerContext) \
        ...
        tare_value = round(random.uniform(1, 10), 2)
        unit = 'g'
        possible_responses = [f'TA A {tare_value} {unit}', 'TA I', 'TA L']
        unit_conversion_dict = {'mg': 10 ** -3, 'g': 10 ** 0, 'kg': 10 ** 3, 't': 10 ** 6}
        command = f'TA\r\n'
