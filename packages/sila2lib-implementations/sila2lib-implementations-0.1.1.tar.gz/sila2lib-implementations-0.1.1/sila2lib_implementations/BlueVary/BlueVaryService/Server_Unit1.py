...
:date: (creation)          2019-11-12T15:31:36.371138
:date: (last modification) 2019-11-12T15:31:36.371138
...
class BlueVaryServiceServer(SiLA2Server):
    ...
    def __init__(self, cmd_args, simulation_mode: bool = False):
        ...
        if os.name == "nt":
            ...
            id1 = '85 CO2_30753 O2_30700 HUM_30279 :I,BD'
            command = '&i\r\n'
...
def parse_command_line():
    ...
    parser.add_argument('-s', '--server-name', action='store',
                        default="BlueVaryService_1", help='start SiLA server with [server-name]')
