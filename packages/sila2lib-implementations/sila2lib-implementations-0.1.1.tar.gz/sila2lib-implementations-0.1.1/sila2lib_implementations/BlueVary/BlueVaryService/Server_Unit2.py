...
class BlueVaryServiceServer(SiLA2Server):
    ...
    def __init__(self, cmd_args, simulation_mode: bool = False):
        ...
        if os.name == "nt":
            ...
            id2 = '86 CO2_30752 O2_30703 HUM_30590 :I,BC'
            command = '&i\r\n'
            ...
            #self.ser = serial.Serial(port=ports[port_index+1], baudrate = 19200,parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, bytesize=serial.EIGHTBITS,timeout=5)
        else:
...
def parse_command_line():
    ...
    parser.add_argument('-s', '--server-name', action='store',
                        default="BlueVaryService_2", help='start SiLA server with [server-name]')
