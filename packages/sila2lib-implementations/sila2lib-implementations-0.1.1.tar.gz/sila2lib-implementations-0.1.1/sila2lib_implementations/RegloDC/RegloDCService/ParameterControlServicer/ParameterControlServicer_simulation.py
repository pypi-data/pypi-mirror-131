...
:date: (creation)          2021-03-16T12:40:00.455684
:date: (last modification) 2021-03-16T12:40:00.455684
...
class ParameterControlServicerSimulation:
    ...
    def SetRPMMode(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}L\r\n'
        try:
            read = '*'
            par_dict = {
    ...
    def SetFlowRateMode(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}M\r\n'
        try:
            read = '*'
            par_dict = {
                'PumpModeSet': silaFW_pb2.String(value=read),
    ...
    def SetDispenseVolumeMode(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}N\r\n'
        try:
            read = '*'
            par_dict = {
                'PumpModeSet': silaFW_pb2.String(value=read),
    ...
    def SetDispenseTimeMode(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}O\r\n'
        try:
            read = '*'
            par_dict = {
                'PumpModeSet': silaFW_pb2.String(value=read),
    ...
    def SetDispenseTimePauseTimeMode(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}P\r\n'
        try:
            read = '*'
            par_dict = {
                'PumpModeSet': silaFW_pb2.String(value=read),
    ...
    def SetDispenseVolumePauseTimeMode(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}Q\r\n'
        try:
            read = '*'
            par_dict = {
                'PumpModeSet': silaFW_pb2.String(value=read),
    ...
    def GetDispenseVolume(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}v\r\n'
        try:
            read = '6320E+1'
            par_dict = {
    ...
    def SetDispenseVolume(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}v{mantisse}{e_sig}{e_val}\r\n'
        try:
            read = f'{mantisse}{e_sig}{e_val}'
            par_dict = {
    ...
    def GetFlowRate(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}f\r\n'
        try:
            read = '1200E-2'
            par_dict = {
    ...
    def SetFlowRate(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}f{mantisse}{e_sig}{e_val}\r\n'
        try:
            read = f'{mantisse}{e_sig}{e_val}'
            par_dict = {
    ...
    def GetRPM(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}S\r\n'
        try:
            read = '155.55'
            par_dict = {
    ...
    def SetRPM(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}S{user_input}\r\n'
        try:
            read = '*'  # f'{user_input}'
            par_dict = {
    ...
    def GetPauseTime(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}T\r\n'
        try:
            read = '20'
            par_dict = {
    ...
    def SetPauseTime(self, request, context: grpc.ServicerContext) \
        ...
        read = 'No values supplied. Set to 0'
        if request.PauseTimeS.value != 0.0:
            ...
            command = f'{self.properties.pump_address_sim}T{user_input_s}\r\n'
            read = '*'
        if request.PauseTimeS.value != 0:
    ...
    def SetDispenseTime(self, request, context: grpc.ServicerContext) \
        ...
        if request.CurrentDispenseTimeS.value != 0.0:
            ...
            user_input_s = user_input_s.zfill(4)  # If to short, pad to length 4
            user_input_s = user_input_s[:4]  # If to long, strictly limit to 4 digits
            command = f'{self.properties.pump_address_sim}V{user_input_s}\r\n'
            read = '*'
        if request.CurrentDispenseTimeMin.value != 0:
            user_input_m = str(request.CurrentDispenseTimeMin.value)
            user_input_m = user_input_m.zfill(3)  # If to short, pad to length 3
            user_input_m = user_input_m[:3]  # If to long, strictly limit to 3 digits
            command = f'{self.properties.pump_address_sim}VM{user_input_m}\r\n'
            read = '*'
        if request.CurrentDispenseTimeH.value != 0:
            user_input_h = str(request.CurrentDispenseTimeH.value)
            user_input_h = user_input_h.zfill(3)  # If to short, pad to length 3
            user_input_h = user_input_h[:3]  # If to long, strictly limit to 3 digits
            command = f'{self.properties.pump_address_sim}VH{user_input_h}\r\n'
            read = '*'
        try:
            par_dict = {
    ...
    def GetRollerSteps(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address_sim}U\r\n'
        try:
            read = '100'
            par_dict = {
                'CurrentRollerSteps': silaFW_pb2.Real(value=int(read)),
            }
    ...
    def SetRollerSteps(self, request, context: grpc.ServicerContext) \
        ...
        command_1 = f'{self.properties.pump_address_sim}U{U}\r\n'
        command_2 = f'{self.properties.pump_address_sim}u{u}\r\n'
        try:
            read_1 = '*'
            read_2 = '*'
            ...
            par_dict = {
                'SetRollerStepsSet': silaFW_pb2.String(value=read),
            }
    ...
    def GetRollerStepVolume(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentRollerStepVolume (Current Roller Step Volume): Current roller step volume in nano-liters 
            (nL).
        """
        ...
        command = f'{self.properties.pump_address_sim}r\r\n'
        try:
            read = '9500E-1'
            par_dict = {
    ...
    def SetRollerStepVolume(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.SetRollerStepVolumeSet (Set Current Roller Step Volume Set): The set roller step volume in 
            nano-liters (nL).
        """
        ...
        command = f'{self.properties.pump_address_sim}r{mantisse}{e_sig}{e_val}\r\n'
        try:
            read = f'{mantisse}E{e_sig}{e_val}'
            par_dict = {
    ...
    def ResetRollerStepVolume(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.ResetRollerStepVolumeSet (Reset Current Roller Step Volume Set): The roller step volume is set to 
            default.
        """
        ...
        command = f'{self.properties.pump_address_sim}r000000\r\n'
        try:
            read = '9500E-1'
            par_dict = {
    ...
    def SetTubingDiameter(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            [0.13,0.19,0.25,0.38,0.44,0.51,0.57,0.64,0.76,0.89,0.95,1.02,1.09,1.14,1.22,1.3,1.42,1.52,1.65,1.75,1.85,
