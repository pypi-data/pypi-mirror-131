...
from .gRPC import AgitationServicer_pb2 as pb2
...
default_dict['GetActuatorPwrPV_Parameters'] = {
    'UnitID': silaFW_pb2.Integer(value=0)
}

default_dict['GetActuatorPwrPV_Responses'] = {
    'CurrentActuatorPwrPV': silaFW_pb2.Real(value=0.0)
}

default_dict['GetActuatorTStirPV_Parameters'] = {
    'UnitID': silaFW_pb2.Integer(value=0)
}

default_dict['GetActuatorTStirPV_Responses'] = {
    'CurrentActuatorTStirPV': silaFW_pb2.Real(value=0.0)
}
