...
:file:    PumpCServicer_real.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:14.899096
:date: (last modification) 2020-04-16T10:19:14.899096
...
from .PumpCServicer_default_arguments import default_dict


# noinspection PyPep8Naming,PyUnusedLocal
class PumpCServicerReal:
    """
    Implementation of the *PumpC Servicer* in *Real* mode
    ...
    def GetPVInt(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.setter.PVInt
        CurrentPVInt = node.get_value()
        return_value = PumpCServicer_pb2.GetPVInt_Responses(CurrentPVInt=silaFW_pb2.Real(value=CurrentPVInt))
    ...
    def GetPV(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.setter.PV
        CurrentPV = node.get_value()
        return_value = PumpCServicer_pb2.GetPV_Responses(CurrentPV=silaFW_pb2.Real(value=CurrentPV))
    ...
    def SetSPM(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpC.setter.SPM = request.SPM.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.setter.SPM
        SPMSet = node.get_value()
        return_value = PumpCServicer_pb2.SetSPM_Responses(SPMSet=silaFW_pb2.Real(value=SPMSet))
    ...
    def SetSPE(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpC.setter.SPE = request.SPE.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.setter.SPE
        SPESet = node.get_value()
        return_value = PumpCServicer_pb2.SetSPE_Responses(SPESet=silaFW_pb2.Real(value=SPESet))
    ...
    def GetSP(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.setter.SP
        CurrentSP = node.get_value()
        return_value = PumpCServicer_pb2.GetSP_Responses(CurrentSP=silaFW_pb2.Real(value=CurrentSP))
    ...
    def GetSPA(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.setter.SPA
        CurrentSPA = node.get_value()
        return_value = PumpCServicer_pb2.GetSPA_Responses(CurrentSPA=silaFW_pb2.Real(value=CurrentSPA))
    ...
    def GetSPM(self, request, context: grpc.ServicerContext) \
        ...
        return_value = PumpCServicer_pb2.GetSPM_Responses(CurrentSPM=silaFW_pb2.Real(value=CurrentSPM))
    ...
    def GetSPE(self, request, context: grpc.ServicerContext) \
        ...
        return_value = PumpCServicer_pb2.GetSPE_Responses(CurrentSPE=silaFW_pb2.Real(value=CurrentSPE))
    ...
    def GetSPR(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.setter.SPR
        CurrentSPR = node.get_value()
        return_value = PumpCServicer_pb2.GetSPR_Responses(CurrentSPR=silaFW_pb2.Real(value=CurrentSPR))
    ...
    def GetAccess(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.status.Access
        CurrentAccess = node.get_value()
        return_value = PumpCServicer_pb2.GetAccess_Responses(CurrentAccess=silaFW_pb2.Integer(value=CurrentAccess))
    ...
    def SetCmd(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpC.status.Cmd = request.Cmd.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.status.Cmd
        CmdSet = node.get_value()
        return_value = PumpCServicer_pb2.SetCmd_Responses(CmdSet=silaFW_pb2.Integer(value=CmdSet))
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentCmd (Current Controller Command): Current controller command value of the PumpC module.
        ...
        return_value = PumpCServicer_pb2.GetCmd_Responses(CurrentCmd=silaFW_pb2.Integer(value=CurrentCmd))
    ...
    def SetMode(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpC.status.Mode = request.Mode.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.status.Mode
        ModeSet = node.get_value()
        return_value = PumpCServicer_pb2.SetMode_Responses(ModeSet=silaFW_pb2.Integer(value=ModeSet))
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentMode (Current Controller Mode): Current controller mode value of the PumpC module.
        ...
        return_value = PumpCServicer_pb2.GetMode_Responses(CurrentMode=silaFW_pb2.Integer(value=CurrentMode))
    ...
    def SetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpC.setter.SetpointSelect = request.SetpointSelect.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.setter.SetpointSelect 
        SetpointSelectSet = node.get_value()
        return_value = PumpCServicer_pb2.SetSetpointSelect_Responses(
    ...
    def GetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSetpointSelect (Current Setpoint Selection): Current setpoint selection value of the PumpC
        ...
        return_value = PumpCServicer_pb2.GetSetpointSelect_Responses(
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentState (Current Controller State): Current controller state value of the PumpC module.
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.status.State
        CurrentState = node.get_value()
        return_value = PumpCServicer_pb2.GetState_Responses(CurrentState=silaFW_pb2.Integer(value=CurrentState))
    ...
    def GetType(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.sysinfo.Type
        CurrentType = node.get_value()
        return_value = PumpCServicer_pb2.GetType_Responses(CurrentType=silaFW_pb2.String(value=CurrentType))
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAvailable (Current Function Availability): Current function availability value of the PumpC
            module.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.sysinfo.Available
        CurrentAvailable = node.get_value()
        return_value = PumpCServicer_pb2.GetAvailable_Responses(
    ...
    def GetName(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.sysinfo.Name
        CurrentName = node.get_value()
        return_value = PumpCServicer_pb2.GetName_Responses(CurrentName=silaFW_pb2.String(value=CurrentName))
    ...
    def GetVersion(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentVersion (Current Function Version): Current function model version number of the PumpC
            module.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.sysinfo.Version
        CurrentVersion = node.get_value()
        return_value = PumpCServicer_pb2.GetVersion_Responses(CurrentVersion=silaFW_pb2.String(value=CurrentVersion))
    ...
    def SetActuatorCalibration(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpC.actuator.Calibration = request.ActuatorCalibration.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.actuator.Calibration
        ActuatorCalibrationSet = node.get_value()
        return_value = PumpCServicer_pb2.SetActuatorCalibration_Responses(
    ...
    def GetActuatorCalibration(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            ...
            PumpC module. Calibration parameter (at 100% speed).
        """
        ...
        return_value = PumpCServicer_pb2.GetActuatorCalibration_Responses(
    ...
    def GetActuatorDirPV(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            ...
            PumpC module. Actual pump direction (0=Clockwise, 1=Counterclockwise).
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpC.actuator.Dir_PV
        CurrentActuatorDirPV = node.get_value()
        return_value = PumpCServicer_pb2.GetActuatorDirPV_Responses(
