...
:file:    PHServicer_servicer.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:14.517938
:date: (last modification) 2020-04-16T10:19:14.517938
...
from .PHServicer_simulation import PHServicerSimulation
from .PHServicer_real import PHServicerReal


class PHServicer(PHServicer_pb2_grpc.PHServicerServicer):
    """
    This is a DASGIP Service
    """
    implementation: Union[PHServicerSimulation, PHServicerReal]
    ...
    def __init__(self, reactors, simulation_mode: bool = True):
        ...
        if simulation_mode:
            self._inject_implementation(PHServicerSimulation(self.reactors))
        else:
            self._inject_implementation(PHServicerReal(self.reactors))

    def _inject_implementation(self,
                               implementation: Union[PHServicerSimulation,
                                                     PHServicerReal]
                               ) -> bool:
        """
