...
:file:    PHServicer_real.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:14.612789
:date: (last modification) 2020-04-16T10:19:14.612789
...
from .gRPC import PHServicer_pb2 as PHServicer_pb2
# from .gRPC import PHServicer_pb2_grpc as PHServicer_pb2_grpc

# import default arguments
from .PHServicer_default_arguments import default_dict


# noinspection PyPep8Naming,PyUnusedLocal
class PHServicerReal:
    """
    Implementation of the *PH Servicer* in *Real* mode
    ...
    def GetPV(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.setter.PV
        CurrentPV = node.get_value()
        return_value = PHServicer_pb2.GetPV_Responses(CurrentPV=silaFW_pb2.Real(value=CurrentPV))
    ...
    def SetSPM(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The manual setpoint of the pH module.
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.setter.SPM = request.SPM.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.setter.SPM
        SPMSet = node.get_value()
        return_value = PHServicer_pb2.SetSPM_Responses(SPMSet=silaFW_pb2.Real(value=SPMSet))
    ...
    def SetSPE(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The external setpoint of the pH module.
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.setter.SPE = request.SPE.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.setter.SPE
        SPESet = node.get_value()
        return_value = PHServicer_pb2.SetSPE_Responses(SPESet=silaFW_pb2.Real(value=SPESet))
    ...
    def GetSP(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.setter.SP
        CurrentSP = node.get_value()
        return_value = PHServicer_pb2.GetSP_Responses(CurrentSP=silaFW_pb2.Real(value=CurrentSP))
    ...
    def GetSPA(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.setter.SPA
        CurrentSPA = node.get_value()
        return_value = PHServicer_pb2.GetSPA_Responses(CurrentSPA=silaFW_pb2.Real(value=CurrentSPA))
    ...
    def GetSPM(self, request, context: grpc.ServicerContext) \
        ...
        return_value = PHServicer_pb2.GetSPM_Responses(CurrentSPM=silaFW_pb2.Real(value=CurrentSPM))
    ...
    def GetSPE(self, request, context: grpc.ServicerContext) \
        ...
        return_value = PHServicer_pb2.GetSPE_Responses(CurrentSPE=silaFW_pb2.Real(value=CurrentSPE))
    ...
    def GetSPR(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.setter.SPR
        CurrentSPR = node.get_value()
        return_value = PHServicer_pb2.GetSPR_Responses(CurrentSPR=silaFW_pb2.Real(value=CurrentSPR))
    ...
    def GetAccess(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.status.Access
        CurrentAccess = node.get_value()
        return_value = PHServicer_pb2.GetAccess_Responses(CurrentAccess=silaFW_pb2.Integer(value=CurrentAccess))
    ...
    def SetCmd(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The controller command of the pH module. Controller command (Nothing, Stop, Start).
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.status.Cmd = request.Cmd.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.status.Cmd
        CmdSet = node.get_value()
        return_value = PHServicer_pb2.SetCmd_Responses(CmdSet=silaFW_pb2.Integer(value=CmdSet))
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentCmd (Current Controller Command): Current controller command value of the pH module.
        ...
        return_value = PHServicer_pb2.GetCmd_Responses(CurrentCmd=silaFW_pb2.Integer(value=CurrentCmd))
    ...
    def SetMode(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The controller mode of the pH module. Controller mode (Manual, Automatic).
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.status.Mode = request.Mode.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.status.Mode
        ModeSet = node.get_value()
        return_value = PHServicer_pb2.SetMode_Responses(ModeSet=silaFW_pb2.Integer(value=ModeSet))
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentMode (Current Controller Mode): Current controller mode value of the pH module. Controller
        ...
        return_value = PHServicer_pb2.GetMode_Responses(CurrentMode=silaFW_pb2.Integer(value=CurrentMode))
    ...
    def SetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The selected setpoint of the pH module. Setpoint selection (Local, Manual, Internal, Script, External).
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.setter.SetpointSelect = request.SetpointSelect.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.setter.SetpointSelect 
        SetpointSelectSet = node.get_value()
        return_value = PHServicer_pb2.SetSetpointSelect_Responses(
    ...
    def GetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSetpointSelect (Current Setpoint Selection): Current setpoint selection value of the pH
        ...
        return_value = PHServicer_pb2.GetSetpointSelect_Responses(
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentState (Current Controller State): Current controller state value of the pH module.
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.status.State
        CurrentState = node.get_value()
        return_value = PHServicer_pb2.GetState_Responses(CurrentState=silaFW_pb2.Integer(value=CurrentState))
    ...
    def GetType(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentType (Current Function Type): Current function type value of the pH module.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.sysinfo.Type
        CurrentType = node.get_value()
        return_value = PHServicer_pb2.GetType_Responses(CurrentType=silaFW_pb2.String(value=CurrentType))
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.sysinfo.Available
        CurrentAvailable = node.get_value()
        return_value = PHServicer_pb2.GetAvailable_Responses(
    ...
    def GetName(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentName (Current Function Name): Current function name of the pH module.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.sysinfo.Name
        CurrentName = node.get_value()
        return_value = PHServicer_pb2.GetName_Responses(CurrentName=silaFW_pb2.String(value=CurrentName))
    ...
    def GetVersion(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentVersion (Current Function Version): Current function model version number of the pH module.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.sysinfo.Version
        CurrentVersion = node.get_value()
        return_value = PHServicer_pb2.GetVersion_Responses(CurrentVersion=silaFW_pb2.String(value=CurrentVersion))
    ...
    def SetSensorOffset(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.sensor.Offset = request.SensorOffset.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.sensor.Offset
        SensorOffsetSet = node.get_value()
        return_value = PHServicer_pb2.SetSensorOffset_Responses(SensorOffsetSet=silaFW_pb2.Real(value=SensorOffsetSet))
    ...
    def GetSensorOffset(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorOffset (Current Sensor Offset): Current sensor offset value of the pH module.
        ...
        return_value = PHServicer_pb2.GetSensorOffset_Responses(
    ...
    def GetSensorPVRaw(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorPVRaw (Current Sensor PVRaw): Current sensor present raw value of the pH module.
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.sensor.PVRaw
        CurrentSensorPVRaw = node.get_value()
        return_value = PHServicer_pb2.GetSensorPVRaw_Responses(
    ...
    def SetSensorSlope(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.sensor.Slope = request.SensorSlope.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.sensor.Slope
        SensorSlopeSet = node.get_value()
        return_value = PHServicer_pb2.SetSensorSlope_Responses(SensorSlopeSet=silaFW_pb2.Real(value=SensorSlopeSet))
    ...
    def GetSensorSlope(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorSlope (Current Sensor Slope): Current sensor slope value of the pH module. Sensor
        ...
        return_value = PHServicer_pb2.GetSensorSlope_Responses(
    ...
    def SetSensorCompensation(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.sensor.Compensation = request.SensorCompensation.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.sensor.Compensation
        SensorCompensationSet = node.get_value()
        return_value = PHServicer_pb2.SetSensorCompensation_Responses(
    ...
    def GetSensorCompensation(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            ...
            pH module. Sensor temperature compensation parameter.
        """
        ...
        return_value = PHServicer_pb2.GetSensorCompensation_Responses(
    ...
    def SetControllerDB(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.controller.DB = request.ControllerDB.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.controller.DB
        ControllerDBSet = node.get_value()
        return_value = PHServicer_pb2.SetControllerDB_Responses(ControllerDBSet=silaFW_pb2.Real(value=ControllerDBSet))
    ...
    def GetControllerDB(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerDB (Current Controller DB): Current controller deadband value of the pH module.
        ...
        return_value = PHServicer_pb2.GetControllerDB_Responses(
    ...
    def GetControllerOut(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerOut (Current Controller Out): Current controller output value of the pH module.
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.controller.Out
        CurrentControllerOut = node.get_value()
        return_value = PHServicer_pb2.GetControllerOut_Responses(
    ...
    def SetControllerP(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.controller.P = request.ControllerP.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.controller.P
        ControllerPSet = node.get_value()
        return_value = PHServicer_pb2.SetControllerP_Responses(ControllerPSet=silaFW_pb2.Real(value=ControllerPSet))
    ...
    def GetControllerP(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            ...
            pH module. PID controller: proportional parameter.
        """
        ...
        return_value = PHServicer_pb2.GetControllerP_Responses(
    ...
    def SetControllerTd(self, request, context: grpc.ServicerContext) \
       ...
       # Set-command
        self.reactors[request.UnitID.value].unit.pH.controller.Td = request.ControllerTd.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.controller.Td
        ControllerTdSet = node.get_value()
        return_value = PHServicer_pb2.SetControllerTd_Responses(ControllerTdSet=silaFW_pb2.Real(value=ControllerTdSet))
    ...
    def GetControllerTd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            ...
            pH module. PID controller: differentiator time constant (set to zero to disable).
        """
        ...
        return_value = PHServicer_pb2.GetControllerTd_Responses(
    ...
    def SetControllerTi(self, request, context: grpc.ServicerContext) \
       ...
       # Set-command
        self.reactors[request.UnitID.value].unit.pH.controller.Ti = request.ControllerTi.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.controller.Ti
        ControllerTiSet = node.get_value()
        return_value = PHServicer_pb2.SetControllerTi_Responses(ControllerTiSet=silaFW_pb2.Real(value=ControllerTiSet))
    ...
    def GetControllerTi(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerTi (Current Controller Ti): Current controller integrator time constant of the pH
            module. PID controller: integrator time constant (set to zero to disable).
        """
        ...
        return_value = PHServicer_pb2.GetControllerTi_Responses(
    ...
    def SetControllerMin(self, request, context: grpc.ServicerContext) \
       ...
       # Set-command
        self.reactors[request.UnitID.value].unit.pH.controller.Min = request.ControllerMin.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.controller.Min
        ControllerMinSet = node.get_value()
        return_value = PHServicer_pb2.SetControllerMin_Responses(
    ...
    def GetControllerMin(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerMin (Current Controller Min): Current controller minimal output value of the pH
        ...
        return_value = PHServicer_pb2.GetControllerMin_Responses(
    ...
    def SetControllerMax(self, request, context: grpc.ServicerContext) \
       ...
       # Set-command
        self.reactors[request.UnitID.value].unit.pH.controller.Max = request.ControllerMax.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.controller.Max
        ControllerMaxSet = node.get_value()
        return_value = PHServicer_pb2.SetControllerMax_Responses(
    ...
    def GetControllerMax(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerMax (Current Controller Max): Current controller maximal output value of the pH
            module. PID controller: maximal output value.
        """
        ...
        return_value = PHServicer_pb2.GetControllerMax_Responses(
    ...
    def SetAlarmEnabled(self, request, context: grpc.ServicerContext) \
       ...
       # Set-command
        self.reactors[request.UnitID.value].unit.pH.alarm.Enabled = request.AlarmEnabled.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.alarm.Enabled
        AlarmEnabledSet = node.get_value()
        return_value = PHServicer_pb2.SetAlarmEnabled_Responses(
    ...
    def GetAlarmEnabled(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmEnabled (Current Alarm Enabled): Current alarm enabled value of the pH module. Enables
            alarm function.
        """
        ...
        return_value = PHServicer_pb2.GetAlarmEnabled_Responses(
    ...
    def SetAlarmAlarmHigh(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.alarm.AlarmHigh = request.AlarmAlarmHigh.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.alarm.AlarmHigh
        AlarmAlarmHighSet = node.get_value()
        return_value = PHServicer_pb2.SetAlarmAlarmHigh_Responses(
    ...
    def GetAlarmAlarmHigh(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmAlarmHigh (Current Alarm AlarmHigh): Current alarm alarmhigh value of the pH module.
            Higher alarm limit.
        """
        ...
        return_value = PHServicer_pb2.GetAlarmAlarmHigh_Responses(
    ...
    def SetAlarmAlarmLow(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.alarm.AlarmLow = request.AlarmAlarmLow.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.alarm.AlarmLow
        AlarmAlarmLowSet = node.get_value()
        return_value = PHServicer_pb2.SetAlarmAlarmLow_Responses(
    ...
    def GetAlarmAlarmLow(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmAlarmLow (Current Alarm AlarmLow): Current alarm alarmlow value of the pH module. Lower
            alarm limit.
        """
        ...
        return_value = PHServicer_pb2.GetAlarmAlarmLow_Responses(
    ...
    def SetAlarmMode(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.alarm.Mode = request.AlarmMode.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.alarm.Mode
        AlarmModeSet = node.get_value()
        return_value = PHServicer_pb2.SetAlarmMode_Responses(AlarmModeSet=silaFW_pb2.Integer(value=AlarmModeSet))
    ...
    def GetAlarmMode(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmMode (Current Alarm Mode): Current alarm mode value of the pH module. Alarm mode.
        """
        ...
        return_value = PHServicer_pb2.GetAlarmMode_Responses(
    ...
    def GetAlarmState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmState (Current Alarm State): Current alarm state value of the pH module. Alarm state.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.alarm.State
        CurrentAlarmState = node.get_value()
        return_value = PHServicer_pb2.GetAlarmState_Responses(
    ...
    def SetAlarmDelay(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.alarm.Delay = request.AlarmDelay.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.alarm.Delay
        AlarmDelaySet = node.get_value()
        return_value = PHServicer_pb2.SetAlarmDelay_Responses(AlarmDelaySet=silaFW_pb2.Real(value=AlarmDelaySet))
    ...
    def GetAlarmDelay(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmDelay (Current Alarm Delay): Current alarm delay value of the pH module. Alarm
            hysteresis time.
        """
        ...
        return_value = PHServicer_pb2.GetAlarmDelay_Responses(
    ...
    def SetAlarmWarnHigh(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.alarm.WarnHigh = request.AlarmWarnHigh.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.alarm.WarnHigh
        AlarmWarnHighSet = node.get_value()
        return_value = PHServicer_pb2.SetAlarmWarnHigh_Responses(
    ...
    def GetAlarmWarnHigh(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmWarnHigh (Current Alarm WarnHigh): Current alarm higher warning value of the pH module.
            Higher warning limit.
        """
        ...
        return_value = PHServicer_pb2.GetAlarmWarnHigh_Responses(
    ...
    def SetAlarmWarnLow(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.pH.alarm.WarnLow = request.AlarmWarnLow.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.pH.alarm.WarnLow
        AlarmWarnLowSet = node.get_value()
        return_value = PHServicer_pb2.SetAlarmWarnLow_Responses(AlarmWarnLowSet=silaFW_pb2.Real(value=AlarmWarnLowSet))
    ...
    def GetAlarmWarnLow(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmWarnLow (Current Alarm WarnLow): Current alarm lower warning value of the pH module.
            Lower warning limit.
        """
        ...
        return_value = PHServicer_pb2.GetAlarmWarnLow_Responses(
