...
:file:    TemperatureServicer_servicer.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:15.198949
:date: (last modification) 2020-04-16T10:19:15.198949
...
from .TemperatureServicer_simulation import TemperatureServicerSimulation
from .TemperatureServicer_real import TemperatureServicerReal


class TemperatureServicer(TemperatureServicer_pb2_grpc.TemperatureServicerServicer):
    """
    This is a DASGIP Service
    """
    implementation: Union[TemperatureServicerSimulation, TemperatureServicerReal]
    ...
    def __init__(self, reactors, simulation_mode: bool = True):
        ...
        if simulation_mode:
            self._inject_implementation(TemperatureServicerSimulation(self.reactors))
        else:
            self._inject_implementation(TemperatureServicerReal(self.reactors))

    def _inject_implementation(self,
                               implementation: Union[TemperatureServicerSimulation,
                                                     TemperatureServicerReal]
                               ) -> bool:
        """
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentCmd (Current Controller Command): Current controller command value of the temperature module. Controller command (Nothing, Stop, Start)
        """
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentMode (Current Controller Mode): Current controller mode value of the temperature module. Controller mode (Manual, Automatic).
        """
    ...
    def SetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The selected setpoint of the temperature module. Setpoint selection (Local, Manual, Internal, Script, External).
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
    ...
    def GetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSetpointSelect (Current Setpoint Selection): Current setpoint selection value of the temperature module. Controller state (Off, On, Error).
        """
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentState (Current Controller State): Current controller state value of the temperature module. Controller state (Off, On, Error).
        """
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAvailable (Current Function Availability): Current function availability value of the temperature module.
        """
    ...
    def GetVersion(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentVersion (Current Function Version): Current function model version number of the temperature module.
        """
    ...
    def GetSensorOffset(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorOffset (Current Sensor Offset): Current sensor offset value of the temperature module. Sensor offset calibration parameter.
        """
    ...
    def GetSensorPVRaw(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorPVRaw (Current Sensor PVRaw): Current sensor present raw value of the temperature module. Actual process raw value.
        """
    ...
    def GetSensorSlope(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorSlope (Current Sensor Slope): Current sensor slope value of the temperature module. Sensor slope calibration parameter.
        """
    ...
    def GetSensorCompensation(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorCompensation (Current Sensor Compensation): Current sensor compensation value of the temperature module. Sensor temperature compensation parameter.
        """
    ...
    def GetControllerDB(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerDB (Current Controller DB): Current controller deadband value of the temperature module. PID controller: deadband (set to zero to disable).
        """
    ...
    def GetControllerOut(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerOut (Current Controller Out): Current controller output value of the temperature module. PID controller: actual output value.
        """
    ...
    def GetControllerP(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerP (Current Controller P): Current controller proportional parameter value of the temperature module. PID controller: proportional parameter.
        """
    ...
    def GetControllerTd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerTd (Current Controller Td): Current controller differentiator time constant of the temperature module. PID controller: differentiator time constant (set to zero to disable).
        """
    ...
    def GetControllerTi(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerTi (Current Controller Ti): Current controller integrator time constant of the temperature module. PID controller: integrator time constant (set to zero to disable).
        """
    ...
    def GetControllerMin(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerMin (Current Controller Min): Current controller minimal output value of the temperature module. PID controller: minimal output value.
        """
    ...
    def GetControllerMax(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerMax (Current Controller Max): Current controller maximal output value of the temperature module. PID controller: maximal output value.
        """
    ...
    def GetAlarmEnabled(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmEnabled (Current Alarm Enabled): Current alarm enabled value of the temperature module. Enables alarm function.
        """
    ...
    def GetAlarmAlarmHigh(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmAlarmHigh (Current Alarm AlarmHigh): Current alarm alarmhigh value of the temperature module. Higher alarm limit.
        """
    ...
    def GetAlarmAlarmLow(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmAlarmLow (Current Alarm AlarmLow): Current alarm alarmlow value of the temperature module. Lower alarm limit.
        """
    ...
    def GetAlarmMode(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmMode (Current Alarm Mode): Current alarm mode value of the temperature module. Alarm mode.
        """
    ...
    def GetAlarmState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmState (Current Alarm State): Current alarm state value of the temperature module. Alarm state.
        """
    ...
    def GetAlarmDelay(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmDelay (Current Alarm Delay): Current alarm delay value of the temperature module. Alarm hysteresis time.
        """
    ...
    def GetAlarmWarnHigh(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmWarnHigh (Current Alarm WarnHigh): Current alarm higher warning value of the temperature module. Higher warning limit.
        """
    ...
    def GetAlarmWarnLow(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmWarnLow (Current Alarm WarnLow): Current alarm lower warning value of the temperature module. Lower warning limit.
        """
