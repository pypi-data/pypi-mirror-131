...
:file:    PumpAServicer_servicer.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:14.733834
:date: (last modification) 2020-04-16T10:19:14.733834
...
from .PumpAServicer_simulation import PumpAServicerSimulation
from .PumpAServicer_real import PumpAServicerReal


class PumpAServicer(PumpAServicer_pb2_grpc.PumpAServicerServicer):
    """
    This is a DASGIP Service
    """
    implementation: Union[PumpAServicerSimulation, PumpAServicerReal]
    ...
    def __init__(self, reactors, simulation_mode: bool = True):
        ...
        if simulation_mode:
            self._inject_implementation(PumpAServicerSimulation(self.reactors))
        else:
            self._inject_implementation(PumpAServicerReal(self.reactors))

    def _inject_implementation(self,
                               implementation: Union[PumpAServicerSimulation,
                                                     PumpAServicerReal]
                               ) -> bool:
        """
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentCmd (Current Controller Command): Current controller command value of the PumpA module. Controller command (Nothing, Stop, Start)
        """
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentMode (Current Controller Mode): Current controller mode value of the PumpA module. Controller mode (Manual, Automatic).
        """
    ...
    def GetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSetpointSelect (Current Setpoint Selection): Current setpoint selection value of the PumpA module. Controller state (Off, On, Error).
        """
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentState (Current Controller State): Current controller state value of the PumpA module. Controller state (Off, On, Error).
        """
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAvailable (Current Function Availability): Current function availability value of the PumpA module.
        """
    ...
    def GetActuatorCalibration(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentActuatorCalibration (Current Actuator Calibration): Current actuator calibration value of the PumpA module. Calibration parameter (at 100% speed).
        """
    ...
    def GetActuatorDirPV(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentActuatorDirPV (Current Actuator Dir PV): Current actuator direction present value of the PumpA module. Actual pump direction (0=Clockwise, 1=Counterclockwise).
        """
