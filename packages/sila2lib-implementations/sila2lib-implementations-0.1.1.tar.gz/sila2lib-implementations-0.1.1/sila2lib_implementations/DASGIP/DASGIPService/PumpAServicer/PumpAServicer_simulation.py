...
:file:    PumpAServicer_simulation.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:14.753444
:date: (last modification) 2020-04-16T10:19:14.753444
...
class PumpAServicerSimulation:
    """
    Implementation of the *PumpA Servicer* in *Simulation* mode
    ...
    def GetPVInt(self, request, context: grpc.ServicerContext) \
        ...
        if return_value is None:
            return_value = PumpAServicer_pb2.GetPVInt_Responses(
    ...
    def GetPV(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.GetPV_Responses(
    ...
    def SetSPM(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.SetSPM_Responses(
    ...
    def SetSPE(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.SetSPE_Responses(
    ...
    def GetSP(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.GetSP_Responses(
    ...
    def GetSPA(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.GetSPA_Responses(
    ...
    def GetSPM(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.GetSPM_Responses(
    ...
    def GetSPE(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.GetSPE_Responses(
    ...
    def GetSPR(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.GetSPR_Responses(
    ...
    def GetAccess(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.GetAccess_Responses(
    ...
    def SetCmd(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.SetCmd_Responses(
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.GetCmd_Responses(
    ...
    def SetMode(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.SetMode_Responses(
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.GetMode_Responses(
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PumpAServicer_pb2.GetState_Responses(
    ...
    def GetActuatorCalibration(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentActuatorCalibration (Current Actuator Calibration): Current actuator calibration value of 
            the PumpA module. Calibration parameter (at 100% speed).
        """
    
        # initialise the return value
        return_value = None

        CurrentActuatorCalibration = 95.0
