...
default_dict['GetPHImax_Parameters'] = {
    
}

default_dict['GetPHImax_Responses'] = {
    'CurrentPHImax': [silaFW_pb2.Real(value=0.0)]
}

default_dict['SetPHImax_Parameters'] = {
    'SetPHImax': [silaFW_pb2.Real(value=0.0)]
}

default_dict['SetPHImax_Responses'] = {
    'CurrentPHImax': [silaFW_pb2.Real(value=0.0)]
}

default_dict['GetPHImin_Parameters'] = {
    
}

default_dict['GetPHImin_Responses'] = {
    'CurrentPHImin': [silaFW_pb2.Real(value=0.0)]
}

default_dict['SetPHImin_Parameters'] = {
    'SetPHImin': [silaFW_pb2.Real(value=0.0)]
}

default_dict['SetPHImin_Responses'] = {
    'CurrentPHImin': [silaFW_pb2.Real(value=0.0)]
}
