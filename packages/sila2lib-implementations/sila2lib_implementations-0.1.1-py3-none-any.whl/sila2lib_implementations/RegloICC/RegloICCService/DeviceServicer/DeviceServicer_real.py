...
:date: (creation)          2020-04-16T10:19:58.230744
:date: (last modification) 2020-04-16T10:19:58.230744
...
class DeviceServicerReal:
    ...
    def SetPumpAddress(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting pump Address"
        logging.debug('Pump address set to %s: %s' % (address, read))
        return_value = DeviceServicer_pb2.SetPumpAddress_Responses(PumpAddressSet=silaFW_pb2.String(value=read))
    ...
    def SetLanguage(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting language"
        logging.debug('Pump %s language set to %s: %s' % (address, value, read))
        return_value = DeviceServicer_pb2.SetLanguage_Responses(LanguageSet=silaFW_pb2.String(value=read))
    ...
    def GetLanguage(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error reading language. NONE")

            else:
                read = int(read)
        except:
            read = None
            logging.error("Error reading language settings")
        logging.debug('Current Language is: %s' % read)
        return_value = DeviceServicer_pb2.GetLanguage_Responses(CurrentLanguage=silaFW_pb2.Integer(value=read))
    ...
    def GetPumpStatus(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                ...
                logging.debug("Error reading status. NONE")
        except:
            read = "Error reading pump status"

        logging.debug("Current pump status is: %s  (+ running; - stopped)" % read)
        return_value = DeviceServicer_pb2.GetPumpStatus_Responses(CurrentPumpStatus=silaFW_pb2.String(value=read))
    ...
    def GetVersionType(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            read = str(read)
            if read is None:
                read = "Error reading version. NONE"
        except:
            read = "Error reading pump version"
        logging.debug("Pump model, software version and head model type code are: %s" % read)
        return_value = DeviceServicer_pb2.GetVersionType_Responses(CurrentVersionType=silaFW_pb2.String(value=read))
    ...
    def CurrentVersionSoftware(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            read = "Error reading software version"
        logging.debug("Current software version is: %s" % read)
        return_value = DeviceServicer_pb2.CurrentVersionSoftware_Responses(CurrentVersionSoftware=silaFW_pb2.String(
            value=read))
    ...
    def GetSerialNumber(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            read = str(read)
            if read is None:
                read = "Error reading serial nummber. NONE"
        except:
            read = "Error reading serial nummber"
        logging.debug("Serial number is: %s" % read)
        return_value = DeviceServicer_pb2.GetSerialNumber_Responses(SerialNumber=silaFW_pb2.String(value=read))
    ...
    def SetChannelAddressing(self, request, context: grpc.ServicerContext) \
        ...
        # initialise the return value
        return_value = None
        value = request.ChannelAddressing.value
        
        address = request.Address.value
        logging.info('%s~%s\r\n' % (address, int(value)))
        command = '%s~%s\r\n' % (address, int(value))
        command_as_bytes = str.encode(command)
        logging.debug(command_as_bytes)
        try:
            self.ser.write(command_as_bytes)
            read = self.ser.readline().rstrip()
            read = bytes.decode(read)
            ...
            print("ERROR")
            read = "Error setting channel Addressing"
        return_value = DeviceServicer_pb2.SetChannelAddressing_Responses(ChannelAddressingSet=silaFW_pb2.String(value=read))

        logging.debug("Setting of channel Addressing to %s : %s" % (value, read))
    ...
    def GetChannelAddressing(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            read = self.ser.readline().rstrip()
            read = bytes.decode(read)
            read = bool(int(read))  # read is string and must be converted to int beacuse bool('anystring') is True
            if read is None:
                logging.error("Error retrieving channel addressing. NONE")
                logging.debug("No information received. Please check if pump %s is connected" % address)
        except:
            read = None
            logging.error("Error retrieving channel addressing")
            logging.debug("No information recieved. Please check if pump %s is connected" %(address))
        if read is False:
            meaning = 'disabled'
        elif read is True:
            meaning = 'enabled'
        logging.info(f'Channel adressing set to: {read}, {meaning}')

        return_value = DeviceServicer_pb2.GetChannelAddressing_Responses(ChannelAddressing=silaFW_pb2.Boolean(value=read))
    ...
    def SetEventMessages(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        address = request.Address.value
        value = request.EventMessages.value
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting event messages"
        logging.debug("Setting event messaging to %s : %s" % (value, read))
        return_value = DeviceServicer_pb2.SetEventMessages_Responses(EventMessagesSet=silaFW_pb2.String(value=read))
    ...
    def GetEventMessages(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error retrieving event messages. NONE")
                logging.debug("No information received. Please check if pump %s is connected" %(address))
            else:
                read = bool(read)
        except:
            read = None
            logging.error("Error retrieving event messages")
            logging.debug("No information recieved. Please check if pump %s is connected" %(address))
        if read is False:
            meaning='disabled'
        elif read is True:
        ...
        return_value = DeviceServicer_pb2.GetEventMessages_Responses(EventMessages=silaFW_pb2.Boolean(value=read))
    ...
    def GetSerialProtocol(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error retrieving version of the serial protocol. NONE")
            else:
                read = int(read)
        except:
            read = None
            logging.error("Error retrieving version of the serial protocol")
        logging.debug("Integer representing the version of the serial protocol is: %s" % read)
        return_value = DeviceServicer_pb2.GetSerialProtocol_Responses(SerialProtocol=silaFW_pb2.Integer(value=read))
    ...
    def SetPumpName(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting pump name"
        logging.debug('Pump name set to %s: %s' % (value, read))
        return_value = DeviceServicer_pb2.SetPumpName_Responses(PumpNameSet=silaFW_pb2.String(value=read))
    ...
    def GetChannelNumber(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error retrieving number of channels. NONE")
            else:
                read = int(read)
        except:
            read = None
            logging.error("Error retrieving number of channels")
        logging.debug("Pump %s has: %s channels" %(address, read))
        return_value = DeviceServicer_pb2.GetChannelNumber_Responses(ChannelNumber=silaFW_pb2.Integer(value=read))
    ...
    def SetChannelNumber(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        address = request.Address.value
        value_user = request.ChannelNumber.value

        value = '{:0>4}'.format(int(value_user))
        command = '%sxA%s\r\n' % (address, value)
        command_as_bytes = str.encode(command)
        try:
            self.ser.write(command_as_bytes)
            ...
            print("ERROR")
            read = "Error setting channel number"
        logging.debug('Channel number set to %s: %s' % (value, read))
        return_value = DeviceServicer_pb2.SetChannelNumber_Responses(ChannelNumberSet=silaFW_pb2.String(value=read))
    ...
    def GetRevolutions(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error retrieving number of revolutions since last reset. NONE")
            else:
                read = int(read)
        except:
            read = None
            logging.error("Error retrieving number of revolutions since last reset")
        logging.debug("Total number of revolutions since last reset is: %s" % read)
        return_value = DeviceServicer_pb2.GetRevolutions_Responses(Revolutions=silaFW_pb2.Integer(value=read))
    ...
    def GetChannelTotalVolume(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error retrieving channel total volume pumped since last reset. NONE")
            else:
                read = float(read)
        except:
            read = None
            logging.error("Error retrieving channel total volume pumped since last reset")
        logging.debug("Channel total volume pumped since last reset is: %s mL" % read)
        return_value = DeviceServicer_pb2.GetChannelTotalVolume_Responses(ChannelTotalVolume=silaFW_pb2.Real(value=read))
    ...
    def GetTotalTime(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error retrieving total time pumped since last reset. NONE")
            else:
                read = int(read)
        except:
            read = None
            logging.error("Error retrieving total time pumped since last reset")
        logging.debug("Total time pumped for channel %s since last reset is: %s seconds" % (channel, int(read)))
        return_value = DeviceServicer_pb2.GetTotalTime_Responses(TotalTime=silaFW_pb2.Integer(value=read))
    ...
    def GetHeadModel(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read= None
                logging.error("Error retrieving pump head model type code. NONE")
            else:
                read = str(read)
        except:
            read = None
            logging.error("Error retrieving pump head model type code")
        logging.debug("Pump head model type code for pump %s is: %s " % (address, read))
        return_value = DeviceServicer_pb2.GetHeadModel_Responses(HeadModel=silaFW_pb2.String(value=read))
    ...
    def SetHeadModel(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        address = request.Address.value
        value_user = request.HeadModel.value
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting pump head model type code"
        logging.debug('Head model set to %s: %s' % (value, read))
        return_value = DeviceServicer_pb2.SetHeadModel_Responses(HeadModelSet=silaFW_pb2.String(value=read))
    ...
    def SetUserInterface(self, request, context: grpc.ServicerContext) \
        ...
        # initialise the return value
        return_value = None
        address = request.UserInterface.value
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting pump local user interface"
        logging.debug('User interface set: %s' % read)
        return_value = DeviceServicer_pb2.SetUserInterface_Responses(UserInterfaceSet=silaFW_pb2.String(value=read))
    ...
    def SetDisableInterface(self, request, context: grpc.ServicerContext) \
        ...
        # initialise the return value
        return_value = None
        address = request.DisableInterface.value
        ...
        try:
            ...
            print("ERROR")
            read = "Error disabling pump local user interface"
    ...
    def SetDisplayNumbers(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        address = request.Address.value
        value = request.DisplayNumbers.value
        value = '{:0>16}'.format(value)
        ...
        try:
            ...
            print("ERROR")
            read = "Error displaying numbers"
        logging.debug('\' %s displayed \': %s' % (value, read))
        return_value = DeviceServicer_pb2.SetDisplayNumbers_Responses(DisplayNumbersSet=silaFW_pb2.String(value=read))
    ...
    def SetDisplayLetters(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        address = request.Address.value
        value = request.DisplayLetters.value
        value = '{:0>16}'.format(value)
        ...
        try:
            ...
            read = "Error displaying numbers"
        logging.debug('\' %s displayed \': %s' % (value, read))
        return_value = DeviceServicer_pb2.SetDisplayLetters_Responses(DisplayLettersSet=silaFW_pb2.String(value=read))
    ...
    def GetTimeSetting(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error reading current setting for pump time. NONE")
            else:
                read = float(read)*0.1
        except:
            read = None
            logging.error("Error getting current setting for pump time")
        logging.debug("Current setting for pump time on channel %s is: %s seconds" % (channel, read))
        return_value = DeviceServicer_pb2.GetTimeSetting_Responses(TimeSetting=silaFW_pb2.Real(value=read))
    ...
    def SetTimeSetting(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        channel = request.Channel.value
        value_user = request.TimeSetting.value

        value = int(float(value_user)*10)           # eliminates '.'
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting current setting for pump time"
        logging.debug("Setting pump time on channel %s is: %s seconds" % (channel, read))
        return_value = DeviceServicer_pb2.SetTimeSetting_Responses(TimeSettingSet=silaFW_pb2.String(value=read))
    ...
    def SetRunTimeM(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        channel = request.Channel.value
        value_user = request.RunTimeM.value

        value = int(float(value_user))          # eliminates '.'
        value = '{:0>3}'.format(value)            # formats the input to 3 digits
        command = '%sVM%s\r\n' % (channel, value)
        command_as_bytes = str.encode(command)
        try:
            self.ser.write(command_as_bytes)
            ...
            print("ERROR")
            read = "Error setting current run time setting for dispensing"
        logging.debug("Setting run time on channel %s is: %s minutes" % (channel, read))
        return_value = DeviceServicer_pb2.SetRunTimeM_Responses(RunTimeMSet=silaFW_pb2.String(value=read))
    ...
    def SetRunTimeH(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            read = "Error setting current run time setting for dispensing"
        logging.debug("Setting run time on channel %s is: %s minutes" % (channel, read))
        return_value = DeviceServicer_pb2.SetRunTimeH_Responses(RunTimeHSet=silaFW_pb2.String(value=read))
    ...
    def GetRollerStepsLow(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error retrieving current setting for volume to pump in low order roller steps. NONE")
            else:
                read = int(read)

        except:
            read = None
            logging.error("Error retrieving current setting for volume to pump in low order roller steps")
        logging.debug("Current setting for volume to pump in low order roller steps for channel %s is: %s " % (channel, int(read)))
        return_value = DeviceServicer_pb2.GetRollerStepsLow_Responses(RollerStepsLow=silaFW_pb2.Integer(value=read))
    ...
    def SetRollerStepsLow(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        channel = request.Channel.value
        value_user = request.RollerStepsLow.value

        value = int(float(value_user))              # eliminates '.'
        value = '{:0>5}'.format(value)              # formats input to 5 digits
        command = '%sU%s\r\n' % (channel, value)
        command_as_bytes = str.encode(command)
        try:
            self.ser.write(command_as_bytes)
            ...
            print("ERROR")
            read = "Error setting volume to pump in roller step"
        logging.debug("Setting volume to pump in low order roller steps of %s for channel %s is: %s " % (value_user, channel, read))
        return_value = DeviceServicer_pb2.SetRollerStepsLow_Responses(RollerStepsLowSet=silaFW_pb2.String(value=read))
    ...
    def GetRollerStepsHigh(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error retrieving current setting for volume to pump in high order roller steps. NONE")
        except:
            read = None
            logging.error("Error retrieving current setting for volume to pump in high order roller steps")
        logging.debug("Current setting for volume to pump in high order roller steps for channel %s is: %s " % (channel, int(read)))
        return_value = DeviceServicer_pb2.GetRollerStepsHigh_Responses(RollerStepsHigh=silaFW_pb2.Integer(value=read))
    ...
    def SetRollerStepsHigh(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        channel = request.Channel.value
        value_user = request.RollerSteps.value
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting volume to pump in roller step"
        logging.debug("Setting volume to pump in high order roller steps of %s for channel %s is: %s "  % (value_user, channel, read))
        return_value = DeviceServicer_pb2.SetRollerStepsHigh_Responses(RollerStepsHighSet=silaFW_pb2.String(value=read))
    ...
    def GetRSV(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error retrieving pump's current setting for roller step volume (RSV). NONE")
            else:
                read = float(read[:4])*0.001*(10**(float(read[5:])))    # translates the answer of the pump to 'human' number in nL
        except:
            read = None
            logging.error("Error retrieving pump's current setting for roller step volume (RSV)")
        logging.debug("The pump's current setting for roller step volume (RSV) for channel %s is: %s nL" % (channel, read))
        return_value = DeviceServicer_pb2.GetRSV_Responses(RSV=silaFW_pb2.Real(value=read))
    ...
    def SetRSV(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        channel = request.Channel.value
        value_user = request.RSV.value

        value = format(float(value_user), '.4E')                # formats input to scientific
        ...
        try:
            ...
            print(read)
            if read != '#':
                read = str(float(read[:4])*0.001*(10**(float(read[5:]))))    # translates the answer of the pump to 'human' number in nL
        except:
            print("ERROR")
            read = "Error setting volume to pump in roller step"
        logging.debug("Setting roller step volume (RSV) for channel %s to %s nL: %s" % (channel, value_user, read))
        return_value = DeviceServicer_pb2.SetRSV_Responses(RSVSet=silaFW_pb2.String(value=read))
    ...
    def SetRSVReset(self, request, context: grpc.ServicerContext) \
        ...
        # initialise the return value
        return_value = None
        address = request.RSVReset.value
        ...
        try:
            ...
            print("ERROR")
            read = "Error resetting the pump to discard calibration data"
        logging.debug("Resetting the pump to discard calibration data: %s " % read)
        return_value = DeviceServicer_pb2.SetRSVReset_Responses(RSVResetSet=silaFW_pb2.String(value=read))
    ...
    def ResetRSVTable(self, request, context: grpc.ServicerContext) \
        ...
        # initialise the return value
        return_value = None
        address = request.RSVTableReset.value
        ...
        try:
            ...
            print("ERROR")
            read = "Error roller step value table to default"
        logging.debug("Resetting roller step value table to default: %s " % read)
        return_value = DeviceServicer_pb2.ResetRSVTable_Responses(ResetRSVTableSet=silaFW_pb2.String(value=read))
    ...
    def SetNonFactoryRSV(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        channel = request.Channel.value
        rollers = request.RollerCount.value
        tube = float(request.TubingID.value)
        value_user = request.NonFactoryRSV.value
        allowed_tube_diameters = [0.13, 0.19, 0.25, 0.38, 0.44, 0.51, 0.57, 0.64, 0.76, 0.89, 0.95, 1.02, 1.09, 1.14,
                                  1.22, 1.3, 1.42, 1.52, 1.65, 1.75, 1.85, 2.06, 2.29, 2.54, 2.79, 3.17]
        if int(rollers) not in [6, 8, 12]:
            logging.debug('Roller count must be 6, 8, or 12')
        if tube not in allowed_tube_diameters:
            logging.debug('Wrong tube ID, see manual p.16 (of 36)')

        tube = str(int(float(format(tube, '.2f'))*100))
        rollers = str(rollers)
        ...
        command = '%sxt%s|%s|%s\r\n' % (channel, rollers[:4], tube[:4], value)
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting non-factory roller step volume "
        logging.debug("Setting non-factory roller step volume: %s " % read)
        return_value = DeviceServicer_pb2.SetNonFactoryRSV_Responses(SetNonFactoryRSVSet=silaFW_pb2.String(value=read))
    ...
    def GetPauseTime(self, request, context: grpc.ServicerContext) \
        ...
        return_value = DeviceServicer_pb2.GetPauseTime_Responses(PauseTime=silaFW_pb2.Real(value=read))
    ...
    def SetPauseTime(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        channel = request.Channel.value
        value_user = request.PauseTime.value
        ...
        logging.debug('Setting of pause time to %s s on channel %s: %s ' % (value_user, channel, read))
        return_value = DeviceServicer_pb2.SetPauseTime_Responses(PauseTimeSet=silaFW_pb2.String(value=read))
    ...
    def SetPauseTimeM(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        channel = request.Channel.value
        value_user = request.PauseTimeM.value
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting pause time"
        logging.debug('Setting of pause time to %s minutes on channel %s: %s ' % (value_user, channel, read))
        return_value = DeviceServicer_pb2.SetPauseTimeM_Responses(PauseTimeMSet=silaFW_pb2.String(value=read))
    ...
    def SetPauseTimeH(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting pause time"
        logging.debug('Setting of pause time to %s hours on channel %s: %s ' % (value_user, channel, read))
        return_value = DeviceServicer_pb2.SetPauseTimeH_Responses(PauseTimeHSet=silaFW_pb2.String(value=read))
    ...
    def GetTotalVolume(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            if read is None:
                read= None
                logging.error("Error reading total volume dispensed since the last reset. NONE")
            else:
                read = float(read)
        except:
            read = None
            logging.error("Error getting total volume dispensed since the last reset")
        logging.debug("Total volume dispensed on channel %s since the last reset is: %s " % (channel, read))
        return_value = DeviceServicer_pb2.GetTotalVolume_Responses(CurrentTotalVolume=silaFW_pb2.Real(value=read))
    ...
    def SaveSettings(self, request, context: grpc.ServicerContext) \
        ...
        # initialise the return value
        return_value = None
        address = request.PumpAddress.value
        ...
        try:
            ...
            if read is None:
                read = None
                logging.error("Error saving the current pump settings values to memory. NONE")
            else:
                read = str(read)
        except:
            read = None
            logging.error("Error saving the current pump settings values to memory")
        logging.debug('Saving the current pump settings values to memory: %s ' % read)
        return_value = DeviceServicer_pb2.SaveSettings_Responses(Save=silaFW_pb2.String(value=read))
    ...
    def SaveSetRoller(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            read = str(read)
            if read is None:
                read = "Error saving set roller step settings. NONE"
        except:
            read = "Error saving set roller step settings"
        logging.debug("Saving set roller step settings: %s " % read)
        return_value = DeviceServicer_pb2.SaveSetRoller_Responses(Save=silaFW_pb2.String(value=read))
    ...
    def GetFootSwitchStatus(self, request, context: grpc.ServicerContext) \
        ...
        try:
            ...
            read = str(read)
            if read is None:
                read = "Error getting the current status of the foot switch. NONE"
        except:
            read= "Error retrieving the current status of the foot switch"
        if read == '-':
            meaning = '-, open'
        elif read == '+':
            meaning = '+, grounded'
        logging.debug("Current status of the foot switch: %s " % meaning)
        return_value = DeviceServicer_pb2.GetFootSwitchStatus_Responses(FootSwitchStatus=silaFW_pb2.String(value=read))
    ...
    def SetRollersNumber(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        channel = request.Channel.value
        value_user = request.RollersNumber.value

        value = '{:0>4}'.format(value_user)             # formats input to 4 digits
        command = '%sxB%s\r\n' % (channel, value)
        command_as_bytes = str.encode(command)
        try:
            self.ser.write(command_as_bytes)
            ...
            print("ERROR")
            read = "Error setting number of rollers for channel"
        logging.debug("Setting number of rollers for channel: %s rollers on channel %s: %s" % (value_user, channel, read))
        return_value = DeviceServicer_pb2.SetRollersNumber_Responses(RollersNumber=silaFW_pb2.String(value=read))
    ...
    def GetRollersNumber(self, request, context: grpc.ServicerContext) \
        ...
        return_value = DeviceServicer_pb2.GetRollersNumber_Responses(RollersNumber=silaFW_pb2.Integer(value=read))
    ...
    def SetPumpSerialNumber(self, request, context: grpc.ServicerContext) \
        ...
        return_value = None
        address = request.Address.value
        value = request.PumpSerialNumber.value
        ...
        try:
            ...
            print("ERROR")
            read = "Error setting number of rollers for channel"
        logging.debug("Setting serial number of pump %s to %s : %s" % (address, value, read))
        return_value = DeviceServicer_pb2.SetPumpSerialNumber_Responses(PumpSerialNumberSet=silaFW_pb2.String(value=read))
