...
:date: (creation)          2021-03-16T12:40:00.415228
:date: (last modification) 2021-03-16T12:40:00.415228
...
class DriveControlServicerReal:
    ...
    def StartPump(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address}H\r\n'
    ...
    def StopPump(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address}I\r\n'
        for i in range(0, 3, 1):
            try:
                with self.properties.acquire_timeout_lock():
                    self.properties.ser.write(str.encode(command))
    ...
    def SetDirectionClockwise(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address}J\r\n'
        for i in range(0, 3, 1):
            try:
                with self.properties.acquire_timeout_lock():
                    self.properties.ser.write(str.encode(command))
    ...
    def SetDirectionCounterClockwise(self, request, context: grpc.ServicerContext) \
        ...
        command = f'{self.properties.pump_address}K\r\n'
        for i in range(0, 3, 1):
            try:
                with self.properties.acquire_timeout_lock():
                    self.properties.ser.write(str.encode(command))
