...
:date: (creation)          2021-04-07T13:30:01.285116
:date: (last modification) 2021-04-07T13:30:01.285116
...
class BalanceServiceSimulation:
    ...
    def Zero(self, request, context: grpc.ServicerContext) \
        ...
        read = possible_responses[np.random.randint(0, 4)]
    ...
    def ZeroImmediate(self, request, context: grpc.ServicerContext) \
        ...
        read = possible_responses[np.random.randint(0, 5)]
    ...
    def Tare(self, request, context: grpc.ServicerContext) \
        ...
        tare_value = np.round(np.random.rand()*10, 2)
        unit = 'g'
