...
:file:    MT_Viper_SW_Balance_Service_client.py
:authors: Lukas Bromig

:date: (creation)          2021-04-09T13:29:06.844605
:date: (last modification) 2021-04-09T13:29:06.844605
...
from sila2lib_implementations.MT_Viper_SW.MT_Viper_SW_Balance_Service.BalanceService.BalanceService_client import BalanceServiceClient
from sila2lib_implementations.MT_Viper_SW.MT_Viper_SW_Balance_Service.DeviceInformationProvider.DeviceInformationProvider_client import DeviceInformationProviderClient
from sila2lib_implementations.MT_Viper_SW.MT_Viper_SW_Balance_Service.DisplayController.DisplayController_client import DisplayControllerClient



# noinspection PyPep8Naming, PyUnusedLocal
class MT_Viper_SW_Balance_ServiceClient(SiLA2Client):
    """
        This is a Mettler Toledo Viper SW balance service
    ...
    balanceService_client =  None
    deviceInformationProvider_client =  None
    displayController_client =  None
    ...
    def __init__(self,
                 name: str = "MT_Viper_SW_Balance_ServiceClient", description: str = "This is a Mettler Toledo Viper SW balance service",
        ...
        logging.info(
            f"Starting SiLA2 service client for service MT_Viper_SW_Balance_Service with service name: {name}"
        )

        self.balanceService_client = BalanceServiceClient(self.channel)
        self.deviceInformationProvider_client = DeviceInformationProviderClient(self.channel)
        self.displayController_client = DisplayControllerClient(self.channel)
...
def parse_command_line():
    ...
    """
    parser = argparse.ArgumentParser(description="A SiLA2 client: MT_Viper_SW_Balance_Service")
