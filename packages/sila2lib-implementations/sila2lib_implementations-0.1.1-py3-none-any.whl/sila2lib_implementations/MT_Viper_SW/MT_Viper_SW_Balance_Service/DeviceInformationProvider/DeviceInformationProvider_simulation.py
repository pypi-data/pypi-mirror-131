...
:file:    DeviceInformationProvider_simulation.py
:authors: Lukas Bromig

:date: (creation)          2021-04-09T13:29:06.772909
:date: (last modification) 2021-04-09T13:29:06.772909
...
from sila2lib_implementations.MT_Viper_SW.MT_Viper_SW_Balance_Service.DeviceInformationProvider.gRPC import DeviceInformationProvider_pb2 as DeviceInformationProvider_pb2
# from .gRPC import DeviceInformationProvider_pb2_grpc as DeviceInformationProvider_pb2_grpc

# import default arguments
from sila2lib_implementations.MT_Viper_SW.MT_Viper_SW_Balance_Service.DeviceInformationProvider.DeviceInformationProvider_default_arguments import default_dict

# import SiLA Defined Error factories
from sila2lib_implementations.MT_Viper_SW.MT_Viper_SW_Balance_Service.DeviceInformationProvider.DeviceInformationProvider_defined_errors import generate_def_error_InternalError, generate_def_error_LogicalError


# noinspection PyPep8Naming,PyUnusedLocal
class DeviceInformationProviderSimulation:
    """
    Implementation of the *Device Information Provider* in *Simulation* mode
    ...
    def Reset(self, request, context: grpc.ServicerContext) \
        ...
        possible_responses = ['I4 A "B021002593"']

        command = f'@\r\n'

        read = possible_responses[random.randint(0, 1)]
        read = read.split('"')[1]
    ...
    def Get_ImplementedCommands(self, request, context: grpc.ServicerContext) \
        ...
        possible_responses = [['I0 B 0 "I0"', 'I0 B 0 "@"', 'I0 B 1 "D', 'I0 B 1 "DW"', 'I0 A 3 "SIR'], ['I0 I']]
    ...
    def Get_DeviceType(self, request, context: grpc.ServicerContext) \
        ...
        possible_responses = ['I2 A "MS204S 220.0090 g"', 'I2 I']
    ...
    def Get_FirmwareVersion(self, request, context: grpc.ServicerContext) \
        ...
        possible_responses = ['I3 A "2.10-10.28.0.493.142"', 'I3 I']
        command = f'I3\r\n'
    ...
    def Get_SerialNumber(self, request, context: grpc.ServicerContext) \
        ...
        possible_responses = ['I4 A "B021002593"', 'I4 I']
        command = f'I4\r\n'
