...
:date: (creation)          2021-03-21T13:49:44.213540
:date: (last modification) 2021-03-21T13:49:44.213540
...
class DeviceServiceSimulation:
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read = b'\x10\x02\x01\x03\x04\x02\x00\x00\x01\x10\x03'
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read = b'\x10\x02\x01\x03\x04\x02\x00\x01\x01\x10\x03'
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read = b'\x10\x02\x01\x03\x04\x02\x00\x03\x01\x10\x03'
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read = b'\x10\x02\x01\x03\x04\x02\x00\x04\x01\x10\x03'
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read = b'\x10\x02\x01\x03\x04\x02\x00\x0e\x01\x10\x03'
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read =  b'\x10\x02\x01\x03\x04\x02q\x05\x01\x10\x03'
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read =  b'\x10\x02\x01\x03\x04\x02q\x0c\x01\x10\x03'
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read =  b'\x10\x02\x01\x03\x04\x02s\x0c\x01\x10\x03'
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read = b'\x10\x02\x01\x03\x04\x02}\x14\x01\x10\x03'
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read = b'\x10\x02\x01\x03\x04\x02}\x15\x01\x10\x03'
        ...
        for i in range(0, 3, 1):
            try:
                if self.protocol == 'ascii':
                    ...
                    read = b'\x10\x02\x01\x03\x04\x02q_\x01\x10\x03'
    ...
    def GetCommunicationProtocol(self, request, context: grpc.ServicerContext) \
        ...
        # TODO:
        #   Add implementation of Simulation for command GetCommunicationProtocol here and write the resulting response
        #   in return_value
    ...
    def GetSerialPort(self, request, context: grpc.ServicerContext) \
        ...
        # TODO:
        #   Add implementation of Simulation for command GetSerialPort here and write the resulting response
        #   in return_value
    ...
    def SetSerialPort(self, request, context: grpc.ServicerContext) \
        ...
        # TODO:
        #   Add implementation of Simulation for command SetSerialPort here and write the resulting response
        #   in return_value
