...
:date: (creation)          2020-04-16T10:19:35.399112
:date: (last modification) 2020-04-16T10:19:35.399112
...
class DeviceServicer(DeviceServicer_pb2_grpc.DeviceServicerServicer):
    ...
    def __init__(self, ser, properties, simulation_mode: bool = True):
        ...
        if simulation_mode:
            self._inject_implementation(DeviceServicerSimulation(self.properties))
        else:
            self._inject_implementation(DeviceServicerReal(self.ser, self.properties))
