...
:file:    PumpBServicer_servicer.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:14.796068
:date: (last modification) 2020-04-16T10:19:14.796068
...
from .PumpBServicer_simulation import PumpBServicerSimulation
from .PumpBServicer_real import PumpBServicerReal


class PumpBServicer(PumpBServicer_pb2_grpc.PumpBServicerServicer):
    """
    This is a DASGIP Service
    """
    implementation: Union[PumpBServicerSimulation, PumpBServicerReal]
    ...
    def __init__(self, reactors, simulation_mode: bool = True):
        ...
        if simulation_mode:
            self._inject_implementation(PumpBServicerSimulation(self.reactors))
        else:
            self._inject_implementation(PumpBServicerReal(self.reactors))

    def _inject_implementation(self,
                               implementation: Union[PumpBServicerSimulation,
                                                     PumpBServicerReal]
                               ) -> bool:
        """
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentCmd (Current Controller Command): Current controller command value of the PumpB module. Controller command (Nothing, Stop, Start)
        """
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentMode (Current Controller Mode): Current controller mode value of the PumpB module. Controller mode (Manual, Automatic).
        """
    ...
    def GetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSetpointSelect (Current Setpoint Selection): Current setpoint selection value of the PumpB module. Controller state (Off, On, Error).
        """
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentState (Current Controller State): Current controller state value of the PumpB module. Controller state (Off, On, Error).
        """
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAvailable (Current Function Availability): Current function availability value of the PumpB module.
        """
    ...
    def GetVersion(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentVersion (Current Function Version): Current function model version number of the PumpB module.
        """
    ...
    def GetActuatorCalibration(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentActuatorCalibration (Current Actuator Calibration): Current actuator calibration value of the PumpB module. Calibration parameter (at 100% speed).
        """
    ...
    def GetActuatorDirPV(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentActuatorDirPV (Current Actuator Dir PV): Current actuator direction present value of the PumpB module. Actual pump direction (0=Clockwise, 1=Counterclockwise).
        """
