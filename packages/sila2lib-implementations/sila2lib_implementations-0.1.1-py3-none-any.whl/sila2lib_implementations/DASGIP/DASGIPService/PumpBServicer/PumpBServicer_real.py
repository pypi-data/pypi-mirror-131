...
:file:    PumpBServicer_real.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:14.836965
:date: (last modification) 2020-04-16T10:19:14.836965
...
class PumpBServicerReal:
    """
    Implementation of the *PumpB Servicer* in *Real* mode
    ...
    def GetPVInt(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.setter.PVInt
    ...
    def GetPV(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.setter.PV
    ...
    def SetSPM(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpB.setter.SPM = request.SPM.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.setter.SPM
    ...
    def SetSPE(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpB.setter.SPE = request.SPE.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.setter.SPE
    ...
    def GetSP(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.setter.SP
    ...
    def GetSPA(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.setter.SPA
    ...
    def GetSPR(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.setter.SPR
    ...
    def GetAccess(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.status.Access
    ...
    def SetCmd(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpB.status.Cmd = request.Cmd.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.status.Cmd
    ...
    def SetMode(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpB.status.Mode = request.Mode.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.status.Mode
    ...
    def SetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpB.setter.SetpointSelect = request.SetpointSelect.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.setter.SetpointSelect 
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.status.State
    ...
    def GetType(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.sysinfo.Type
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.sysinfo.Available
    ...
    def GetName(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.sysinfo.Name
    ...
    def GetVersion(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.sysinfo.Version
    ...
    def SetActuatorCalibration(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpB.actuator.Calibration = request.ActuatorCalibration.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.actuator.Calibration
    ...
    def GetActuatorDirPV(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpB.actuator.Dir_PV
