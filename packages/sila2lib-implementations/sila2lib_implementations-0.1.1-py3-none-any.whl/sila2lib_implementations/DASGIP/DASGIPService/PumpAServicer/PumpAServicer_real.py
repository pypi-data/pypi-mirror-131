...
:file:    PumpAServicer_real.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:14.774156
:date: (last modification) 2020-04-16T10:19:14.774156
...
from .gRPC import PumpAServicer_pb2 as PumpAServicer_pb2
# from .gRPC import PumpAServicer_pb2_grpc as PumpAServicer_pb2_grpc

# import default arguments
from .PumpAServicer_default_arguments import default_dict


# noinspection PyPep8Naming,PyUnusedLocal
class PumpAServicerReal:
    """
    Implementation of the *PumpA Servicer* in *Real* mode
    ...
    def GetPVInt(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.setter.PVInt
        CurrentPVInt = node.get_value()
        return_value = PumpAServicer_pb2.GetPVInt_Responses(CurrentPVInt=silaFW_pb2.Real(value=CurrentPVInt))
    ...
    def GetPV(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.setter.PV
        CurrentPV = node.get_value()
        return_value = PumpAServicer_pb2.GetPV_Responses(CurrentPV=silaFW_pb2.Real(value=CurrentPV))
    ...
    def SetSPM(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The manual setpoint of the PumpA module.
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpA.setter.SPM = request.SPM.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.setter.SPM
        SPMSet = node.get_value()
        return_value = PumpAServicer_pb2.SetSPM_Responses(SPMSet=silaFW_pb2.Real(value=SPMSet))
    ...
    def SetSPE(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The external setpoint of the PumpA module.
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpA.setter.SPE = request.SPE.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.setter.SPE
        SPESet = node.get_value()
        return_value = PumpAServicer_pb2.SetSPE_Responses(SPESet=silaFW_pb2.Real(value=SPESet))
    ...
    def GetSP(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.setter.SP
        CurrentSP = node.get_value()
        return_value = PumpAServicer_pb2.GetSP_Responses(CurrentSP=silaFW_pb2.Real(value=CurrentSP))
    ...
    def GetSPA(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.setter.SPA
        CurrentSPA = node.get_value()
        return_value = PumpAServicer_pb2.GetSPA_Responses(CurrentSPA=silaFW_pb2.Real(value=CurrentSPA))
    ...
    def GetSPM(self, request, context: grpc.ServicerContext) \
        ...
        return_value = PumpAServicer_pb2.GetSPM_Responses(CurrentSPM=silaFW_pb2.Real(value=CurrentSPM))
    ...
    def GetSPE(self, request, context: grpc.ServicerContext) \
        ...
        return_value = PumpAServicer_pb2.GetSPE_Responses(CurrentSPE=silaFW_pb2.Real(value=CurrentSPE))
    ...
    def GetSPR(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.setter.SPR
        CurrentSPR = node.get_value()
        return_value = PumpAServicer_pb2.GetSPR_Responses(CurrentSPR=silaFW_pb2.Real(value=CurrentSPR))
    ...
    def GetAccess(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.status.Access
        CurrentAccess = node.get_value()
        return_value = PumpAServicer_pb2.GetAccess_Responses(CurrentAccess=silaFW_pb2.Integer(value=CurrentAccess))
    ...
    def SetCmd(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The controller command of the PumpA module. Controller command (Nothing, Stop, Start).
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpA.status.Cmd = request.Cmd.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.status.Cmd
        CmdSet = node.get_value()
        return_value = PumpAServicer_pb2.SetCmd_Responses(CmdSet=silaFW_pb2.Integer(value=CmdSet))
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentCmd (Current Controller Command): Current controller command value of the PumpA module. 
        ...
        return_value = PumpAServicer_pb2.GetCmd_Responses(CurrentCmd=silaFW_pb2.Integer(value=CurrentCmd))
    ...
    def SetMode(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The controller mode of the PumpA module. Controller mode (Manual, Automatic).
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpA.status.Mode = request.Mode.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.status.Mode
        ModeSet = node.get_value()
        return_value = PumpAServicer_pb2.SetMode_Responses(ModeSet=silaFW_pb2.Integer(value=ModeSet))
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentMode (Current Controller Mode): Current controller mode value of the PumpA module. 
        ...
        return_value = PumpAServicer_pb2.GetMode_Responses(CurrentMode=silaFW_pb2.Integer(value=CurrentMode))
    ...
    def SetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The selected setpoint of the PumpA module. Setpoint selection (Local, Manual, Internal, Script, External).
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpA.setter.SetpointSelect = request.SetpointSelect.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.setter.SetpointSelect 
        SetpointSelectSet = node.get_value()
        return_value = PumpAServicer_pb2.SetSetpointSelect_Responses(
    ...
    def GetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSetpointSelect (Current Setpoint Selection): Current setpoint selection value of the PumpA 
        ...
        return_value = PumpAServicer_pb2.GetSetpointSelect_Responses(
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentState (Current Controller State): Current controller state value of the PumpA module. 
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.status.State
        CurrentState = node.get_value()
        return_value = PumpAServicer_pb2.GetState_Responses(CurrentState=silaFW_pb2.Integer(value=CurrentState))
    ...
    def GetType(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentType (Current Function Type): Current function type value of the PumpA module.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.sysinfo.Type
        CurrentType = node.get_value()
        return_value = PumpAServicer_pb2.GetType_Responses(CurrentType=silaFW_pb2.String(value=CurrentType))
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAvailable (Current Function Availability): Current function availability value of the PumpA 
            module.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.sysinfo.Available
        CurrentAvailable = node.get_value()
        return_value = PumpAServicer_pb2.GetAvailable_Responses(
    ...
    def GetName(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentName (Current Function Name): Current function name of the PumpA module.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.sysinfo.Name
        CurrentName = node.get_value()
        return_value = PumpAServicer_pb2.GetName_Responses(CurrentName=silaFW_pb2.String(value=CurrentName))
    ...
    def GetVersion(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentVersion (Current Function Version): Current function model version number of the PumpA module.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.sysinfo.Version
        CurrentVersion = node.get_value()
        return_value = PumpAServicer_pb2.GetVersion_Responses(CurrentVersion=silaFW_pb2.String(value=CurrentVersion))
    ...
    def SetActuatorCalibration(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.PumpA.actuator.Calibration = request.ActuatorCalibration.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.actuator.Calibration
        ActuatorCalibrationSet = node.get_value()
        return_value = PumpAServicer_pb2.SetActuatorCalibration_Responses(
    ...
    def GetActuatorCalibration(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            ...
            PumpA module. Calibration parameter (at 100% speed).
        """
        ...
        node = self.reactors[request.UnitID.value].unit.PumpA.actuator.Calibration
        print(node)
        CurrentActuatorCalibration = node.get_value()
        return_value = PumpAServicer_pb2.GetActuatorCalibration_Responses(
    ...
    def GetActuatorDirPV(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            ...
            PumpA module. Actual pump direction (0=Clockwise, 1=Counterclockwise).
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.PumpA.actuator.Dir_PV
        CurrentActuatorDirPV = node.get_value()
        return_value = PumpAServicer_pb2.GetActuatorDirPV_Responses(
