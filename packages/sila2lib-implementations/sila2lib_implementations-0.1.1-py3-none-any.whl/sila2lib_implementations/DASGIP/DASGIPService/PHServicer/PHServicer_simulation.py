...
:file:    PHServicer_simulation.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:14.565858
:date: (last modification) 2020-04-16T10:19:14.565858
...
class PHServicerSimulation:
    """
    Implementation of the *PH Servicer* in *Simulation* mode
    ...
    def GetPV(self, request, context: grpc.ServicerContext) \
        ...
        if return_value is None:
            return_value = PHServicer_pb2.GetPV_Responses(
    ...
    def SetSPM(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetSPM_Responses(
    ...
    def SetSPE(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetSPE_Responses(
    ...
    def GetSP(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.GetSP_Responses(
    ...
    def GetSPA(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.GetSPA_Responses(
    ...
    def GetSPM(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.GetSPM_Responses(
    ...
    def GetSPE(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.GetSPE_Responses(
    ...
    def GetSPR(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.GetSPR_Responses(
    ...
    def GetAccess(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.GetAccess_Responses(
    ...
    def SetCmd(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetCmd_Responses(
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentCmd (Current Controller Command): Current controller command value of the pH module. Controller command (Nothing, Stop, Start)
        """
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.GetCmd_Responses(
    ...
    def SetMode(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetMode_Responses(
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentMode (Current Controller Mode): Current controller mode value of the pH module. Controller mode (Manual, Automatic).
        """
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.GetMode_Responses(
    ...
    def GetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSetpointSelect (Current Setpoint Selection): Current setpoint selection value of the pH module. Controller state (Off, On, Error).
        """
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentState (Current Controller State): Current controller state value of the pH module. Controller state (Off, On, Error).
        """
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.GetState_Responses(
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAvailable (Current Function Availability): Current function availability value of the pH module.
        """
    ...
    def GetName(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.GetName_Responses(
    ...
    def SetSensorOffset(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetSensorOffset_Responses(
    ...
    def GetSensorOffset(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorOffset (Current Sensor Offset): Current sensor offset value of the pH module. Sensor offset calibration parameter.
        """
    ...
    def GetSensorPVRaw(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorPVRaw (Current Sensor PVRaw): Current sensor present raw value of the pH module. Actual process raw value.
        """
    ...
    def SetSensorSlope(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetSensorSlope_Responses(
    ...
    def GetSensorSlope(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorSlope (Current Sensor Slope): Current sensor slope value of the pH module. Sensor slope calibration parameter.
        """
    ...
    def GetSensorCompensation(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorCompensation (Current Sensor Compensation): Current sensor compensation value of the pH module. Sensor temperature compensation parameter.
        """
    ...
    def SetControllerDB(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetControllerDB_Responses(
    ...
    def GetControllerDB(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerDB (Current Controller DB): Current controller deadband value of the pH module. PID controller: deadband (set to zero to disable).
        """
    ...
    def GetControllerOut(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerOut (Current Controller Out): Current controller output value of the pH module. PID controller: actual output value.
        """
    ...
    def SetControllerP(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetControllerP_Responses(
    ...
    def GetControllerP(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerP (Current Controller P): Current controller proportional parameter value of the pH module. PID controller: proportional parameter.
        """
    ...
    def SetControllerTd(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetControllerTd_Responses(
    ...
    def GetControllerTd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerTd (Current Controller Td): Current controller differentiator time constant of the pH module. PID controller: differentiator time constant (set to zero to disable).
        """
    ...
    def SetControllerTi(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetControllerTi_Responses(
    ...
    def GetControllerTi(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerTi (Current Controller Ti): Current controller integrator time constant of the pH module. PID controller: integrator time constant (set to zero to disable).
        """
    ...
    def GetControllerMin(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerMin (Current Controller Min): Current controller minimal output value of the pH module. PID controller: minimal output value.
        """
    ...
    def GetControllerMax(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerMax (Current Controller Max): Current controller maximal output value of the pH module. PID controller: maximal output value.
        """
    ...
    def GetAlarmEnabled(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmEnabled (Current Alarm Enabled): Current alarm enabled value of the pH module. Enables alarm function.
        """
    ...
    def GetAlarmAlarmHigh(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmAlarmHigh (Current Alarm AlarmHigh): Current alarm alarmhigh value of the pH module. Higher alarm limit.
        """
    ...
    def GetAlarmAlarmLow(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmAlarmLow (Current Alarm AlarmLow): Current alarm alarmlow value of the pH module. Lower alarm limit.
        """
    ...
    def SetAlarmMode(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetAlarmMode_Responses(
    ...
    def SetAlarmDelay(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetAlarmDelay_Responses(
    ...
    def GetAlarmDelay(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmDelay (Current Alarm Delay): Current alarm delay value of the pH module. Alarm hysteresis time.
        """
    ...
    def GetAlarmWarnHigh(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmWarnHigh (Current Alarm WarnHigh): Current alarm higher warning value of the pH module. Higher warning limit.
        """
    ...
    def SetAlarmWarnLow(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = PHServicer_pb2.SetAlarmWarnLow_Responses(
    ...
    def GetAlarmWarnLow(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmWarnLow (Current Alarm WarnLow): Current alarm lower warning value of the pH module. Lower warning limit.
        """
