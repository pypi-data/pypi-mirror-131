...
:file:    RedoxServicer_simulation.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:15.105790
:date: (last modification) 2020-04-16T10:19:15.105790
...
class RedoxServicerSimulation:
    """
    Implementation of the *Redox Servicer* in *Simulation* mode
    ...
    def GetPV(self, request, context: grpc.ServicerContext) \
        ...
        if return_value is None:
            return_value = RedoxServicer_pb2.GetPV_Responses(
    ...
    def SetSPM(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.SetSPM_Responses(
    ...
    def SetSPE(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.SetSPE_Responses(
    ...
    def GetSP(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.GetSP_Responses(
    ...
    def GetSPA(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.GetSPA_Responses(
    ...
    def GetSPM(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.GetSPM_Responses(
    ...
    def GetSPE(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.GetSPE_Responses(
    ...
    def GetSPR(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.GetSPR_Responses(
    ...
    def GetAccess(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.GetAccess_Responses(
    ...
    def SetCmd(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.SetCmd_Responses(
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.GetCmd_Responses(
    ...
    def SetMode(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.SetMode_Responses(
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.GetMode_Responses(
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.GetState_Responses(
    ...
    def SetControllerP(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.SetControllerP_Responses(
    ...
    def GetControllerMax(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerMax (Current Controller Max): Current controller maximal output value of the Redox 
    ...
    def SetAlarmMode(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.SetAlarmMode_Responses(
    ...
    def SetAlarmDelay(self, request, context: grpc.ServicerContext) \
        ...
        # fallback to default
        if return_value is None:
            return_value = RedoxServicer_pb2.SetAlarmDelay_Responses(
