...
:file:    RedoxServicer_servicer.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:15.057074
:date: (last modification) 2020-04-16T10:19:15.057074
...
from .RedoxServicer_simulation import RedoxServicerSimulation
from .RedoxServicer_real import RedoxServicerReal


class RedoxServicer(RedoxServicer_pb2_grpc.RedoxServicerServicer):
    """
    This is a DASGIP Service
    """
    implementation: Union[RedoxServicerSimulation, RedoxServicerReal]
    ...
    def __init__(self, reactors, simulation_mode: bool = True):
        ...
        if simulation_mode:
            self._inject_implementation(RedoxServicerSimulation(self.reactors))
        else:
            self._inject_implementation(RedoxServicerReal(self.reactors))

    def _inject_implementation(self,
                               implementation: Union[RedoxServicerSimulation,
                                                     RedoxServicerReal]
                               ) -> bool:
        """
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentCmd (Current Controller Command): Current controller command value of the Redox module. Controller command (Nothing, Stop, Start)
        """
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentMode (Current Controller Mode): Current controller mode value of the Redox module. Controller mode (Manual, Automatic).
        """
    ...
    def GetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSetpointSelect (Current Setpoint Selection): Current setpoint selection value of the Redox module. Controller state (Off, On, Error).
        """
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentState (Current Controller State): Current controller state value of the Redox module. Controller state (Off, On, Error).
        """
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAvailable (Current Function Availability): Current function availability value of the Redox module.
        """
    ...
    def GetVersion(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentVersion (Current Function Version): Current function model version number of the Redox module.
        """
    ...
    def GetSensorOffset(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorOffset (Current Sensor Offset): Current sensor offset value of the Redox module. Sensor offset calibration parameter.
        """
    ...
    def GetSensorPVRaw(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorPVRaw (Current Sensor PVRaw): Current sensor present raw value of the Redox module. Actual process raw value.
        """
    ...
    def GetSensorCompensation(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentSensorCompensation (Current Sensor Compensation): Current sensor compensation value of the Redox module. Sensor temperature compensation parameter.
        """
    ...
    def GetControllerDB(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerDB (Current Controller DB): Current controller deadband value of the Redox module. PID controller: deadband (set to zero to disable).
        """
    ...
    def GetControllerOut(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerOut (Current Controller Out): Current controller output value of the Redox module. PID controller: actual output value.
        """
    ...
    def GetControllerP(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerP (Current Controller P): Current controller proportional parameter value of the Redox module. PID controller: proportional parameter.
        """
    ...
    def GetControllerTd(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerTd (Current Controller Td): Current controller differentiator time constant of the Redox module. PID controller: differentiator time constant (set to zero to disable).
        """
    ...
    def GetControllerTi(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerTi (Current Controller Ti): Current controller integrator time constant of the Redox module. PID controller: integrator time constant (set to zero to disable).
        """
    ...
    def GetControllerMin(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerMin (Current Controller Min): Current controller minimal output value of the Redox module. PID controller: minimal output value.
        """
    ...
    def GetControllerMax(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentControllerMax (Current Controller Max): Current controller maximal output value of the Redox module. PID controller: maximal output value.
        """
    ...
    def GetAlarmEnabled(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmEnabled (Current Alarm Enabled): Current alarm enabled value of the Redox module. Enables alarm function.
        """
    ...
    def GetAlarmAlarmHigh(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmAlarmHigh (Current Alarm AlarmHigh): Current alarm alarmhigh value of the Redox module. Higher alarm limit.
        """
    ...
    def GetAlarmAlarmLow(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmAlarmLow (Current Alarm AlarmLow): Current alarm alarmlow value of the Redox module. Lower alarm limit.
        """
    ...
    def GetAlarmDelay(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmDelay (Current Alarm Delay): Current alarm delay value of the Redox module. Alarm hysteresis time.
        """
    ...
    def GetAlarmWarnHigh(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmWarnHigh (Current Alarm WarnHigh): Current alarm higher warning value of the Redox module. Higher warning limit.
        """
    ...
    def GetAlarmWarnLow(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmWarnLow (Current Alarm WarnLow): Current alarm lower warning value of the Redox module. Lower warning limit.
        """
