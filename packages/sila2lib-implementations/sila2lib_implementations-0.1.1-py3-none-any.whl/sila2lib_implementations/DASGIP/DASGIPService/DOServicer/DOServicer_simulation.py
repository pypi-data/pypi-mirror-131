...
:file:    DOServicer_simulation.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:13.565870
:date: (last modification) 2020-04-16T10:19:13.565870
...
class DOServicerSimulation:
    """
    Implementation of the *DO Servicer* in *Simulation* mode
    ...
    def GetPV(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetPV_Responses(CurrentPV=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetPV_Responses(
    ...
    def SetSPM(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetSPM_Responses(SPMSet=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetSPM_Responses(
    ...
    def SetSPE(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetSPE_Responses(SPESet=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetSPE_Responses(
    ...
    def GetSP(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetSP_Responses(CurrentSP=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetSP_Responses(
    ...
    def GetSPA(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetSPA_Responses(CurrentSPA=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetSPA_Responses(
    ...
    def GetSPM(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetSPM_Responses(CurrentSPM=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetSPM_Responses(
    ...
    def GetSPE(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetSPE_Responses(CurrentSPE=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetSPE_Responses(
    ...
    def GetSPR(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetSPR_Responses(CurrentSPR=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetSPR_Responses(
    ...
    def GetAccess(self, request, context: grpc.ServicerContext) \
        ...
        response = 1
        return_value =DOServicer_pb2.GetAccess_Responses(CurrentAccess=silaFW_pb2.Integer(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetAccess_Responses(
    ...
    def SetCmd(self, request, context: grpc.ServicerContext) \
        ...
        response = 0
        return_value =DOServicer_pb2.SetCmd_Responses(CmdSet=silaFW_pb2.Integer(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetCmd_Responses(
    ...
    def GetCmd(self, request, context: grpc.ServicerContext) \
        ...
        response = 0
        return_value =DOServicer_pb2.GetCmd_Responses(CurrentCmd=silaFW_pb2.Integer(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetCmd_Responses(
    ...
    def SetMode(self, request, context: grpc.ServicerContext) \
        ...
        response = 1
        return_value =DOServicer_pb2.SetMode_Responses(ModeSet=silaFW_pb2.Integer(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetMode_Responses(
    ...
    def GetMode(self, request, context: grpc.ServicerContext) \
        ...
        response = 1
        return_value =DOServicer_pb2.GetMode_Responses(CurrentMode=silaFW_pb2.Integer(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetMode_Responses(
    ...
    def SetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        response = 2
        return_value =DOServicer_pb2.SetSetpointSelect_Responses(SetpointSelectSet=silaFW_pb2.Integer(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetSetpointSelect_Responses(
    ...
    def GetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        response = 2
        return_value =DOServicer_pb2.GetSetpointSelect_Responses(CurrentSetpointSelect=silaFW_pb2.Integer(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetSetpointSelect_Responses(
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        response = 0
        return_value =DOServicer_pb2.GetState_Responses(CurrentState=silaFW_pb2.Integer(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetState_Responses(
    ...
    def GetType(self, request, context: grpc.ServicerContext) \
        ...
        response = 'SimDO'
        return_value =DOServicer_pb2.GetType_Responses(CurrentType=silaFW_pb2.String(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetType_Responses(
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        response = 0
        return_value =DOServicer_pb2.GetAvailable_Responses(CurrentAvailable=silaFW_pb2.Integer(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetAvailable_Responses(
    ...
    def GetName(self, request, context: grpc.ServicerContext) \
        ...
        response = 'SimDO'
        return_value =DOServicer_pb2.GetName_Responses(CurrentName=silaFW_pb2.String(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetName_Responses(
    ...
    def GetVersion(self, request, context: grpc.ServicerContext) \
        ...
        response = 'SimVersion'
        return_value =DOServicer_pb2.GetVersion_Responses(CurrentVersion=silaFW_pb2.String(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetVersion_Responses(
    ...
    def SetSensorOffset(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetSensorOffset_Responses(SensorOffsetSet=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetSensorOffset_Responses(
    ...
    def GetSensorOffset(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetSensorOffset_Responses(CurrentSensorOffset=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetSensorOffset_Responses(
    ...
    def GetSensorPVRaw(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetSensorPVRaw_Responses(CurrentSensorPVRaw=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetSensorPVRaw_Responses(
    ...
    def SetSensorSlope(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetSensorSlope_Responses(SensorSlopeSet=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetSensorSlope_Responses(
    ...
    def GetSensorSlope(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetSensorSlope_Responses(CurrentSensorSlope=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetSensorSlope_Responses(
    ...
    def SetSensorCompensation(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetSensorCompensation_Responses(SensorCompensationSet=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetSensorCompensation_Responses(
    ...
    def GetSensorCompensation(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetSensorCompensation_Responses(CurrentSensorCompensation=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetSensorCompensation_Responses(
    ...
    def SetControllerDB(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetControllerDB_Responses(ControllerDBSet=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetControllerDB_Responses(
    ...
    def GetControllerDB(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetControllerDB_Responses(CurrentControllerDB=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetControllerDB_Responses(
    ...
    def GetControllerOut(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetControllerOut_Responses(CurrentControllerOut=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetControllerOut_Responses(
    ...
    def SetControllerP(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetControllerP_Responses(ControllerPSet=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetControllerP_Responses(
    ...
    def GetControllerP(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetControllerP_Responses(CurrentControllerP=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetControllerP_Responses(
    ...
    def SetControllerTd(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetControllerTd_Responses(ControllerTdSet=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetControllerTd_Responses(
    ...
    def GetControllerTd(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetControllerTd_Responses(CurrentControllerTd=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetControllerTd_Responses(
    ...
    def SetControllerTi(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetControllerTi_Responses(ControllerTiSet=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetControllerTi_Responses(
    ...
    def GetControllerTi(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetControllerTi_Responses(CurrentControllerTi=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetControllerTi_Responses(
    ...
    def SetControllerMin(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetControllerMin_Responses(ControllerMinSet=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetControllerMin_Responses(
    ...
    def GetControllerMin(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetControllerMin_Responses(CurrentControllerMin=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetControllerMin_Responses(
    ...
    def SetControllerMax(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetControllerMax_Responses(ControllerMaxSet=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetControllerMax_Responses(
    ...
    def GetControllerMax(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetControllerMax_Responses(CurrentControllerMax=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetControllerMax_Responses(
    ...
    def SetAlarmEnabled(self, request, context: grpc.ServicerContext) \
        ...
        response = 0
        return_value =DOServicer_pb2.SetAlarmEnabled_Responses(AlarmEnabledSet=silaFW_pb2.Integer(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetAlarmEnabled_Responses(
    ...
    def GetAlarmEnabled(self, request, context: grpc.ServicerContext) \
        ...
        response = 0
        return_value =DOServicer_pb2.GetAlarmEnabled_Responses(CurrentAlarmEnabled=silaFW_pb2.Integer(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetAlarmEnabled_Responses(
    ...
    def SetAlarmAlarmHigh(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetAlarmAlarmHigh_Responses(AlarmAlarmHighSet=silaFW_pb2.Real(value=response))


        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetAlarmAlarmHigh_Responses(
    ...
    def GetAlarmAlarmHigh(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetAlarmAlarmHigh_Responses(CurrentAlarmAlarmHigh=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetAlarmAlarmHigh_Responses(
    ...
    def SetAlarmAlarmLow(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetAlarmAlarmLow_Responses(AlarmAlarmLowSet=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetAlarmAlarmLow_Responses(
    ...
    def GetAlarmAlarmLow(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetAlarmAlarmLow_Responses(CurrentAlarmAlarmLow=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetAlarmAlarmLow_Responses(
    ...
    def SetAlarmMode(self, request, context: grpc.ServicerContext) \
        ...
        response = 1
        return_value =DOServicer_pb2.SetAlarmMode_Responses(AlarmModeSet=silaFW_pb2.Integer(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetAlarmMode_Responses(
    ...
    def GetAlarmMode(self, request, context: grpc.ServicerContext) \
        ...
        response = 1
        return_value =DOServicer_pb2.GetAlarmMode_Responses(CurrentAlarmMode=silaFW_pb2.Integer(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetAlarmMode_Responses(
    ...
    def GetAlarmState(self, request, context: grpc.ServicerContext) \
        ...
        response = 0
        return_value =DOServicer_pb2.GetAlarmState_Responses(CurrentAlarmState=silaFW_pb2.Integer(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetAlarmState_Responses(
    ...
    def SetAlarmDelay(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetAlarmDelay_Responses(AlarmDelaySet=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetAlarmDelay_Responses(
    ...
    def GetAlarmDelay(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetAlarmDelay_Responses(CurrentAlarmDelay=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetAlarmDelay_Responses(
    ...
    def SetAlarmWarnHigh(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetAlarmWarnHigh_Responses(AlarmWarnHighSet=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetAlarmWarnHigh_Responses(
    ...
    def GetAlarmWarnHigh(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetAlarmWarnHigh_Responses(CurrentAlarmWarnHigh=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetAlarmWarnHigh_Responses(
    ...
    def SetAlarmWarnLow(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.SetAlarmWarnLow_Responses(AlarmWarnLowSet=silaFW_pb2.Real(value=response))
    
        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.SetAlarmWarnLow_Responses(
    ...
    def GetAlarmWarnLow(self, request, context: grpc.ServicerContext) \
        ...
        response = 0.0
        return_value =DOServicer_pb2.GetAlarmWarnLow_Responses(CurrentAlarmWarnLow=silaFW_pb2.Real(value=response))

        # fallback to default
        if return_value is None:
            return_value = DOServicer_pb2.GetAlarmWarnLow_Responses(
