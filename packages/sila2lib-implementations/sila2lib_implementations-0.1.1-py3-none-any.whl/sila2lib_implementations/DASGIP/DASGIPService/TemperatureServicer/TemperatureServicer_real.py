...
:file:    TemperatureServicer_real.py
:authors: Lukas Bromig

:date: (creation)          2020-04-16T10:19:15.293205
:date: (last modification) 2020-04-16T10:19:15.293205
...
class TemperatureServicerReal:
    """
    Implementation of the *Temperature Servicer* in *Real* mode
    ...
    def GetPV(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.setter.PV
    ...
    def SetSPM(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.setter.SPM = request.SPM.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.setter.SPM
    ...
    def SetSPE(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.setter.SPE = request.SPE.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.setter.SPE
    ...
    def GetSP(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.setter.SP
    ...
    def GetSPA(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.setter.SPA
    ...
    def GetSPR(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.setter.SPR
    ...
    def GetAccess(self, request, context: grpc.ServicerContext) \
        ...
        node = self.reactors[request.UnitID.value].unit.Temperature.status.Access
    ...
    def SetCmd(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.status.Cmd = request.Cmd.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.status.Cmd
    ...
    def SetMode(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.status.Mode = request.Mode.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.status.Mode
    ...
    def SetSetpointSelect(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.setter.SetpointSelect = request.SetpointSelect.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.setter.SetpointSelect 
    ...
    def GetState(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.status.State
    ...
    def GetType(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.sysinfo.Type
    ...
    def GetAvailable(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.sysinfo.Available
    ...
    def GetName(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.sysinfo.Name
    ...
    def GetVersion(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.sysinfo.Version
    ...
    def SetSensorOffset(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.sensor.Offset = request.SensorOffset.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.sensor.Offset
    ...
    def GetSensorPVRaw(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.sensor.PVRaw
    ...
    def SetSensorSlope(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.sensor.Slope = request.SensorSlope.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.sensor.Slope
    ...
    def SetSensorCompensation(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.sensor.Compensation = request.SensorCompensation.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.sensor.Compensation
    ...
    def SetControllerDB(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.controller.DB = request.ControllerDB.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.controller.DB
    ...
    def GetControllerOut(self, request, context: grpc.ServicerContext) \
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.controller.Out
    ...
    def SetControllerP(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.controller.P = request.ControllerP.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.controller.P
    ...
    def SetControllerTd(self, request, context: grpc.ServicerContext) \
        ...
        :param request: gRPC request containing the parameters passed:
            ...
            The controller differentiator time constant. PID controller: differentiator time constant (set to zero
            to disable).
        :param context: gRPC :class:`~grpc.ServicerContext` object providing gRPC-specific information
       ...
       # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.controller.Td = request.ControllerTd.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.controller.Td
    ...
    def SetControllerTi(self, request, context: grpc.ServicerContext) \
       ...
       # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.controller.Ti = request.ControllerTi.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.controller.Ti
    ...
    def SetControllerMin(self, request, context: grpc.ServicerContext) \
       ...
       # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.controller.Min = request.ControllerMin.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.controller.Min
    ...
    def SetControllerMax(self, request, context: grpc.ServicerContext) \
       ...
       # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.controller.Max = request.ControllerMax.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.controller.Max
    ...
    def SetAlarmEnabled(self, request, context: grpc.ServicerContext) \
       ...
       # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.alarm.Enabled = request.AlarmEnabled.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.alarm.Enabled
    ...
    def SetAlarmAlarmHigh(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.alarm.AlarmHigh = request.AlarmAlarmHigh.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.alarm.AlarmHigh
    ...
    def SetAlarmAlarmLow(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.alarm.AlarmLow = request.AlarmAlarmLow.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.alarm.AlarmLow
    ...
    def SetAlarmMode(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.alarm.Mode = request.AlarmMode.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.alarm.Mode
    ...
    def GetAlarmState(self, request, context: grpc.ServicerContext) \
        ...
        :returns: The return object defined for the command with the following fields:
            request.CurrentAlarmState (Current Alarm State): Current alarm state value of the temperature module.
            Alarm state.
        """
        ...
        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.alarm.State
    ...
    def SetAlarmDelay(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.alarm.Delay = request.AlarmDelay.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.alarm.Delay
    ...
    def SetAlarmWarnHigh(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.alarm.WarnHigh = request.AlarmWarnHigh.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.alarm.WarnHigh
    ...
    def SetAlarmWarnLow(self, request, context: grpc.ServicerContext) \
        ...
        # Set-command
        self.reactors[request.UnitID.value].unit.Temperature.alarm.WarnLow = request.AlarmWarnLow.value

        # Get command
        node = self.reactors[request.UnitID.value].unit.Temperature.alarm.WarnLow
