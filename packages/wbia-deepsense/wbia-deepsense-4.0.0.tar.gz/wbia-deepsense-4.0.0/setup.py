...
def parse_version(fpath='wbia_deepsense/__init__.py'):
    """
...
URL = 'https://github.com/WildbookOrg/wbia-plugin-deepsense'
...
KWARGS = OrderedDict(
    ...
    use_scm_version={
        'write_to': 'wbia_deepsense/_version.py',
        'write_to_template': '__version__ = "{version}"',
        'tag_regex': '^(?P<prefix>v)?(?P<version>[^\\+]+)(?P<suffix>.*)?$',
        'local_scheme': 'dirty-tag',
    },
    packages=find_packages(),
    package_dir={'wbia_deepsense': 'wbia_deepsense'},
