...
class ContractApi(object):
    ...
    def calculate_statistics_with_http_info(self, delivery_area, delivery_start, delivery_end, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('delivery_area' not in local_var_params or  # noqa: E501
                                                        local_var_params['delivery_area'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('delivery_start' not in local_var_params or  # noqa: E501
                                                        local_var_params['delivery_start'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('delivery_end' not in local_var_params or  # noqa: E501
                                                        local_var_params['delivery_end'] is None):  # noqa: E501
        ...
        if 'delivery_start' in local_var_params and local_var_params['delivery_start'] is not None:  # noqa: E501
            query_params.append(('delivery_start', local_var_params['delivery_start']))  # noqa: E501
        if 'delivery_end' in local_var_params and local_var_params['delivery_end'] is not None:  # noqa: E501
            query_params.append(('delivery_end', local_var_params['delivery_end']))  # noqa: E501
        if 'execution_from' in local_var_params and local_var_params['execution_from'] is not None:  # noqa: E501
            query_params.append(('execution_from', local_var_params['execution_from']))  # noqa: E501
        if 'execution_to' in local_var_params and local_var_params['execution_to'] is not None:  # noqa: E501
            query_params.append(('execution_to', local_var_params['execution_to']))  # noqa: E501
        if 'limit_to_last_mw' in local_var_params and local_var_params['limit_to_last_mw'] is not None:  # noqa: E501
    ...
    def get_contract_history(self, contract_id, delivery_area, **kwargs):  # noqa: E501
        ...
        :param delivery_area: The EIC code of the delivery area (required)
        :type delivery_area: str
        :param offset: the item offset of the request
        :type offset: int
        :param limit: the amount of items that should be retrieved
        :type limit: int
        :param portfolio_id:
    ...
    def get_contract_history_with_http_info(self, contract_id, delivery_area, **kwargs):  # noqa: E501
        ...
        if 'from_revision' in local_var_params and local_var_params['from_revision'] is not None:  # noqa: E501
            query_params.append(('from_revision', local_var_params['from_revision']))  # noqa: E501
        if 'to_revision' in local_var_params and local_var_params['to_revision'] is not None:  # noqa: E501
            query_params.append(('to_revision', local_var_params['to_revision']))  # noqa: E501
        if 'as_of' in local_var_params and local_var_params['as_of'] is not None:  # noqa: E501
            query_params.append(('as_of', local_var_params['as_of']))  # noqa: E501
        if 'with_owntrades' in local_var_params and local_var_params['with_owntrades'] is not None:  # noqa: E501
            query_params.append(('with_owntrades', local_var_params['with_owntrades']))  # noqa: E501
        if 'with_signals' in local_var_params and local_var_params['with_signals'] is not None:  # noqa: E501
            query_params.append(('with_signals', local_var_params['with_signals']))  # noqa: E501
        if 'with_orders' in local_var_params and local_var_params['with_orders'] is not None:  # noqa: E501
    ...
    def get_limits(self, contract_id, delivery_area, **kwargs):  # noqa: E501
        ...
        Calculates the current positions (portfolio-information) for a given contract. The response contains information about   - the currency of all parameters   - order-to-trade-ratios for the exchange, tenant and portfolio   - cash-positions   - net-posistions  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_order_books(self, **kwargs):  # noqa: E501
        ...
        :param with_order_details: If set to true, the returned orderbook will contain all current bids and asks of each contract (full orderbook depth). *Heads up* Only up to 100 calls are are allowed per hour and per delivery area when requesting the full orderbook for several contracts. This is not applicable if only one contract is requested.
    ...
    def get_order_books_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_order_books`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        if 'with_bid_or_ask_only' in local_var_params and local_var_params['with_bid_or_ask_only'] is not None:  # noqa: E501
        ...
        if 'contract_name' in local_var_params and local_var_params['contract_name'] is not None:  # noqa: E501
            query_params.append(('contractName', local_var_params['contract_name']))  # noqa: E501
        if 'delivery_start' in local_var_params and local_var_params['delivery_start'] is not None:  # noqa: E501
            query_params.append(('delivery_start', local_var_params['delivery_start']))  # noqa: E501
        if 'delivery_end' in local_var_params and local_var_params['delivery_end'] is not None:  # noqa: E501
            query_params.append(('delivery_end', local_var_params['delivery_end']))  # noqa: E501
        if 'delivery_within' in local_var_params and local_var_params['delivery_within'] is not None:  # noqa: E501
            query_params.append(('delivery_within', local_var_params['delivery_within']))  # noqa: E501
        if 'past_hours' in local_var_params and local_var_params['past_hours'] is not None:  # noqa: E501
            query_params.append(('past_hours', local_var_params['past_hours']))  # noqa: E501
        if 'delivery_area' in local_var_params and local_var_params['delivery_area'] is not None:  # noqa: E501
            query_params.append(('delivery_area', local_var_params['delivery_area']))  # noqa: E501
        if 'delivery_from' in local_var_params and local_var_params['delivery_from'] is not None:  # noqa: E501
            query_params.append(('delivery_from', local_var_params['delivery_from']))  # noqa: E501
        if 'delivery_to' in local_var_params and local_var_params['delivery_to'] is not None:  # noqa: E501
            query_params.append(('delivery_to', local_var_params['delivery_to']))  # noqa: E501
        if 'with_order_details' in local_var_params and local_var_params['with_order_details'] is not None:  # noqa: E501
        ...
        if 'with_portfolio_information' in local_var_params and local_var_params['with_portfolio_information'] is not None:  # noqa: E501
            query_params.append(('with_portfolio_information', local_var_params['with_portfolio_information']))  # noqa: E501
        if 'with_risk_settings' in local_var_params and local_var_params['with_risk_settings'] is not None:  # noqa: E501
            query_params.append(('with_risk_settings', local_var_params['with_risk_settings']))  # noqa: E501
        if 'with_products' in local_var_params and local_var_params['with_products'] is not None:  # noqa: E501
