...
class NewApiKey(object):
    ...
    def __init__(self, name=None, description=None, type=None, tenant_id=None, portfolio_ids=None, can_read=None, can_trade=None, can_signal=None, local_vars_configuration=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["STANDARD_API_KEY", "TENANT_MASTER_API_KEY", "SCHEDULING_API_KEY"]  # noqa: E501
    ...
    def portfolio_ids(self):
        ...
        The portfolios the API key belongs to  # noqa: E501
