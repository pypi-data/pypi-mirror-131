...
class DeliveryArea(object):
    ...
    def __init__(self, eic=None, market_eic=None, name=None, long_name=None, state=None, time_zone=None, currency=None, products=None, local_vars_configuration=None):  # noqa: E501
