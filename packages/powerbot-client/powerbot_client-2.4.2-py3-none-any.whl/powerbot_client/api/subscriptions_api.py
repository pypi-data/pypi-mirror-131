...
class SubscriptionsApi(object):
    ...
    def get_subscription_endpoints(self, **kwargs):  # noqa: E501
        ...
        Allows you to retrieve a list of all possible websockets endpoints you can subscribe to. Please note that you need to use a different technology to do this, this method only provides a list for information purposes. The response models can be found in the full openAPI specification. <p> A demonstration can be found [here](websockets-demo)  # noqa: E501
