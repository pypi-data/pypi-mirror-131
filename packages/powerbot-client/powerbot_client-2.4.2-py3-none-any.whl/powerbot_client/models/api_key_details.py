...
class ApiKeyDetails(object):
    ...
    def __init__(self, name=None, description=None, type=None, tenant_id=None, tenant_name=None, portfolios=None, tenant_risk_settings=None, can_read=None, can_trade=None, can_signal=None, local_vars_configuration=None):  # noqa: E501
