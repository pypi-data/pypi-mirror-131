...
class Worker:
    def __init__(self, worker_name: str, 
        ...
        self.metadata_repository = MetadataRepository(self.connection_string, worker_name + "Data", create_if_not_exist)
        self.message_queue_client = MessageQueueClient(worker_name.lower(), worker_name.lower() + "-poison", self.connection_string, create_if_not_exist)
