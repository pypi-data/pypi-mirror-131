...
class ManualLog:
    ...
    def __check_set_experiment(self):
        ...
        if existing_experiment is not None:
            set_experiment(self.experiment_name)
            _logger.info("Sucessfully set {} as current experiment".format(
                self.experiment_name))
    ...
    def start_trace(self, experiment_id: str = None):
        ...
        return ("Manual tracing initiated successfully under run {}".format(self.run_id))
    ...
    def end_trace(self):
        ...
        """
        end_trace()
        return ("Manual tracing ended successfully for run {}".format(self.run_id))
