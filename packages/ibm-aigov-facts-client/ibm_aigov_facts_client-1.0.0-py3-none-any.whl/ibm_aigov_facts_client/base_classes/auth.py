...
class FactsheetServiceClientAutolog:
    ...
    def add_payload(self, container_type: str, container_id: str, run_id: str, token: str, payload: Dict[str, Any], external:bool, **kwargs) -> DetailedResponse:
...
class FactsheetServiceClientManual:
    ...
    def add_payload(self, run_id: str, token: str, payload: Dict[str, Any],external:bool, **kwargs) -> DetailedResponse:
        headers = {}
        params={}
        self.run_id = run_id
