...
class TransactionController(BaseController):
    ...
    def _create_s3_client(self, aws_access_key_id, aws_secret_access_key, aws_session_token, role_arn):
        try:
            if role_arn is not None:
                ...
                self.logger.error("Error create s3 client - role arn or access and secret keys not provided")
                raise
        except Exception as e:
    ...
    def log_from_s3(
        self, file_path, aws_access_key_id=None, aws_secret_access_key=None, role_arn=None, aws_session_token=None
    ):
        """
        ...
        :param aws_session_token: Optional
        :return transaction_id: string - uuid of the log operation
        """
