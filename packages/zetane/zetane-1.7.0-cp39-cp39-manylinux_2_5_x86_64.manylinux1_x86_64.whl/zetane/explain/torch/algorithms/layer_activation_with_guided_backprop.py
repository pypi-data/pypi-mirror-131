class LayerActivationsWithGuidedBackprop:
    """
    Produces layer activations generated with guided backpropagation from the given image.
   ...
   Attributes:
    ...
    def generate_gradients(self, input_image, target_class, cnn_layer, filter_pos):
        """
        Generates layer activations through gradients for a given input image and target class through backpropagation.
