...
class LinkExtractedData(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["date",b"date","field",b"field","language",b"language","link_image",b"link_image","link_preview",b"link_preview","link_thumbnail",b"link_thumbnail","metadata",b"metadata","title",b"title"]) -> None: ...
