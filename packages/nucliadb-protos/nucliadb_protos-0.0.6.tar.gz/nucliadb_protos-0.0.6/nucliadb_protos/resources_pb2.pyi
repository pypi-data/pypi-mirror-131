...
class FileExtractedData(google.protobuf.message.Message):
    ...
    icon: typing.Text = ...
    @property
    def nested_position(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___NestedPosition]: ...
    def __init__(self,
        *,
        language : typing.Text = ...,
        md5 : typing.Text = ...,
        ...
        field : typing.Text = ...,
        icon : typing.Text = ...,
        nested_position : typing.Optional[typing.Iterable[global___NestedPosition]] = ...,
        ) -> None: ...
