...
"""
    ...
    The version of the OpenAPI document: 0.1.172
...
class UpdateWebhookNotification(object):
    ...
    required_map = {
        ...
        'authentication_configuration_item_paths': 'required',
    ...
    def authentication_configuration_item_paths(self, authentication_configuration_item_paths):
        ...
        :type authentication_configuration_item_paths: dict(str, str)
        """
        if self.local_vars_configuration.client_side_validation and authentication_configuration_item_paths is None:  # noqa: E501
            raise ValueError("Invalid value for `authentication_configuration_item_paths`, must not be `None`")  # noqa: E501
