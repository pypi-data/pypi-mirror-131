...
class ImageCrop:
    ...
    def crop(self, slot_config, img):
        ...
        # 寻找上下裁剪点
        top, bottom, left, right = self._get_top_bottom_crop_point(crop_parameter, img, x_center_method)
    ...
    def _get_top_bottom_crop_point(self, crop_parameter, img, x_center_method):
        #  寻找 裁剪点
