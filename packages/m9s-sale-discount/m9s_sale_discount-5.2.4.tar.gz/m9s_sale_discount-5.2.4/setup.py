...
name = 'm9s_sale_discount'
download_url = 'https://gitlab.com/m9s/sale_discount.git'
local_version = []
...
setup(name=name,
    version=version,
    description='Tryton Sale Discount Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/sale_discount.git',
        },
    keywords='',
    package_dir={'trytond.modules.sale_discount': '.'},
    packages=(
        ['trytond.modules.sale_discount'] +
        ['trytond.modules.sale_discount.%s' % p for p in find_packages()]
        ),
    package_data={
