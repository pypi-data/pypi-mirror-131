...
from quinteng.dagcircuit.dagnode import DAGNode, DAGOpNode, DAGInNode, DAGOutNode
...
class DAGCircuit:
    ...
    def _add_op_node(self, op, qargs, cargs):
        ...
        Args:
            op (quinteng.circuit.Instruction): the operation associated with the DAG node
    ...
    def num_qubits(self):
        ...
        consistency with Circuit.width() [quinteng-chaoyue #2564].
        """
    ...
    def topological_nodes(self, key=None):
        ...
        Args:
            key (Callable): A callable which will take a DAGNode object and
                ...
                :attr:`~quinteng.dagcircuit.DAGNode.sort_key` attribute will be
    ...
    def replace_block_with_op(self, node_block, op, wire_pos_map, cycle_check=True):
        ...
        Args:
            ...
            op (quinteng.circuit.Instruction): The instruction to replace the
                block with
    ...
    def substitute_node(self, node, op, inplace=False):
        ...
        Args:
            ...
            op (quinteng.circuit.Instruction): The :class:`quinteng.circuit.Instruction`
    ...
    def op_nodes(self, op=None, include_directives=True):
        ...
        Args:
            op (Type): :class:`quinteng.circuit.Instruction` subclass op nodes to
    ...
    def draw(self, scale=0.7, filename=None, style="color"):
        ...
        Returns:
            ...
            otherwise None.
        """
        from quinteng.visualization.dag_visualization import dag_drawer
