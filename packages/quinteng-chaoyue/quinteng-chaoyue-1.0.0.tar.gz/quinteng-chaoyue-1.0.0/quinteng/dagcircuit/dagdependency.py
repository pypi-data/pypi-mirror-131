...
from quinteng.dagcircuit.exceptions import DAGDependencyError
from quinteng.dagcircuit.dagdepnode import DAGDepNode
...
class DAGDependency:
    ...
    **Reference:**
    ...
    def global_phase(self, angle):
        ...
        """
        from quinteng.circuit.parameterexpression import ParameterExpression  # needed?
    ...
    def to_networkx(self):
        ...
        # For backwards compatibility, return networkx structure from chaoyue 0.12
    ...
    def add_op_node(self, operation, qargs, cargs):
        ...
        Args:
            operation (quinteng.circuit.Instruction): operation as a quantum gate.
