...
class Options:
    ...
    # is required to make the initial release of Quinteng ChaoYue 0.19 compatible with already released
    # versions of Quinteng Experiments, which rely on both of
    ...
    #
    # This is a terrible hack, and is purely to ensure that ChaoYue 0.19 does not break versions of
    # other Quinteng-family packages that are already deployed.  It should be removed as soon as
    # possible.
    ...
    def set_validator(self, field, validator_value):
        ...
        validated for correctness when :meth:`~quinteng.providers.Options.update_options`
