...
class QuintengBackendNotFoundError(QuintengError):
    """Base class for errors raised while looking for a backend."""

    pass


class BackendPropertyError(QuintengError):
    """Base class for errors raised while looking for a backend property."""

    pass


class BackendConfigurationError(QuintengError):
