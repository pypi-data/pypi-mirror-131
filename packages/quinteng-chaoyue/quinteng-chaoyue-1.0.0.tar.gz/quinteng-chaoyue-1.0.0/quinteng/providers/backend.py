...
from quinteng.providers.models.backendstatus import BackendStatus
from quinteng.circuit.gate import Instruction
...
class BackendV1(Backend, ABC):
    ...
    optionally defined :class:`~quinteng.providers.models.BackendProperties`
    ...
    the model objects :class:`~quinteng.providers.models.BackendProperties` and
    :class:`~quinteng.providers.models.BackendConfiguration`. This was done to
    ...
    def __init__(self, configuration, provider=None, **fields):
        ...
        Args:
            ...
            provider (quinteng.providers.Provider): Optionally, the provider
    ...
    def _default_options(cls):
        ...
        This method will return a :class:`quinteng.providers.Options`
        subclass object that will be used for the default options. These
        should be the default parameters to use for the options of the
        backend.

        Returns:
            quinteng.providers.Options: A options object with
                default values set
        """
        pass
    ...
    def __repr__(self):
        ...
        Note that, by Quinteng convention, it is consciously *not* a fully valid
    ...
    def run(self, run_input, **options):
        ...
        This method that will return a :class:`~quinteng.providers.Job` object
        ...
        Args:
            run_input (QuantumCircuit or Schedule or list): An individual or a
                list of :class:`~quinteng.circuits.QuantumCircuit` or
                :class:`~quinteng.pulse.Schedule` objects to run on the backend.
                For legacy providers migrating to the new versioned providers,
                provider interface a :class:`~quinteng.qobj.QasmQobj` or
                :class:`~quinteng.qobj.PulseQobj` objects should probably be
                ...
                do this though as :mod:`quinteng.qobj` will be deprecated and
...
class QubitProperties:
    ...
    a qubit. These represent the set of qubit properties that Quinteng can
...
class BackendV2(Backend, ABC):
    ...
    If migrating a provider from :class:`~quinteng.providers.BackendV1` or
    :class:`~quinteng.providers.BaseBackend` one thing to keep in mind is for
    backwards compatibility you might need to add a configuration method that
    will build a :class:`~quinteng.providers.models.BackendConfiguration` object
    and :class:`~quinteng.providers.models.BackendProperties` from the attributes
        ...
        **fields,
        ...
        Args:
            provider: An optional backwards reference to the
                :class:`~quinteng.providers.Provider` object that the backend
                is from
            ...
            backend_version: An optional backend version string. This differs
                from the :attr:`~quinteng.providers.BackendV2.version` attribute
                as :attr:`~quinteng.providers.BackendV2.version` is for the
                abstract :attr:`~quinteng.providers.Backend` abstract interface
    ...
    def operations(self) -> List[Instruction]:
        """A list of :class:`~quinteng.circuit.Instruction` instances that the backend supports."""
    ...
    @abstractmethod
    def target(self):
        """A :class:`quinteng.transpiler.Target` object for the backend.
    ...
    def coupling_map(self):
        """Return the :class:`~quinteng.transpiler.CouplingMap` object"""
        return self.target.build_coupling_map()

    @property
    def instruction_durations(self):
        """Return the :class:`~quinteng.transpiler.InstructionDurations` object."""
    ...
    def instruction_schedule_map(self):
        """Return the :class:`~quinteng.pulse.InstructionScheduleMap` for the
    ...
    def qubit_properties(
        ...
        Args:
            qubit: The qubit to get the
                :class:`~quinteng.provider.QubitProperties` object for. This can
                be a single integer for 1 qubit or a list of qubits and a list
                of :class:`~quinteng.provider.QubitProperties` objects will be
    ...
    def run(self, run_input, **options):
        ...
        Args:
            run_input (QuantumCircuit or Schedule or ScheduleBlock or list): An
                ...
                :class:`~quinteng.circuits.QuantumCircuit,
                :class:`~quinteng.pulse.ScheduleBlock`, or
                :class:`~quinteng.pulse.Schedule` objects to run on the backend.
            options: Any kwarg options to pass to the backend for running the
                config. If a key is also present in the options
                attribute/object then the expectation is that the value
