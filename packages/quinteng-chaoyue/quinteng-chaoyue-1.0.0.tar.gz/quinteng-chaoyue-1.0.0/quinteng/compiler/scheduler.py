...
control over pulse scheduling, look at `quinteng.scheduler.schedule_circuit`.
"""
import logging
...
from quinteng.scheduler.schedule_circuit import schedule_circuit
...
def schedule(
    ...
    methods. Supported methods are documented in :py:mod:`quinteng.scheduler.schedule_circuit`.
