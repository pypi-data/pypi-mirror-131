...
from quinteng.circuit.quantumregister import Qubit
from quinteng.converters import isinstanceint, isinstancelist, dag_to_circuit, circuit_to_dag
...
from quinteng.providers.models.backendproperties import Gate
from quinteng.pulse import Schedule, InstructionScheduleMap
from quinteng.tools.parallel import parallel_map
from quinteng.transpiler import Layout, CouplingMap, PropertySet, PassManager
from quinteng.transpiler.basepasses import BasePass
from quinteng.transpiler.exceptions import TranspilerError
from quinteng.transpiler.instruction_durations import InstructionDurations, InstructionDurationsType
from quinteng.transpiler.passes import ApplyLayout
from quinteng.transpiler.passmanager_config import PassManagerConfig
from quinteng.transpiler.preset_passmanagers import (
...
from quinteng.transpiler.target import Target
...
def transpile(
    ...
    Args:
        ...
        pass_manager: The pass manager to use for a custom pipeline of transpiler passes.
            ...
            pass manager will be used directly (Quinteng will not attempt to
        ...
        unitary_synthesis_method (str): The name of the unitary synthesis
            ...
            method included with quinteng. If you have installed any unitary
        ...
        target: A backend transpiler target. Normally this is specified as part of
            ...
            :class:`~quinteng.transpiler.Target` object you can specify it manually here.
