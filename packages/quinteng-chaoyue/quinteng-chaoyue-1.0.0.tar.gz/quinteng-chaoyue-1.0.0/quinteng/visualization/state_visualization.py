...
from quinteng.visualization.array import array_to_latex
...
from quinteng.visualization.utils import (
    _bloch_multivector_data,
    _paulivec_data,
    matplotlib_close_if_inline,
)
from quinteng.circuit.tools.pi_check import pi_check
...
def plot_state_hinton(
    ...
    Example:
        .. jupyter-execute::
            ...
            from quinteng.visualization import plot_state_hinton
            %matplotlib inline
...
def plot_bloch_vector(bloch, title="", ax=None, figsize=None, coord_type="cartesian"):
    ...
    Example:
        .. jupyter-execute::
           ...
           from quinteng.visualization import plot_bloch_vector
           %matplotlib inline
    ...
    from quinteng.visualization.bloch import Bloch
...
def plot_bloch_multivector(
    ...
    Args:
        ...
        reverse_bits (bool): If True, plots qubits following Quinteng's convention [Default:False].
    ...
    Example:
        .. jupyter-execute::
            ...
            from quinteng.visualization import plot_bloch_multivector
            %matplotlib inline
    ...
    *,
    ...
    Example:
        .. jupyter-execute::
           ...
           from quinteng import QuantumCircuit
           from quinteng.quantum_info import DensityMatrix
           from quinteng.visualization import plot_state_city
           %matplotlib inline
...
def plot_state_paulivec(
    ...
    Example:
        .. jupyter-execute::
           ...
           from quinteng import QuantumCircuit
           from quinteng.quantum_info import Statevector
           from quinteng.visualization import plot_state_paulivec
           %matplotlib inline
...
def plot_state_qsphere(
    ...
    *,
    ...
    Raises:
        ...
        QuintengError: Input statevector does not have valid dimensions.
    ...
    Example:
        .. jupyter-execute::
           ...
           from quinteng import QuantumCircuit
           from quinteng.quantum_info import Statevector
           from quinteng.visualization import plot_state_qsphere
           %matplotlib inline
    ...
    from quinteng.visualization.bloch import Arrow3D
    ...
    for idx in range(eigvals.shape[0] - 1, -1, -1):
        if eigvals[idx] > 0.001:
            ...
            for i in range(2 ** num):
                ...
                prob = min(prob, 1)  # See https://github.com/Quinteng/quinteng-chaoyue/issues/4666
...
def state_to_latex(
    ...
    for `quinteng.visualization.array_to_latex` for convention 'vector'.
