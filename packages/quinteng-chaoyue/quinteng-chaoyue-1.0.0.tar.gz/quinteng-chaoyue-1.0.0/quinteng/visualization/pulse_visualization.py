...
from quinteng.visualization.pulse import matplotlib as _matplotlib
from quinteng.visualization.matplotlib import HAS_MATPLOTLIB
from quinteng.visualization.utils import matplotlib_close_if_inline
...
def pulse_drawer(
    ...
    Args:
        ...
        style: A style sheet to configure plot appearance.
            See :mod:`~quinteng.visualization.pulse.qcstyle` for more information.
        ...
        interp_method: Interpolation function. Interpolation is disabled in default.
            See :mod:`~quinteng.visualization.pulse.interpolation` for more information.
    ...
    Example:
        ...
        .. jupyter-execute::
            ...
            from quinteng.test.mock.backends.almaden import FakeAlmaden
            ...
            quinteng.visualization.pulse_drawer(sched,
                                              channels=channels,
                                              plot_range=(0, 1000),
                                              label=True,
        ...
        .. jupyter-execute::
            ...
            # setup style sheet
            my_style = quinteng.visualization.SchedStyle(
                figsize = (10, 5),
                bg_color='w',
            ...
            quinteng.visualization.pulse_drawer(sched, style=my_style,
                                              channels=channels,
                                              plot_range=(0, 1000),
                                              label=True,
                                              channel_scales=scales)
    ...
    warnings.warn(
        ...
        "3 months after the release date. Use `quinteng.visualization.pulse_drawer_v2` "
