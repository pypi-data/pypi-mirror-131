...
Thus the core :py:class:`quinteng.visualization.pulse_v2.core.DrawerCanvas` generates
...
See py:mod:`quinteng.visualization.pulse_v2.types` for detail on the data type.
