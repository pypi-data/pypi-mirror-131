...
See py:mod:`quinteng.visualization.pulse_v2.types` for more info on the required
data.
...
from quinteng.visualization.pulse_v2.device_info import DrawerBackendInfo
