...
information :py:class:`~quinteng.visualization.pulse_v2.device_info.DrawerBackendInfo`.
...
from quinteng.visualization.pulse_v2 import events, types, drawings, device_info
from quinteng.visualization.pulse_v2.stylesheet import QuintengPulseStyle
...
class DrawerCanvas:
    ...
    def __init__(self, stylesheet: QuintengPulseStyle, device: device_info.DrawerBackendInfo):
