...
from quinteng.pulse import Waveform, ParametricPulse, Schedule, ScheduleBlock
from quinteng.pulse.channels import Channel
from quinteng.visualization.exceptions import VisualizationError
from quinteng.visualization.pulse_v2 import core, device_info, stylesheet, types
...
def draw(
    ...
    Args:
        program: Program to visualize. This program can be arbitrary Quinteng Pulse program,
            such as :py:class:`~quinteng.pulse.Waveform`, :py:class:`~quinteng.pulse.ParametricPulse`,
            and :py:class:`~quinteng.pulse.Schedule`.
    ...
    **Style Dict Details**
    ...
    Args:
        ...
        generator.waveform: List of callback functions that generates drawing
            ...
            See :py:mod:`~quinteng.visualization.pulse_v2.generators.waveform` for more details.
        ...
        generator.frame: List of callback functions that generates drawing
            ...
            can be set here. There are some default generators in the pulse drawer.
            See :py:mod:`~quinteng.visualization.pulse_v2.generators.frame` for more details.
            No default generator is set.
        generator.chart: List of callback functions that generates drawing
            ...
            can be set here. There are some default generators in the pulse drawer.
            See :py:mod:`~quinteng.visualization.pulse_v2.generators.chart` for more details.
            No default generator is set.
        generator.snapshot: List of callback functions that generates drawing
            ...
            can be set here. There are some default generators in the pulse drawer.
            See :py:mod:`~quinteng.visualization.pulse_v2.generators.snapshot` for more details.
            No default generator is set.
        generator.barrier: List of callback functions that generates drawing
            ...
            can be set here. There are some default generators in the pulse drawer.
            See :py:mod:`~quinteng.visualization.pulse_v2.generators.barrier` for more details.
            No default generator is set.
        layout.chart_channel_map: Callback function that determines the relationship
            between pulse channels and charts.
            See :py:mod:`~quinteng.visualization.pulse_v2.layout` for more details.
    ...
    Examples:
        ...
        .. jupyter-execute::
            ...
            from quinteng import QuantumCircuit, transpile, schedule
            from quinteng.visualization.pulse_v2 import draw
        ...
        .. jupyter-execute::
            ...
            from quinteng import QuantumCircuit, transpile, schedule
            from quinteng.visualization.pulse_v2 import draw, IQXSimple
            from quinteng.test.mock import FakeAlmaden
        ...
        .. jupyter-execute::
            ...
            from quinteng import QuantumCircuit, transpile, schedule
            from quinteng.visualization.pulse_v2 import draw, IQXDebugging
            from quinteng.test.mock import FakeAlmaden
    ...
    """
    temp_style = stylesheet.QuintengPulseStyle()
    ...
    if plotter == types.Plotter.Mpl2D.value:
        try:
            from quinteng.visualization.pulse_v2.plotters import Mpl2DPlotter
