...
from quinteng.visualization.timeline import drawings, events, types
from quinteng.visualization.timeline.stylesheet import QuintengTimelineStyle


class DrawerCanvas:
    """Data container for drawings."""

    def __init__(self, stylesheet: QuintengTimelineStyle):
