...
from quinteng.visualization.timeline import types, core, stylesheet
...
def draw(
    ...
    Args:
        ...
        style: Stylesheet options. This can be dictionary or preset stylesheet classes. See
            :py:class:`~quinteng.visualization.timeline.stylesheets.IQXStandard`,
            :py:class:`~quinteng.visualization.timeline.stylesheets.IQXSimple`, and
            :py:class:`~quinteng.visualization.timeline.stylesheets.IQXDebugging` for details of
    ...
    **Style Dict Details**
    ...
    Args:
        ...
        generator.gates: List of callback functions that generates drawings
            ...
            :py:mod:`~quinteng.visualization.timeline.generators` for more details.
        ...
        layout.bit_arrange: Callback function that sorts bits. See
            :py:mod:`~quinteng.visualization.timeline.layouts` for more details.
            No default layout is set. (default `None`).
        layout.time_axis_map: Callback function that determines the layout of
            horizontal axis labels. See :py:mod:`~quinteng.visualization.timeline.layouts`
    ...
    Examples:
        ...
        .. jupyter-execute::
            ...
            from quinteng.visualization.timeline import draw
        ...
        .. jupyter-execute::
            ...
            from quinteng import QuantumCircuit, transpile, schedule
            from quinteng.visualization.timeline import draw, IQXSimple
            from quinteng.test.mock import FakeAlmaden
        ...
        .. jupyter-execute::
            ...
            from quinteng import QuantumCircuit, transpile, schedule
            from quinteng.visualization.timeline import draw, IQXDebugging
            from quinteng.test.mock import FakeAlmaden
    ...
    """
    # update stylesheet
    temp_style = stylesheet.QuintengTimelineStyle()
    ...
    if plotter == types.Plotter.MPL.value:
        try:
            from quinteng.visualization.timeline.plotters import MplPlotter
