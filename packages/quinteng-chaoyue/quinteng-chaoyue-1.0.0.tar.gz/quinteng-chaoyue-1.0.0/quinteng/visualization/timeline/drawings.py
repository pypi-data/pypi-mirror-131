...
Thus the core :py:class:`~quinteng.visualization.timeline.core.DrawerCanvas` generates
...
See py:mod:`quinteng.visualization.timeline.types` for detail on the data type.
