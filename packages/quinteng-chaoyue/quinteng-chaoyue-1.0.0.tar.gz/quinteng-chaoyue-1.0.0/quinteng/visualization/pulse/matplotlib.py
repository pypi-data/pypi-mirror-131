...
from quinteng.visualization.pulse.interpolation import step_wise
...
from quinteng.pulse.schedule import ScheduleComponent
    ...
    def draw(
        ...
        Args:
            ...
            interp_method: Interpolation function. See example.
                ...
                See `quinteng.visualization.pulse.interpolation` for more information.
