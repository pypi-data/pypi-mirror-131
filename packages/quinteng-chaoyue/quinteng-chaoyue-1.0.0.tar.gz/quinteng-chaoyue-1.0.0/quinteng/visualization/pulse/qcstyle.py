...
class SchedStyle:
    """Style sheet for Quinteng-Pulse schedule drawer."""
    ...
    def __init__(
        ...
        warnings.warn(
            ...
            "Please use new drawer `quinteng.visualization.pulse_drawer_v2` "
            "with new stylesheet classes provided by `quinteng.visualization.pulse_v2`. "
...
class PulseStyle:
    ...
    Style sheet for Quinteng-Pulse sample pulse drawer."""
