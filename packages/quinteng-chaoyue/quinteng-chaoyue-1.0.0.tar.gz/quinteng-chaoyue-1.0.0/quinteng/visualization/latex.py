...
from quinteng.circuit.library.standard_gates import SwapGate, XGate, ZGate, RZZGate, U1Gate, PhaseGate
from quinteng.circuit.measure import Measure
from quinteng.visualization.qcstyle import load_style
...
class QCircuitImage:
    ...
    Thanks to Eric Sabo for the initial implementation for Quinteng.
    """
