...
"""
======================================================
Executing Experiments (:mod:`quinteng.execute_function`)
======================================================

.. currentmodule:: quinteng.execute_function
...
def execute(
    ...
    **run_config,
    ...
    """Execute a list of :class:`quinteng.circuit.QuantumCircuit` or
    :class:`quinteng.pulse.Schedule` on a backend.
    ...
    Args:
        ...
        initial_layout (Layout or dict or list):
            ...
            #. :class:`quinteng.transpiler.Layout` instance
            #. ``dict``:
               virtual to physical::
        ...
        qobj_header (QobjHeader or dict): User input that will be inserted in Qobj header,
            and will also be copied to the corresponding :class:`quinteng.result.Result`
        ...
        schedule_circuit (bool): If ``True``, ``experiments`` will be converted to
            :class:`quinteng.pulse.Schedule` objects prior to execution.
    ...
    Raises:
        QuintengError: if the execution cannot be interpreted as either circuits or schedules
    ...
    Example:
        ...
        .. jupyter-execute::
            ...
            from quinteng import QuantumCircuit, execute, BasicAer
    ...
    if isinstance(experiments, (Schedule, ScheduleBlock)) or (
        ...
        if schedule_circuit:
            raise QuintengError("Must supply QuantumCircuit to schedule circuit.")
    ...
    if isinstance(backend, BaseBackend):
        ...
        raise QuintengError("Invalid backend type %s" % type(backend))
    return job
