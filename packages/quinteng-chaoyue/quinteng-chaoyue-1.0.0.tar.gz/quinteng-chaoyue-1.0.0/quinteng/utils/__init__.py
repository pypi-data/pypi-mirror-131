...
"""
===============================
Utilities (:mod:`quinteng.utils`)
===============================

.. currentmodule:: quinteng.utils
...
A QuantumInstance holds the Quinteng `backend` as well as a number of compile and
runtime parameters controlling circuit compilation and execution. Quantum
:mod:`algorithms <quinteng.algorithms>`
