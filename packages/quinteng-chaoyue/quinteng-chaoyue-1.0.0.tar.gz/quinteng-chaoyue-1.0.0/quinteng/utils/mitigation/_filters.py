...
class MeasurementFilter:
    ...
    def apply(self, raw_data, method="least_squares"):
        ...
        Raises:
            QuintengError: if `raw_data` is not an integer multiple
        ...
        if isinstance(raw_data, dict):
        ...
        elif isinstance(raw_data, quinteng.result.result.Result):
            ...
            raise QuintengError("Unrecognized type for raw_data.")
        ...
        for data_idx, _ in enumerate(raw_data2):
            ...
            if method == "pseudo_inverse":
                ...
                raise QuintengError("Unrecognized method.")
...
class TensoredFilter:
    ...
    def __init__(self, cal_matrices: np.matrix, substate_labels_list: list, mit_pattern: list):
        ...
        (https://quinteng.org/documentation/tutorials/noise/3_measurement_error_mitigation.html).
    ...
    def apply(
        ...
        Raises:
            QuintengError: if raw_data is not in a one of the defined forms.
        """
