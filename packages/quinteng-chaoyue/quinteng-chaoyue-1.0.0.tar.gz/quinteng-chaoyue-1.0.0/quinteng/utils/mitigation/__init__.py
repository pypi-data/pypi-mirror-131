...
# https://github.com/Quinteng/quinteng-ignis/blob/b91066c72171bcd55a70e6e8993b813ec763cf41/quinteng/ignis/mitigation/measurement/__init__.py
# it was migrated as quinteng-ignis is being deprecated

"""
=============================================================
Measurement Mitigation Utils (:mod:`quinteng.utils.mitigation`)
=============================================================

.. currentmodule:: quinteng.utils.mitigation

.. warning::

    The user-facing API stability of this module is not guaranteed except for
    its use with the :class:`~quinteng.utils.QuantumInstance` (i.e. using the
    :class:`~quinteng.utils.mitigation.CompleteMeasFitter` or
    :class:`~quinteng.utils.mitigation.TensoredMeasFitter` classes as values for the
...
with the :class:`~quinteng.utils.QuantumInstance` class as part of
:mod:`quinteng.algorithms` and :mod:`quinteng.opflow`.
