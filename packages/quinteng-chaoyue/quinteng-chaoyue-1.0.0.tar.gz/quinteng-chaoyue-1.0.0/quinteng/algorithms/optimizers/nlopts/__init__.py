...
If you running on Windows, then you might want to refer to the specific
`instructions for NLopt on Windows
<https://nlopt.readthedocs.io/en/latest/NLopt_on_Windows/>`__.

If you are running on a Unix-like system, first ensure that your environment is set
to the Python executable for which the Quinteng package is installed and running.
...
To have these be used by Quinteng, the following commands can be entered to augment the dynamic
...
home directory for automatic execution.  Now you can run Quinteng and these optimizers should be
