...
from quinteng.circuit.library import PhaseEstimation
from quinteng.circuit.library.arithmetic.piecewise_chebyshev import PiecewiseChebyshev
...
from quinteng.providers import Backend, BaseBackend
...
class HHL(LinearSolver):
    ...
    Examples:
        ...
        .. jupyter-execute::
            ...
            from quinteng.algorithms.linear_solvers.matrices import TridiagonalToeplitz
            from quinteng.algorithms.linear_solvers.observables import MatrixFunctional
    ...
    def construct_circuit(
        ...
        """
        # State preparation circuit - default is quinteng
