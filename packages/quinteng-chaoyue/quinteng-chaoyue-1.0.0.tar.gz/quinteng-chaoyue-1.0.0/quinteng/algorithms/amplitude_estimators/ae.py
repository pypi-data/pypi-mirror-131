...
from quinteng import QuantumCircuit, ClassicalRegister
    ...
    def __init__(
        ...
        Args:
            ...
            phase_estimation_circuit: The phase estimation circuit used to run the algorithm.
                ...
                `quinteng.circuit.library.PhaseEstimation` when None.
            iqft: The inverse quantum Fourier transform component, defaults to using a standard
                implementation from `quinteng.circuit.library.QFT` when None.
