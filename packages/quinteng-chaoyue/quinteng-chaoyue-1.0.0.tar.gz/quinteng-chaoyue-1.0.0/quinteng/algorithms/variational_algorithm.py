...
.. note::
    ...
    (``quinteng.utils.algorithm_globals.random_seed = seed``).
"""
...
from quinteng.utils import QuantumInstance, algorithm_globals, deprecate_function
    ...
    def __init__(
        ...
        if any(
            ...
            warnings.warn(
                ...
                "Quinteng ChaoYue 0.18.0 and will be unsupported no sooner than 3 months "
...
quantum_instance property is deprecated as of Quinteng ChaoYue 0.18.0
...
and will be removed no sooner than 3 months after the releasedate."""
    ...
    @deprecate_function(
        """
The VariationalAlgorithm is reduced to an interface. Thus, the
ansatz property is deprecated as of Quinteng ChaoYue 0.18.0
and will be removed no sooner than 3 months after the releasedate."""
    )
...
and will be removed no sooner than 3 months after the releasedate."""
    ...
    @deprecate_function(
        """
The VariationalAlgorithm is reduced to an interface. Thus, the
optimizer property is deprecated as of Quinteng ChaoYue 0.18.0
and will be removed no sooner than 3 months after the releasedate."""
    )
...
3 months after the release date of Quinteng ChaoYue 0.18.0. You should
...
the implementation here which will be removed."""
    ...
    @deprecate_function(
        """
The VariationalAlgorithm is reduced to an interface. Thus, the
find_minimum method is deprecated as of Quinteng ChaoYue 0.18.0
and will be removed no sooner than 3 months after the releasedate."""
    )
    def find_minimum(
        self,
    ...
    @deprecate_function(
        """
The VariationalAlgorithm is reduced to an interface. Thus, the
get_prob_vector_for_params method is deprecated as of Quinteng ChaoYue 0.18.0
and will be removed no sooner than 3 months after the releasedate."""
    )
    ...
    @deprecate_function(
        """
The VariationalAlgorithm is reduced to an interface. Thus, the
get_probabilities_for_counts method is deprecated as of Quinteng ChaoYue 0.18.0
and will be removed no sooner than 3 months after the releasedate."""
    )
    ...
    @deprecate_function(
        """
The VariationalAlgorithm is reduced to an interface. Thus, the
cleanup_paramterized_circuits method is deprecated as of Quinteng ChaoYue 0.18.0
and will be removed no sooner than 3 months after the releasedate."""
    )
