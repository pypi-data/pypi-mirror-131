...
from quinteng import ClassicalRegister, QuantumCircuit
from quinteng.providers import Backend, BaseBackend
from quinteng.quantum_info import partial_trace
...
class Grover(AmplitudeAmplifier):
    ...
    This class supports oracles in form of a :class:`~quinteng.circuit.QuantumCircuit`.
    ...
    For more information, see the :class:`~quinteng.circuit.library.GroverOperator` in the
    circuit library.
