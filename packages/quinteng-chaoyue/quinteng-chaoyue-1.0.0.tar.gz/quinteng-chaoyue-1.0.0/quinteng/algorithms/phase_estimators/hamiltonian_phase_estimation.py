...
class HamiltonianPhaseEstimation:
    ...
    This class is nearly the same as :class:`~quinteng.algorithms.PhaseEstimation`, differing only
    ...
    This class uses and works together with :class:`~quinteng.algorithms.PhaseEstimationScale` to
