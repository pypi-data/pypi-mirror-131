...
class PhaseEstimation(PhaseEstimator):
    ...
    first. `estimate`, which takes a state preparation circuit to prepare an input state, and
      ...
      :class:`quinteng.circuit.PhaseEstimation`, a QPE circuit, containing
    ...
    :class:`~quinteng.algorithms.phase_estimator_result.PhaseEstimationResult`.
    ...
    **Reference:**
    ...
    def _compute_phases(
    ...
    ) -> Union[numpy.ndarray, quinteng.result.Counts]:
        ...
        if self._quantum_instance.is_statevector:
            ...
            evaluation_density_matrix = quinteng.quantum_info.partial_trace(
                state_vec,
                range(
    ...
    def estimate_from_pe_circuit(
        ...
        Returns:
            An instance of quinteng.algorithms.phase_estimator_result.PhaseEstimationResult.
        """
