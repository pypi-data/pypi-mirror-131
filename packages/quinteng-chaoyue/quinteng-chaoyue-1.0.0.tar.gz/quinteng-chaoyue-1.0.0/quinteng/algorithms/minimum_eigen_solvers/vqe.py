...
from quinteng.circuit.library import RealAmplitudes
...
from quinteng.utils.validation import validate_min
from quinteng.utils.backend_utils import is_aer_provider
from quinteng.utils.deprecation import deprecate_function
from quinteng.utils import QuantumInstance, algorithm_globals
...
class VQE(VariationalAlgorithm, MinimumEigensolver):
    ...
    :mod:`~quinteng.algorithms.optimizers`. The ansatz is varied, via its set of parameters, by the
    ...
    `initial point tutorial <https://github.com/Quinteng/quinteng-tutorials-community/blob/master
    ...
    def __init__(
        ...
        Args:
            ...
            expectation: The Expectation converter for taking the average value of the
                ...
                :class:`~quinteng.opflow.expectations.ExpectationFactory` is used to select
    ...
    def compute_minimum_eigenvalue(
        ...
        try:
            ...
            warnings.warn(
                ...
                "deprecated as of Quinteng ChaoYue 0.19.0 and will be unsupported no "
                "sooner than 3 months after the release date. Instead use an optimizer "
                "providing ``minimize`` (see quinteng.algorithms.optimizers.Optimizer).",
                DeprecationWarning,
                stacklevel=2,
            )
    ...
    @deprecate_function(
        """
The VQE.get_optimal_cost method is deprecated as of Quinteng ChaoYue 0.18.0
...
queried as VQEResult.eigenvalue."""
    ...
    @deprecate_function(
        """
The VQE.get_optimal_circuit method is deprecated as of Quinteng ChaoYue
...
queried as VQEResult.ansatz.bind_parameters(VQEResult.optimal_point)."""
    ...
    @deprecate_function(
        """
The VQE.get_optimal_vector method is deprecated as of Quinteng ChaoYue 0.18.0
and will be removed no sooner than 3 months after the releasedate.
This information is part of the returned result object and can be
queried as VQEResult.eigenvector."""
    ...
    @deprecate_function(
        """
The VQE.optimal_params property is deprecated as of Quinteng ChaoYue 0.18.0
and will be removed no sooner than 3 months after the releasedate.
This information is part of the returned result object and can be
