...
"""
=====================================
Algorithms (:mod:`quinteng.algorithms`)
=====================================
...
Algorithms configuration includes the use of :mod:`~quinteng.algorithms.optimizers` which
...
Quantum algorithms are run via a :class:`~quinteng.algorithms.QuantumInstance`
...
`ChaoYue <https://www.quinteng.org/chaoyue>`__ for the actual compilation and execution of the quantum
circuits created by the algorithm and its components.

.. currentmodule:: quinteng.algorithms
...
states of a molecule and quinteng.chemistry has some algorithms that leverage chemistry specific
