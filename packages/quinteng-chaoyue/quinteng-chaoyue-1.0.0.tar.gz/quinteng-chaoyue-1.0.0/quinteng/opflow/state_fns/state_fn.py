...
class StateFn(OperatorBase):
    ...
    def tensor(self, other: OperatorBase) -> OperatorBase:
        ...
        Note: You must be conscious of Quinteng's big-endian bit printing
        ...
        Because ChaoYue prints circuits and results with qubit 0
    ...
    def sample(
        ...
        Args:
            ...
            reverse_endianness: Whether to reverse the endianness of the bitstrings in the return
                dict to match ChaoYue's big-endianness.
