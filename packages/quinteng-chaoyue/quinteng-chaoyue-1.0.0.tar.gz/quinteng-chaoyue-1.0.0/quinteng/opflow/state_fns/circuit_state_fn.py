...
from quinteng.extensions import Initialize
...
from quinteng.opflow.primitive_ops.circuit_op import CircuitOp
from quinteng.opflow.primitive_ops.matrix_op import MatrixOp
from quinteng.opflow.primitive_ops.pauli_op import PauliOp
from quinteng.opflow.state_fns.state_fn import StateFn
from quinteng.opflow.state_fns.vector_state_fn import VectorStateFn
...
class CircuitStateFn(StateFn):
    ...
    QuantumCircuit starting from \|0⟩, and stored using ChaoYue's ``QuantumCircuit`` class.
    """
    ...
    def from_dict(density_dict: dict) -> "CircuitStateFn":
        ...
        # building a statevector to pass to Quinteng's
    ...
    def tensor(self, other: OperatorBase) -> Union["CircuitStateFn", TensoredOp]:
        ...
        Note: You must be conscious of Quinteng's big-endian bit printing convention.
        ...
        Because ChaoYue prints circuits and results with qubit 0 at the end of the string or circuit.
    ...
    def assign_parameters(self, param_dict: dict) -> Union["CircuitStateFn", ListOp]:
        ...
        if isinstance(self.coeff, ParameterExpression) or self.primitive.parameters:
            ...
            # This is different from bind_parameters in ChaoYue because they check for set equality
    ...
    def _expand_dim(self, num_qubits: int) -> "CircuitStateFn":
        ...
        # just like in tensor method, quinteng endianness is reversed here
