...
from quinteng.opflow.operator_globals import H, I, S
...
from quinteng.opflow.primitive_ops.primitive_op import PrimitiveOp
...
class PauliBasisChange(ConverterBase):
    ...
    def get_diagonalizing_clifford(self, pauli: Union[Pauli, PauliOp]) -> OperatorBase:
        ...
        Note, underlying Pauli bits are in Quinteng endianness, so we need to reverse before we
    ...
    def pad_paulis_to_equal_length(
        ...
        applied to the end of the Paulis. Note that the ChaoYue represents Paulis in big-endian
    ...
    def construct_cnot_chain(self, diag_pauli_op1: PauliOp, diag_pauli_op2: PauliOp) -> PrimitiveOp:
        ...
        # Need to do this or a ChaoYue bug sometimes flips cnots. No time to investigate.
        cnots.i(0)
