...
from quinteng.utils.backend_utils import is_aer_provider, is_statevector_backend
...
class CircuitSampler(ConverterBase):
    ...
    def __init__(
        ...
        # Set to False until https://github.com/Quinteng/quinteng-aer/issues/1249 is closed.
        param_qobj = False
    ...
    def sample_circuits(
        ...
        supported, and only binding dicts which are valid to be passed into ChaoYue can be included
        in this list.
