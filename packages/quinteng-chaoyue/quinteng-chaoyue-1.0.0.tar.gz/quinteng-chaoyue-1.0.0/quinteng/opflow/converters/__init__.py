...
"""
Converters (:mod:`quinteng.opflow.converters`)
============================================

.. currentmodule:: quinteng.opflow.converters
...
a converter may accept :class:`~quinteng.opflow.primitive_ops.CircuitOp` and return a
:class:`~quinteng.opflow.list_ops.SummedOp` of
:class:`~quinteng.opflow.primitive_ops.PauliOp`'s representing the
...
:class:`~quinteng.opflow.expectations.MatrixExpectation` or
:class:`~quinteng.opflow.evolutions.MatrixEvolution`,
which convert :class:`~quinteng.opflow.primitive_ops.PauliOp`'s to
:class:`~quinteng.opflow.primitive_ops.MatrixOp`'s internally, will require time or space
exponential in the number of qubits unless a clever trick is known
(such as the use of sparse matrices).

Note:
     Not all converters are in this module, as :mod:`~quinteng.opflow.expectations`
     and :mod:`~quinteng.opflow.evolutions` are also converters.
