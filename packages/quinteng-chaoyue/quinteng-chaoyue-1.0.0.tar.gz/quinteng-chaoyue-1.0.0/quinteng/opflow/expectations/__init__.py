...
"""
Expectations (:mod:`quinteng.opflow.expectations`)
================================================

.. currentmodule:: quinteng.opflow.expectations
...
:class:`~quinteng.opflow.state_fns.OperatorStateFn` measurements with equivalent
...
a :class:`~quinteng.opflow.converters.CircuitSampler`. All in all, this would be:
...
such as :class:`~quinteng.algorithms.VQE`, the algorithm can give the opportunity for the user
