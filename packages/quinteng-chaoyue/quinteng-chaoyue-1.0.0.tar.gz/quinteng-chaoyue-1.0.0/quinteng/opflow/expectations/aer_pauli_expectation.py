...
from quinteng.quantum_info import SparsePauliOp
...
class AerPauliExpectation(ExpectationBase):
    ...
    def _replace_pauli_sums(cls, operator):
        try:
            from quinteng.providers.aer.library import SaveExpectationValue
        except ImportError as ex:
            raise MissingOptionalLibraryError(
                libname="quinteng-aer",
                name="AerPauliExpectation",
                pip_install="pip install quinteng-aer",
            ) from ex
