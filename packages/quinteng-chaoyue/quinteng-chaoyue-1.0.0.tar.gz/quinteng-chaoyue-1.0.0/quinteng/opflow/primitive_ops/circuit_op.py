...
class CircuitOp(PrimitiveOp):
    """Class for Operators backed by ChaoYue's ``QuantumCircuit`` module."""
    ...
    def tensor(self, other: OperatorBase) -> Union["CircuitOp", TensoredOp]:
        ...
        if isinstance(other, CircuitOp):
            ...
            # NOTE!!! REVERSING QUINTENG ENDIANNESS HERE
            new_qc.append(
    ...
    def to_matrix(self, massive: bool = False) -> np.ndarray:
        ...
        unitary = quinteng.quantum_info.Operator(self.to_circuit()).data
