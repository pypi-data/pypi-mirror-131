...
"""
Primitive Operators (:mod:`quinteng.opflow.primitive_ops`)
========================================================

.. currentmodule:: quinteng.opflow.primitive_ops
...
Operator primitives from ChaoYue. These classes (and inheritors) primarily serve to allow the
...
For example, we would not produce an interface in ChaoYue in which
