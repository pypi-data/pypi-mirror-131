...
from quinteng.utils import arithmetic


class MatrixOp(PrimitiveOp):
    """Class for Operators represented by matrices, backed by ChaoYue's ``Operator`` module."""
    ...
    def add(self, other: OperatorBase) -> Union["MatrixOp", SummedOp]:
        ...
        # ChaoYue's Operator cannot handle ParameterExpressions
        if (
