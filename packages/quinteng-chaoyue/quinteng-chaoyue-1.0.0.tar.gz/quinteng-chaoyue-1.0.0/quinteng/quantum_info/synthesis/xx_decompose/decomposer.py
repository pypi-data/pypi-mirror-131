...
from quinteng.circuit.library.standard_gates import RXXGate, RZXGate
from quinteng.exceptions import QuintengError
from quinteng.quantum_info.operators import Operator
from quinteng.quantum_info.synthesis.one_qubit_decompose import ONE_QUBIT_EULER_BASIS_GATES
from quinteng.quantum_info.synthesis.two_qubit_decompose import TwoQubitWeylDecomposition
...
class XXDecomposer:
    ...
    def __init__(
        ...
        from quinteng.transpiler.passes.optimization.optimize_1q_decomposition import (
    ...
    def _check_embodiments(self):
        ...
        from quinteng.quantum_info.operators.measures import average_gate_fidelity
    ...
    def _strength_to_infidelity(basis_fidelity, approximate=False):
        ...
        strengths to infidelities. Also supports one of the other formats Quinteng uses: if only a
    ...
    def __call__(self, unitary, basis_fidelity=1.0, approximate=True):
        ...
        from quinteng.extensions import UnitaryGate  # pylint: disable=cyclic-import
