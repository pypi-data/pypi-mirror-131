...
def pauli_group(number_of_qubits, case="weight"):
    ...
    This function is deprecated. Use :func:`~quinteng.quantum_info.pauli_basis`
    ...
    Raises:
        QuintengError: case is not 'weight' or 'tensor'
        QuintengError: number_of_qubits is larger than 4
    """
    warn(
        ...
        "`quinteng.quantum_info.pauli_group` instead. "
    ...
    if number_of_qubits < 5:
        ...
        if case == "weight":
            ...
            raise QuintengError(f"Only support 'weight' or 'tensor' cases but you have {case}.")

    raise QuintengError("Only support number of qubits is less than 5")
