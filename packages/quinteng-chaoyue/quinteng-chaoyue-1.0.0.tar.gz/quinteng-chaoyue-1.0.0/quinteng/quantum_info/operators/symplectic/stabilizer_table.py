...
class StabilizerTable(PauliTable, AdjointMixin):
    ...
    **Iteration**
    ...
    def __init__(self, data, phase=None):
        ...
        Raises:
            QuintengError: if input array or phase vector has an invalid shape.
        ...
        if phase is None or phase is False:
            ...
            if self._phase.shape != (self.size,):
                raise QuintengError("Phase vector is incorrect shape.")
    ...
    def sort(self, weight=False):
        ...
        .. jupyter-execute::
            ...
            from quinteng.quantum_info.operators import StabilizerTable
    ...
    def tensor(self, other):
        ...
        **Example**
        ...
        Raises:
            QuintengError: if other cannot be converted to a StabilizerTable.
        """
    ...
    def compose(self, other, qargs=None, front=False):
        ...
        **Example**
        ...
        if qargs is None and other.num_qubits != self.num_qubits:
            raise QuintengError("other StabilizerTable must be on the same number of qubits.")
        if qargs and other.num_qubits != len(qargs):
            raise QuintengError("Number of qubits in the other StabilizerTable does not match qargs.")
    ...
    def _multiply(self, other):
        ...
        Raises:
            QuintengError: if other is not in (False, True, 1, -1).
        """
        # Numeric (integer) value case
        if not isinstance(other, bool) and other not in [1, -1]:
            raise QuintengError("Can only multiply a Stabilizer value by +1 or -1 phase.")
