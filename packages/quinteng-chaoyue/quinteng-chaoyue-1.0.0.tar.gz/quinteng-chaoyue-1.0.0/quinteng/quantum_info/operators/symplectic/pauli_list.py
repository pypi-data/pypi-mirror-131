...
from quinteng.quantum_info.operators.symplectic.stabilizer_table import StabilizerTable
...
class PauliList(BasePauli, LinearMixin, GroupMixin):
    ...
    **Initialization**
    ...
    A PauliList object can be initialized in several ways.
        ...
        ``PauliList(list[str])``
            where strings are same representation with :class:`~quinteng.quantum_info.Pauli`.

        ``PauliList(Pauli) and PauliList(list[Pauli])``
            where Pauli is :class:`~quinteng.quantum_info.Pauli`.
    ...
    .. jupyter-execute::
        ...
        from quinteng.quantum_info import Pauli, PauliList
    ...
    **Iteration**
    ...
    def _from_paulis(data):
        ...
        num_paulis = len(data)
        if num_paulis == 0:
            raise QuintengError("Input Pauli list is empty.")
        paulis = []
        for i in data:
    ...
    def insert(self, ind, value, qubit=False):
        ...
        Raises:
            QuintengError: if the insertion index is invalid.
        """
        if not isinstance(ind, int):
            raise QuintengError("Insert index must be an integer.")
    ...
    def sort(self, weight=False, phase=False):
        ...
        **Example**
        ...
        .. jupyter-execute::
            ...
            from quinteng.quantum_info.operators import PauliList
    ...
    def tensor(self, other):
        ...
        Raises:
            QuintengError: if other cannot be converted to a PauliList, does
