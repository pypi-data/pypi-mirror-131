...
def pauli_basis(num_qubits, weight=False, pauli_list=False):
    ...
    if pauli_list:
        ...
        warnings.warn(
            ...
            "future release of Quinteng ChaoYue.  Returning PauliTable is deprecated as of "
            "Quinteng ChaoYue 0.19, and will be removed in a future release.  To immediately switch "
