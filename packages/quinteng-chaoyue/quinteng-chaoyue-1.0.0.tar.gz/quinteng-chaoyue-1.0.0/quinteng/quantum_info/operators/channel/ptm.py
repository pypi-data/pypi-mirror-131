...
from quinteng.quantum_info.operators.channel.transformations import _to_ptm
    ...
    def __init__(self, data, input_dims=None, output_dims=None):
        ...
        if isinstance(data, (list, np.ndarray)):
            ...
            if output_dim ** 2 != dout or input_dim ** 2 != din or input_dim != output_dim:
                raise QuintengError("Invalid shape for PTM matrix.")
        else:
        ...
        if 2 ** num_qubits != input_dim or input_dim != output_dim:
            raise QuintengError("Input is not an n-qubit Pauli transfer matrix.")
