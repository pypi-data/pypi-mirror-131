...
from quinteng.quantum_info.operators.channel.transformations import _to_stinespring
        ...
        if isinstance(data, (list, tuple, np.ndarray)):
            ...
            if stine[1] is not None:
                if stine[1].shape != (dim_left, dim_right):
                    raise QuintengError("Invalid Stinespring input.")
            input_dim = dim_right
            if output_dims:
            ...
            if dim_left % output_dim != 0:
                raise QuintengError("Invalid output_dim")
