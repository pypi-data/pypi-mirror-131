...
class Kraus(QuantumChannel):
    ...
    evolution of a :class:`~quinteng.quantum_info.DensityMatrix`
        ...
        if isinstance(data, (list, tuple, np.ndarray)):
            ...
            # E(rho) = sum_i A_i * rho * A_i^dagger
                ...
                for i in data[1:]:
                    ...
                    if op.shape != shape:
                        raise QuintengError("Kraus operators are different dimensions.")
                    kraus.append(op)
            ...
            # E(rho) = sum_i A_i * rho * B_i^dagger
                ...
                raise QuintengError("Invalid input for Kraus channel.")
