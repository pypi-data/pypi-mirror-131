...
from quinteng.quantum_info.operators.channel.transformations import _to_chi
...
class Chi(QuantumChannel):
    ...
    def __init__(self, data, input_dims=None, output_dims=None):
        ...
        Raises:
            QuintengError: if input data is not an N-qubit channel or
        ...
        if isinstance(data, (list, np.ndarray)):
            ...
            if dim_l != dim_r:
                raise QuintengError("Invalid Chi-matrix input.")
            if input_dims:
            ...
            if input_dim * output_dim != dim_l:
                raise QuintengError("Invalid shape for Chi-matrix input.")
        else:
        ...
        if 2 ** num_qubits != input_dim or input_dim != output_dim:
            raise QuintengError("Input is not an n-qubit Chi matrix.")
