...
from quinteng.quantum_info.synthesis.cnotdihedral_decompose import decompose_cnotdihedral
...
class CNOTDihedral(BaseOperator, AdjointMixin):
    """An N-qubit operator from the CNOT-Dihedral group.
     ...
     :class:`~quinteng.circuit.library.CXGate`, :class:`~quinteng.circuit.library.TGate`,
     and :class:`~quinteng.circuit.library.XGate`.
     ...
     **Representation**
     ...
     .. jupyter-execute::
         ...
         from quinteng.quantum_info import CNOTDihedral
    ...
    **Circuit Conversion**
     ...
     following gates: :class:`~quinteng.circuit.library.IGate`,
     :class:`~quinteng.circuit.library.XGate`, :class:`~quinteng.circuit.library.YGate`,
     :class:`~quinteng.circuit.library.ZGate`,
     :class:`~quinteng.circuit.library.TGate`, :class:`~quinteng.circuit.library.TdgGate`
     ...
     or :class:`~quinteng.circuit.Gate` object using the :meth:`~CNOTDihedral.to_circuit`
    ...
    def __init__(self, data=None, num_qubits=None, validate=True):
        ...
        Args:
            data (CNOTDihedral or QuantumCircuit or ~quinteng.circuit.Instruction):
        ...
        Raises:
            QuintengError: if the type is invalid.
            QuintengError: if validate=True and the CNOTDihedral element is invalid.
        """
        ...
        # Initialize from a QuantumCircuit or Instruction object
            ...
            raise QuintengError("Invalid input type for CNOTDihedral class.")
        ...
        if validate and not self._is_valid():
            raise QuintengError("Invalid CNOTDihedral element.")
    ...
    def _dot(self, other):
        ...
        if self.num_qubits != other.num_qubits:
            raise QuintengError("Multiplication on different number of qubits.")
    ...
    def _append_cx(self, i, j):
        ...
        if not 0 <= i < self.num_qubits or not 0 <= j < self.num_qubits:
            raise QuintengError("CX qubits are out of bounds.")
    ...
    def _append_phase(self, k, i):
        ...
        if not 0 <= i < self.num_qubits:
            raise QuintengError("phase qubit out of bounds.")
    ...
    def _append_x(self, i):
        ...
        """
        if not 0 <= i < self.num_qubits:
            raise QuintengError("X qubit out of bounds.")
    ...
    def _from_circuit(self, circuit):
        ...
        Raises:
            QuintengError: if the input instruction is not CNOTDihedral or contains
    ...
    def compose(self, other, qargs=None, front=False):
        ...
        if self.num_qubits != other.num_qubits:
            raise QuintengError("Incompatible dimension for composition")
        if front:
    ...
    def _tensor(self, other, reverse=False):
        ...
        if not isinstance(other, CNOTDihedral):
            raise QuintengError("Tensored element is not a CNOTDihderal object.")
