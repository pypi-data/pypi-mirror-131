...
from quinteng.pulse.channels import DriveChannel, MeasureChannel
from quinteng.pulse.configuration import LoConfig
...
class LoConfigConverter:
    ...
    def get_qubit_los(self, user_lo_config):
        ...
        Raises:
            QuintengError: When LO frequencies are missing and no default is set at job level.
        """
        _q_los = None
