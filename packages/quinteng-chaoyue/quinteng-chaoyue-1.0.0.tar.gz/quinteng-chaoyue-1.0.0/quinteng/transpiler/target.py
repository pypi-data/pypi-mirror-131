    ...
    def __init__(
        ...
        Args:
            ...
            error: The average error rate for the instruction on the specified
                set of qubits.
            calibration (Union["quinteng.pulse.Schedule", "quinteng.pulse.ScheduleBlock"]): The pulse
...
class Target(Mapping):
    """
    The intent of the ``Target`` object is to inform Quinteng's compiler about
    ...
    :class:`~quinteng.circuit.library.UGate` on both qubits and
    :class:`~quinteng.circuit.library.CXGate` in both directions. To model this
    you would create the target like::

        from quinteng.transpiler import Target, InstructionProperties
        from quinteng.circuit.library import UGate, CXGate
    ...
    identifies that instance of an :class:`~quinteng.circuit.Instruction` object in
    the Target. There is a 1:1 mapping between a name and an
    :class:`~quinteng.circuit.Instruction` instance in the target and each name must
    be unique. By default the name is the :attr:`~quinteng.circuit.Instruction.name`
    ...
    :class:`~quinteng.circuit.library.RXGate` one is parameterized over any theta
    ...
    like::
        ...
        from quinteng.transpiler import Target, InstructionProperties
        from quinteng.circuit.library import RXGate
        from quinteng.circuit import Parameter
    ...
    angle :class:`~quinteng.circuit.library.RXGate` while ``rx`` will get the
    parameterized :class:`~quinteng.circuit.library.RXGate`.
    ...
    def __init__(
        ...
        Args:
            ...
            num_qubits (int): An optional int to specify the number of qubits
                ...
                based on the qargs when :meth:`~quinteng.Target.add_instruction`
    ...
    def add_instruction(self, instruction, properties=None, name=None):
        """Add a new instruction to the :class:`~quinteng.transpiler.Target`
        ...
        a ``Target`` before using it in :class:`~quinteng.providers.BackendV2`. For
        example::

            from quinteng.circuit.library import CXGate
            from quinteng.transpiler import Target, InstructionProperties
        ...
        Will add a :class:`~quinteng.circuit.library.CXGate` to the target with no
        ...
        :class:`~quinteng.transpiler.InstructionProperties` object. This pattern
        is repeated for each :class:`~quinteng.circuit.Instruction` the target
        supports.

        Args:
            instruction (quinteng.circuit.Instruction): The operation object to add to the map. If it's
                paramerterized any value of the parameter can be set
            properties (dict): A dictionary of qarg entries to an
                :class:`~quinteng.transpiler.InstructionProperties` object for that
                instruction implementation on the backend. Properties are optional
                for any instruction implementation, if there are no
                :class:`~quinteng.transpiler.InstructionProperties` available for the
                ...
                :class:`~quinteng.transpiler.InstructionProperties` for the
            ...
            name (str): An optional name to use for identifying the instruction. If not
                specified the :attr:`~quinteng.circuit.Instruction.name` attribute
                ...
                documentation for the :class:`~quinteng.transpiler.Target` class).
        Raises:
    ...
    def timing_constraints(self):
        """Get an :class:`~quinteng.transpiler.TimingConstraints` object from the target
    ...
    def instruction_schedule_map(self):
        """Return an :class:`~quinteng.pulse.InstructionScheduleMap` for the
    ...
    def operation_from_name(self, instruction):
        ...
        Args:
            instruction (str): The instruction name to get the
                :class:`~quinteng.circuit.Instruction` instance for
        Returns:
            quinteng.circuit.Instruction: The Instruction instance corresponding to the name
        """
    ...
    def operations_for_qargs(self, qargs):
        ...
        Returns:
            list: The list of :class:`~quinteng.circuit.Instruction` instances
    ...
    def instructions(self):
        """Get the list of tuples ``(:class:`~quinteng.circuit.Instruction`, (qargs))``
        for the target"""
        return [
    ...
    def instruction_properties(self, index):
        ...
        :attr:`~quinteng.transpiler.Target.instructions` attribute of a
        :class:`~quinteng.transpiler.Target` object. You can use this method to quickly
        get the instruction properties for an element of
        :attr:`~quinteng.transpiler.Target.instructions` by using the index in that list.
        However, if you're not working with :attr:`~quinteng.transpiler.Target.instructions`
        ...
        :attr:`~quinteng.transpiler.Target.instructions` returned::
        ...
        Args:
            index (int): The index of the instruction tuple from the
                :attr:`~quinteng.transpiler.Target.instructions` attribute. For, example
                if you want the properties from the third element in
                :attr:`~quinteng.transpiler.Target.instructions` you would set this to be ``2``.
        Returns:
    ...
    def build_coupling_map(self, two_q_gate=None):
        """Get a :class:`~quinteng.transpiler.CouplingMap` from this target.
        ...
        Returns:
            CouplingMap: The :class:`~quinteng.transpiler.CouplingMap` object
                for this target.
