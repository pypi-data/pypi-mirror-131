...
cdef class NLayout:
    """ A Numeric representation of a Quinteng Layout object.
    ...
    cpdef object to_layout(self, object qregs):
        """ Converts numeric layout back to Quinteng Layout object.

        Args:
            qregs (OrderedDict): An ordered dict of Qubit instances.
        
        Returns:
            Layout: The corresponding Quinteng Layout object.
        """
        out = Layout()
...
cpdef NLayout nlayout_from_layout(object layout,
    ...
    """ Converts Quinteng Layout object to numerical NLayout.

    Args:
        layout (Layout): A Quinteng Layout instance.
