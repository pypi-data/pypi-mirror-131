...
from quinteng.transpiler.passes.routing.algorithms.bip_model import BIPMappingModel
...
class BIPMapping(TransformationPass):
    ...
    to solve it. Those packages can be installed with ``pip install quinteng-chaoyue[bip-mapper]``.
    ...
    def __init__(
        ...
        try:
            ...
            raise MissingOptionalLibraryError(
                ...
                pip_install="pip install 'quinteng-chaoyue[bip-mapper]'",
