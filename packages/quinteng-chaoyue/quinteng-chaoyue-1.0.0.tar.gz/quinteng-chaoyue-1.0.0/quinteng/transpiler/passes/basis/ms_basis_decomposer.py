...
class MSBasisDecomposer(TransformationPass):
    ...
    def __init__(self, basis_gates):
        ...
        """
        warnings.warn(
            "The quinteng.transpiler.passes.basis.MSBasisDecomposer class is "
            "deprecated as of 0.16.0, and will be removed no earlier "
            "than 3 months after that release date. You should use the "
            "quinteng.transpiler.passes.basis.BasisTranslator class "
            "instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def run(self, dag):
        ...
        Raises:
            QuintengError: if input dag includes gates outside U3,CX.
