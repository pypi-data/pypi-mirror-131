...
from quinteng.transpiler.passes.optimization import Optimize1qGates
...
class DynamicalDecoupling(TransformationPass):
    ...
    .. jupyter-execute::
        ...
        from quinteng.circuit.library import XGate
        from quinteng.transpiler import PassManager, InstructionDurations
        from quinteng.transpiler.passes import ALAPSchedule, DynamicalDecoupling
        from quinteng.visualization import timeline_drawer
