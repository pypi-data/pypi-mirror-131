...
def graysynth(cnots, angles, section_size=2):
    ...
    Raises:
        QuintengError: when dimensions of cnots and angles don't align
    """
    ...
    if len(cnots[0]) != len(angles):
        raise QuintengError('Size of "cnots" and "angles" do not match.')
...
def cnot_synth(state, section_size=2):
    ...
    Raises:
        QuintengError: when variable "state" isn't of type numpy.matrix
    """
