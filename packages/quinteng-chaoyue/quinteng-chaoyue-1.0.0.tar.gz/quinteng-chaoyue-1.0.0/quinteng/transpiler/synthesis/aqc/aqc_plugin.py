...
"""
An AQC synthesis plugin to Quinteng's transpiler.
"""
import numpy as np
...
class AQCSynthesisPlugin(UnitarySynthesisPlugin):
    ...
    the :func:`~quinteng.compiler.transpile` function.
    ...
    optimizer (:class:`~quinteng.algorithms.optimizers.Optimizer`)
    ...
    def run(self, unitary, **options):
        ...
        from quinteng.algorithms.optimizers import L_BFGS_B
        from quinteng.transpiler.synthesis.aqc.aqc import AQC
        from quinteng.transpiler.synthesis.aqc.cnot_structures import make_cnot_network
        from quinteng.transpiler.synthesis.aqc.cnot_unit_circuit import CNOTUnitCircuit
        from quinteng.transpiler.synthesis.aqc.cnot_unit_objective import DefaultCNOTUnitObjective
