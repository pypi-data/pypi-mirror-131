...
"""
=====================================
Transpiler (:mod:`quinteng.transpiler`)
=====================================

.. currentmodule:: quinteng.transpiler
...
Quinteng has four pre-built transpilation pipelines available here:
:mod:`quinteng.transpiler.preset_passmanagers`.  Unless the reader is familiar with
...
.. dropdown:: Basis gates
   ...
   care of for us in the :func:`quinteng.execute` function. However, we can
...
.. dropdown:: Initial layout
   ...
   By default, quinteng will do this mapping for you.  The choice of mapping depends on the
   ...
   circuits returned by :func:`quinteng.compiler.transpile` have this initial layout information
   in them, and we can view this layout selection graphically using
   :func:`quinteng.visualization.plot_circuit_layout`:

   .. jupyter-execute::

      from quinteng import QuantumCircuit, transpile
      from quinteng.visualization import plot_circuit_layout
      from quinteng.test.mock import FakeVigo
      backend = FakeVigo()
   ...
   pass a list of integers to :func:`quinteng.compiler.transpile` via the `initial_layout`
...
.. dropdown:: Mapping circuits to hardware topology
   ...
   by default Quinteng uses a stochastic heuristic algorithm called
   :class:`Quinteng.transpiler.passes.StochasticSwap` to compute a good, but not necessarily minimal
   SWAP count.  The use of a stochastic method means the circuits generated by
   :func:`Quinteng.compiler.transpile` (or :func:`Quinteng.execute` that calls `transpile` internally)
   ...
   .. jupyter-execute::
      ...
      from quinteng import QuantumCircuit, transpile
      from quinteng.test.mock import FakeBoeblingen
