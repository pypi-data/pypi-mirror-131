...
"""
==========================
Qasm (:mod:`quinteng.qasm3`)
==========================

.. currentmodule:: quinteng.qasm3
...
def dumps(circuit, **kwargs) -> str:
    """Serialize a :class:`~quinteng.circuit.QuantumCircuit` object in an OpenQASM3 string.
...
def dump(circuit, stream, **kwargs) -> None:
    """Serialize a :class:`~quinteng.circuit.QuantumCircuit` object as a OpenQASM3 stream to file-like
    object.
