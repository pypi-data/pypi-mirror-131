...
from quinteng.circuit import QuantumRegister, Qubit
from quinteng.circuit.exceptions import CircuitError
from quinteng.circuit._utils import _compute_control_matrix
from quinteng.circuit.quantumcircuit import _qasm_escape_gate_name
from quinteng.circuit.library.standard_gates import U3Gate
from quinteng.extensions.quantum_initializer import isometry
from quinteng.quantum_info.operators.predicates import matrix_equal
from quinteng.quantum_info.operators.predicates import is_unitary_matrix
from quinteng.quantum_info.synthesis.one_qubit_decompose import OneQubitEulerDecomposer
from quinteng.quantum_info.synthesis.two_qubit_decompose import two_qubit_cnot_decompose
...
class UnitaryGate(Gate):
    ...
    def control(self, num_ctrl_qubits=1, label=None, ctrl_state=None):
        ...
        Raises:
            QuintengError: Invalid ctrl_state.
