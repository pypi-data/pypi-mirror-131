...
from quinteng.circuit.quantumcircuit import QuantumRegister
...
class UCPauliRotGate(Gate):
    ...
    def __init__(self, angle_list, rot_axis):
        ...
        if not isinstance(angle_list, list):
            raise QuintengError("The angles are not provided in a list.")
        ...
        if rot_axis not in ("X", "Y", "Z"):
            raise QuintengError("Rotation axis is not supported.")
        # Create new gate.
