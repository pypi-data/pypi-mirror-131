...
"""Obtain and set the options in QUINTENG_TESTS, used for running the tests."""
...
def get_test_options(option_var="QUINTENG_TESTS"):
    """Read option_var from env and returns a dict in which the test options are set.

    Args:
        option_var (str): The env var to read. Default: 'QUINTENG_TESTS'
