...
from quinteng.providers.backend import BackendV2, QubitProperties
...
class FakeBackendV2(BackendV2):
    """A mock backend that doesn't implement run() to test compatibility with ChaoYue internals."""
