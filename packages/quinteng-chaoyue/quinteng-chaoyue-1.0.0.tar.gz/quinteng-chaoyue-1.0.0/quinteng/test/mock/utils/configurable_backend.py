...
from quinteng.providers.models import (
...
from quinteng.test.mock.fake_backend import FakeBackend
    ...
    def _build_props(self) -> BackendProperties:
        ...
        for gate in self.basis_gates:
            ...
            if gate in self.single_qubit_gates:
                ...
                raise QuintengError(f"{gate} is not supported by fake backend builder.")
