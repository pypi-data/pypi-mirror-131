...
from quinteng.providers import BackendV1, BaseBackend
from quinteng import pulse
from quinteng.exceptions import QuintengError
from quinteng.test.mock import fake_job
...
class FakeBackend(BackendV1):
    ...
    def run(self, run_input, **kwargs):
        ...
        if HAS_AER:
            if pulse_job:
                from quinteng.providers.aer.pulse import PulseSystemModel
            ...
            if pulse_job:
                raise QuintengError("Unable to run pulse schedules without quinteng-aer installed")
