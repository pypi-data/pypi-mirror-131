...
from quinteng.qasm.qasm import Qasm
from quinteng.qasm.exceptions import QasmError
...
try:
    ...
    from quinteng.qasm.pygments import OpenQASMLexer  # pylint: disable=ungrouped-imports
    from quinteng.qasm.pygments import QasmTerminalStyle  # pylint: disable=ungrouped-imports
...
if typing.TYPE_CHECKING:
    import quinteng  # pylint: disable=cyclic-import
...
class QuantumCircuit:
    ...
    Args:
        ...
        metadata (dict): Arbitrary key value metadata to associate with the
            ...
            :attr:`~quinteng.circuit.QuantumCircuit.metadata` attribute. It will
    ...
    Examples:
        ...
        .. jupyter-execute::
            ...
            from quinteng import QuantumRegister, ClassicalRegister, QuantumCircuit
    ...
    def power(self, power: float, matrix_power: bool = False) -> "QuantumCircuit":
        ...
        try:
            gate = self.to_gate()
        except QuintengError as ex:
            raise CircuitError(
                "The circuit contains non-unitary operations and cannot be "
                "controlled. Note that no quinteng.circuit.Instruction objects may "
    ...
    def combine(self, rhs: "QuantumCircuit") -> "QuantumCircuit":
        ...
        Raises:
            QuintengError: if the rhs circuit is not compatible
        """
    ...
    def compose(
        ...
        Args:
            other (quinteng.circuit.Instruction or QuantumCircuit):
        ...
        Raises:
            ...
            QuintengError: if ``other`` is wider or there are duplicate edge mappings.
        ...
        for instr, qargs, cargs in instrs:
            ...
            if instr.condition is not None:
                from quinteng.dagcircuit import DAGCircuit  # pylint: disable=cyclic-import
    ...
    def tensor(self, other: "QuantumCircuit", inplace: bool = False) -> Optional["QuantumCircuit"]:
        ...
        [the docs](quinteng.org/documentation/tutorials/circuits/3_summary_of_quantum_operations.html)
    ...
    def append(
        ...
        Args:
            instruction (quinteng.circuit.Instruction): Instruction instance to append
            qargs (list(argument)): qubits to attach instruction to
            cargs (list(argument)): clbits to attach instruction to

        Returns:
            quinteng.circuit.Instruction: a handle to the instruction that was just added
    ...
    def to_instruction(
        ...
        Returns:
            quinteng.circuit.Instruction: a composite instruction encapsulating this circuit
            (can be decomposed back)
        """
        from quinteng.converters.circuit_to_instruction import circuit_to_instruction
    ...
    def to_gate(
        ...
        Returns:
            ...
            (can be decomposed back)
        """
        from quinteng.converters.circuit_to_gate import circuit_to_gate
    ...
    def decompose(
        ...
        from quinteng.transpiler.passes.basis.decompose import Decompose
        from quinteng.converters.circuit_to_dag import circuit_to_dag
        from quinteng.converters.dag_to_circuit import dag_to_circuit
        ...
        **latex_source**: raw uncompiled latex output.
        ...
        Args:
            output (str): select the output method to use for drawing the circuit.
                ...
                (usually ``~/.quinteng/settings.conf``) has an alternative backend set
            ...
            style (dict or str): dictionary of style or file name of style json file.
                ...
                ``~/.quinteng/settings.conf``) will be used, for example,
                ...
                See: :class:`~quinteng.visualization.qcstyle.DefaultStyle` for more
        ...
        Example:
            .. jupyter-execute::
                ...
                from quinteng import QuantumRegister, ClassicalRegister, QuantumCircuit
                from quinteng.tools.visualization import circuit_drawer
                q = QuantumRegister(1)
        ...
        # pylint: disable=cyclic-import
        from quinteng.visualization import circuit_drawer
    ...
    def num_tensor_factors(self) -> int:
        ...
        Notes:
            ...
            removed in a future release of Quinteng. You should call
    ...
    def reset(self, qubit: QubitSpecifier) -> InstructionSet:
        ...
        Returns:
            quinteng.circuit.InstructionSet: handle to the added instruction.
        """
    ...
    def measure(self, qubit: QubitSpecifier, cbit: ClbitSpecifier) -> InstructionSet:
        ...
        Returns:
            quinteng.circuit.InstructionSet: handle to the added instructions.
    ...
    def remove_final_measurements(self, inplace: bool = True) -> Optional["QuantumCircuit"]:
        ...
        """
        # pylint: disable=cyclic-import
        from quinteng.transpiler.passes import RemoveFinalMeasurements
        from quinteng.converters import circuit_to_dag
    ...
    def assign_parameters(
        ...
        Examples:
            ...
            .. jupyter-execute::
                ...
                from quinteng.circuit import QuantumCircuit, ParameterVector
    ...
    def barrier(self, *qargs: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.Barrier`. If qargs is empty, applies to all qubits in the
        circuit.
    ...
    def delay(
        ...
        """Apply :class:`~quinteng.circuit.Delay`. If qarg is None, applies to all qubits.
    ...
    def h(self, qubit: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.HGate`.
    ...
    def ch(
        ...
        """Apply :class:`~quinteng.circuit.library.CHGate`.
    ...
    def i(self, qubit: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.IGate`.
    ...
    def ms(self, theta: ParameterValueType, qubits: Sequence[QubitSpecifier]) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.generalized_gates.gms.MSGate`.
    ...
    def p(self, theta: ParameterValueType, qubit: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.PhaseGate`.
    ...
    def cp(
        ...
        """Apply :class:`~quinteng.circuit.library.CPhaseGate`.
    ...
    def mcp(
        ...
        """Apply :class:`~quinteng.circuit.library.MCPhaseGate`.
    ...
    def r(
        ...
        """Apply :class:`~quinteng.circuit.library.RGate`.
    ...
    def rv(
        ...
        """Apply :class:`~quinteng.circuit.library.RVGate`.
    ...
    def rccx(
        ...
        """Apply :class:`~quinteng.circuit.library.RCCXGate`.
    ...
    def rcccx(
        ...
        """Apply :class:`~quinteng.circuit.library.RC3XGate`.
    ...
    def rx(
        ...
        """Apply :class:`~quinteng.circuit.library.RXGate`.
    ...
    def crx(
        ...
        """Apply :class:`~quinteng.circuit.library.CRXGate`.
    ...
    def rxx(
        ...
        """Apply :class:`~quinteng.circuit.library.RXXGate`.
    ...
    def ry(
        ...
        """Apply :class:`~quinteng.circuit.library.RYGate`.
    ...
    def cry(
        ...
        """Apply :class:`~quinteng.circuit.library.CRYGate`.
    ...
    def ryy(
        ...
        """Apply :class:`~quinteng.circuit.library.RYYGate`.
    ...
    def crz(
        ...
        """Apply :class:`~quinteng.circuit.library.CRZGate`.
    ...
    def rzx(
        ...
        """Apply :class:`~quinteng.circuit.library.RZXGate`.
    ...
    def rzz(
        ...
        """Apply :class:`~quinteng.circuit.library.RZZGate`.
    ...
    def ecr(self, qubit1: QubitSpecifier, qubit2: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.ECRGate`.
    ...
    def s(self, qubit: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.SGate`.
    ...
    def sdg(self, qubit: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.SdgGate`.
    ...
    def swap(self, qubit1: QubitSpecifier, qubit2: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.SwapGate`.
    ...
    def iswap(self, qubit1: QubitSpecifier, qubit2: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.iSwapGate`.
    ...
    def cswap(
        ...
        """Apply :class:`~quinteng.circuit.library.CSwapGate`.
    ...
    def sx(self, qubit: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.SXGate`.
    ...
    def sxdg(self, qubit: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.SXdgGate`.
    ...
    def csx(
        ...
        """Apply :class:`~quinteng.circuit.library.CSXGate`.
    ...
    def t(self, qubit: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.TGate`.
    ...
    def tdg(self, qubit: QubitSpecifier) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.library.TdgGate`.
    ...
    def u(
        ...
        r"""Apply :class:`~quinteng.circuit.library.UGate`.
    ...
    def cu(
        ...
        r"""Apply :class:`~quinteng.circuit.library.CUGate`.
    ...
    def u1(self, theta: ParameterValueType, qubit: QubitSpecifier) -> InstructionSet:
        r"""Apply :class:`~quinteng.circuit.library.U1Gate`.
    ...
    def cu1(
        ...
        r"""Apply :class:`~quinteng.circuit.library.CU1Gate`.
    ...
    def mcu1(
        ...
        r"""Apply :class:`~quinteng.circuit.library.MCU1Gate`.
    ...
    def u2(
        ...
        r"""Apply :class:`~quinteng.circuit.library.U2Gate`.
    ...
    def u3(
        ...
        r"""Apply :class:`~quinteng.circuit.library.U3Gate`.
    ...
    def cu3(
        ...
        r"""Apply :class:`~quinteng.circuit.library.CU3Gate`.
    ...
    def x(self, qubit: QubitSpecifier, label: Optional[str] = None) -> InstructionSet:
        r"""Apply :class:`~quinteng.circuit.library.XGate`.
    ...
    def cx(
        ...
        r"""Apply :class:`~quinteng.circuit.library.CXGate`.
    ...
    def dcx(self, qubit1: QubitSpecifier, qubit2: QubitSpecifier) -> InstructionSet:
        r"""Apply :class:`~quinteng.circuit.library.DCXGate`.
    ...
    def ccx(
        ...
        r"""Apply :class:`~quinteng.circuit.library.CCXGate`.
    ...
    def mcx(
        ...
        """Apply :class:`~quinteng.circuit.library.MCXGate`.
    ...
    def y(self, qubit: QubitSpecifier) -> InstructionSet:
        r"""Apply :class:`~quinteng.circuit.library.YGate`.
    ...
    def cy(
        ...
        r"""Apply :class:`~quinteng.circuit.library.CYGate`.
    ...
    def z(self, qubit: QubitSpecifier) -> InstructionSet:
        r"""Apply :class:`~quinteng.circuit.library.ZGate`.
    ...
    def cz(
        ...
        r"""Apply :class:`~quinteng.circuit.library.CZGate`.
    ...
    def pauli(
        ...
        """Apply :class:`~quinteng.circuit.library.PauliGate`.
        ...
        Returns:
            A handle to the instructions created.
        """
        from quinteng.circuit.library.generalized_gates.pauli import PauliGate
    ...
    def _push_scope(
        ...
        """
        # pylint: disable=cyclic-import
        from quinteng.circuit.controlflow.builder import ControlFlowBuilderBlock
    ...
    def _pop_scope(self) -> "quinteng.circuit.controlflow.builder.ControlFlowBuilderBlock":
    ...
    def while_loop(
        ...
        *,
        label: Optional[str],
    ) -> "quinteng.circuit.controlflow.while_loop.WhileLoopContext":
        ...
    ...
    def while_loop(self, condition, body=None, qubits=None, clbits=None, *, label=None):
        ...
        :obj:`~quinteng.circuit.controlflow.WhileLoopOp` with the given ``body``.  If ``body`` (and
        ``qubits`` and ``clbits``) are *not* passed, then this acts as a context manager, which
        will automatically build a :obj:`~quinteng.circuit.controlflow.WhileLoopOp` when the scope
        ...
        Example usage::
            ...
            from quinteng.circuit import QuantumCircuit, Clbit, Qubit
        ...
        """
        # pylint: disable=cyclic-import
        from quinteng.circuit.controlflow.while_loop import WhileLoopOp, WhileLoopContext
    ...
    def for_loop(
        ...
        *,
        label: Optional[str],
    ) -> "quinteng.circuit.controlflow.for_loop.ForLoopContext":
        ...
    ...
    def for_loop(
        ...
        There are two forms for calling this function.  If called with all its arguments (with the
        possible exception of ``label``), it will create a
        :obj:`~quinteng.circuit.controlflow.ForLoopOp` with the given ``body``.  If ``body`` (and
        ``qubits`` and ``clbits``) are *not* passed, then this acts as a context manager, which,
        when entered, provides a loop variable (unless one is given, in which case it will be
        reused) and will automatically build a :obj:`~quinteng.circuit.controlflow.ForLoopOp` when the
        ...
        """
        # pylint: disable=cyclic-import
        from quinteng.circuit.controlflow.for_loop import ForLoopOp, ForLoopContext
    ...
    def if_test(
        ...
        *,
        label: Optional[str],
    ) -> "quinteng.circuit.controlflow.if_else.IfContext":
        ...
    ...
    def if_test(
        ...
        *,
        ...
        There are two forms for calling this function.  If called with all its arguments (with the
        possible exception of ``label``), it will create a
        :obj:`~quinteng.circuit.controlflow.IfElseOp` with the given ``true_body``, and there will be
        ...
        For example::
            ...
            from quinteng.circuit import QuantumCircuit, Qubit, Clbit
        ...
        """
        # pylint: disable=cyclic-import
        from quinteng.circuit.controlflow.if_else import IfElseOp, IfContext
    ...
    def if_else(
        ...
        """Apply :class:`~quinteng.circuit.controlflow.IfElseOp`.
    ...
    def break_loop(self) -> InstructionSet:
        ...
        """
        # pylint: disable=cyclic-import
        from quinteng.circuit.controlflow.break_loop import BreakLoopOp, BreakLoopPlaceholder
    ...
    def continue_loop(self) -> InstructionSet:
        """Apply :class:`~quinteng.circuit.controlflow.ContinueLoopOp`.
        ...
        """
        # pylint: disable=cyclic-import
        from quinteng.circuit.controlflow.continue_loop import ContinueLoopOp, ContinueLoopPlaceholder
    ...
    def add_calibration(
        ...
        gate: Union[Gate, str],
        qubits: Sequence[int],
        # Schedule has the type `quinteng.pulse.Schedule`, but `quinteng.pulse` cannot be imported
...
def _circuit_from_qasm(qasm: Qasm) -> "QuantumCircuit":
    # pylint: disable=cyclic-import
    from quinteng.converters import ast_to_dag
