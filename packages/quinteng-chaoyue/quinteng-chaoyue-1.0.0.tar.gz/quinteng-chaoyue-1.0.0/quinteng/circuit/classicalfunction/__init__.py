...
"""
====================================================================
ClassicalFunction compiler (:mod:`quinteng.circuit.classicalfunction`)
====================================================================

.. currentmodule:: quinteng.circuit.classicalfunction
...
QuantumCircuit:
   ...
   .. jupyter-execute::
      ...
      from quinteng.circuit import classical_function,  Int1
...
Following Quinteng's little-endian bit ordering convention, the left-most bit (`a`) is the most
...
.. container:: toggle
   ...
   ``quinteng.circuit.classicalfunction.types.Int1``. The classical function function
