...
from .utils import tweedledum2quinteng
...
class ClassicalFunction(ClassicalElement):
    ...
    def __init__(self, source, name=None):
        ...
        Raises:
            QuintengError: If source is not a string.
        """
        if not isinstance(source, str):
            raise QuintengError("ClassicalFunction needs a source code as a string.")
    ...
    def synth(
        ...
        """Synthesis the logic network into a :class:`~quinteng.circuit.QuantumCircuit`.
        ...
        return tweedledum2quinteng(pkrm_synth(self.truth_table[0]), name=self.name, qregs=qregs)
