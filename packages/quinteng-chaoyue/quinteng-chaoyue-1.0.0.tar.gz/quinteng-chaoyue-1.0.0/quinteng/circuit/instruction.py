...
from quinteng.circuit.parameter import ParameterExpression
...
class Instruction:
    ...
    def __init__(self, name, num_qubits, num_clbits, params, duration=None, unit="dt", label=None):
        ...
        #       the next stable quinteng-aer release
    ...
    def mirror(self):
        ...
        Return:
            quinteng.circuit.Instruction: a new instruction with sub-instructions
                reversed.
        """
        warnings.warn(
    ...
    def reverse_ops(self):
        ...
        Returns:
            quinteng.circuit.Instruction: a new instruction with
    ...
    def inverse(self):
        ...
        Returns:
            quinteng.circuit.Instruction: a fresh instruction for the inverse
        ...
        from quinteng.circuit import QuantumCircuit, Gate  # pylint: disable=cyclic-import
    ...
    def copy(self, name=None):
        ...
        Returns:
          quinteng.circuit.Instruction: a copy of the current instruction, with the name
    ...
    def repeat(self, n):
        ...
        Returns:
            quinteng.circuit.Instruction: Containing the definition.
