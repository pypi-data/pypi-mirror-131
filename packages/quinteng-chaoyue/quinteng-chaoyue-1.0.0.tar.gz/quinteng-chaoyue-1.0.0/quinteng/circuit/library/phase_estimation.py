...
class PhaseEstimation(QuantumCircuit):
    ...
    **References:**
    ...
    [3]: Quinteng
        `textbook <https://quinteng.org/textbook/ch-algorithms/quantum-phase-estimation.html>`_
    ...
    def __init__(
        ...
        Args:
            ...
            iqft: A inverse Quantum Fourier Transform, per default the inverse of
                :class:`~quinteng.circuit.library.QFT` is used. Note that the QFT should not include
                the usual swaps!
