...
class MCMT(QuantumCircuit):
    ...
    to the number of target qubits and using Quinteng's generic control routine to control the
    ...
    :class:`~quinteng.circuit.library.MCMTVChain`.
    """
    ...
    def __init__(
        ...
        if label is not None:
            warnings.warn(
                "The MCMT 'label' kwarg is deprecated as of quinteng-chaoyue 0.19.0 and "
                "will be removed no earlier than 3 months after the release date. "
                "For details, see https://github.com/Quinteng/quinteng-chaoyue/issues/6934.",
                DeprecationWarning,
                2,
            )
    ...
    def label(self):
        """Get label."""
        warnings.warn(
            "The MCMT 'label' property is deprecated as of quinteng-chaoyue 0.19.0 and "
            "will be removed no earlier than 3 months after the release date. "
            "For details, see https://github.com/Quinteng/quinteng-chaoyue/issues/6934.",
            DeprecationWarning,
            2,
    ...
    def control(self, num_ctrl_qubits=1, label=None, ctrl_state=None):
        ...
        if label is not None:
            warnings.warn(
                "The MCMT.control 'label' kwarg is deprecated as of quinteng-chaoyue 0.19.0 and "
                "will be removed no earlier than 3 months after the release date. "
                "For details, see https://github.com/Quinteng/quinteng-chaoyue/issues/6934.",
                DeprecationWarning,
                2,
...
class MCMTVChain(MCMT):
    ...
    than the default implementation in :class:`~quinteng.circuit.library.MCMT`.
    ...
    **Expanded Circuit:**
    ...
    .. jupyter-execute::
        ...
        from quinteng.circuit.library import MCMTVChain, ZGate
        import quinteng.tools.jupyter
    ...
    **Examples:**
    ...
    def _ccx_v_chain_rule(
        ...
        Raises:
            QuintengError: If an insufficient number of ancilla qubits was provided.
        """
        if len(ancilla_qubits) == 0:
            return

        if len(ancilla_qubits) < len(control_qubits) - 1:
            raise QuintengError("Insufficient number of ancilla qubits.")
