...
class GR(QuantumCircuit):
    ...
    **Expanded Circuit:**
    ...
    .. jupyter-execute::
        ...
        from quinteng.circuit.library import GR
...
class GRX(GR):
    ...
    **Expanded Circuit:**
    ...
    .. jupyter-execute::
        ...
        from quinteng.circuit.library import GRX
        import quinteng.tools.jupyter
        import numpy as np
...
class GRY(GR):
    ...
    **Expanded Circuit:**
    ...
    .. jupyter-execute::
        ...
        from quinteng.circuit.library import GRY
        import quinteng.tools.jupyter
        import numpy as np
...
class GRZ(QuantumCircuit):
    ...
    **Expanded Circuit:**
    ...
    .. jupyter-execute::
        ...
        from quinteng.circuit.library import GRZ
        import quinteng.tools.jupyter
        import numpy as np
