...
from quinteng.circuit import Parameter, QuantumRegister, QuantumCircuit
...
class EvolvedOperatorAnsatz(NLocal):
    ...
    def __init__(
        ...
        if evolution is None:
            ...
            from quinteng.opflow import PauliTrotterEvolution
...
def _is_pauli_identity(operator):
    from quinteng.opflow import PauliOp, PauliSumOp
