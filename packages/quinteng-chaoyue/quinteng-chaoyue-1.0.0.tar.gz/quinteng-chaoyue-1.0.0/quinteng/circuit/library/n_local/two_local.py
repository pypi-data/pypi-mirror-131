...
class TwoLocal(NLocal):
    ...
    * ``'sca'`` (shifted-circular-alternating) entanglement is a generalized and modified version
    ...
    :class:`~quinteng.circuit.library.ParameterVector`. The name of these parameters can be chosen
    ...
    def __init__(
        ...
        Args:
            ...
            parameter_prefix: The parameterized gates require a parameter to be defined, for which
                we use instances of `quinteng.circuit.Parameter`. The name of each parameter will
