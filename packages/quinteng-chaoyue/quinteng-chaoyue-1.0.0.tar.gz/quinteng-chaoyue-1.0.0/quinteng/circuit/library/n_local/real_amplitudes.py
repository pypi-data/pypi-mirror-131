...
class RealAmplitudes(TwoLocal):
    ...
    index-pairs. See the documentation of :class:`~quinteng.circuit.library.TwoLocal` and
    :class:`~quinteng.circuit.NLocal` for more detail. Additional options that can be set include the
    ...
    def __init__(
        ...
        Args:
            ...
            entanglement: Specifies the entanglement structure. Can be a string ('full', 'linear'
                ...
                See the Examples section of :class:`~quinteng.circuit.library.TwoLocal` for more
                detail.
            ...
            parameter_prefix: The parameterized gates require a parameter to be defined, for which
                we use :class:`~quinteng.circuit.ParameterVector`.
