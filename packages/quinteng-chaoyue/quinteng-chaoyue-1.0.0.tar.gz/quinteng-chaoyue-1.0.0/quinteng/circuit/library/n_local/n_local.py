...
from quinteng.circuit import Instruction, Parameter, ParameterVector, ParameterExpression
from quinteng.circuit.parametertable import ParameterTable
...
class NLocal(BlueprintCircuit):
    ...
    If an initial state object of Quinteng Aqua is provided, it is added in front of the NLocal.
    """
    ...
    def __init__(
        ...
        Raises:
            ImportError: If an ``initial_state`` is specified but Quinteng Aqua is not installed.
    ...
    def num_parameters_settable(self) -> int:
        ...
        :class:`~quinteng.circuit.Parameter` objects currently in the circuit.
    ...
    def initial_state(self, initial_state: Any) -> None:
        ...
        if not isinstance(self._initial_state, QuantumCircuit):
            warnings.warn(
                ...
                "deprecated as of Quinteng ChaoYue 0.18.0, and "
