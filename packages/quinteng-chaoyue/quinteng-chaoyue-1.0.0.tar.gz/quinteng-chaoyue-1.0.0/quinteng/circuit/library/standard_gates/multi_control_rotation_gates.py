...
from quinteng.circuit import QuantumCircuit, QuantumRegister, Qubit
from quinteng.circuit.library.standard_gates.x import MCXGate
from quinteng.circuit.library.standard_gates.u3 import _generate_gray_code
...
def mcrx(
    ...
    Raises:
        QuintengError: parameter errors
    """
    ...
    if isinstance(q_target, Qubit):
        ...
        raise QuintengError("The mcrx gate needs a single qubit as target.")
...
def mcry(
    ...
    if isinstance(q_target, Qubit):
        ...
        raise QuintengError("The mcry gate needs a single qubit as target.")
    ...
    if mode == "basic":
        ...
        raise QuintengError(f"Unrecognized mode for building MCRY circuit: {mode}.")
...
def mcrz(
    ...
    if isinstance(q_target, Qubit):
        ...
        raise QuintengError("The mcrz gate needs a single qubit as target.")
