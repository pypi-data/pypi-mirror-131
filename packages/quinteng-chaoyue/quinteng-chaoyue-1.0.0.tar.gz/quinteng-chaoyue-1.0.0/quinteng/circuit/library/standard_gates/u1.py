...
from quinteng.circuit._utils import _ctrl_state_to_int
...
class U1Gate(Gate):
    ...
    **Examples:**
    ...
    .. seealso::
        ...
        :class:`~quinteng.circuit.library.standard_gates.RZGate`:
        ...
        :class:`~quinteng.circuit.library.standard_gates.U3Gate`:
...
class CU1Gate(ControlledGate):
    ...
    **Matrix representation:**
    ...
    .. seealso::
        ...
        :class:`~quinteng.circuit.library.standard_gates.CRZGate`:
...
class MCU1Gate(ControlledGate):
    ...
    **Circuit symbol:**
    ...
    .. seealso::
        ...
        :class:`~quinteng.circuit.library.standard_gates.CU1Gate`:
