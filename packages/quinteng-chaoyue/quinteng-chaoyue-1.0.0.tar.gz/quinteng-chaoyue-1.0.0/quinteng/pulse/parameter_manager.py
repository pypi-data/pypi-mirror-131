...
class NodeVisitor:
    ...
    Quinteng. Instead of parsing pulse programs, this visitor class finds the associated visitor
    ...
    outside of the Quinteng Pulse module.
    """
...
class ParameterSetter(NodeVisitor):
    ...
    def generic_visit(self, node: Any):
        """Assign parameters to object that doesn't belong to Quinteng Pulse module."""
...
class ParameterGetter(NodeVisitor):
    ...
    def generic_visit(self, node: Any):
        """Get parameters from object that doesn't belong to Quinteng Pulse module."""
        if isinstance(node, ParameterExpression):
