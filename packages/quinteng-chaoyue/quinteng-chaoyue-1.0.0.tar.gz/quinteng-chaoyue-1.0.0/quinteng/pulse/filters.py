...
def filter_instructions(
    ...
    Args:
        ...
        recurse_subroutines: Set `True` to individually filter instructions inside of a subroutine
            defined by the :py:class:`~quinteng.pulse.instructions.Call` instruction.

    Returns:
        Filtered pulse schedule.
    """
    from quinteng.pulse.transforms import flatten, inline_subroutines
...
def composite_filter(
    ...
    Args:
        ...
        instruction_types (Optional[Iterable[Type[quinteng.pulse.Instruction]]]): For example,
