...
from quinteng.pulse.exceptions import UnassignedDurationError
...
from quinteng.pulse.schedule import Schedule, ScheduleBlock, ScheduleComponent
...
def align_measures(
    ...
    def get_max_calibration_duration(inst_map, cal_gate):
        ...
        # TODO (quinteng-chaoyue #5472): fix behavior of this.
