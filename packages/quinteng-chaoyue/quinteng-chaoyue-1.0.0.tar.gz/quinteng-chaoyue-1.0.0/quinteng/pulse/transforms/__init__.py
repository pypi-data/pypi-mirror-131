...
r"""
=================================================
Pulse Transforms (:mod:`quinteng.pulse.transforms`)
=================================================
...
from quinteng.pulse.transforms.alignments import (
    AlignEquispaced,
    AlignFunc,
    AlignLeft,
    AlignRight,
...
from quinteng.pulse.transforms.canonicalization import (
    add_implicit_acquires,
    align_measures,
    block_to_schedule,
    compress_pulses,
...
from quinteng.pulse.transforms.dag import block_to_dag
