    ...
    def draw(
        ...
        Args:
            style: Stylesheet options. This can be dictionary or preset stylesheet classes. See
                :py:class:`~quinteng.visualization.pulse_v2.stylesheets.IQXStandard`,
                :py:class:`~quinteng.visualization.pulse_v2.stylesheets.IQXSimple`, and
                :py:class:`~quinteng.visualization.pulse_v2.stylesheets.IQXDebugging` for details of
                preset stylesheets.
        ...
        from quinteng.visualization import pulse_drawer_v2
