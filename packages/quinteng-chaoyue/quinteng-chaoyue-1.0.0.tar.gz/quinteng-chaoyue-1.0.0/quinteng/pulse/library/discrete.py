...
def constant(duration: int, amp: complex, name: Optional[str] = None) -> Waveform:
    r"""Generates constant-sampled :class:`~quinteng.pulse.library.Waveform`.
...
def zero(duration: int, name: Optional[str] = None) -> Waveform:
    """Generates zero-sampled :class:`~quinteng.pulse.library.Waveform`.
...
def square(
    ...
    r"""Generates square wave :class:`~quinteng.pulse.library.Waveform`.
...
def sawtooth(
    ...
    r"""Generates sawtooth wave :class:`~quinteng.pulse.library.Waveform`.
    ...
    Example:
        .. jupyter-execute::
            ...
            from quinteng.pulse.library import sawtooth
            import numpy as np
...
def triangle(
    ...
    r"""Generates triangle wave :class:`~quinteng.pulse.library.Waveform`.
    ...
    Example:
        .. jupyter-execute::
            ...
            import matplotlib.pyplot as plt
            from quinteng.pulse.library import triangle
            import numpy as np
...
def cos(
    ...
    r"""Generates cosine wave :class:`~quinteng.pulse.library.Waveform`.
...
def sin(
    ...
    r"""Generates sine wave :class:`~quinteng.pulse.library.Waveform`.
...
def gaussian(
    ...
    r"""Generates unnormalized gaussian :class:`~quinteng.pulse.library.Waveform`.
...
def gaussian_deriv(
    ...
    r"""Generates unnormalized gaussian derivative :class:`~quinteng.pulse.library.Waveform`.
...
def sech(
    ...
    r"""Generates unnormalized sech :class:`~quinteng.pulse.library.Waveform`.
...
def sech_deriv(duration: int, amp: complex, sigma: float, name: str = None) -> Waveform:
    r"""Generates unnormalized sech derivative :class:`~quinteng.pulse.library.Waveform`.
...
def gaussian_square(
    ...
    r"""Generates gaussian square :class:`~quinteng.pulse.library.Waveform`.
...
def drag(
    ...
    r"""Generates Y-only correction DRAG :class:`~quinteng.pulse.library.Waveform` for standard nonlinear
    oscillator (SNO) [1].
