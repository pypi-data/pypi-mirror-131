...
class ShiftPhase(Instruction):
    ...
    same :py:class:`~quinteng.pulse.channels.Channel`. It is a relative increase in phase determined
    ...
    def channel(self) -> PulseChannel:
        """Return the :py:class:`~quinteng.pulse.channels.Channel` that this instruction is
        scheduled on.
        """
