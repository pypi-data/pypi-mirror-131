...
try:
    from quinteng.providers.ibmq.job.exceptions import IBMQJobApiError
...
class JobWatcherMagic(Magics):
    ...
    @line_magic
    def quinteng_job_watcher(self, line="", cell=None):
        """A Jupyter magic function to enable job watcher."""
        _JOB_WATCHER.stop_viewer()
        _JOB_WATCHER.start_viewer()

    @line_magic
    def quinteng_disable_job_watcher(self, line="", cell=None):
