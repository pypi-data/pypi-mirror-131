...
class VersionTable(Magics):
    ...
    @line_magic
    def quinteng_version_table(self, line="", cell=None):
        """
        Print an HTML-formatted table with version numbers for Quinteng and its
        ...
        html += "<table>"
        html += "<tr><th>Quinteng Software</th><th>Version</th></tr>"

        packages = []
        qver = quinteng.__quinteng_version__
