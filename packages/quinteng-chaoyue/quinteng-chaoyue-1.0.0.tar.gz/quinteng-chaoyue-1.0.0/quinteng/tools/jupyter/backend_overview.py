...
from quinteng.visualization.gate_map import plot_gate_map
...
class BackendOverview(Magics):
    ...
    def quinteng_backend_overview(self, line=""):
        """A Jupyter magic function to monitor backends."""
        args = magic_arguments.parse_argstring(self.quinteng_backend_overview, line)
