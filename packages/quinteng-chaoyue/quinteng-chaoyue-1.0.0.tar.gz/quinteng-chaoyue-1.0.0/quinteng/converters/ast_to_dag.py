...
from quinteng.circuit.library.standard_gates.x import CCXGate
from quinteng.circuit.library.standard_gates.swap import CSwapGate
from quinteng.circuit.library.standard_gates.x import CXGate
from quinteng.circuit.library.standard_gates.y import CYGate
from quinteng.circuit.library.standard_gates.z import CZGate
from quinteng.circuit.library.standard_gates.swap import SwapGate
from quinteng.circuit.library.standard_gates.h import HGate
from quinteng.circuit.library.standard_gates.i import IGate
from quinteng.circuit.library.standard_gates.s import SGate
from quinteng.circuit.library.standard_gates.s import SdgGate
from quinteng.circuit.library.standard_gates.sx import SXGate
from quinteng.circuit.library.standard_gates.sx import SXdgGate
from quinteng.circuit.library.standard_gates.t import TGate
from quinteng.circuit.library.standard_gates.t import TdgGate
...
from quinteng.circuit.library.standard_gates.u2 import U2Gate
from quinteng.circuit.library.standard_gates.u3 import U3Gate
...
from quinteng.circuit.library.standard_gates.rx import RXGate
from quinteng.circuit.library.standard_gates.ry import RYGate
from quinteng.circuit.library.standard_gates.rz import RZGate
from quinteng.circuit.library.standard_gates.rxx import RXXGate
from quinteng.circuit.library.standard_gates.rzz import RZZGate
from quinteng.circuit.library.standard_gates.p import CPhaseGate
from quinteng.circuit.library.standard_gates.u import CUGate
from quinteng.circuit.library.standard_gates.u1 import CU1Gate
from quinteng.circuit.library.standard_gates.u3 import CU3Gate
from quinteng.circuit.library.standard_gates.h import CHGate
from quinteng.circuit.library.standard_gates.rx import CRXGate
from quinteng.circuit.library.standard_gates.ry import CRYGate
from quinteng.circuit.library.standard_gates.rz import CRZGate
from quinteng.circuit.library.standard_gates.sx import CSXGate
...
def ast_to_dag(ast):
    ...
    Raises:
        QuintengError: if the AST is malformed.

    Example:
        .. jupyter-execute::

            from quinteng.converters import ast_to_dag
            from quinteng import qasm, QuantumCircuit, ClassicalRegister, QuantumRegister
            from quinteng.visualization import dag_drawer
            %matplotlib inline
...
class AstInterpreter:
    ...
    def _process_node(self, node):
        ...
        if node.type == "program":
            ...
            raise QuintengError("internal error: _process_node on id")

        elif node.type == "int":
            raise QuintengError("internal error: _process_node on int")

        elif node.type == "real":
            raise QuintengError("internal error: _process_node on real")

        elif node.type == "indexed_id":
            raise QuintengError("internal error: _process_node on indexed_id")
            ...
            raise QuintengError("internal error: _process_node on binop")

        elif node.type == "prefix":
            raise QuintengError("internal error: _process_node on prefix")
            ...
            raise QuintengError("internal error: _process_node on external")
    ...
    def _gate_rules_to_quinteng_circuit(self, node, params):
    ...
    def _create_dag_op(self, name, params, qargs):
        ...
        Raises:
            QuintengError: if encountering a non-basis opaque gate
        """
    ...
    def _create_op(self, name, params):
        if name in self.standard_extension:
            ...
            if not self.gates[name]["opaque"]:
                ...
                op.definition = self._gate_rules_to_quinteng_circuit(self.gates[name], params=params)
        else:
            raise QuintengError("unknown operation for ast node name %s" % name)
        return op
