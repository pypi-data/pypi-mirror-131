...
from quinteng.scheduler.methods import as_soon_as_possible, as_late_as_possible
...
def schedule_circuit(
    ...
    Raises:
        QuintengError: If method isn't recognized.
    """
    methods = {
    ...
    try:
        ...
        raise QuintengError(f"Scheduling method {method} isn't recognized.") from ex
