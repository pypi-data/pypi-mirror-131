...
from quinteng.pulse import instructions as pulse_inst
from quinteng.pulse.channels import AcquireChannel, MemorySlot, DriveChannel
...
def lower_gates(circuit: QuantumCircuit, schedule_config: ScheduleConfig) -> List[CircuitPulseDef]:
    ...
    Raises:
        QuintengError: If circuit uses a command that isn't defined in config.inst_map.
    """
    from quinteng.pulse.transforms.base_transforms import target_qobj_transform
