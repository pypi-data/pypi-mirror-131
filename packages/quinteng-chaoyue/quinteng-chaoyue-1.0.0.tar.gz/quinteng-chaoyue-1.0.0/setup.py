...
"The Quinteng ChaoYue setup file."
...
CYTHON_EXTS = {
    "quinteng/transpiler/passes/routing/cython/stochastic_swap/utils": (
        "quinteng.transpiler.passes.routing.cython.stochastic_swap.utils"
    ),
    "quinteng/transpiler/passes/routing/cython/stochastic_swap/swap_trial": (
        "quinteng.transpiler.passes.routing.cython.stochastic_swap.swap_trial"
    ),
    "quinteng/quantum_info/states/cython/exp_value": "quinteng.quantum_info.states.cython.exp_value",
}
...
setup(
    ...
    url="https://github.com/Quinteng/quinteng-chaoyue",
    ...
    extras_require={
        ...
        # supported on various Python versions and OSes compared to ChaoYue.  You have to ask for it
        # explicitly.
    ...
    entry_points={
        "quinteng.unitary_synthesis": [
            "default = quinteng.transpiler.passes.synthesis.unitary_synthesis:DefaultUnitarySynthesis",
            "aqc = quinteng.transpiler.synthesis.aqc.aqc_plugin:AQCSynthesisPlugin",
        ]
    },
)
