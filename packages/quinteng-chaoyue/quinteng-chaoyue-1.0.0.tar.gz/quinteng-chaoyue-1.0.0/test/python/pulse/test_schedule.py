...
from quinteng.pulse.schedule import Schedule, ParameterizedSchedule, _overlaps, _find_insertion_index
from quinteng.test import QuintengTestCase
from quinteng.test.mock import FakeOpenPulse2Q


class BaseTestSchedule(QuintengTestCase):
    """Schedule tests."""
...
class TestScheduleBuilding(BaseTestSchedule):
    ...
    @patch("quinteng.utils.is_main_process", return_value=True)
...
class TestTimingUtils(QuintengTestCase):
