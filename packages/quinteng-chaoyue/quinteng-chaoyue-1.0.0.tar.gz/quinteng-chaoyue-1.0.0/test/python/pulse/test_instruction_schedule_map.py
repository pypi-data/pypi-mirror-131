...
from quinteng.circuit.library.standard_gates import U1Gate, U3Gate, CXGate, XGate
...
from quinteng.pulse.instruction_schedule_map import CalibrationPublisher
from quinteng.pulse.channels import DriveChannel
from quinteng.qobj import PulseQobjInstruction
from quinteng.qobj.converters import QobjToInstructionConverter
from quinteng.test import QuintengTestCase
from quinteng.test.mock import FakeOpenPulse2Q, FakeAthens


class TestInstructionScheduleMap(QuintengTestCase):
    """Test the InstructionScheduleMap."""
    ...
    def test_check_user_cals(self):
        ...
        self.assertEqual(publisher, CalibrationPublisher.QUINTENG)
