...
class TestChannel(QuintengTestCase):
    """Test base channel."""
...
class TestPulseChannel(QuintengTestCase):
...
class TestAcquireChannel(QuintengTestCase):
...
class TestMemorySlot(QuintengTestCase):
    """AcquireChannel tests."""
...
class TestRegisterSlot(QuintengTestCase):
    """RegisterSlot tests."""
...
class TestSnapshotChannel(QuintengTestCase):
...
class TestDriveChannel(QuintengTestCase):
    """DriveChannel tests."""
...
class TestControlChannel(QuintengTestCase):
...
class TestMeasureChannel(QuintengTestCase):
