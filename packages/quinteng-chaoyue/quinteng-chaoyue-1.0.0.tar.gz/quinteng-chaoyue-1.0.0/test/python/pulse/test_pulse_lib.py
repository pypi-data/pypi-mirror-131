...
from quinteng.pulse import functional_pulse, PulseError
from quinteng.test import QuintengTestCase


class TestWaveform(QuintengTestCase):
    """Waveform tests."""
...
class TestParametricPulses(QuintengTestCase):
    ...
    def test_constant_samples(self):
        ...
        with patch("quinteng.pulse.library.parametric_pulses.Pulse.limit_amplitude", new=False):
            const = quinteng.pulse.library.parametric_pulses.Constant(duration=150, amp=0.1 + 0.4j)
...
class TestFunctionalPulse(QuintengTestCase):
    """Waveform tests."""
