...
from quinteng.transpiler import PassManager, TranspilerError
from quinteng.transpiler.runningpassmanager import (
    DoWhileController,
...
class SchedulerTestCase(QuintengTestCase):
...
class TestLogPasses(QuintengTestCase):
