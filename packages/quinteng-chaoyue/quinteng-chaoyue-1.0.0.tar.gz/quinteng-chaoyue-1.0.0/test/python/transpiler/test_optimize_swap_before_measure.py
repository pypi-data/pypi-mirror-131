...
from quinteng.transpiler.passes import OptimizeSwapBeforeMeasure, DAGFixedPoint
from quinteng.converters import circuit_to_dag
from quinteng.test import QuintengTestCase


class TestOptimizeSwapBeforeMeasure(QuintengTestCase):
...
class TestOptimizeSwapBeforeMeasureFixedPoint(QuintengTestCase):
