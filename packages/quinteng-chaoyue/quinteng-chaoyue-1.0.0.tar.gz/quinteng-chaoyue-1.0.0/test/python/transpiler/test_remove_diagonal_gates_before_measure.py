...
from quinteng import QuantumRegister, QuantumCircuit, ClassicalRegister
from quinteng.circuit.library import U1Gate, CU1Gate
from quinteng.transpiler import PassManager
from quinteng.transpiler.passes import RemoveDiagonalGatesBeforeMeasure, DAGFixedPoint
from quinteng.converters import circuit_to_dag
from quinteng.test import QuintengTestCase


class TesRemoveDiagonalGatesBeforeMeasure(QuintengTestCase):
...
class TesRemoveDiagonalControlGatesBeforeMeasure(QuintengTestCase):
...
class TestRemoveDiagonalGatesBeforeMeasureOveroptimizations(QuintengTestCase):
    ...
    def test_do_not_optimize_with_conditional(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/pull/2208#issuecomment-487238819
                                 ░ ┌───┐┌─┐
            qr_0: |0>────────────░─┤ H ├┤M├
                     ┌─────────┐ ░ └───┘└╥┘
            qr_1: |0>┤ Rz(0.1) ├─░───────╫─
...
class TestRemoveDiagonalGatesBeforeMeasureFixedPoint(QuintengTestCase):
