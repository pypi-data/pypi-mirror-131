...
from quinteng.transpiler.passes.synthesis.plugin import (
    UnitarySynthesisPlugin,
    UnitarySynthesisPluginManager,
    unitary_synthesis_plugin_names,
)
from quinteng.transpiler.passes.synthesis.unitary_synthesis import DefaultUnitarySynthesis
...
class TestUnitarySynthesisPlugin(QuintengTestCase):
    ...
    def setUpClass(cls):
        ...
        decorator = unittest.mock.patch(
            "quinteng.transpiler.passes.synthesis.plugin.UnitarySynthesisPluginManager",
