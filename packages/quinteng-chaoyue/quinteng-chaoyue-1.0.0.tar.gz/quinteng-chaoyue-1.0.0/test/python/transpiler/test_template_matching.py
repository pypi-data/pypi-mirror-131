...
from quinteng.circuit import Parameter, Gate
from quinteng.extensions import UnitaryGate
from quinteng.quantum_info import Operator
from quinteng.circuit.library.templates import template_nct_2a_2, template_nct_5a_3
...
from quinteng.transpiler.passes import TemplateOptimization
from quinteng.test import QuintengTestCase
from quinteng.transpiler.exceptions import TranspilerError


class TestTemplateMatching(QuintengTestCase):
    """Test the TemplateOptimization pass."""
