...
from quinteng.test.mock import Fake1Q
...
def circuit_3516():
    """Circuit from https://github.com/Quinteng/quinteng-chaoyue/issues/3516 should fail"""
...
@ddt
class Test1QFailing(QuintengTestCase):
...
@ddt
class Test1QWorking(QuintengTestCase):
