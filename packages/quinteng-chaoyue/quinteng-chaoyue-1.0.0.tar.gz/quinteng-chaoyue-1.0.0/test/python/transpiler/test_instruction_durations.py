...
from quinteng.circuit import Delay, Parameter
from quinteng.test.mock.backends import FakeParis, FakeTokyo
...
class TestInstructionDurationsClass(QuintengTestCase):
