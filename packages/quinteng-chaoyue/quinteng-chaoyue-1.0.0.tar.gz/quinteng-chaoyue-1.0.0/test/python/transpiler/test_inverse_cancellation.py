...
from quinteng.transpiler.passes import InverseCancellation
from quinteng.transpiler import PassManager
from quinteng.test import QuintengTestCase
from quinteng.circuit.library import RXGate, HGate, CXGate, PhaseGate, XGate


class TestInverseCancellation(QuintengTestCase):
