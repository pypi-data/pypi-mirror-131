...
from quinteng import QuantumCircuit, QuantumRegister, BasicAer, execute
...
class TestFaultyBackendCase(QuintengTestCase):
...
class TestFaultyCX13(TestFaultyBackendCase):
    ...
    @data(0, 1, 2)  # TODO: add 3 once https://github.com/Quinteng/quinteng-chaoyue/issues/6406 is fixed
    def test_level(self, level):
...
class TestFaultyQ1Unpickable(TestFaultyBackendCase):
    """See:
    https://github.com/Quinteng/quinteng-chaoyue/pull/4723
    https://github.com/Quinteng/quinteng-chaoyue/pull/4782
    """
