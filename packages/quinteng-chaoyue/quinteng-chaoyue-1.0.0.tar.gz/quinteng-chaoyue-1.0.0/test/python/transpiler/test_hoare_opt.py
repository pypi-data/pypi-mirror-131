...
from quinteng.transpiler.passes.optimization.hoare_opt import HAS_Z3
from quinteng.transpiler.passes import HoareOptimizer
...
from quinteng.circuit.library import XGate, RZGate, CSwapGate, SwapGate
...
class TestHoareOptimizer(QuintengTestCase):
    """Test the HoareOptimizer pass"""
