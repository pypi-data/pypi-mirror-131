...
from quinteng.transpiler.passes import ASAPSchedule, ALAPSchedule
from quinteng.transpiler.passmanager import PassManager


@ddt
class TestSchedulingPass(QuintengTestCase):
    ...
    def test_classically_controlled_gate_after_measure(self, schedule_pass):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/7006
