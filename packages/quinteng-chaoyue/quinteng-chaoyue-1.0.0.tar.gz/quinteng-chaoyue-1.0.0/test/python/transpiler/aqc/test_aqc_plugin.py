...
from quinteng.algorithms.optimizers import SLSQP
...
from quinteng.transpiler.synthesis.aqc.aqc_plugin import AQCSynthesisPlugin


class TestAQCSynthesisPlugin(QuintengTestCase):
