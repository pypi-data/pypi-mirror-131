...
from quinteng.circuit import QuantumRegister, QuantumCircuit, ClassicalRegister
from quinteng.circuit.library.standard_gates import UGate, SXGate, PhaseGate
from quinteng.circuit.library.standard_gates import U3Gate, U2Gate, U1Gate
from quinteng.circuit.random import random_circuit
...
@ddt.ddt
class TestOptimize1qGatesDecomposition(QuintengTestCase):
    ...
    def test_in_the_back(self, basis):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/2004.
