...
from quinteng.transpiler.passes.basis import UnrollCustomDefinitions

from quinteng.test import QuintengTestCase
from quinteng.circuit import EquivalenceLibrary, Gate
...
class TestUnrollCustomDefinitions(QuintengTestCase):
    ...
    def test_raise_for_opaque_not_in_eq_lib(self):
        ...
        dag = circuit_to_dag(qc)
        with self.assertRaisesRegex(QuintengError, "Cannot unroll"):
