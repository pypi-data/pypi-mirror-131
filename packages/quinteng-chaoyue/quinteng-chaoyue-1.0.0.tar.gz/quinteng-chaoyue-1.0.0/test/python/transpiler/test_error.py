...
class TestErrorPass(QuintengTestCase):
    ...
    def test_logger(self):
        ...
        pass_.property_set["variable"] = "message"
        with self.assertLogs("quinteng.transpiler.passes.utils.error", level="INFO") as log:
            pass_.run(None)
        self.assertEqual(log.output, ["INFO:quinteng.transpiler.passes.utils.error:a message"])
