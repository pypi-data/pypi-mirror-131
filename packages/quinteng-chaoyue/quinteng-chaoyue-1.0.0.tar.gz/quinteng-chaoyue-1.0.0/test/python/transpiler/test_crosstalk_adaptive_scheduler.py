...
from quinteng.transpiler.passes.optimization import CrosstalkAdaptiveSchedule
from quinteng.transpiler.passes.optimization.crosstalk_adaptive_schedule import HAS_Z3
...
from quinteng.providers.models.backendproperties import Nduv, Gate
...
class TestCrosstalk(QuintengTestCase):
    """
