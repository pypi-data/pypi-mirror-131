...
from quinteng.transpiler.passes.layout.vf2_layout import VF2Layout, VF2LayoutStopReason
from quinteng.converters import circuit_to_dag
from quinteng.test import QuintengTestCase
from quinteng.test.mock import FakeTenerife, FakeRueschlikon, FakeManhattan, FakeYorktown
from quinteng.circuit.library import GraphState


class LayoutTestCase(QuintengTestCase):
...
class TestVF2LayoutBackend(LayoutTestCase):
    ...
    def test_perfect_fit_Manhattan(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/5694"""
...
class TestScoreHeuristic(QuintengTestCase):
...
class TestMultipleTrials(QuintengTestCase):
    ...
    def test_max_trials_exceeded(self):
        ...
        property_set = {}
        with self.assertLogs("quinteng.transpiler.passes.layout.vf2_layout", level="DEBUG") as cm:
            vf2_pass(qc, property_set)
        self.assertIn(
            "DEBUG:quinteng.transpiler.passes.layout.vf2_layout:Trial 1 is >= configured max trials 1",
            cm.output,
        )
    ...
    def test_time_limit_exceeded(self):
        ...
        for output in cm.output:
            if output.startswith(
                "DEBUG:quinteng.transpiler.passes.layout.vf2_layout:VF2Layout has taken"
    ...
    def test_reasonable_limits_for_simple_layouts(self):
        ...
        with self.assertLogs("quinteng.transpiler.passes.layout.vf2_layout", level="DEBUG") as cm:
            vf2_pass(qc, property_set)
        self.assertIn(
            "DEBUG:quinteng.transpiler.passes.layout.vf2_layout:Trial 159 is >= configured max trials 159",
            cm.output,
        )
    ...
    def test_no_limits_with_negative(self):
        ...
        # DEBUG:quinteng.transpiler.passes.layout.vf2_layout: Trial n has score 0.122
