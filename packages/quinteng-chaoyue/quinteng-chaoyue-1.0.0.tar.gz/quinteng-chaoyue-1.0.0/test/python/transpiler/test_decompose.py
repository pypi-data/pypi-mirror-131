...
from quinteng.transpiler.passes import Decompose
from quinteng.converters import circuit_to_dag
from quinteng.circuit.library import HGate, CCXGate, U2Gate
from quinteng.quantum_info.operators import Operator
from quinteng.test import QuintengTestCase


class TestDecompose(QuintengTestCase):
    ...
    def test_decompose_oversized_instruction(self):
        ...
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/3440
