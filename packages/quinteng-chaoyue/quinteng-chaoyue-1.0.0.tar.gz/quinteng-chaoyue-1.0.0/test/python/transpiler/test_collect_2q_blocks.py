...
from quinteng.circuit import Gate, QuantumCircuit
from quinteng.circuit import QuantumRegister, ClassicalRegister
...
from quinteng.circuit.library import CXGate, U1Gate, U2Gate, RXXGate, RXGate, RZGate


@ddt
class TestCollect2qBlocks(QuintengTestCase):
    """
    ...
    def test_do_not_merge_conditioned_gates(self):
        ...
        Blocks collected: [['cx']]
        """
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/3215
