...
from quinteng.circuit import Gate, Parameter, EquivalenceLibrary
...
from quinteng.converters import circuit_to_dag, dag_to_circuit, circuit_to_instruction
from quinteng.exceptions import QuintengError
from quinteng.quantum_info import Operator
from quinteng.transpiler.target import Target, InstructionProperties
from quinteng.transpiler.exceptions import TranspilerError
from quinteng.transpiler.passes.basis import BasisTranslator, UnrollCustomDefinitions


from quinteng.circuit.library.standard_gates.equivalence_library import (
...
class TestBasisTranslator(QuintengTestCase):
    """Test the BasisTranslator pass."""
...
class TestUnrollerCompatability(QuintengTestCase):
...
class TestBasisExamples(QuintengTestCase):
...
class TestBasisTranslatorWithTarget(QuintengTestCase):
