...
from quinteng import ClassicalRegister, QuantumRegister, QuantumCircuit
...
from quinteng.test.mock import FakeTenerife, FakeRueschlikon


class TestTrivialLayout(QuintengTestCase):
