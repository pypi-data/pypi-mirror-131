...
from quinteng.circuit import Barrier
...
from quinteng.test.mock.backends import FakeLima
from quinteng.transpiler import CouplingMap, Layout, PassManager
from quinteng.transpiler.exceptions import TranspilerError
from quinteng.transpiler.passes import BIPMapping
from quinteng.transpiler.passes import CheckMap, Collect2qBlocks, ConsolidateBlocks, UnitarySynthesis
...
class TestBIPMapping(QuintengTestCase):
