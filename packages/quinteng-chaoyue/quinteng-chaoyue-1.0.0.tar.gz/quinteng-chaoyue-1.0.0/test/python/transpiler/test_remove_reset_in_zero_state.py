...
from quinteng.transpiler.passes import RemoveResetInZeroState, DAGFixedPoint
from quinteng.converters import circuit_to_dag
from quinteng.test import QuintengTestCase


class TestRemoveResetInZeroState(QuintengTestCase):
...
class TestRemoveResetInZeroStateFixedPoint(QuintengTestCase):
