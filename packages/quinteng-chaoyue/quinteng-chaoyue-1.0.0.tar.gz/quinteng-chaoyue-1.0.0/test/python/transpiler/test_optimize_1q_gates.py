...
from quinteng.transpiler.passes import Optimize1qGates, Unroller
...
from quinteng.circuit.library import U1Gate, U2Gate, U3Gate, UGate, PhaseGate
from quinteng.transpiler.exceptions import TranspilerError


class TestOptimize1qGates(QuintengTestCase):
    ...
    def test_dont_optimize_id(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/2373
        """
    ...
    def test_optimize_1q_gates_collapse_identity_equivalent(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/159
        """
...
class TestOptimize1qGatesParamReduction(QuintengTestCase):
...
class TestOptimize1qGatesBasis(QuintengTestCase):
