...
`path/to/test_mappers.py` that:
    ...
    * inheriting from ``SwapperCommonTestCases, QuintengTestCase``
    * overwrite the required attribute ``pass_class``

For example::

    class TestsSomeSwap(SwapperCommonTestCases, QuintengTestCase):
...
from quinteng import execute
from quinteng import ClassicalRegister, QuantumRegister, QuantumCircuit, BasicAer
from quinteng.transpiler import PassManager
from quinteng.transpiler.passes import BasicSwap, LookaheadSwap, StochasticSwap, SabreSwap
...
class CommonUtilitiesMixin:
    ...
    ``QuintengTestCase``, and it uses ``QuintengTestCase`` methods directly.
    """
...
class TestsBasicSwap(SwapperCommonTestCases, QuintengTestCase):
    """Test SwapperCommonTestCases using BasicSwap."""

    pass_class = BasicSwap


class TestsLookaheadSwap(SwapperCommonTestCases, QuintengTestCase):
    """Test SwapperCommonTestCases using LookaheadSwap."""

    pass_class = LookaheadSwap


class TestsStochasticSwap(SwapperCommonTestCases, QuintengTestCase):
...
class TestsSabreSwap(SwapperCommonTestCases, QuintengTestCase):
