...
from quinteng import QuantumCircuit, ClassicalRegister, QuantumRegister
from quinteng.circuit import Qubit
from quinteng.compiler import transpile, assemble
from quinteng.transpiler import CouplingMap, Layout
from quinteng.circuit.library import U2Gate, U3Gate
from quinteng.test import QuintengTestCase
from quinteng.test.mock import (
    FakeTenerife,
    FakeMelbourne,
    FakeJohannesburg,
    FakeRueschlikon,
...
from quinteng.circuit.library import GraphState
from quinteng.quantum_info import random_unitary
...
def circuit_2532():
    """See https://github.com/Quinteng/quinteng-chaoyue/issues/2532"""
...
@ddt
class TestPresetPassManager(QuintengTestCase):
    ...
    def test_layout_3239(self, level=3):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/3239
        """
    ...
    def test_alignment_constraints_called_with_by_default(self, level):
        ...
        circuit.h(q[0])
        circuit.cz(q[0], q[1])
        with unittest.mock.patch("quinteng.transpiler.passes.TimeUnitConversion.run") as mock:
    ...
    def test_alignment_constraints_called_with_delay_in_circuit(self, level):
        ...
        with unittest.mock.patch(
            "quinteng.transpiler.passes.TimeUnitConversion.run", return_value=circuit_to_dag(circuit)
        ) as mock:
            transpile(circuit, backend=FakeJohannesburg(), optimization_level=level)
...
@ddt
class TestTranspileLevels(QuintengTestCase):
...
@ddt
class TestPassesInspection(QuintengTestCase):
    ...
    def test_5409(self, level):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/5409
        """
        qr = QuantumRegister(5, "q")
        qc = QuantumCircuit(qr)
        qc.cx(qr[2], qr[4])
    ...
    def test_initial_layout_fully_connected_cm(self, level):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/5345
        """
        qr = QuantumRegister(2, "q")
        qc = QuantumCircuit(qr)
        qc.h(qr[0])
...
@ddt
class TestInitialLayouts(QuintengTestCase):
    ...
    def test_layout_1711(self, level):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/1711
        """
    ...
    def test_layout_2503(self, level):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/2503
        """
        # build a circuit which works as-is on the coupling map, using the initial layout
        qr = QuantumRegister(3, "q")
        cr = ClassicalRegister(2)
...
class TestFinalLayouts(QuintengTestCase):
    ...
    def test_all_levels_use_trivial_if_perfect(self, level):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/5694 for more
        details
        """
        backend = FakeTokyo()
    ...
    def test_trivial_layout(self, level):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/pull/3657#pullrequestreview-342012465
        """
...
@ddt
class TestTranspileLevelsSwap(QuintengTestCase):
    """Test if swap is in the basis, do not unroll
    See https://github.com/Quinteng/quinteng-chaoyue/pull/3963
...
@ddt
class TestOptimizationWithCondition(QuintengTestCase):
