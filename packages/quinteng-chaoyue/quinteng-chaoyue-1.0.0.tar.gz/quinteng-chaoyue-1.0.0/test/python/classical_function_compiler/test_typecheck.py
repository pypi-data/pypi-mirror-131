...
from quinteng.circuit.classicalfunction import ClassicalFunctionCompilerTypeError
from quinteng.circuit.classicalfunction import classical_function as compile_classical_function

from . import examples, bad_examples


class TestTypeCheck(QuintengTestCase):
...
class TestTypeCheckFail(QuintengTestCase):
