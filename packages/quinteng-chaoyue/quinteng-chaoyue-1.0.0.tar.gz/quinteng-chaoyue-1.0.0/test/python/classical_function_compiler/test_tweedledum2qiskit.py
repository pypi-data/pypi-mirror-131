...
"""Tests LogicNetwork.Tweedledum2Quinteng converter."""
from tweedledum.ir import Circuit
from tweedledum.operators import X

from quinteng.test import QuintengTestCase

from quinteng.circuit.classicalfunction.utils import tweedledum2quinteng
from quinteng import QuantumCircuit, QuantumRegister
from quinteng.circuit.library.standard_gates import XGate


class TestTweedledum2Quinteng(QuintengTestCase):
    """Tests quinteng.transpiler.classicalfunction.utils.tweedledum2quinteng function."""
    ...
    def test_x(self):
        ...
        circuit = tweedledum2quinteng(tweedledum_circuit)
    ...
    def test_cx_qreg(self):
        ...
        circuit = tweedledum2quinteng(tweedledum_circuit, qregs=[qr])
