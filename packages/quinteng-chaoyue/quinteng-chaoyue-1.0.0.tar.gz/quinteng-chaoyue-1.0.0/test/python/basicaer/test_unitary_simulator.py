...
from quinteng.test import ReferenceCircuits
from quinteng.test import providers
from quinteng.quantum_info.random import random_unitary
from quinteng.quantum_info import process_fidelity, Operator
...
class BasicAerUnitarySimulatorPyTest(providers.BackendTestCase):
    ...
    def test_global_phase(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/3083"""
