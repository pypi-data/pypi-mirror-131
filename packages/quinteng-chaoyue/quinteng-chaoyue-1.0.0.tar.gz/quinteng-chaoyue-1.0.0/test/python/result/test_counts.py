...
from quinteng.result import counts
from quinteng import exceptions
from quinteng.result import utils
...
class TestCounts(unittest.TestCase):
    ...
    def test_most_frequent_duplicate(self):
        ...
        counts_obj = counts.Counts(raw_counts)
        self.assertRaises(exceptions.QuintengError, counts_obj.most_frequent)
    ...
    def test_qudit_counts_raises_with_format(self):
        ...
        self.assertRaises(exceptions.QuintengError, counts.Counts, raw_counts, creg_sizes=[["c0", 4]])
    ...
    def test_qudit_counts_hex_outcome(self):
        ...
        counts_obj = counts.Counts(raw_counts)
        self.assertRaises(exceptions.QuintengError, counts_obj.hex_outcomes)
    ...
    def test_qudit_counts_int_outcome(self):
        ...
        counts_obj = counts.Counts(raw_counts)
        self.assertRaises(exceptions.QuintengError, counts_obj.int_outcomes)
