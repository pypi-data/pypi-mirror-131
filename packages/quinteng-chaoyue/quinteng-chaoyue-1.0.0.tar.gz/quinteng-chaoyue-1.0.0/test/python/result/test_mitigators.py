...
from quinteng.result import CorrelatedReadoutMitigator
from quinteng.result import LocalReadoutMitigator
from quinteng.result.mitigation.utils import (
    z_diagonal,
...
from quinteng.test.mock import FakeYorktown
from quinteng.quantum_info.operators.predicates import matrix_equal


@ddt
class TestReadoutMitigation(QuintengTestCase):
    ...
    def test_error_handling(self):
        ...
        for bad_matrix in [bad_matrix_A, bad_matrix_B]:
            with self.assertRaises(QuintengError) as cm:
