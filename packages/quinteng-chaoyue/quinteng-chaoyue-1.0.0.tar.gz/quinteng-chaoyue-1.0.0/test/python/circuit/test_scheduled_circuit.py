...
from quinteng import QuantumCircuit, QuintengError
from quinteng import transpile, assemble, BasicAer
from quinteng.circuit import Parameter
from quinteng.test.mock.backends import FakeParis
...
@ddt
class TestScheduledCircuit(QuintengTestCase):
    """Test scheduled circuit (quantum circuit with duration)."""
    ...
    def test_transpile_circuit_with_custom_instruction(self):
        """See: https://github.com/Quinteng/quinteng-chaoyue/issues/5154"""
    ...
    def test_per_qubit_durations(self):
        """See: https://github.com/Quinteng/quinteng-chaoyue/issues/5109"""
        qc = QuantumCircuit(3)
        qc.h(0)
        qc.delay(500, 1)
        qc.cx(0, 1)
    ...
    def test_duration_on_same_instruction_instance(self, scheduling_method):
        """See: https://github.com/Quinteng/quinteng-chaoyue/issues/5771"""
    ...
    def test_transpile_and_assemble_delay_circuit_for_simulator(self):
        """See: https://github.com/Quinteng/quinteng-chaoyue/issues/5962"""
        qc = QuantumCircuit(1)
        qc.delay(100, 0, "ns")
