...
import quinteng
import quinteng.circuit.library as circlib
from quinteng import BasicAer, ClassicalRegister, QuantumCircuit, QuantumRegister
from quinteng.circuit import Gate, Instruction, Parameter, ParameterExpression, ParameterVector
from quinteng.circuit.parametertable import ParameterView
from quinteng.circuit.exceptions import CircuitError
from quinteng.compiler import assemble, transpile
from quinteng.execute_function import execute
from quinteng import pulse
from quinteng.quantum_info import Operator
from quinteng.test import QuintengTestCase
from quinteng.test.mock import FakeOurense
from quinteng.tools import parallel_map
                ...
                for parameter in parameters:
                    if (instr, param_index) not in table[parameter]:
                        raise CircuitError(
                            ...
                            "param_index: {}".format(instr, param_index)
                        )


@ddt
class TestParameters(QuintengTestCase):
    ...
    def test_binding_parameterized_circuits_built_in_multiproc(self):
        ...
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/2429
    ...
    def test_transpiling_multiple_parameterized_circuits(self):
        ...
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/2864
    ...
    def test_repeated_gates_to_dag_and_back(self):
        ...
        from quinteng.converters import circuit_to_dag, dag_to_circuit
    ...
    def test_decompose_propagates_bound_parameters(self, target_type, parameter_type):
        ...
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/2482
        theta = Parameter("th")
        qc = QuantumCircuit(1)
        qc.rx(theta, 0)
    ...
    def test_to_instruction_after_inverse(self):
        ...
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/4235
        qc = QuantumCircuit(1)
        theta = Parameter("theta")
        qc.rz(theta, 0)
...
@ddt
class TestParameterExpressions(QuintengTestCase):
    ...
    def test_standard_cu3(self):
        ...
        from quinteng.circuit.library import CU3Gate

        x = Parameter("x")
        y = Parameter("y")
        z = Parameter("z")
        qc = quinteng.QuantumCircuit(2)
    ...
    def test_binding_across_broadcast_instruction(self):
        ...
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/3008
        ...
        for theta_val, bound_circ in zip(theta_range, circuits):
            rz_gates = [inst for inst, qargs, cargs in bound_circ.data if isinstance(inst, RZGate)]
...
class TestParameterEquality(QuintengTestCase):
...
class TestParameterView(QuintengTestCase):
