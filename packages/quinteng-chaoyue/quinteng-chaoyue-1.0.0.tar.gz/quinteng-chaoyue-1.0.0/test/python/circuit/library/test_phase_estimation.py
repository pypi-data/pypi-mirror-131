...
from quinteng.circuit.library import PhaseEstimation, QFT
from quinteng.quantum_info import Statevector


class TestPhaseEstimation(QuintengTestCase):
    ...
    def assertPhaseEstimationIsCorrect(
        ...
        # TODO use Statevector for simulation once Quinteng/quinteng-chaoyue#4681 is resolved
