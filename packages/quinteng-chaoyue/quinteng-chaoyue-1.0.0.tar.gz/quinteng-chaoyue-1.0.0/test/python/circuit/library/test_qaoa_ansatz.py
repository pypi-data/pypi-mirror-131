...
from quinteng.circuit.library import HGate, RXGate, YGate, RYGate, RZGate
from quinteng.circuit.library.n_local.qaoa_ansatz import QAOAAnsatz
from quinteng.opflow import I, Y, Z, PauliSumOp
from quinteng.test import QuintengTestCase


@ddt
class TestQAOAAnsatz(QuintengTestCase):
    """Test QAOAAnsatz."""
