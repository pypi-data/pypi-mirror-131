...
from quinteng.circuit.library import UniformDistribution, NormalDistribution, LogNormalDistribution
from quinteng.quantum_info import Statevector


class TestUniformDistribution(QuintengTestCase):
...
@ddt
class TestNormalDistribution(QuintengTestCase):
...
@ddt
class TestLogNormalDistribution(QuintengTestCase):
    """Test the normal distribution circuit."""
