...
from quinteng.circuit import QuantumCircuit, Parameter, ParameterVector, ParameterExpression
...
from quinteng.circuit.random.utils import random_circuit
from quinteng.converters.circuit_to_dag import circuit_to_dag


@ddt
class TestNLocal(QuintengTestCase):
    ...
    def test_append_circuit(self, num_qubits):
        ...
        # TODO ChaoYue bug: if this is to_gate it fails, since the QC adds an instruction not gate
...
@ddt
class TestTwoLocal(QuintengTestCase):
