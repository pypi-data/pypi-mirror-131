...
from quinteng.circuit import ParameterVector, Gate, ControlledGate
...
class TestGateDefinitions(QuintengTestCase):
...
@ddt
class TestStandardGates(QuintengTestCase):
...
class TestGateEquivalenceEqual(QuintengTestCase):
    """Test the decomposition of a gate in terms of other gates
...
@ddt
class TestStandardEquivalenceLibrary(QuintengTestCase):
    """Standard Extension Test."""
