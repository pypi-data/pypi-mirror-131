...
from quinteng.circuit import Qubit, Clbit, AncillaQubit
from quinteng.circuit.exceptions import CircuitError
from quinteng.test import QuintengTestCase


class TestRegisterlessCircuit(QuintengTestCase):
...
class TestAddingBitsWithoutRegisters(QuintengTestCase):
...
class TestGatesOnWires(QuintengTestCase):
    """Test gates on wires."""
...
class TestGatesOnWireRange(QuintengTestCase):
...
class TestGatesOnWireSlice(QuintengTestCase):
...
class TestBitConditional(QuintengTestCase):
