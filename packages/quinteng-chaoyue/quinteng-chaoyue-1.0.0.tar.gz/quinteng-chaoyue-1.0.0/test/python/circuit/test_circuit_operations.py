...
"""Test Quinteng's QuantumCircuit class."""
...
from quinteng.circuit import Gate, Instruction, Parameter
from quinteng.circuit.classicalregister import Clbit
from quinteng.circuit.exceptions import CircuitError
from quinteng.circuit.quantumcircuit import BitLocations
from quinteng.test import QuintengTestCase
from quinteng.circuit.library.standard_gates import SGate
from quinteng.quantum_info import Operator


@ddt
class TestCircuitOperations(QuintengTestCase):
    ...
    def test_remove_final_measurements_copy_with_parameters(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/6108 for more details
        """
        qr = QuantumRegister(2)
        cr = ClassicalRegister(2, "meas")
    ...
    def test_remove_final_measurements_5802(self):
        ...
        https://github.com/Quinteng/quinteng-chaoyue/issues/5802.
        """
        qr = QuantumRegister(2)
        cr = ClassicalRegister(2)
    ...
    def test_remove_final_measurements_7089(self):
        ...
        https://github.com/Quinteng/quinteng-chaoyue/issues/7089.
        """
...
class TestCircuitPrivateOperations(QuintengTestCase):
