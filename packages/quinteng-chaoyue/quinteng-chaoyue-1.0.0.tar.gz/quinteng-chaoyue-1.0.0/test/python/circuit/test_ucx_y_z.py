...
from quinteng import BasicAer, QuantumCircuit, QuantumRegister, execute
...
class TestUCRXYZ(QuintengTestCase):
    """Quinteng tests for UCRXGate, UCRYGate and UCRZGate rotations gates."""
