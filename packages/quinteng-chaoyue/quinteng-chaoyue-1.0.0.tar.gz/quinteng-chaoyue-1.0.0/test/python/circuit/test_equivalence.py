...
"""Test Quinteng's EquivalenceLibrary class."""

import numpy as np

from quinteng.test import QuintengTestCase

from quinteng.circuit import QuantumCircuit, Parameter, Gate
from quinteng.circuit.library import U2Gate
from quinteng.circuit.exceptions import CircuitError
from quinteng.converters import circuit_to_instruction, circuit_to_gate

from quinteng.circuit import EquivalenceLibrary
...
class TestEquivalenceLibraryWithoutBase(QuintengTestCase):
...
class TestEquivalenceLibraryWithBase(QuintengTestCase):
...
class TestEquivalenceLibraryWithParameters(QuintengTestCase):
...
class TestSessionEquivalenceLibrary(QuintengTestCase):
