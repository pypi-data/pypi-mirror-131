...
from quinteng.circuit import Clbit, ClassicalRegister, Instruction, Parameter, QuantumCircuit
from quinteng.circuit.library import XGate, RXGate
...
@ddt
class TestCreatingControlFlowOperations(QuintengTestCase):
...
@ddt
class TestAddingControlFlowOperations(QuintengTestCase):
