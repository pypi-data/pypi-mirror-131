...
class TestCircuitRegisters(QuintengTestCase):
    ...
    def test_numpy_array_of_registers(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/1898
        """
    ...
    def test_4_args_custom_gate_trivial_expansion(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/2508"""
        qr = QuantumRegister(4)
