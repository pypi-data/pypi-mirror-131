...
from quinteng.circuit import Gate, Parameter
...
class LoadFromQasmTest(QuintengTestCase):
    ...
    def test_loading_all_qelib1_gates(self):
        """Test setting up a circuit with all gates defined in quinteng/qasm/libs/qelib1.inc."""
        from quinteng.circuit.library import U1Gate, U2Gate, U3Gate, CU1Gate, CU3Gate, UGate
    ...
    def test_fail_qasm_file(self):
        ...
        If all is correct we should get a QuintengError
        """
        self.assertRaises(QuintengError, QuantumCircuit.from_qasm_file, "")
    ...
    def test_fail_qasm_string(self):
        ...
        If all is correct we should get a QuintengError
        """
        self.assertRaises(QuintengError, QuantumCircuit.from_qasm_str, "")
    ...
    def test_opaque_gate(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/1566.
        """
    ...
    def test_from_qasm_str_custom_gate2(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/pull/3393#issuecomment-551307250
        """
        qasm_string = """OPENQASM 2.0;
                         include "qelib1.inc";
                         gate swap2 a,b {
    ...
    def test_from_qasm_str_custom_gate6(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/pull/3393#issuecomment-591668924
        """
        qasm_string = """OPENQASM 2.0;
                         include "qelib1.inc";
    ...
    def test_from_qasm_str_custom_gate7(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/pull/3393#issuecomment-592208951
        """
        qasm_string = """OPENQASM 2.0;
                         include "qelib1.inc";
                         gate my_gate(phi,lambda) q
    ...
    def test_from_qasm_str_nested_custom_gate(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/pull/3393#issuecomment-592261942
        """
        qasm_string = """OPENQASM 2.0;
                         include "qelib1.inc";
    ...
    def test_from_qasm_str_delay(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/6510
        """
        qasm_string = """OPENQASM 2.0;
                         include "qelib1.inc";
