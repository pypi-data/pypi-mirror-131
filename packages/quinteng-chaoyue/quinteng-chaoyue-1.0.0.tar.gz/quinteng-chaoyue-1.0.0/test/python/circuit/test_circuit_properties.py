...
"""Test Quinteng's inverse gate operation."""

import unittest
import numpy as np
from quinteng import QuantumRegister, ClassicalRegister, QuantumCircuit, pulse
from quinteng.circuit import Clbit
from quinteng.circuit.library import RXGate, RYGate
from quinteng.test import QuintengTestCase
from quinteng.circuit.exceptions import CircuitError
from quinteng.extensions.simulator import Snapshot
...
class TestCircuitProperties(QuintengTestCase):
    ...
    def test_circuit_nonlocal_gates_no_instruction(self):
        ...
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/4500
        n = 3
        qc = QuantumCircuit(n)
        qc.h(range(n))
    ...
    def test_metadata_copy_does_not_share_state(self):
        ...
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/6057
