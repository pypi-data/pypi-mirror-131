...
"""Test Quinteng's power instruction operation."""
...
@ddt
class TestPowerIntCX(QuintengTestCase):
...
class TestGateSqrt(QuintengTestCase):
...
@ddt
class TestGateFloat(QuintengTestCase):
...
@ddt
class TestPowerInvariant(QuintengTestCase):
