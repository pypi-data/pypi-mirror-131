...
from quinteng.extensions.quantum_initializer.squ import SingleQubitUnitary
...
class TestSingleQubitUnitary(QuintengTestCase):
    """Quinteng ZYZ-decomposition tests."""
