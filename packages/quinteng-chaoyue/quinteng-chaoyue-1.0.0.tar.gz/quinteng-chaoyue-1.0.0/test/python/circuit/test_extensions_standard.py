...
from quinteng import ClassicalRegister, QuantumCircuit, QuantumRegister, execute
...
class TestStandard1Q(QuintengTestCase):
    ...
    def test_conditional_barrier_invalid(self):
        ...
        self.assertRaises(QuintengError, barrier.c_if, self.cr, 0)
...
class TestStandard2Q(QuintengTestCase):
...
class TestStandard3Q(QuintengTestCase):
...
class TestStandardMethods(QuintengTestCase):
    """Standard Extension Test."""

    def test_to_matrix(self):
        """test gates implementing to_matrix generate matrix which matches definition."""
        from quinteng.circuit.library.pauli_evolution import PauliEvolutionGate
        ...
        for gate_class in gate_class_list:
            ...
            except (CircuitError, QuintengError, AttributeError):
    ...
    def test_to_matrix_op(self):
        ...
        from quinteng.circuit.library.standard_gates.ms import MSGate
        from quinteng.circuit.library.generalized_gates.pauli import PauliGate
        from quinteng.circuit.library.pauli_evolution import PauliEvolutionGate
        from quinteng.circuit.classicalfunction.boolean_expression import BooleanExpression
