...
from quinteng import ClassicalRegister
from quinteng import transpile
from quinteng import execute, assemble, BasicAer
from quinteng.quantum_info import state_fidelity, Statevector, Operator
from quinteng.exceptions import QuintengError
from quinteng.test import QuintengTestCase


class TestInitialize(QuintengTestCase):
    """Quinteng Initialize tests."""
    ...
    def test_statevector(self):
        ...
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/5134 (footnote)
    ...
    def test_malformed_amplitudes(self):
        ...
        qr = QuantumRegister(2, "qr")
        qc = QuantumCircuit(qr)
        self.assertRaises(QuintengError, qc.initialize, desired_vector, [qr[0], qr[1]])
    ...
    def test_wrong_vector_size(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/2372"""
        ...
        self.assertRaises(QuintengError, qc.initialize, random_state, qr[0:2])
    ...
    def test_global_phase_random(self):
        ...
        from quinteng.quantum_info.random import random_statevector
...
class TestInstructionParam(QuintengTestCase):
    """Test conversion of numpy type parameters."""

    def test_diag(self):
        """Verify diagonal gate converts numpy.complex to complex."""
        # ref: https://github.com/Quinteng/quinteng-aer/issues/696
    ...
    def test_init(self):
        ...
        # ref: https://github.com/Quinteng/quinteng-chaoyue/issues/4151
        qc = QuantumCircuit(1)
        vec = np.array([0, 0 + 1j])
        qc.initialize(vec, 0)
