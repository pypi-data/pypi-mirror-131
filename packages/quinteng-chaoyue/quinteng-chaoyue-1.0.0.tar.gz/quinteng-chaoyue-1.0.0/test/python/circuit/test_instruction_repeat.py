...
"""Test Quinteng's repeat instruction operation."""
...
from quinteng.circuit.library import SGate, U3Gate, CXGate
from quinteng.circuit import Instruction, Measure, Gate
from quinteng.transpiler.passes import Unroller
from quinteng.circuit.exceptions import CircuitError


class TestRepeatInt1Q(QuintengTestCase):
...
class TestRepeatInt2Q(QuintengTestCase):
...
class TestRepeatIntMeasure(QuintengTestCase):
...
class TestRepeatUnroller(QuintengTestCase):
...
class TestRepeatErrors(QuintengTestCase):
