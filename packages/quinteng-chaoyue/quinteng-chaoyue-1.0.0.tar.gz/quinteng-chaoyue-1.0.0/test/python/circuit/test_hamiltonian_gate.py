...
import quinteng
from quinteng.extensions.hamiltonian_gate import HamiltonianGate, UnitaryGate
...
class TestHamiltonianGate(QuintengTestCase):
...
class TestHamiltonianCircuit(QuintengTestCase):
