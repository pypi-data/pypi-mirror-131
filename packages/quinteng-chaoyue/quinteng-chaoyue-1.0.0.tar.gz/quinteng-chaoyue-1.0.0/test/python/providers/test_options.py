...
class TestOptions(QuintengTestCase):
...
class TestOptionsSimpleNamespaceBackwardCompatibility(QuintengTestCase):
    """Tests that SimpleNamespace-like functionality that quinteng-experiments relies on for Options
    still works."""
