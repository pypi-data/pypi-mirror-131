...
from quinteng import BasicAer
from quinteng import QuantumRegister, ClassicalRegister, QuantumCircuit, pulse
from quinteng.circuit import Parameter, Gate, Qubit, Clbit
from quinteng.compiler import transpile
from quinteng.dagcircuit import DAGOutNode
from quinteng.converters import circuit_to_dag
from quinteng.circuit.library import CXGate, U3Gate, U2Gate, U1Gate, RXGate, RYGate, RZGate
from quinteng.test import QuintengTestCase
from quinteng.test.mock import FakeMelbourne, FakeRueschlikon, FakeAlmaden
...
from quinteng.transpiler.passes import BarrierBeforeFinalMeasurements, GateDirection
from quinteng.quantum_info import Operator, random_unitary
from quinteng.transpiler.passmanager_config import PassManagerConfig
from quinteng.transpiler.preset_passmanagers import level_0_pass_manager


@ddt
class TestTranspile(QuintengTestCase):
    ...
    def test_pass_manager_none(self):
        ...
        It should perform the default quinteng flow:
    ...
    def test_already_mapped_1(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/342
        """
    ...
    def test_already_mapped_via_layout(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/2036
        """
        basis_gates = ["u1", "u2", "u3", "cx", "id"]
        coupling_map = [
            [0, 1],
    ...
    def test_transpile_singleton(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/5260"""
        backend = BasicAer.get_backend("qasm_simulator")
    ...
    def test_optimize_to_nothing(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/2035"""
        qr = QuantumRegister(2)
    ...
    def test_transpile_calibrated_custom_gate_on_diff_qubit(self):
        """Test if the custom, non calibrated gate raises QuintengError."""
        custom_180 = Gate("mycustom", 1, [3.14])
    ...
    def test_multiqubit_gates_calibrations(self, opt_level):
        ...
        Adapted from issue description in https://github.com/Quinteng/quinteng-chaoyue/issues/6572
        """
...
class TestLogTranspile(QuintengTestCase):
...
class TestTranspileCustomPM(QuintengTestCase):
    ...
    def test_custom_multiple_circuits(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/3925
        """
        qc = QuantumCircuit(2)
        qc.h(0)
        qc.cx(0, 1)
