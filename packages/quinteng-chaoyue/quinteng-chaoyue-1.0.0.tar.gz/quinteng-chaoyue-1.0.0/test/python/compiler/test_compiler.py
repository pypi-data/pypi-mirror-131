...
from quinteng.circuit.library import U1Gate, U2Gate
from quinteng.compiler import transpile, assemble
from quinteng.test import QuintengTestCase
from quinteng.test.mock import FakeRueschlikon, FakeTenerife
from quinteng.qobj import QasmQobj


class TestCompiler(QuintengTestCase):
    """Quinteng Compiler Tests."""
    ...
    def test_no_conflict_backend_passmanager(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/5037
        """
        backend = BasicAer.get_backend("qasm_simulator")
        qc = QuantumCircuit(2)
    ...
    def test_mapper_overoptimization(self):
        ...
        https://github.com/Quinteng/quinteng-chaoyue/issues/81
        """
        # -X-.-----
        # -Y-+-S-.-
        # -Z-.-T-+-
    ...
    def test_math_domain_error(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/111
        """
        qr = QuantumRegister(4)
        cr = ClassicalRegister(4)
        circ = QuantumCircuit(qr, cr)
    ...
    def test_yzy_zyz_cases(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/607
        """
