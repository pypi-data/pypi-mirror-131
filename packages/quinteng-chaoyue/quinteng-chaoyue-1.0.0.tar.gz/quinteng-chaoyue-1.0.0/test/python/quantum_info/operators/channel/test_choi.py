...
from quinteng.quantum_info.operators.channel import Choi
...
class TestChoi(ChannelTestCase):
    ...
    def test_init(self):
        ...
        self.assertRaises(QuintengError, Choi, mat8, input_dims=[4], output_dims=[4])
    ...
    def test_circuit_init_except(self):
        ...
        self.assertRaises(QuintengError, Choi, circuit)
    ...
    def test_compose_except(self):
        ...
        self.assertRaises(QuintengError, Choi(np.eye(4)).compose, Choi(np.eye(8)))
        self.assertRaises(QuintengError, Choi(np.eye(4)).compose, 2)
