...
from quinteng.quantum_info import (
    Choi,
    Clifford,
    Operator,
    PauliList,
...
from quinteng.quantum_info.random import (
    random_clifford,
    random_hermitian,
    random_pauli_list,
    random_pauli_table,
...
@ddt
class TestRandomUnitary(QuintengTestCase):
...
@ddt
class TestRandomHermitian(QuintengTestCase):
...
@ddt
class TestRandomQuantumChannel(QuintengTestCase):
...
@ddt
class TestRandomClifford(QuintengTestCase):
...
@ddt
class TestPauliTwoDesignTable(QuintengTestCase):
...
@ddt
class TestRandomPauliList(QuintengTestCase):
    """Testing random_pauli_table function."""
...
@ddt
class TestRandomStabilizerTable(QuintengTestCase):
