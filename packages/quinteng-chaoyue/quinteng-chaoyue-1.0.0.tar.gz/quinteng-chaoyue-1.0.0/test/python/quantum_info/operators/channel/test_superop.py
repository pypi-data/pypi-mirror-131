...
from quinteng import QuintengError, QuantumCircuit
...
class TestSuperOp(ChannelTestCase):
    ...
    def test_init(self):
        ...
        self.assertRaises(QuintengError, SuperOp, mat, input_dims=[4], output_dims=[4])
    ...
    def test_circuit_init_except(self):
        ...
        self.assertRaises(QuintengError, SuperOp, circuit)
    ...
    def test_compose_except(self):
        ...
        self.assertRaises(QuintengError, SuperOp(np.eye(4)).compose, SuperOp(np.eye(16)))
        self.assertRaises(QuintengError, SuperOp(np.eye(4)).compose, 2)
