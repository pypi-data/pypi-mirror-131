...
from quinteng.quantum_info import Kraus
...
class TestKraus(ChannelTestCase):
    ...
    def test_init(self):
        ...
        self.assertRaises(QuintengError, Kraus, kraus, input_dims=4, output_dims=4)
    ...
    def test_circuit_init_except(self):
        ...
        self.assertRaises(QuintengError, Kraus, circuit)
    ...
    def test_compose_except(self):
        ...
        self.assertRaises(QuintengError, Kraus(np.eye(2)).compose, Kraus(np.eye(4)))
        self.assertRaises(QuintengError, Kraus(np.eye(2)).compose, 2)
