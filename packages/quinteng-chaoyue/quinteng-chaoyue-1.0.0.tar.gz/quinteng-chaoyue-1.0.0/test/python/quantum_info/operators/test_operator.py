...
from quinteng.circuit.library import HGate, CHGate, CXGate, QFT
...
class OperatorTestCase(QuintengTestCase):
...
class TestOperator(OperatorTestCase):
    ...
    def test_init_array_except(self):
        ...
        self.assertRaises(QuintengError, Operator, mat, input_dims=[4, 2])
        self.assertRaises(QuintengError, Operator, mat, input_dims=[2, 4])
        self.assertRaises(QuintengError, Operator, mat, input_dims=5)
    ...
    def test_circuit_init_except(self):
        ...
        self.assertRaises(QuintengError, Operator, circuit)
    ...
    def test_reshape_raise(self):
        ...
        self.assertRaises(QuintengError, op.reshape, num_qubits=2)
    ...
    def test_compose_except(self):
        ...
        self.assertRaises(QuintengError, Operator(np.eye(2)).compose, Operator(np.eye(3)))
        self.assertRaises(QuintengError, Operator(np.eye(2)).compose, 2)
    ...
    def test_power_except(self):
        ...
        self.assertRaises(QuintengError, op.power, 0.5)
    ...
    def test_add_except(self):
        ...
        self.assertRaises(QuintengError, op1._add, op2)
    ...
    def test_multiply_except(self):
        ...
        self.assertRaises(QuintengError, op._multiply, "s")
        self.assertRaises(QuintengError, op.__rmul__, "s")
        self.assertRaises(QuintengError, op._multiply, op)
        self.assertRaises(QuintengError, op.__rmul__, op)
