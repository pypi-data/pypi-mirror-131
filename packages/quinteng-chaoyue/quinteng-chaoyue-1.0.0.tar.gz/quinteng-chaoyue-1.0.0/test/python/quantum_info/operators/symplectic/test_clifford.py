...
from quinteng.circuit import Gate, QuantumRegister, QuantumCircuit
...
from quinteng.quantum_info.operators import Clifford, Operator
from quinteng.quantum_info.operators.symplectic.clifford_circuits import _append_circuit
from quinteng.quantum_info.synthesis.clifford_decompose import (
    decompose_clifford_ag,
    decompose_clifford_bm,
    decompose_clifford_greedy,
)
from quinteng.quantum_info import random_clifford
...
@ddt
class TestCliffordGates(QuintengTestCase):
...
@ddt
class TestCliffordSynthesis(QuintengTestCase):
...
@ddt
class TestCliffordDecomposition(QuintengTestCase):
...
@ddt
class TestCliffordOperators(QuintengTestCase):
    ...
    def test_from_dict(self):
        ...
        with self.subTest(msg="test raises not unitary"):
            ...
            self.assertRaises(QuintengError, Clifford.from_dict, cliff_dict)
