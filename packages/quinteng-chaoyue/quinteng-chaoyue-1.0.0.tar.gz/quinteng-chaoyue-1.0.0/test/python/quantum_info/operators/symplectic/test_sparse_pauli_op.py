...
class TestSparsePauliOpInit(QuintengTestCase):
...
class TestSparsePauliOpConversions(QuintengTestCase):
...
class TestSparsePauliOpIteration(QuintengTestCase):
...
@ddt
class TestSparsePauliOpMethods(QuintengTestCase):
