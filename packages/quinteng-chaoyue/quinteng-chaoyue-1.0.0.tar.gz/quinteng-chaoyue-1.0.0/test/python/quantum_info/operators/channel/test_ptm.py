...
from quinteng.quantum_info.operators.channel import PTM
...
class TestPTM(ChannelTestCase):
    ...
    def test_init(self):
        ...
        self.assertRaises(QuintengError, PTM, mat16, input_dims=2, output_dims=4)

        # Non multi-qubit dimensions should raise exception
        self.assertRaises(QuintengError, PTM, np.eye(6) / 2, input_dims=3, output_dims=2)
    ...
    def test_circuit_init_except(self):
        ...
        self.assertRaises(QuintengError, PTM, circuit)
    ...
    def test_compose_except(self):
        ...
        self.assertRaises(QuintengError, PTM(np.eye(4)).compose, PTM(np.eye(16)))
        self.assertRaises(QuintengError, PTM(np.eye(4)).compose, 2)
