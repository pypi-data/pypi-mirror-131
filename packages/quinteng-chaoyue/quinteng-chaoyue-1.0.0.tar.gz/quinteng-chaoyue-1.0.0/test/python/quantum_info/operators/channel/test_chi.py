...
from quinteng.quantum_info.operators.channel import Chi
...
class TestChi(ChannelTestCase):
    ...
    def test_init(self):
        ...
        self.assertRaises(QuintengError, Chi, mat16, input_dims=2, output_dims=4)

        # Non multi-qubit dimensions should raise exception
        self.assertRaises(QuintengError, Chi, np.eye(6) / 2, input_dims=3, output_dims=2)
    ...
    def test_circuit_init_except(self):
        ...
        self.assertRaises(QuintengError, Chi, circuit)
    ...
    def test_compose_except(self):
        ...
        self.assertRaises(QuintengError, Chi(np.eye(4)).compose, Chi(np.eye(16)))
        self.assertRaises(QuintengError, Chi(np.eye(4)).compose, 2)
    ...
    def test_add_except(self):
        ...
        chan1 = Chi(self.chiI)
        chan2 = Chi(np.eye(16))
        self.assertRaises(QuintengError, chan1._add, chan2)
        self.assertRaises(QuintengError, chan1._add, 5)
    ...
    def test_multiply_except(self):
        ...
        chan = Chi(self.chiI)
        self.assertRaises(QuintengError, chan._multiply, "s")
        self.assertRaises(QuintengError, chan.__rmul__, "s")
        self.assertRaises(QuintengError, chan._multiply, chan)
        self.assertRaises(QuintengError, chan.__rmul__, chan)
