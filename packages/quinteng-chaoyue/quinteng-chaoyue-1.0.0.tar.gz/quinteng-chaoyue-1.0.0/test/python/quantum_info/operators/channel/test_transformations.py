...
from quinteng.quantum_info.states import DensityMatrix
...
from quinteng.quantum_info.operators.channel.choi import Choi
...
from quinteng.quantum_info.operators.channel.stinespring import Stinespring
from quinteng.quantum_info.operators.channel.ptm import PTM
from quinteng.quantum_info.operators.channel.chi import Chi
...
class TestTransformations(ChannelTestCase):
    ...
    def test_superop_to_operator(self):
        ...
        for mat, sop in zip(self.unitary_mat, self.unitary_sop):
            ...
            self.assertTrue(matrix_equal(chan2.data, chan1.data, ignore_phase=True))
        self.assertRaises(QuintengError, Operator, SuperOp(self.depol_sop(0.5)))
    ...
    def test_kraus_to_operator(self):
        ...
        for mat in self.unitary_mat:
            ...
            self.assertTrue(matrix_equal(chan2.data, chan1.data, ignore_phase=True))
        self.assertRaises(QuintengError, Operator, Kraus(self.depol_kraus(0.5)))
    ...
    def test_stinespring_to_operator(self):
        ...
        for mat in self.unitary_mat:
            ...
            self.assertTrue(matrix_equal(chan2.data, chan1.data, ignore_phase=True))
        self.assertRaises(QuintengError, Operator, Stinespring(self.depol_stine(0.5)))
    ...
    def test_chi_to_operator(self):
        ...
        for mat, chi in zip(self.unitary_mat, self.unitary_chi):
            ...
            self.assertTrue(matrix_equal(chan2.data, chan1.data, ignore_phase=True))
        self.assertRaises(QuintengError, Operator, Chi(self.depol_chi(0.5)))
    ...
    def test_ptm_to_operator(self):
        ...
        for mat, ptm in zip(self.unitary_mat, self.unitary_ptm):
            ...
            self.assertTrue(matrix_equal(chan2.data, chan1.data, ignore_phase=True))
        self.assertRaises(QuintengError, Operator, PTM(self.depol_ptm(0.5)))
