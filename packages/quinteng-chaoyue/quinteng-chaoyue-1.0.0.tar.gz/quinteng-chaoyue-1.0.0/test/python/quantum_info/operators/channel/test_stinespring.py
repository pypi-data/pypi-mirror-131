...
from quinteng.quantum_info import Stinespring
...
class TestStinespring(ChannelTestCase):
    ...
    def test_init(self):
        ...
        self.assertRaises(QuintengError, Stinespring, stine_l, input_dims=4, output_dims=4)
    ...
    def test_circuit_init_except(self):
        ...
        self.assertRaises(QuintengError, Stinespring, circuit)
    ...
    def test_compose_except(self):
        ...
        self.assertRaises(QuintengError, Stinespring(np.eye(2)).compose, Stinespring(np.eye(4)))
        self.assertRaises(QuintengError, Stinespring(np.eye(2)).compose, 2)
