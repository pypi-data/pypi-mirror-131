...
from quinteng.quantum_info import Operator, Choi
from quinteng.quantum_info import process_fidelity
from quinteng.quantum_info import average_gate_fidelity
from quinteng.quantum_info import gate_error
from quinteng.quantum_info import diamond_norm
from quinteng.test import QuintengTestCase


@ddt
class TestOperatorMeasures(QuintengTestCase):
    """Tests for Operator measures"""
    ...
    def test_noncp_process_fidelity(self):
        ...
        self.assertLogs("quinteng.quantum_info.operators.measures", level="WARNING")
