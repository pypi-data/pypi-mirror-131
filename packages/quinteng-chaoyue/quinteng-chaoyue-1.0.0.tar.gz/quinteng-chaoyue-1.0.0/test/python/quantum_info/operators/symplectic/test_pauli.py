...
from quinteng.quantum_info.random import random_clifford, random_pauli
from quinteng.quantum_info.operators import Pauli, Operator
from quinteng.quantum_info.operators.symplectic.pauli import _split_pauli_label, _phase_from_label
...
@ddt
class TestPauliConversions(QuintengTestCase):
...
@ddt
class TestPauliProperties(QuintengTestCase):
...
@ddt
class TestPauli(QuintengTestCase):
    """Tests for Pauli operator class."""
    ...
    def test_multiply_except(self):
        ...
        op = Pauli("XYZ")
        self.assertRaises(QuintengError, op._multiply, 2)
