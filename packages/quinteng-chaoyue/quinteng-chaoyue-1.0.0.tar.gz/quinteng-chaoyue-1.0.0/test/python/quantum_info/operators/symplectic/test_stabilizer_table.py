...
from quinteng.quantum_info.operators.symplectic import StabilizerTable
from quinteng.quantum_info.operators.symplectic import PauliTable
...
def stab_mat(label):
    ...
    for i in label:
        if i == "I":
            ...
            raise QuintengError(f"Invalid stabilizer string {i}")
    return mat


class TestStabilizerTableInit(QuintengTestCase):
    ...
    def test_array_init(self):
        ...
        with self.subTest(msg="bool array raises"):
            ...
            self.assertRaises(QuintengError, StabilizerTable, array)
...
class TestStabilizerTableProperties(QuintengTestCase):
...
class TestStabilizerTableLabels(QuintengTestCase):
...
class TestStabilizerTableMatrix(QuintengTestCase):
...
class TestStabilizerTableMethods(QuintengTestCase):
