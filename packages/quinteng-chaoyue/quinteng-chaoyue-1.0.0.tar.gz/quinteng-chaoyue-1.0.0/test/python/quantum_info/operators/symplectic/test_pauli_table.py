...
def pauli_mat(label):
    ...
    for i in label:
        if i == "I":
            ...
            raise QuintengError(f"Invalid Pauli string {i}")
    return mat


class TestPauliTableInit(QuintengTestCase):
    ...
    def test_array_init(self):
        ...
        with self.subTest(msg="bool array raises"):
            ...
            self.assertRaises(QuintengError, PauliTable, array)
...
class TestPauliTableProperties(QuintengTestCase):
...
class TestPauliTableLabels(QuintengTestCase):
...
class TestPauliTableMatrix(QuintengTestCase):
...
class TestPauliTableIteration(QuintengTestCase):
...
@ddt
class TestPauliTableOperator(QuintengTestCase):
...
class TestPauliTableMethods(QuintengTestCase):
