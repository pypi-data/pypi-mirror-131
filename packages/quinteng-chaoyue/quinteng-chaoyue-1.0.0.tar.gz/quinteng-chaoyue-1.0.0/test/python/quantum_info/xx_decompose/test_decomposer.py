...
"""
Tests for quinteng-chaoyue/quinteng/quantum_info/synthesis/xx_decompose/quinteng.py .
"""
...
from quinteng.quantum_info.synthesis.xx_decompose.decomposer import (
    XXDecomposer,
...
@ddt.ddt
class TestMonodromyQUINTeng(unittest.TestCase):
    """Check QUINTeng routines."""
    ...
    def test_check_embodiment(self):
        ...
        good_angle = np.pi / 2
        good_embodiment = quinteng.QuantumCircuit(2)
        good_embodiment.h(0)
        ...
        bad_angle = np.pi / 10
        bad_embodiment = quinteng.QuantumCircuit(2)

        # "self.assertDoesNotRaise"
        XXDecomposer(embodiments={good_angle: good_embodiment})

        self.assertRaises(
            quinteng.exceptions.QuintengError, XXDecomposer, embodiments={bad_angle: bad_embodiment}
        )
