...
from quinteng import execute, QuintengError
from quinteng.circuit import QuantumCircuit, QuantumRegister
from quinteng.converters import dag_to_circuit, circuit_to_dag
...
from quinteng.providers.basicaer import UnitarySimulatorPy
from quinteng.quantum_info.operators import Operator
from quinteng.quantum_info.random import random_unitary
from quinteng.quantum_info.synthesis.one_qubit_decompose import OneQubitEulerDecomposer
from quinteng.quantum_info.synthesis.two_qubit_decompose import (
...
from quinteng.quantum_info.synthesis.ion_decompose import cnot_rxx_decompose
...
class CheckDecompositions(QuintengTestCase):
    ...
    def assertDebugOnly(self):  # FIXME: when at python 3.10+ replace with assertNoLogs
        ...
        with self.assertLogs("quinteng.quantum_info.synthesis", "DEBUG") as ctx:
            yield
    ...
    def check_two_qubit_weyl_specialization(
        ...
        if expected_specialization is not TwoQubitWeylGeneral:
            with self.assertRaises(QuintengError) as exc:
...
class TestTwoQubitDecompose(CheckDecompositions):
    ...
    def test_seed_289(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/pull/3652"""
...
class TestDecomposeProductRaises(QuintengTestCase):
