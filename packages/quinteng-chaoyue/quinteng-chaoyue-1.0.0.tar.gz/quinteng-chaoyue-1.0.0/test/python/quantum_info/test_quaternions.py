...
from quinteng.quantum_info.synthesis.quaternion import Quaternion

from quinteng.test import QuintengTestCase


class TestQuaternions(QuintengTestCase):
    """Tests quinteng.quantum_info.operators.quaternion"""
