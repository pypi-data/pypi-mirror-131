...
from quinteng.quantum_info.states import DensityMatrix, Statevector
from quinteng.quantum_info import state_fidelity
from quinteng.quantum_info import purity
from quinteng.quantum_info import entropy
from quinteng.quantum_info import concurrence
from quinteng.quantum_info import entanglement_of_formation
from quinteng.quantum_info import mutual_information
from quinteng.quantum_info.states import shannon_entropy


class TestStateMeasures(QuintengTestCase):
    ...
    def test_state_fidelity_statevector(self):
        ...
        self.assertRaises(QuintengError, state_fidelity, psi1, psi2)
        self.assertRaises(QuintengError, state_fidelity, psi1, psi2, validate=True)
    ...
    def test_state_fidelity_density_matrix(self):
        ...
        self.assertRaises(QuintengError, state_fidelity, rho1, mix)
        self.assertRaises(QuintengError, state_fidelity, rho1, mix, validate=True)
    ...
    def test_purity_statevector(self):
        ...
        self.assertRaises(QuintengError, purity, psi)
        self.assertRaises(QuintengError, purity, psi, validate=True)
    ...
    def test_purity_density_matrix(self):
        ...
        rho = np.diag([1, 0, 0, 1])
        self.assertRaises(QuintengError, purity, rho)
        self.assertRaises(QuintengError, purity, rho, validate=True)
