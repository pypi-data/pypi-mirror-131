...
from quinteng.quantum_info.random import random_unitary, random_density_matrix, random_pauli
...
@ddt
class TestDensityMatrix(QuintengTestCase):
    ...
    def test_init_array_except(self):
        ...
        rho = self.rand_rho(4)
        self.assertRaises(QuintengError, DensityMatrix, rho, dims=[4, 2])
        self.assertRaises(QuintengError, DensityMatrix, rho, dims=[2, 4])
        self.assertRaises(QuintengError, DensityMatrix, rho, dims=5)
    ...
    def test_densitymatrix_to_statevector_mixed(self):
        ...
        rho = DensityMatrix(psi)
        self.assertRaises(QuintengError, rho.to_statevector)
