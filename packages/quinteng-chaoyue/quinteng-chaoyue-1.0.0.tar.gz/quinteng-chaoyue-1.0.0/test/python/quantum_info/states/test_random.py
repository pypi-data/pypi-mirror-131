...
from quinteng.quantum_info import Statevector, DensityMatrix
from quinteng.quantum_info.random import random_statevector
from quinteng.quantum_info.random import random_density_matrix


@ddt
class TestRandomStatevector(QuintengTestCase):
...
@ddt
class TestRandomDensityMatrix(QuintengTestCase):
