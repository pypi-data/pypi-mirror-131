...
from quinteng.circuit import QuantumRegister, ClassicalRegister, QuantumCircuit, Qubit, Clbit
...
from quinteng.converters import circuit_to_dagdependency
...
class TestDagNodeEdge(QuintengTestCase):
