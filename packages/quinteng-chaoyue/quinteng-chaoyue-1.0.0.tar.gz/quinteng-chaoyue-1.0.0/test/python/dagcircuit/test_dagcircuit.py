...
from quinteng.dagcircuit import DAGCircuit, DAGOpNode, DAGInNode, DAGOutNode
from quinteng.circuit import QuantumRegister
from quinteng.circuit import ClassicalRegister, Clbit
from quinteng.circuit import QuantumCircuit, Qubit
from quinteng.circuit import Measure
from quinteng.circuit import Reset
from quinteng.circuit import Delay
from quinteng.circuit import Gate, Instruction
...
from quinteng.dagcircuit.exceptions import DAGCircuitError
...
class TestDagRegisters(QuintengTestCase):
...
class TestDagWireRemoval(QuintengTestCase):
...
class TestDagApplyOperation(QuintengTestCase):
...
class TestDagNodeSelection(QuintengTestCase):
...
class TestDagLayers(QuintengTestCase):
...
class TestCircuitProperties(QuintengTestCase):
...
class TestCircuitSpecialCases(QuintengTestCase):
    ...
    def test_circuit_depth_with_repetition(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/1994
        """
...
class TestDagEquivalence(QuintengTestCase):
...
class TestDagSubstitute(QuintengTestCase):
...
@ddt
class TestDagSubstituteNode(QuintengTestCase):
...
class TestReplaceBlock(QuintengTestCase):
...
class TestDagProperties(QuintengTestCase):
...
class TestConditional(QuintengTestCase):
...
class TestDAGDeprecations(QuintengTestCase):
    """Test DAG deprecations"""

    def test_DAGNode_deprecations(self):
        """Test DAGNode deprecations."""
        from quinteng.dagcircuit import DAGNode
