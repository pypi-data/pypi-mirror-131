...
from quinteng.algorithms import Grover, AmplificationProblem
from quinteng.circuit.library import GroverOperator, PhaseOracle
from quinteng.quantum_info import Operator, Statevector


@ddt
class TestAmplificationProblem(QuintengAlgorithmsTestCase):
...
@ddt
class TestGrover(QuintengAlgorithmsTestCase):
