...
from quinteng.algorithms.optimizers import GradientDescent
from quinteng.circuit.library import PauliTwoDesign
from quinteng.opflow import I, Z, StateFn
from quinteng.test.decorators import slow_test


class TestGradientDescent(QuintengAlgorithmsTestCase):
    """Tests for the gradient descent optimizer."""
