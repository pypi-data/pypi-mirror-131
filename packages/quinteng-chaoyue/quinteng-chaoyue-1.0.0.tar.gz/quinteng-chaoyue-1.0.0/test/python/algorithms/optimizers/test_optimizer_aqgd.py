...
from quinteng.opflow import PauliSumOp
from quinteng.algorithms.optimizers import AQGD
from quinteng.algorithms import VQE, AlgorithmError
from quinteng.opflow.gradients import Gradient
from quinteng.test import slow_test


@unittest.skipUnless(Aer, "Aer is required to run these tests")
class TestOptimizerAQGD(QuintengAlgorithmsTestCase):
