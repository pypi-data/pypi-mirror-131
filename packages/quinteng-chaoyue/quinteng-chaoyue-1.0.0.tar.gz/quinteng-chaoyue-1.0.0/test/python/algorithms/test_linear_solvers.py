...
import unittest
from test.python.algorithms import QuintengAlgorithmsTestCase
from scipy.linalg import expm
import numpy as np
from ddt import ddt, idata, unpack
from quinteng import BasicAer, QuantumCircuit
from quinteng.algorithms.linear_solvers.hhl import HHL
from quinteng.algorithms.linear_solvers.matrices.tridiagonal_toeplitz import TridiagonalToeplitz
from quinteng.algorithms.linear_solvers.matrices.numpy_matrix import NumPyMatrix
from quinteng.algorithms.linear_solvers.observables.absolute_average import AbsoluteAverage
from quinteng.algorithms.linear_solvers.observables.matrix_functional import MatrixFunctional
from quinteng.circuit.library.arithmetic.exact_reciprocal import ExactReciprocal
from quinteng.quantum_info import Operator, partial_trace
from quinteng.opflow import I, Z, StateFn
from quinteng.utils import QuantumInstance
from quinteng import quantum_info


@ddt
class TestMatrices(QuintengAlgorithmsTestCase):
...
@ddt
class TestObservables(QuintengAlgorithmsTestCase):
...
@ddt
class TestReciprocal(QuintengAlgorithmsTestCase):
...
@ddt
class TestLinearSolver(QuintengAlgorithmsTestCase):
