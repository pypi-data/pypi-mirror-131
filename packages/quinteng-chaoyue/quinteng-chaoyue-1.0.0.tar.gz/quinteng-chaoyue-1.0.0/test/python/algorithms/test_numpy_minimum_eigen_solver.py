...
from quinteng.algorithms import NumPyMinimumEigensolver
from quinteng.opflow import PauliSumOp, X, Y, Z


@ddt
class TestNumPyMinimumEigensolver(QuintengAlgorithmsTestCase):
    """Test NumPy Minimum Eigensolver"""
