...
from quinteng import QuantumRegister, QuantumCircuit, BasicAer
from quinteng.circuit.library import QFT, GroverOperator
from quinteng.utils import QuantumInstance
from quinteng.algorithms import (
    AmplitudeEstimation,
...
@ddt
class TestBernoulli(QuintengAlgorithmsTestCase):
...
@ddt
class TestSineIntegral(QuintengAlgorithmsTestCase):
...
@ddt
class TestFasterAmplitudeEstimation(QuintengAlgorithmsTestCase):
