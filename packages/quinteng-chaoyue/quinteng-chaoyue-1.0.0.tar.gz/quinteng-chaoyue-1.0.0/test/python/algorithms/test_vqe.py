...
from quinteng.algorithms import VQE, AlgorithmError
from quinteng.algorithms.optimizers import (
    CG,
    COBYLA,
    L_BFGS_B,
    P_BFGS,
...
from quinteng.circuit.library import EfficientSU2, RealAmplitudes, TwoLocal
...
from quinteng.transpiler import PassManager, PassManagerConfig
from quinteng.transpiler.preset_passmanagers import level_1_pass_manager
from quinteng.utils import QuantumInstance, algorithm_globals, has_aer
...
@ddt
class TestVQE(QuintengAlgorithmsTestCase):
    """Test VQE"""
