...
from quinteng import Aer, ClassicalRegister
from quinteng.utils import QuantumInstance
from quinteng.algorithms import Shor
from quinteng.test import slow_test


@unittest.skipUnless(Aer, "quinteng-aer is required for these tests")
@ddt
class TestShor(QuintengAlgorithmsTestCase):
