...
from quinteng.algorithms import VQE, QAOA
from quinteng.opflow import I, X, Z, PauliSumOp
from quinteng.algorithms.optimizers import SPSA, COBYLA
from quinteng.circuit.library import EfficientSU2
from quinteng.utils.mitigation import CompleteMeasFitter, TensoredMeasFitter

try:
    from quinteng import Aer
    from quinteng.providers.aer import noise
...
@ddt
class TestMeasurementErrorMitigation(QuintengAlgorithmsTestCase):
    """Test measurement error mitigation."""

    @unittest.skipUnless(HAS_AER, "quinteng-aer is required for this test")
    ...
    def test_measurement_error_mitigation_with_diff_qubit_order(self, fitter_str):
        ...
        self.assertRaises(QuintengError, quantum_instance.execute, [qc1, qc3])
    ...
    @unittest.skipUnless(HAS_AER, "quinteng-aer is required for this test")
    @unittest.skipUnless(HAS_IGNIS, "quinteng-ignis is required to run this test")
    @data("CompleteMeasFitter", "TensoredMeasFitter")
