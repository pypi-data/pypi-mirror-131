...
from quinteng import QuantumRegister, ClassicalRegister, QuantumCircuit, schedule
from quinteng.circuit import Gate, Parameter
from quinteng.circuit.library import U1Gate, U2Gate, U3Gate
...
from quinteng.pulse import build, macros, play, InstructionScheduleMap

from quinteng.test.mock import FakeBackend, FakeOpenPulse2Q, FakeOpenPulse3Q
from quinteng.test import QuintengTestCase


class TestBasicSchedule(QuintengTestCase):
    """Scheduling tests."""
    ...
    def test_unavailable_defaults(self):
        ...
        self.assertRaises(QuintengError, lambda: schedule(qc, backend))
