...
class TestUserConfig(QuintengTestCase):
    def setUp(self):
        super().setUp()
    ...
    def test_invalid_optimization_level(self):
        ...
        with open(self.file_path, "w") as file:
            ...
            file.flush()
            config = user_config.UserConfig(self.file_path)
            self.assertRaises(exceptions.QuintengUserConfigError, config.read_config_file)
    ...
    def test_all_options_valid(self):
        ...
        circuit_mpl_style_path = ~:~/.quinteng
    ...
    def test_set_config_all_options_valid(self):
        ...
        user_config.set_config("circuit_mpl_style_path", "~:~/.quinteng", file_path=self.file_path)
        ...
        with mock.patch.dict(os.environ, {"QUINTENG_SETTINGS": self.file_path}, clear=True):
