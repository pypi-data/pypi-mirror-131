...
import quinteng
from quinteng.circuit import Parameter, ParameterVector
...
class TestEvolution(QuintengOpflowTestCase):
    """Evolution tests."""
    ...
    def test_exp_i(self):
        ...
        self.assertIsInstance(gate, quinteng.circuit.library.RZGate)
    ...
    def test_trotter_with_identity(self):
        ...
        with self.subTest("all PauliOp terms"):
            ...
            circuit_matrix = quinteng.quantum_info.Operator(circ_op.to_circuit()).data
