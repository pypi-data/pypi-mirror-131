...
from quinteng import QuantumCircuit, QuantumRegister, BasicAer
from quinteng.test import slow_test
...
from quinteng.algorithms import VQE
from quinteng.algorithms.optimizers import CG
...
from quinteng.opflow.gradients import Gradient, NaturalGradient, Hessian
from quinteng.opflow.gradients.qfi import QFI
from quinteng.opflow.gradients.circuit_qfis import LinCombFull, OverlapBlockDiag, OverlapDiag
from quinteng.circuit import Parameter
from quinteng.circuit import ParameterVector
from quinteng.circuit.library import RealAmplitudes, EfficientSU2


@ddt
class TestGradients(QuintengOpflowTestCase):
    """Test Quinteng Gradient Framework"""
...
@ddt
class TestParameterGradients(QuintengOpflowTestCase):
...
@ddt
class TestQFI(QuintengOpflowTestCase):
