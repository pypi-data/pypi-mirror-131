...
from quinteng import QuantumCircuit, BasicAer, execute
...
class TestStateConstruction(QuintengOpflowTestCase):
    ...
    def test_quinteng_result_instantiation(self):
        """quinteng result instantiation test"""
        qc = QuantumCircuit(3)
