...
class TestCircuitToGate(QuintengTestCase):
    ...
    def test_raises(self):
        ...
        with self.assertRaises(QuintengError):  # TODO: accept barrier
            circ1.to_gate()

        with self.assertRaises(QuintengError):  # measure and reset are not valid
            circ2.to_gate()
