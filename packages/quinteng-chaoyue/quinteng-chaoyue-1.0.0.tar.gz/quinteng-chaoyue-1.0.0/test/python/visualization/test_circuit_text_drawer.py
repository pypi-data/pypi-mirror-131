...
from quinteng import QuantumCircuit, QuantumRegister, ClassicalRegister, transpile
from quinteng.circuit import Gate, Parameter, Qubit, Clbit
from quinteng.quantum_info.operators import SuperOp
from quinteng.quantum_info.random import random_unitary
from quinteng.test import QuintengTestCase
from quinteng.transpiler import Layout
from quinteng.visualization import text as elements
from quinteng.visualization.circuit_visualization import _text_circuit_drawer
from quinteng.extensions import UnitaryGate, HamiltonianGate
from quinteng.extensions.quantum_initializer import UCGate
from quinteng.circuit.library import (
    HGate,
    U2Gate,
    U3Gate,
    XGate,
...
from quinteng.transpiler.passes import ApplyLayout
from .visualization import path_to_diagram_reference, QuintengVisualizationTestCase


class TestTextDrawerElement(QuintengTestCase):
    """Draw each element"""
...
class TestTextDrawerGatesInCircuit(QuintengTestCase):
    ...
    def test_text_box_length(self):
        ...
        https://github.com/Quinteng/quinteng-chaoyue/issues/1882"""
        expected = "\n".join(
            [
                "             ┌───┐    ┌───┐",
                "q1_0: |0>────┤ H ├────┤ H ├",
    ...
    def test_text_spacing_2378(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/2378"""
        expected = "\n".join(
            [
                "                     ",
                "q_0: |0>──────X──────",
...
class TestTextDrawerLabels(QuintengTestCase):
    """Gates with labels."""
    ...
    def test_rzz_on_wide_layer(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/4838"""
        expected = "\n".join(
            [
                "                                               ",
                "q_0: |0>────────────────■──────────────────────",
...
class TestTextDrawerMultiQGates(QuintengTestCase):
    ...
    def test_kraus(self):
        """Test Kraus.
        See https://github.com/Quinteng/quinteng-chaoyue/pull/2238#issuecomment-487630014"""
        # fmt: off
        expected = "\n".join(["      ┌───────┐",
                              "q: |0>┤ kraus ├",
                              "      └───────┘"])
    ...
    def test_label_over_name_2286(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/2286"""
        expected = "\n".join(
            [
                "        ┌───┐┌───────┐┌────────┐",
                "q_0: |0>┤ X ├┤ alt-X ├┤0       ├",
    ...
    def test_control_gate_with_base_label_4361(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/4361"""
        expected = "\n".join(
            [
                "        ┌──────┐ my ch  ┌──────┐",
                "q_0: |0>┤ my h ├───■────┤ my h ├",
...
class TestTextDrawerParams(QuintengTestCase):
    ...
    def test_text_bound_parameters(self):
        """Bound parameters
        See: https://github.com/Quinteng/quinteng-chaoyue/pull/3876"""
        # fmt: off
        expected = "\n".join(["       ┌────────────┐",
                              "qr: |0>┤ my_u2(π,π) ├",
                              "       └────────────┘"])
...
class TestTextDrawerVerticalCompressionLow(QuintengTestCase):
...
class TestTextDrawerVerticalCompressionMedium(QuintengTestCase):
...
class TestTextConditional(QuintengTestCase):
...
class TestTextIdleWires(QuintengTestCase):
    ...
    def test_text_barrier(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/4391"""
        # fmt: off
        expected = "\n".join(["         ┌───┐ ░ ",
                              "qr_1: |0>┤ H ├─░─",
                              "         └───┘ ░ "])
...
class TestTextNonRational(QuintengTestCase):
    ...
    def test_text_complex(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/3640"""
        expected = "\n".join(
            [
                "     ┌────────────────────────────────────┐",
                "q_0: ┤0                                   ├",
...
class TestTextInstructionWithBothWires(QuintengTestCase):
    """Composite instructions with both kind of wires
    See https://github.com/Quinteng/quinteng-chaoyue/issues/2973"""
    ...
    def test_text_2q_1c(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/4066"""
        expected = "\n".join(
            [
                "        ┌───────┐",
                "q_0: |0>┤0      ├",
    ...
    def test_text_3q_3c_qlabels_inverted(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/6178"""
        expected = "\n".join(
            [
                "        ┌───────┐",
                "q_0: |0>┤1      ├",
...
class TestTextDrawerAppendedLargeInstructions(QuintengTestCase):
    """Composite instructions with more than 10 qubits
    See https://github.com/Quinteng/quinteng-chaoyue/pull/4095"""
...
class TestTextControlledGate(QuintengTestCase):
    ...
    def test_controlled_composite_gate_edge(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/3546"""
        expected = "\n".join(
            [
                "        ┌──────┐",
                "q_0: |0>┤0     ├",
...
class TestTextOpenControlledGate(QuintengTestCase):
    ...
    def test_open_controlled_x(self):
        """Controlled X gates.
        See https://github.com/Quinteng/quinteng-chaoyue/issues/4180"""
        expected = "\n".join(
            [
                "                                  ",
                "qr_0: |0>──o────o────o────o────■──",
    ...
    def test_open_out_of_order(self):
        """Out of order CXs
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/4052#issuecomment-613736911"""
        expected = "\n".join(
            [
                "             ",
                "q_0: |0>──■──",
...
class TestTextWithLayout(QuintengTestCase):
    ...
    def test_partial_layout(self):
        ...
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/4757"""
        expected = "\n".join(
            [
                "            ┌───┐",
                "v_0 -> 0 |0>┤ H ├",
...
class TestTextInitialValue(QuintengTestCase):
...
class TestTextHamiltonianGate(QuintengTestCase):
...
class TestTextPhase(QuintengTestCase):
...
class TestCircuitVisualizationImplementation(QuintengVisualizationTestCase):
