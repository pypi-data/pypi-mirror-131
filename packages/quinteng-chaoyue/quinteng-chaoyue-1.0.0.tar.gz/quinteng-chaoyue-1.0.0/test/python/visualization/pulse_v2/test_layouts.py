...
from quinteng.visualization.pulse_v2 import layouts, device_info


class TestChannelArrangement(QuintengTestCase):
...
class TestHorizontalAxis(QuintengTestCase):
...
class TestFigureTitle(QuintengTestCase):
