...
from quinteng.visualization.pulse_v2 import core, stylesheet, device_info, drawings, types, layouts


class TestChart(QuintengTestCase):
    """Tests for chart."""

    def setUp(self) -> None:
        super().setUp()

        self.style = stylesheet.QuintengPulseStyle()
...
class TestDrawCanvas(QuintengTestCase):
