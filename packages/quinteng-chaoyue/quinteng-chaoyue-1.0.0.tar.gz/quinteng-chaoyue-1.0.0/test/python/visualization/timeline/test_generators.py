...
from quinteng.visualization.timeline import generators, types, stylesheet
from quinteng.circuit import library, Delay


class TestGates(QuintengTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.qubit = list(quinteng.QuantumRegister(1))[0]
        ...
        style = stylesheet.QuintengTimelineStyle()
...
class TestTimeslot(QuintengTestCase):
...
class TestBarrier(QuintengTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.qubits = list(quinteng.QuantumRegister(3))
...
class TestGateLink(QuintengTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.qubits = list(quinteng.QuantumRegister(2))
