...
from quinteng.visualization.timeline import layouts


class TestBitArrange(QuintengTestCase):
    ...
    def setUp(self) -> None:
        ...
        qregs = quinteng.QuantumRegister(3)
        cregs = quinteng.ClassicalRegister(3)
...
class TestAxisMap(QuintengTestCase):
