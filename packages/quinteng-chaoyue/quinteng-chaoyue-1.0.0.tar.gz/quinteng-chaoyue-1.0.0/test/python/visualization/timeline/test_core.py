...
from quinteng.visualization.timeline import core, stylesheet, generators, layouts


class TestCanvas(QuintengTestCase):
    """Test for canvas."""

    def setUp(self):
        super().setUp()

        self.style = stylesheet.QuintengTimelineStyle()
