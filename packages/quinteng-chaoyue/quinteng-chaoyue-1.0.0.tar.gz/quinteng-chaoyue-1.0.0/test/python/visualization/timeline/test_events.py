...
from quinteng.visualization.timeline import events, types


class TestLoadScheduledCircuit(QuintengTestCase):
...
class TestBitEvents(QuintengTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.clbits = list(quinteng.ClassicalRegister(2))
