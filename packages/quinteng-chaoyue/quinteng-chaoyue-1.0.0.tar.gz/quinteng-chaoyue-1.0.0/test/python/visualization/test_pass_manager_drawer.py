...
from quinteng.transpiler.passes import CXDirection
...
from .visualization import QuintengVisualizationTestCase, path_to_diagram_reference
...
class TestPassManagerDrawer(QuintengVisualizationTestCase):
    """Quinteng pass manager drawer tests."""
