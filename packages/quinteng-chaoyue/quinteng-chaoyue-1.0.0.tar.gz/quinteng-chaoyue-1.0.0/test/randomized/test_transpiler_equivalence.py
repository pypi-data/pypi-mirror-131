...
from quinteng import execute, transpile, Aer
from quinteng import QuantumCircuit, QuantumRegister, ClassicalRegister
from quinteng.circuit import Measure, Reset, Gate, Barrier
...
from quinteng.test.base import dicts_almost_equal
...
# FakeRochester disabled until https://github.com/Quinteng/quinteng-aer/pull/693 is released.
...
class QCircuitMachine(RuleBasedStateMachine):
    ...
    Build circuits with up to QUINTENG_RANDOM_QUBITS qubits, apply a random
    selection of gates from quinteng.circuit.library with randomly selected
