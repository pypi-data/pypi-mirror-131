...
from quinteng.test.mock import FakeTenerife
from quinteng.visualization.circuit_visualization import _matplotlib_circuit_drawer
from quinteng.circuit.library import XGate, MCXGate, HGate, RZZGate, SwapGate, DCXGate, ZGate, SGate
from quinteng.circuit.library import MCXVChain
from quinteng.extensions import HamiltonianGate
from quinteng.circuit import Parameter, Qubit, Clbit
from quinteng.circuit.library import IQP
from quinteng.quantum_info.random import random_unitary
from quinteng.tools.visualization import HAS_MATPLOTLIB
...
class TestMatplotlibDrawer(QuintengTestCase):
    ...
    def test_calibrations(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/5920
        """
    ...
    def test_no_ops(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/5393"""
    ...
    def test_plot_barriers(self):
        ...
        import quinteng.extensions.simulator  # pylint: disable=unused-import
    ...
    def test_scale(self):
        """Tests scale
        See: https://github.com/Quinteng/quinteng-chaoyue/issues/4179"""
    ...
    def test_6095(self):
        ...
        See https://github.com/Quinteng/quinteng-chaoyue/issues/6095"""
        circuit = QuantumCircuit(2)
        circuit.cp(1.0, 0, 1)
        circuit.h(1)
