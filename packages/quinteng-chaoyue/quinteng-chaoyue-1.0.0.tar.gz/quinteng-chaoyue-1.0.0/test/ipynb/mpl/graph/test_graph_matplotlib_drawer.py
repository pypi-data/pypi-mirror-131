...
from quinteng import BasicAer, execute
...
from quinteng.visualization.gate_map import plot_gate_map, plot_coupling_map
from quinteng.test.mock.fake_provider import (
    FakeArmonk,
    FakeBelem,
    FakeCasablanca,
    FakeRueschlikon,
...
class TestGraphMatplotlibDrawer(QuintengTestCase):
    ...
    def test_plot_bloch_multivector(self):
        """test bloch sphere
        See https://github.com/Quinteng/quinteng-chaoyue/issues/6397.
        """
