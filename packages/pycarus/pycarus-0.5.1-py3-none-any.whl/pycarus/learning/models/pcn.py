...
class PCN_encoder(nn.Module):
    ...
    def __init__(self, size_latent: int = 1024) -> None:
        ...
        """
        super(PCN_encoder, self).__init__()  # type: ignore
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        x = torch.cat(
            (x, global_feature.view(batch_size, -1, 1).repeat(1, 1, num_points).contiguous()), 1
        )
...
class PCN_decoder(nn.Module):
    ...
    def __init__(
        ...
        """
        super(PCN_decoder, self).__init__()  # type: ignore
...
class PCNNetwork(nn.Module):
    ...
    def __init__(
        ...
        """
        super(PCNNetwork, self).__init__()  # type: ignore
