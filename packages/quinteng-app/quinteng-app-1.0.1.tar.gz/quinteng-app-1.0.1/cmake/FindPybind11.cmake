...
function(basic_pybind11_add_module target_name)
    ...
    elseif(APPLE)
        ...
        if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
            set(APP_LINKER_FLAGS "${APP_LINKER_FLAGS} -undefined dynamic_lookup")
        else()
            ...
            set(APP_LINKER_FLAGS "${APP_LINKER_FLAGS} -undefined dynamic_lookup -flat_namespace")
        endif()
        if(ARG_SHARED)
    ...
    set_target_properties(${target_name} PROPERTIES LINK_FLAGS ${APP_LINKER_FLAGS})
    set_target_properties(${target_name} PROPERTIES COMPILE_FLAGS ${APP_COMPILER_FLAGS})
endfunction()
