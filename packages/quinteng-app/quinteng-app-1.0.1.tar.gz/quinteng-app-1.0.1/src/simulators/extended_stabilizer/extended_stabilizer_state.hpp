...
#ifndef _app_chsimulator_state_hpp
#define _app_chsimulator_state_hpp
...
protected:
  ...
  void apply_reset(const reg_t &qubits, APP::RngEngine &rng);
...
void State::apply_reset(const reg_t &qubits, APP::RngEngine &rng)
{
