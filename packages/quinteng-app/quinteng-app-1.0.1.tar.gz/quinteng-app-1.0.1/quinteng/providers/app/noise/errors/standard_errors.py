...
"""
Standard quantum computing error channels for Quinteng App.
"""
...
import numpy as np
from quinteng.circuit import QuantumCircuit, Reset
...
from quinteng.quantum_info.operators.channel import Choi, Kraus
...
def kraus_error(noise_ops, standard_gates=None, canonical_kraus=False):
    ...
    if standard_gates is not None:
        warnings.warn(
            '"standard_gates" option has been deprecated as of quinteng-app 0.10.0'
