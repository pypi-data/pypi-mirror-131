...
simulating a Quinteng quantum circuit in the presence of errors.
...
:class:`~quinteng.providers.app.QasmSimulator`. It can be used to construct
...
.. code-block:: python
    ...
    from quinteng import QuantumCircuit, execute
    from quinteng import IBMQ, App
    from quinteng.visualization import plot_histogram
    from quinteng.providers.app.noise import NoiseModel
    ...
    result = execute(circ, App.get_backend('qasm_simulator'),
...
.. code-block:: python
    ...
    from quinteng import QuantumCircuit, execute, App
    from quinteng.visualization import plot_histogram
    import quinteng.providers.app.noise as noise
