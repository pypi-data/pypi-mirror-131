...
macro(setup_dependencies)
	# Defines APP_DEPENDENCY_PKG alias which refers to either conan-provided or system libraries.
	if(DISABLE_CONAN)
...
macro(_use_system_libraries)
	...
	_import_app_system_dependency(nlohmann_json 3.1.1)
	_import_app_system_dependency(spdlog 1.5.0)

	if(SKBUILD)
		_import_app_system_dependency(muparserx 4.0.8)
	endif()

	if(APP_THRUST_BACKEND AND NOT APP_THRUST_BACKEND STREQUAL "CUDA")
		string(TOLOWER ${APP_THRUST_BACKEND} THRUST_BACKEND)
		_import_app_system_dependency(Thrust 1.9.5)
	endif()

	if(BUILD_TESTS)
		_import_app_system_dependency(Catch2 2.13.6)
	endif()
...
macro(_import_app_system_dependency package version)
	# Arguments:
	...
	add_library(APP_DEPENDENCY_PKG::${PACKAGE_LOWER} INTERFACE IMPORTED)
	target_link_libraries(APP_DEPENDENCY_PKG::${PACKAGE_LOWER} PUBLIC INTERFACE ${package})
