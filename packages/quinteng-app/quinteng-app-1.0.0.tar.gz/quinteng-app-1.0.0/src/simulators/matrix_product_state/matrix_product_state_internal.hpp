...
#ifndef _app_matrix_product_state_hpp_
#define _app_matrix_product_state_hpp_
...
public:
  ...
  void apply_matrix(const APP::reg_t &qubits, const cvector_t &vmat)
  {
    apply_diagonal_matrix(qubits, vmat);
  }

  void apply_diagonal_matrix(const APP::reg_t &qubits, const cvector_t &vmat);
...
//-------------------------------------------------------------------------
#endif /* _app_matrix_product_state_hpp_ */
