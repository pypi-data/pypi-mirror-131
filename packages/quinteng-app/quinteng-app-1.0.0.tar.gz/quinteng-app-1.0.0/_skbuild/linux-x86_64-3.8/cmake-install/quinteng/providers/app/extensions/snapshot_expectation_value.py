...
class SnapshotExpectationValue(Snapshot):
    ...
    def __init__(self, label, op, single_shot=False, variance=False):
        ...
        .. deprecated:: 0.9.0
            ...
            :class:`quinteng.providers.app.library.SaveExpectationValue` and
            :class:`quinteng.providers.app.library.SaveExpectationValueVariance`
            instructions.
        """
        warn('The `SnapshotExpectationValue` instruction has been deprecated as of'
             ' quinteng-app 0.9. It has been superseded by the `SaveExpectationValue` and'
...
def snapshot_expectation_value(self, label, op, qubits,
    ...
    .. deprecated:: 0.9.0
        ...
        This instruction has been deprecated and will be removed no earlier
        than 3 months from the 0.9.0 release date. It has been superseded by the
        :func:`quinteng.providers.app.library.save_expectation_value` and
        :func:`quinteng.providers.app.library.save_expectation_value_variance`
        circuit methods.
    """
    warn('The `snapshot_expectation_value` circuit method has been deprecated as of'
         ' quinteng-app 0.9 and will be removed in a future release.'
