...
"""
=============================================
Utilities (:mod:`quinteng.providers.app.utils`)
=============================================

.. currentmodule:: quinteng.providers.app.utils

This module contains utility functions for modifying
:class:`~quinteng.providers.app.noise.NoiseModel` objects and ``QuantumCircuits``
using noise models.
