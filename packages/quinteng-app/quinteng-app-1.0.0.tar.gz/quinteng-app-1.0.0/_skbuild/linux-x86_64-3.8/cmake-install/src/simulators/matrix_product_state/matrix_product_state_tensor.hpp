...
//  A4 A5 A6 A7
  ...
  cmatrix_t temp0_1 = APP::Utils::concatenate(data[0], data[1], 1),
            temp2_3 = APP::Utils::concatenate(data[2], data[3], 1),
            temp4_5 = APP::Utils::concatenate(data[4], data[5], 1),
            temp6_7 = APP::Utils::concatenate(data[6], data[7], 1);
