...
#ifndef _app_framework_pybind_json_hpp_
#define _app_framework_pybind_json_hpp_
...
void std::to_json(json_t &js, const py::handle &obj) {
    static py::object PyNoiseModel = py::module::import("quinteng.providers.app.noise.noise_model").attr("NoiseModel");
    static py::object PyQasmQobj = py::module::import("quinteng.qobj.qasm_qobj").attr("QasmQobj");
