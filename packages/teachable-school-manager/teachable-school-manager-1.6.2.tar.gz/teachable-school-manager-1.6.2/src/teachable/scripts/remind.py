...
def parse_arguments():
    ...
    group.add_argument('--reportonly', '-r', action='store_true',
...
def remind_app(args):
    ...
    for section in config.keys():
        if section != 'DEFAULT':
                ...
                if summary_stats:
                    ...
                    if message:
                        ...
                        if since_last_notif >= notif_freq and days_since <= max_inactivity:
                            if args.dryrun is not True and args.reportonly is not True:
            ...
            if data and 'contact_email' in config[section].keys():
                ...
                if args.dryrun is not True and args.notifyonly is not True:
