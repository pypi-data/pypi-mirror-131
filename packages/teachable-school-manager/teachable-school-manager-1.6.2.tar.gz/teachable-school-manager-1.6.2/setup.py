...
setup(
    ...
    entry_points={"console_scripts": ["teachable_leaderboard=teachable.scripts.leaderboard:main",
                                      ...
                                      "teachable_scheduler=teachable.scripts.scheduler:main",
                                      "teachable_statements=teachable.scripts.statements:main",
                                      "teachable_unenroll=teachable.scripts.unenroll:main"]},  # Optional
