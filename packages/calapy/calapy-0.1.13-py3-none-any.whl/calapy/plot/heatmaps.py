    ...
    **kwargs
    ...
    if kwargs.get('labels_ticks_x') is None:
        ...
        if kwargs.get('ticks_x') is None:
            if kwargs.get('n_ticks_x') is None:
                ...
                tick_x_lower = min_x
                tick_x_higher = max_x
                kwargs['ticks_x'] = np.arange(tick_x_lower, tick_x_higher + (delta_x / 2), delta_x)
        ...
        if (kwargs.get('stagger_labels_ticks_x') or
            ...
            if kwargs.get('ticks_x') is None:
                kwargs['ticks_x'] = [None] * n_labels_ticks_x
                get_ticks_x = True
            else:
                get_ticks_x = False
            ...
            for l, label_l in enumerate(tmp_labels_ticks_x):
                ...
                if get_ticks_x:
                    kwargs['ticks_x'][l] = label_l.get_position()[0]
    ...
    if kwargs.get('labels_ticks_y') is None:
        ...
        if kwargs.get('ticks_y') is None:
            if kwargs.get('n_ticks_y') is None:
                ...
                tick_y_lower = min_y
                tick_y_higher = max_y
                kwargs['ticks_y'] = np.arange(tick_y_lower, tick_y_higher + (delta_y / 2), delta_y)
        ...
        if (kwargs.get('stagger_labels_ticks_y') or
            ...
            if kwargs.get('ticks_y') is None:
                kwargs['ticks_y'] = [None] * n_labels_ticks_y
                get_ticks_y = True
            else:
                get_ticks_y = False
            ...
            for l, label_l in enumerate(tmp_labels_ticks_y):
                ...
                if get_ticks_y:
                    kwargs['ticks_y'][l] = label_l.get_position()[1]
    ...
    if annot:
        ...
        if n_colors_annot == 1:
            ...
            kw = dict(horizontalalignment="center",
                      verticalalignment="center",
                      fontsize=kwargs.get('fontsize_annot'))
