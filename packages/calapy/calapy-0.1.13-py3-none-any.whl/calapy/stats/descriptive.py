...
def samples_to_frequencies(data, axis_samples, axis_variables_table, exclude_values=False, values=-1):
    ...
    combinations_others_and_samples = cp_combinations.n_conditions_to_combinations(shape_data[axes_others_and_samples])
...
def scores_to_local_mean(data, axis, n_neighbours, ignore_nan=True):
