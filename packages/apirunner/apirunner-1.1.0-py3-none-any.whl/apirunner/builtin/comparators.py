...
def if_equal(check_value: Any, expect_value: Any, message: Text = ""):
...
def if_contains(check_value: Any, expect_value: Any, message: Text = ""):
    if check_value is None:
        assert check_value is None, message
        return
    assert isinstance(
...
def if_type_match(check_value: Any, expect_value: Any, message: Text = ""):
    if check_value is None:
        assert check_value is None, message
        return
