...
class _MPSolverResponseStatus(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[MPSolverResponseStatusValue]):
    ...
    MPSOLVER_CANCELLED_BY_USER = typing___cast(MPSolverResponseStatusValue, 98)
    ...
    MPSOLVER_INCOMPATIBLE_OPTIONS = typing___cast(MPSolverResponseStatusValue, 113)
MPSOLVER_OPTIMAL = typing___cast(MPSolverResponseStatusValue, 0)
MPSOLVER_FEASIBLE = typing___cast(MPSolverResponseStatusValue, 1)
MPSOLVER_INFEASIBLE = typing___cast(MPSolverResponseStatusValue, 2)
MPSOLVER_UNBOUNDED = typing___cast(MPSolverResponseStatusValue, 3)
...
class MPModelRequest(google___protobuf___message___Message):
    ...
    populate_additional_solutions_up_to: builtin___int = ...
    ...
    def __init__(self,
        *,
        ...
        populate_additional_solutions_up_to : typing___Optional[builtin___int] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"enable_internal_solver_output",b"enable_internal_solver_output",u"ignore_solver_specific_parameters_failure",b"ignore_solver_specific_parameters_failure",u"model",b"model",u"model_delta",b"model_delta",u"populate_additional_solutions_up_to",b"populate_additional_solutions_up_to",u"solver_specific_parameters",b"solver_specific_parameters",u"solver_time_limit_seconds",b"solver_time_limit_seconds",u"solver_type",b"solver_type"]) -> builtin___bool: ...
...
class MPSolution(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"objective_value",b"objective_value"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"objective_value",b"objective_value",u"variable_value",b"variable_value"]) -> None: ...
type___MPSolution = MPSolution

class MPSolveInfo(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    solve_wall_time_seconds: builtin___float = ...
    solve_user_time_seconds: builtin___float = ...

    def __init__(self,
        *,
        solve_wall_time_seconds : typing___Optional[builtin___float] = None,
        solve_user_time_seconds : typing___Optional[builtin___float] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"solve_user_time_seconds",b"solve_user_time_seconds",u"solve_wall_time_seconds",b"solve_wall_time_seconds"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"solve_user_time_seconds",b"solve_user_time_seconds",u"solve_wall_time_seconds",b"solve_wall_time_seconds"]) -> None: ...
type___MPSolveInfo = MPSolveInfo
...
class MPSolutionResponse(google___protobuf___message___Message):
    ...
    @property
    def solve_info(self) -> type___MPSolveInfo: ...

    @property
    def additional_solutions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___MPSolution]: ...
    ...
    def __init__(self,
        *,
        ...
        variable_value : typing___Optional[typing___Iterable[builtin___float]] = None,
        solve_info : typing___Optional[type___MPSolveInfo] = None,
        ...
        additional_solutions : typing___Optional[typing___Iterable[type___MPSolution]] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"best_objective_bound",b"best_objective_bound",u"objective_value",b"objective_value",u"solve_info",b"solve_info",u"status",b"status",u"status_str",b"status_str"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"additional_solutions",b"additional_solutions",u"best_objective_bound",b"best_objective_bound",u"dual_value",b"dual_value",u"objective_value",b"objective_value",u"reduced_cost",b"reduced_cost",u"solve_info",b"solve_info",u"status",b"status",u"status_str",b"status_str",u"variable_value",b"variable_value"]) -> None: ...
