...
class Repository(WMLResource):
        ...
        """
                ...
                **Parameters**
                ...
                .. important::
                    ...
                    #. **Example**:
                    >>> published_model_details = wml_client.repository.store_model(model="rf_model_0.4.tar.gz", meta_props=metadata)
    ...
    def download(self, artifact_uid, filename='downloaded_artifact.tar.gz', rev_uid=None, format=None):
        ...
        elif not self._client.CLOUD_PLATFORM_SPACES and not self._client.ICP_35 and not self._client.ICP_40 and res['library'] is True:
            return self._client.runtimes.download_library(artifact_uid, filename)
        elif not self._client.CLOUD_PLATFORM_SPACES and not self._client.ICP_35 and not self._client.ICP_40 and res['runtime'] is True:
    ...
    @docstring_parameter({'str_type': STR_TYPE_NAME})
    def get_model_details(self, model_uid=None, limit=None, asynchronous=False, get_all=False):
        """
        ...
        return self._client._models.get_details(model_uid, limit,
                                                asynchronous=asynchronous, get_all=get_all)
    ...
    def list_models(self, limit=None, asynchronous=False, get_all=False):
        """
