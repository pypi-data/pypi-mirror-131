...
class Deployments(WMLResource):
    ...
    def create(self, artifact_uid=None, meta_props=None, rev_id=None, **kwargs):
            ...
            if 'serving_name' in str(metaProps) and 'r_shiny' in str(metaProps):
                metaProps['serving_name'] = meta_props['serving_name']
    ...
    def _get_serving_name_info(self, serving_name: str) -> tuple:
        """
           ...
           **Parameters**
           ...
           .. important::
                #. **serving_name**: Serving name to filter deployments (optional)\n
                   **type**: str\n

           **Output**

           .. important::
                **returns**: information about serving name: (<status_code>, <response json if any>)\n
                **return type**: tuple\n
    ...
    def get_details(self, deployment_uid=None, serving_name=None, limit=None, asynchronous=False, get_all=False):
        ...
        if deployment_uid is None:
            deployment_details = self._get_artifact_details(url, deployment_uid, limit, 'deployments', query_params=query_params,
           ...
           **Parameters**
           ...
           .. important::
                ...
                #. **job_uid**: Unique Job ID (optional)\n
                   **type**: str\n
                #. **include**:  fields to be retrieved from 'decision_optimization' and 'scoring' section mentioned as value(s) (comma separated) as output response fields (optional)\n
                   **type**: str\n
                #. **limit**:  limit number of fetched records (optional)\n
                   **type**: int\n
