...
class Test(TestCase):
    ...
    def test_task(self):
        ...
        task = Task('uuid', 'name', 'product_uuid', Pose(Vector3(0.0, 0.0, 0.0), Vector3(0.0, 0.0, 0.0)), [Task.ASSIGNED_TO_HUMAN])
    ...
    def test_task_equals(self):
        task1 = Task('uuid', 'name', 'product_uuid', Pose(Vector3(0.0, 0.0, 0.0), Vector3(0.0, 0.0, 0.0)), [Task.ASSIGNED_TO_HUMAN])
        task2 = Task('uuid', 'name', 'product_uuid', Pose(Vector3(0.0, 0.0, 0.0), Vector3(0.0, 0.0, 0.0)), [Task.ASSIGNED_TO_HUMAN])
        task3 = Task('other', 'name', 'product_uuid', Pose(Vector3(0.0, 0.0, 0.0), Vector3(0.0, 0.0, 0.0)), [Task.ASSIGNED_TO_HUMAN])
    ...
    def test_task_repr(self):
        task = Task('uuid', 'name', 'product_uuid', Pose(Vector3(0.0, 0.0, 0.0), Vector3(0.0, 0.0, 0.0)),
                    [Task.ASSIGNED_TO_HUMAN], description="Hard task!")
