...
def test_futures_contracts_formula2():
...
def test_relations1():
    symbols = 'BRENT_DATED', 'NG'
    rels = lim.relations(*symbols)
    assert 'BRENT_DATED' in rels
    assert 'NG' in rels
