...
class MultiplesExperimentos:
    ...
    def procesa_diccionario_divergencias(self):
        ...
        self.calcula_divergencia("visitas_regiones_preferenciales", lista_arreglos_solo_regiones_preferidas)
    ...
    def graficar(self, grafica):
        ...
        if grafica is 'entropia_visitas_regiones':
            plt.plot(range(1, cantidad_experimentos+1),
                     self.resultados_entropia["visitas_regiones"])
            plt.show()

        elif grafica is 'entropia_visitas_regiones_preferidasvelocidad':
            plt.plot(range(1, cantidad_experimentos+1),
