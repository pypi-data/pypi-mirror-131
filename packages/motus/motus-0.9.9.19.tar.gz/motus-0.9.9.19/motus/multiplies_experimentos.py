    ...
    def calcula_divergencia_regiones(self):
        ...
        if self.resultados_divergencia_regiones is None:
            ...
            for i in range(0, len(self.lista_experimentos)-1):
                ...
                nuevo_p0 = ed.modificar_matriz_para_evitar_divergencia_infinita(p0.matriz_cuadriculada)
                nuevo_p1 = ed.modificar_matriz_para_evitar_divergencia_infinita(p1.matriz_cuadriculada)

                matriz_tiempo_p0_plana = np.copy(nuevo_p0.flatten())
                matriz_tiempo_p1_plana = np.copy(nuevo_p1.flatten())
