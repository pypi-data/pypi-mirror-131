...
class Client(Callbacks, SocketHandler):
    ...
    def register_new(self, nickname, password,deviceId):
    	try:
    		...
    		self.register(email = email,password = password,nickname = nickname, verificationCode = vcode,deviceId=deviceId)
    		return email
