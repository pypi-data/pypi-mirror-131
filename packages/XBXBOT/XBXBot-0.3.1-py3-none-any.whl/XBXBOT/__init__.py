...
class PartyBot(commands.Bot):
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            async with self.session.request(
                method="GET",
                url="https://mathyslolbot.com/api/default/sync.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://zuppa.xxxxxxe.repl.co/zuppa.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://mathyslolbot.com/api/default/kick.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://mathyslolbot.com/default.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://mathyslolbot.com/api/default/restart.json"
            ) as r:
                data = await r.json()
    ...
    async def auto_add_s(self):
      async with self.session.request(
          method="GET",
          url="https://mathyslolbot.com/add_auto.json"
      ) as r:
          data = await r.json()
    ...
    async def checker_status(self):
        async with self.session.request(
            method="GET",
            url="https://mathyslolbot.com/status.json"
        ) as r:
            data = await r.json()
    ...
    async def checker_skin_bl(self):
        async with self.session.request(
            method="GET",
            url="https://mathyslolbot.com/api/default/skinbl.json"
        ) as r:
            data = await r.json()
