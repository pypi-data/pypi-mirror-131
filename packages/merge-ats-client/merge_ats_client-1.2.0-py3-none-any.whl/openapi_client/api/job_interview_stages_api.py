...
class JobInterviewStagesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __job_interview_stages_list(
            self,
            x_account_token,
            **kwargs
        ):
        ...
        self.job_interview_stages_list = _Endpoint(
            settings={
                'response_type': (PaginatedJobInterviewStageList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/job-interview-stages',
            ...
            callable=__job_interview_stages_list
        )

        def __job_interview_stages_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.job_interview_stages_retrieve = _Endpoint(
            settings={
                'response_type': (JobInterviewStage,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/job-interview-stages/{id}',
            ...
            api_client=api_client,
            callable=__job_interview_stages_retrieve
        )
