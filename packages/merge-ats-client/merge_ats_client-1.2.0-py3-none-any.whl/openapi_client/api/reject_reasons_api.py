    ...
    def __init__(self, api_client=None):
        ...
        def __reject_reasons_list(
            ...
            **kwargs
            ...
            >>> thread = api.reject_reasons_list(x_account_token, async_req=True)
            >>> result = thread.get()
        ...
        self.reject_reasons_list = _Endpoint(
            ...
            callable=__reject_reasons_list
        )

        def __reject_reasons_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
            ...
            >>> thread = api.reject_reasons_retrieve(x_account_token, id, async_req=True)
            >>> result = thread.get()
        ...
        self.reject_reasons_retrieve = _Endpoint(
            settings={
                ...
                'endpoint_path': '/reject-reasons/{id}',
            ...
            api_client=api_client,
            callable=__reject_reasons_retrieve
        )
