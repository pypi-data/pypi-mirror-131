...
class AuthServiceProxy(object):
    ...
    def __init__(
        ...
        if connection:
            ...
            self.__conn = httplib.HTTPSConnection(
                self.__url.hostname, port, timeout=timeout, context=ssl_context
            )
        else:
    ...
    def batch_(self, rpc_calls):
        ...
        if isinstance(responses, (dict,)):
            ...
            raise JSONRPCException({"code": -32700, "message": "Parse error"})
    ...
    def _get_response(self):
        ...
        responsedata = http_response.read().decode("utf8", "replace")
