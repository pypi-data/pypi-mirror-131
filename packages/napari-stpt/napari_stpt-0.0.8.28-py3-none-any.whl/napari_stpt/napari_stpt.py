...
class NapariSTPT:
    ...
    def MakeBoundingBox(self):
        ...
        size_y = self.shape[1]#  * output_resolution
        size_z = self.shape[2]#  * output_resolution
        ...
        self.viewer.add_shapes(np.asarray(line_locations), name = 'bounding box',shape_type='line', edge_color = "white", edge_width = 2)
