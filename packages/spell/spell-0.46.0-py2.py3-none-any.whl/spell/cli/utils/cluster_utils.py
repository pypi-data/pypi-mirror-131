...
def create_build_run_configmap(namespace):
    ...
    kubectl(
        ...
        "-n",
        namespace,
        "--from-file=python/spell/cli/utils/kube_manifests/spell-run/build.sh",
    )


def create_build_artifacts_pvc(namespace):
    kubectl("apply", "-n", namespace, "-f", "python/spell/cli/utils/kube_manifests/spell-run/build_artifacts_pvc.yaml")
