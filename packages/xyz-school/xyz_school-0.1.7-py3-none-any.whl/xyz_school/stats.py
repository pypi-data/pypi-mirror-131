...
def online_store_stat(qset, begin_date=None, end_date=None):
    ...
    return st.count({'date': {'$gte': begin_date, '$lte': end_date}, 'user': {'$in': uids}}, distinct='user')
...
def stats_student(qset=None, measures=None, period=None, time_field=None):
    ...
    funcs = {
        ...
        'online': lambda: online_store_stat(qset, *dateutils.get_period_by_name(period))
    }
