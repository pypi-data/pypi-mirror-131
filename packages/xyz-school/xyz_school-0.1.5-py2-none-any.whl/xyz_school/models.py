...
class Class(CodeMixin, models.Model):
    ...
    major = models.ForeignKey(Major, verbose_name=Major._meta.verbose_name, null=True, blank=True, on_delete=models.PROTECT,
...
class Student(CodeMixin, models.Model):
    ...
    stage = models.PositiveSmallIntegerField("阶段", choices=choices.CHOICES_STAGE, blank=True, default=choices.STAGE_PENDING)
