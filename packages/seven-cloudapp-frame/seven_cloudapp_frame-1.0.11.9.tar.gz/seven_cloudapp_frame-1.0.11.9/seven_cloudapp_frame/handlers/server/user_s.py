...
@LastEditTime: 2021-12-02 17:58:45
...
class AssetLogListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        asset_base_model = AssetBaseModel(context=self)
        page_info = asset_base_model.get_asset_log_list(app_id, act_id, asset_type, page_size, page_index, user_id, asset_object_id, start_date, end_date, user_nick, user_open_id, source_type, source_object_id, field, is_cache=False)
        ref_params = {}
