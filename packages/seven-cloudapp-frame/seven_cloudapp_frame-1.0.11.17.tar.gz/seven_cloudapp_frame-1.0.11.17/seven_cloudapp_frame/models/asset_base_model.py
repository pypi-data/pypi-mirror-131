...
@LastEditTime: 2021-12-07 15:26:38
...
class AssetBaseModel():
    ...
    def get_asset_log_list(self, app_id, act_id, asset_type, page_size=20, page_index=0, user_id=0, asset_object_id="", start_date="", end_date="", user_nick="", open_id="", source_type=0, source_object_id=None, field="*",is_cache=True):
        """
