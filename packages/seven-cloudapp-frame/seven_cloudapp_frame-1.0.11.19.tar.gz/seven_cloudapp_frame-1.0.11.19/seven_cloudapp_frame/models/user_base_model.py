...
@LastEditTime: 2021-12-16 16:27:51
    ...
    def save_user_by_openid(self, app_id, act_id, open_id, user_nick, avatar, union_id=""):
        ...
        try:
            ...
            if not user_account:
                ...
                user_account.is_auth = 0 if not user_nick else 1
                ...
                user_account.is_auth = 0 if not user_account.user_nick else 1
                user_account.avatar = avatar if avatar and user_account.avatar != avatar else user_account.avatar
                user_account_model.update_entity(user_account, "user_nick,avatar,is_auth")
