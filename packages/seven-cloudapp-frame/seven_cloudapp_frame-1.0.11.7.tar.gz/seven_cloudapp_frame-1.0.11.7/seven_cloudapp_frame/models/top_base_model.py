...
@LastEditTime: 2021-12-02 15:41:38
...
class TopBaseModel():
    ...
    def get_buy_order_list(self, open_id, access_token, app_key, app_secret, start_created="", end_created="", page_size=50, is_log=False, type="fixed,step"):
        """
