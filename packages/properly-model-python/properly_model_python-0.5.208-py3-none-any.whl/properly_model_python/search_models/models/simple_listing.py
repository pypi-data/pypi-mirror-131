...
class SimpleListing(Model):
    ...
    def __init__(self, id: str=None, list_price: int=None, predicted_price: float=None, image_url: str=None, image_medium_url: str=None, image_thumbnail_url: str=None, address: str=None, bedrooms: int=None, bathrooms: int=None, bathrooms_half: int=None, square_feet: int=None, parking: int=None, brokerage: str=None, listing_agent_id: str=None, community: str=None, city: str=None, start_date: float=None):  # noqa: E501
