...
from shangqi_cloud_lib.utils.JwtUtil import decode_token
    ...
    if especial_tag_list is not None:
        for tag in especial_tag_list:
            ...
            if tag in ["主板上市", "创业板上市", "科创板上市", "新三板-基础层", "新三板-创新层", "新三板-精选层", "北交所"]:
                es_condition_by_terms(bool_should_list, "tags.market_tag.block.keyword", [tag])
            if tag in ["规上企业"]:
                es_condition_by_terms(bool_should_list, "tags.nonpublic_tag.keyword", [tag])
