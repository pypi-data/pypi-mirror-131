...
from .component import Option, CommandInterface, Subcommand, Arpamar, OptionInterface
from .types import NonTextElement, MessageChain, Default, Argument_T
...
class Alconna(CommandInterface):
    ...
    def __init__(
            ...
            options: List[OptionInterface] = None,
    ...
    def help(self, help_string: str):
        help_string += "\n" if help_string else ""
        command_string = f"{'|'.join(self._command_headers)}" + (" <main_argument>" if self.main_argument != "" else "")
        ...
        setattr(self, "help_doc", f"{command_string}{help_string}\n"
