...
from fiddler.utils import _type_enforce, df_from_json_rows
...
class Dataset:
    ...
    def get_info(self) -> DatasetInfo:
        ...
        dataset_id = _type_enforce('dataset_id', self.dataset_id, str)
    ...
    def _query_dataset(
        ...
        path = ['dataset_query', self.connection.org_id, self.project_id, self.dataset_id]
