...
from fiddler.utils import ResourceNotFound, JSONException
    ...
    def _form_request(
        ...
        if is_get_request:
            ...
            if files is not None:
                ...
                req = requests.Request('POST', endpoint, data=mp_encoder, headers={'Content-Type': mp_encoder.content_type})
            else:
