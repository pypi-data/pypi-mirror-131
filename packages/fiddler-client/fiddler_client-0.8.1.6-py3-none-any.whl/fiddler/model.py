...
from fiddler.core_objects import ModelInfo, AttributionExplanation, \
    MulticlassAttributionExplanation

from fiddler.utils import _type_enforce, cast_input_data, _df_to_dict
...
class Model:
    ...
    def get_info(self) -> ModelInfo:
        ...
        """
        # Type enforcement
        project_id = _type_enforce('project_id', self.project_id, str)
        model_id = _type_enforce('model_id', self.model_id, str)
    ...
    def delete(
        self, delete_prod=False, delete_pred=True
    ):
