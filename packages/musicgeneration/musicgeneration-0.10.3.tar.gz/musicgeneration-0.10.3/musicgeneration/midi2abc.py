from musicgeneration.midi.MidiOutStream import MidiOutStream
from musicgeneration.midi.MidiInFile import MidiInFile
from fractions import Fraction
from musicgeneration.simple_abc_parser import get_best_key_for_midi_notes, get_accidentals_for_key
