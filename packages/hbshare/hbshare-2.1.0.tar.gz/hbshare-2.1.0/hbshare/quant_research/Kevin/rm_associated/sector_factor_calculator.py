...
from hbshare.quant_research.Kevin.rm_associated.util.config import industry_cluster_dict
...
if __name__ == '__main__':
    ...
    res = SectorIndexCalculator('20210101', '20211015').get_construct_result()
    # print(res)