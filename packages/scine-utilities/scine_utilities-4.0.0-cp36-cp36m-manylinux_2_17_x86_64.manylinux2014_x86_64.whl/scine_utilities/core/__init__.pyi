...
class Sink():
    ...
    """
    pass
def get_available_settings(method_family: str, program: str) -> typing.List[str]:
    """
    Lists the available settings of a Calculator with the given method and from the given program
    """
def get_calculator(method_family: str, program: str) -> Calculator:
    """
    Generates a calculator with the given method and from the given program.
    """
def get_possible_properties(method_family: str, program: str) -> scine_utilities.PropertyList:
    """
    Lists the available properties of a Calculator with the given method and from the given program.
    """
def has_calculator(method_family: str, program: str) -> bool:
    """
