...
class PeriodicBoundaries():
    ...
    @typing.overload
    def __init__(self, cubeLength: float = 1.0) -> None: 
        """
        ...
        """
    @typing.overload
    def __init__(self, lengths: numpy.ndarray, angles: numpy.ndarray, isBohr: bool = True, isDegrees: bool = True) -> None: ...
    @typing.overload
...
class SingleParticleEnergies():
    ...
    @typing.overload
    def set_restricted(self, values: typing.List[float]) -> None: ...
    @typing.overload
    def set_unrestricted(self, alpha: numpy.ndarray, beta: numpy.ndarray) -> None: ...
    @typing.overload
    def set_unrestricted(self, alpha: typing.List[float], beta: typing.List[float]) -> None: ...
    @property
