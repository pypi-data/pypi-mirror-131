...
class TestAiDriver():
    def __init__(self, driver, api_key, test_case_name=None, debug=False, use_classifier_during_creation=True, train=False, server_url=None):
        ...
        self.test_case_creation_mode = test_case_name is not None
    ...
    def find_element(self, by='id', value=None, element_name=None):
        ...
        try:
            ...
            if driver_element and self.train == True:
    ...
    def find_by_element_name(self, element_name):
        ...
        :Usage:
            ::
                ...
                element = driver.find_element_by_xpath('//div/td[1]')
        """
        el, key, msg = self._classify(element_name, find_by_elem=True)
        if el is None:
            raise Exception(msg)
        return el

    def _update_elem(self, elem, key, element_name, train_if_necessary=True):
        # print('update_elem', type(elem.rect['x']))
        data = {
            'key': key,
    ...
    def _classify(self, element_name, find_by_elem=False):
        msg = ''
        if self.test_case_creation_mode and find_by_elem == True:
            ...
            if element_box:
                ...
                print('Waiting for bounding box of element {} to be drawn in the UI: \n\t{}'.format(element_name, label_url))
