...
class EntityWorklistItemsList:
    ...
    _worklist_items: Union[Unset, List[Entity]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        worklist_items = []
        _worklist_items = d.pop("worklistItems", UNSET)
        for worklist_items_item_data in _worklist_items or []:
            worklist_items_item = Entity.from_dict(worklist_items_item_data)
    ...
    @property
    def worklist_items(self) -> List[Entity]:
    ...
    def worklist_items(self, value: List[Entity]) -> None:
