...
class OptimizeCodons:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        avoided_cutsite_enzyme_ids = cast(List[str], d.pop("avoidedCutsiteEnzymeIds", UNSET))

        codon_usage_table_id = d.pop("codonUsageTableId", UNSET)

        gc_content = None
        _gc_content = d.pop("gcContent", UNSET)
        ...
        hairpin_parameters: Union[Unset, OptimizeCodonsHairpinParameters] = UNSET
        _hairpin_parameters = d.pop("hairpinParameters", UNSET)
        ...
        reduced_patterns = []
        _reduced_patterns = d.pop("reducedPatterns", UNSET)
        for reduced_patterns_item_data in _reduced_patterns or []:
            reduced_patterns_item = ReducedPattern.from_dict(reduced_patterns_item_data)

            reduced_patterns.append(reduced_patterns_item)

        schema_id = d.pop("schemaId", UNSET)

        should_deplete_uridine = d.pop("shouldDepleteUridine", UNSET)
