...
class WorkflowTaskSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        can_set_assignee_on_task_creation = d.pop("canSetAssigneeOnTaskCreation", UNSET)

        default_creation_folder_id = d.pop("defaultCreationFolderId", UNSET)

        default_entry_execution_folder_id = d.pop("defaultEntryExecutionFolderId", UNSET)

        default_responsible_team = None
        _default_responsible_team = d.pop("defaultResponsibleTeam", UNSET)
        ...
        _status_lifecycle = d.pop("statusLifecycle", UNSET)
        if not isinstance(_status_lifecycle, Unset):
            status_lifecycle = WorkflowTaskStatusLifecycle.from_dict(_status_lifecycle)

        task_group_prefix = d.pop("taskGroupPrefix", UNSET)

        workflow_output_schema = None
        _workflow_output_schema = d.pop("workflowOutputSchema", UNSET)
