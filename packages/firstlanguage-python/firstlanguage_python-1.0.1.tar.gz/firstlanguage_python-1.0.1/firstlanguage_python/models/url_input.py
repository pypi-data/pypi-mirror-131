...
"""
from firstlanguage_python.models.input_1 import Input1
import os
...
class URLInput(object):
    ...
    """Implementation of the 'URLInput' model.
    ...
    def __init__(self,
                 input=None):
        """Constructor for the URLInput class"""
    ...
    def from_dictionary(cls,
        ...
        input = Input1.from_dictionary(dictionary.get('input')) if dictionary.get('input') else None
