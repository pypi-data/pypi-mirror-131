...
class NanoZMuMuBase(NanoAODModule):
    ...
    def prepareTree(self, tree, sample=None, sampleCfg=None):
        if self.args.postprocessed:
            return self.prepare_postprocessed(tree, sample=sample, sampleCfg=sampleCfg)
        else:
            return self.prepare_ondemand(tree, sample=sample, sampleCfg=sampleCfg)

    def prepare_ondemand(self, tree, sample=None, sampleCfg=None):
