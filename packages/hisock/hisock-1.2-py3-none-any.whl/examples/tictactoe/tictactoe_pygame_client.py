...
)  # Not needed usually; used to run examples

from hisock.client import threaded_connect
    ...
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                pygame.quit()
                sys.exit()
            elif event.type == pygame.MOUSEBUTTONDOWN and data.game_start and data.turn:
                bod_idx = [xy // 133 for xy in event.pos]
            ...
            pygame.draw.line(screen, (0, 0, 0), (133, 20), (133, 380), width=10)
            pygame.draw.line(screen, (0, 0, 0), (266, 20), (266, 380), width=10)
            pygame.draw.line(screen, (0, 0, 0), (20, 133), (380, 133), width=10)
            pygame.draw.line(screen, (0, 0, 0), (20, 266), (380, 266), width=10)

            if data.tictactoe_opponent is None:
                opp_txt = opp_font.render("Waiting for opponent...", True, (0, 0, 0))
            else:
                opp_txt = opp_font.render(
                    f"Opponent: {data.tictactoe_opponent}", True, (0, 0, 0)
                )
