...
class GuiModule(VisusKernelPy.VisusModule):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["attached"] = _VisusGuiPy.GuiModule_attached_set
    __swig_getmethods__["attached"] = _VisusGuiPy.GuiModule_attached_get
    if _newclass:
        attached = _swig_property(_VisusGuiPy.GuiModule_attached_get, _VisusGuiPy.GuiModule_attached_set)
    if _newclass:
...
class GLTexture(VisusKernelPy.DynObject):
    __swig_setmethods__ = {}
    for _s in [VisusKernelPy.DynObject]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    ...
    __swig_setmethods__["dims"] = _VisusGuiPy.GLTexture_dims_set
    __swig_getmethods__["dims"] = _VisusGuiPy.GLTexture_dims_get
    if _newclass:
        dims = _swig_property(_VisusGuiPy.GLTexture_dims_get, _VisusGuiPy.GLTexture_dims_set)
    __swig_setmethods__["dtype"] = _VisusGuiPy.GLTexture_dtype_set
    __swig_getmethods__["dtype"] = _VisusGuiPy.GLTexture_dtype_get
    if _newclass:
        dtype = _swig_property(_VisusGuiPy.GLTexture_dtype_get, _VisusGuiPy.GLTexture_dtype_set)
    __swig_setmethods__["minfilter"] = _VisusGuiPy.GLTexture_minfilter_set
    __swig_getmethods__["minfilter"] = _VisusGuiPy.GLTexture_minfilter_get
    if _newclass:
        minfilter = _swig_property(_VisusGuiPy.GLTexture_minfilter_get, _VisusGuiPy.GLTexture_minfilter_set)
    __swig_setmethods__["magfilter"] = _VisusGuiPy.GLTexture_magfilter_set
    __swig_getmethods__["magfilter"] = _VisusGuiPy.GLTexture_magfilter_get
    if _newclass:
        magfilter = _swig_property(_VisusGuiPy.GLTexture_magfilter_get, _VisusGuiPy.GLTexture_magfilter_set)
    __swig_setmethods__["wrap"] = _VisusGuiPy.GLTexture_wrap_set
    __swig_getmethods__["wrap"] = _VisusGuiPy.GLTexture_wrap_get
    if _newclass:
        wrap = _swig_property(_VisusGuiPy.GLTexture_wrap_get, _VisusGuiPy.GLTexture_wrap_set)
    __swig_setmethods__["envmode"] = _VisusGuiPy.GLTexture_envmode_set
    __swig_getmethods__["envmode"] = _VisusGuiPy.GLTexture_envmode_get
    if _newclass:
        envmode = _swig_property(_VisusGuiPy.GLTexture_envmode_get, _VisusGuiPy.GLTexture_envmode_set)
    __swig_setmethods__["ranges"] = _VisusGuiPy.GLTexture_ranges_set
    __swig_getmethods__["ranges"] = _VisusGuiPy.GLTexture_ranges_get
    if _newclass:
        ranges = _swig_property(_VisusGuiPy.GLTexture_ranges_get, _VisusGuiPy.GLTexture_ranges_set)
    __swig_setmethods__["compression"] = _VisusGuiPy.GLTexture_compression_set
    __swig_getmethods__["compression"] = _VisusGuiPy.GLTexture_compression_get
    if _newclass:
        compression = _swig_property(_VisusGuiPy.GLTexture_compression_get, _VisusGuiPy.GLTexture_compression_set)

    def __init__(self):
        this = _VisusGuiPy.new_GLTexture()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
    if _newclass:
        createFromArray = staticmethod(_VisusGuiPy.GLTexture_createFromArray)
    else:
        createFromArray = _VisusGuiPy.GLTexture_createFromArray
    if _newclass:
        createFromQImage = staticmethod(_VisusGuiPy.GLTexture_createFromQImage)
    else:
        createFromQImage = _VisusGuiPy.GLTexture_createFromQImage
