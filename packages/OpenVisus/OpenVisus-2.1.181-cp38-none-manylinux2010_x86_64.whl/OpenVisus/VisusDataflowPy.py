...
class DataflowModule(VisusKernelPy.VisusModule):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["attached"] = _VisusDataflowPy.DataflowModule_attached_set
    __swig_getmethods__["attached"] = _VisusDataflowPy.DataflowModule_attached_get
    if _newclass:
        attached = _swig_property(_VisusDataflowPy.DataflowModule_attached_get, _VisusDataflowPy.DataflowModule_attached_set)
    if _newclass:
