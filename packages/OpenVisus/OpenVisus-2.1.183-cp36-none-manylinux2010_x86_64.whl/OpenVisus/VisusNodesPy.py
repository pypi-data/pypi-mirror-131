...
class NodesModule(VisusKernelPy.VisusModule):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["attached"] = _VisusNodesPy.NodesModule_attached_set
    __swig_getmethods__["attached"] = _VisusNodesPy.NodesModule_attached_get
    if _newclass:
        attached = _swig_property(_VisusNodesPy.NodesModule_attached_get, _VisusNodesPy.NodesModule_attached_set)
    if _newclass:
...
class PaletteNode(VisusDataflowPy.Node):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["last_statistics"] = _VisusNodesPy.PaletteNode_last_statistics_set
    __swig_getmethods__["last_statistics"] = _VisusNodesPy.PaletteNode_last_statistics_get
    if _newclass:
        last_statistics = _swig_property(_VisusNodesPy.PaletteNode_last_statistics_get, _VisusNodesPy.PaletteNode_last_statistics_set)
