...
class DbModule(VisusKernelPy.VisusModule):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["attached"] = _VisusDbPy.DbModule_attached_set
    __swig_getmethods__["attached"] = _VisusDbPy.DbModule_attached_get
    if _newclass:
        attached = _swig_property(_VisusDbPy.DbModule_attached_get, _VisusDbPy.DbModule_attached_set)
    if _newclass:
...
class Query(_object):
    ...
    __swig_setmethods__["accuracy"] = _VisusDbPy.Query_accuracy_set
    __swig_getmethods__["accuracy"] = _VisusDbPy.Query_accuracy_get
    if _newclass:
        accuracy = _swig_property(_VisusDbPy.Query_accuracy_get, _VisusDbPy.Query_accuracy_set)
...
class IdxFile(_object):
    ...
    __swig_setmethods__["metadata"] = _VisusDbPy.IdxFile_metadata_set
    __swig_getmethods__["metadata"] = _VisusDbPy.IdxFile_metadata_get
    if _newclass:
        metadata = _swig_property(_VisusDbPy.IdxFile_metadata_get, _VisusDbPy.IdxFile_metadata_set)
