...
class DynObject(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, DynObject, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, DynObject, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = _VisusKernelPy.new_DynObject()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
DynObject_swigregister = _VisusKernelPy.DynObject_swigregister
DynObject_swigregister(DynObject)
...
class KernelModule(VisusModule):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["attached"] = _VisusKernelPy.KernelModule_attached_set
    __swig_getmethods__["attached"] = _VisusKernelPy.KernelModule_attached_get
    if _newclass:
        attached = _swig_property(_VisusKernelPy.KernelModule_attached_get, _VisusKernelPy.KernelModule_attached_set)
    if _newclass:
...
class StatisticsComponent(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, StatisticsComponent, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, StatisticsComponent, name)
    __repr__ = _swig_repr
    __swig_setmethods__["dtype"] = _VisusKernelPy.StatisticsComponent_dtype_set
    __swig_getmethods__["dtype"] = _VisusKernelPy.StatisticsComponent_dtype_get
    if _newclass:
        dtype = _swig_property(_VisusKernelPy.StatisticsComponent_dtype_get, _VisusKernelPy.StatisticsComponent_dtype_set)
    __swig_setmethods__["dims"] = _VisusKernelPy.StatisticsComponent_dims_set
    __swig_getmethods__["dims"] = _VisusKernelPy.StatisticsComponent_dims_get
    if _newclass:
        dims = _swig_property(_VisusKernelPy.StatisticsComponent_dims_get, _VisusKernelPy.StatisticsComponent_dims_set)
    __swig_setmethods__["field_range"] = _VisusKernelPy.StatisticsComponent_field_range_set
    __swig_getmethods__["field_range"] = _VisusKernelPy.StatisticsComponent_field_range_get
    if _newclass:
        field_range = _swig_property(_VisusKernelPy.StatisticsComponent_field_range_get, _VisusKernelPy.StatisticsComponent_field_range_set)
    __swig_setmethods__["computed_range"] = _VisusKernelPy.StatisticsComponent_computed_range_set
    __swig_getmethods__["computed_range"] = _VisusKernelPy.StatisticsComponent_computed_range_get
    if _newclass:
        computed_range = _swig_property(_VisusKernelPy.StatisticsComponent_computed_range_get, _VisusKernelPy.StatisticsComponent_computed_range_set)
    __swig_setmethods__["average"] = _VisusKernelPy.StatisticsComponent_average_set
    __swig_getmethods__["average"] = _VisusKernelPy.StatisticsComponent_average_get
    if _newclass:
        average = _swig_property(_VisusKernelPy.StatisticsComponent_average_get, _VisusKernelPy.StatisticsComponent_average_set)
    __swig_setmethods__["variance"] = _VisusKernelPy.StatisticsComponent_variance_set
    __swig_getmethods__["variance"] = _VisusKernelPy.StatisticsComponent_variance_get
    if _newclass:
        variance = _swig_property(_VisusKernelPy.StatisticsComponent_variance_get, _VisusKernelPy.StatisticsComponent_variance_set)
    __swig_setmethods__["standard_deviation"] = _VisusKernelPy.StatisticsComponent_standard_deviation_set
    __swig_getmethods__["standard_deviation"] = _VisusKernelPy.StatisticsComponent_standard_deviation_get
    if _newclass:
        standard_deviation = _swig_property(_VisusKernelPy.StatisticsComponent_standard_deviation_get, _VisusKernelPy.StatisticsComponent_standard_deviation_set)
    __swig_setmethods__["median"] = _VisusKernelPy.StatisticsComponent_median_set
    __swig_getmethods__["median"] = _VisusKernelPy.StatisticsComponent_median_get
    if _newclass:
        median = _swig_property(_VisusKernelPy.StatisticsComponent_median_get, _VisusKernelPy.StatisticsComponent_median_set)
    __swig_setmethods__["histogram"] = _VisusKernelPy.StatisticsComponent_histogram_set
    __swig_getmethods__["histogram"] = _VisusKernelPy.StatisticsComponent_histogram_get
    if _newclass:
        histogram = _swig_property(_VisusKernelPy.StatisticsComponent_histogram_get, _VisusKernelPy.StatisticsComponent_histogram_set)

    def __init__(self):
        this = _VisusKernelPy.new_StatisticsComponent()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
StatisticsComponent_swigregister = _VisusKernelPy.StatisticsComponent_swigregister
StatisticsComponent_swigregister(StatisticsComponent)
...
class Statistics(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["dtype"] = _VisusKernelPy.Statistics_dtype_set
    __swig_getmethods__["dtype"] = _VisusKernelPy.Statistics_dtype_get
    if _newclass:
        dtype = _swig_property(_VisusKernelPy.Statistics_dtype_get, _VisusKernelPy.Statistics_dtype_set)
    __swig_setmethods__["dims"] = _VisusKernelPy.Statistics_dims_set
    __swig_getmethods__["dims"] = _VisusKernelPy.Statistics_dims_get
    if _newclass:
        dims = _swig_property(_VisusKernelPy.Statistics_dims_get, _VisusKernelPy.Statistics_dims_set)
    __swig_setmethods__["components"] = _VisusKernelPy.Statistics_components_set
    __swig_getmethods__["components"] = _VisusKernelPy.Statistics_components_get
    if _newclass:
        components = _swig_property(_VisusKernelPy.Statistics_components_get, _VisusKernelPy.Statistics_components_set)

    def __init__(self):
        this = _VisusKernelPy.new_Statistics()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    if _newclass:
        compute = staticmethod(_VisusKernelPy.Statistics_compute)
    else:
        compute = _VisusKernelPy.Statistics_compute
    __swig_destroy__ = _VisusKernelPy.delete_Statistics
    __del__ = lambda self: None
Statistics_swigregister = _VisusKernelPy.Statistics_swigregister
Statistics_swigregister(Statistics)

def Statistics_compute(*args):
    return _VisusKernelPy.Statistics_compute(*args)
Statistics_compute = _VisusKernelPy.Statistics_compute
...
class VectorOfStatisticsComponent(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, VectorOfStatisticsComponent, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, VectorOfStatisticsComponent, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _VisusKernelPy.new_VectorOfStatisticsComponent(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
VectorOfStatisticsComponent_swigregister = _VisusKernelPy.VectorOfStatisticsComponent_swigregister
VectorOfStatisticsComponent_swigregister(VectorOfStatisticsComponent)
