...
CONFIG_TUW_OAI_DATACENTRE_SYMBOL = None
"""The datacentre symbol to report in OAI for the 'oai_datacite' metadata prefix.

If set to ``None``, the value of ``DATACITE_USERNAME`` will be used.
"""
...
OAISERVER_METADATA_FORMATS = {
    ...
    "oai_datacite": {
        "serializer": ("invenio_config_tuw.oai:oai_datacite_etree"),
        "schema": "http://schema.datacite.org/oai/oai-1.1/oai.xsd",
        "namespace": "http://schema.datacite.org/oai/oai-1.1/",
    },
    "datacite": {
        "serializer": ("invenio_config_tuw.oai:datacite_etree"),
