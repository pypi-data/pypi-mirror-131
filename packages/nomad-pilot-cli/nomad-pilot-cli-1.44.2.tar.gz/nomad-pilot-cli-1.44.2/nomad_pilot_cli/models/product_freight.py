...
class ProductFreight(object):
    ...
    def customs_unit_code(self, customs_unit_code):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and customs_unit_code is None:  # noqa: E501
            raise ValueError("Invalid value for `customs_unit_code`, must not be `None`")  # noqa: E501
