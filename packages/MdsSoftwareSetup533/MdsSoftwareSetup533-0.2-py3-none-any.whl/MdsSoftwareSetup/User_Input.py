...
def mds_software_setup_function():
    ...
    import pandas as pd
    try:
        from MdsSoftwareSetup.mac import anaconda as mac_conda
        from MdsSoftwareSetup.mac import vscode as mac_vscode
        from MdsSoftwareSetup.mac import postgresql as mac_psql
        from MdsSoftwareSetup.windows import anaconda as win_conda
        from MdsSoftwareSetup.windows import vscode as win_vscode
        from MdsSoftwareSetup.windows import postgresql as win_psql
        import sys
    except ImportError:
