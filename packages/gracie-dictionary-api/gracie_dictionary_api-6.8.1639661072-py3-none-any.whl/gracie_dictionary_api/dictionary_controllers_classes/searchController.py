class searchController:
    ...
    def processFile(self, file, **kwargs):
        ...
        all_api_parameters = {'file': {'name': 'file', 'required': True, 'in': 'formData'}, 'filterFields': {'name': 'filterFields', 'required': False, 'in': 'formData'}, 'idfScoreMin': {'name': 'idfScoreMin', 'required': False, 'in': 'formData'}, 'includeKeywordsReport': {'name': 'includeKeywordsReport', 'required': False, 'in': 'formData'}, 'languageId': {'name': 'languageId', 'required': False, 'in': 'formData'}, 'logging': {'name': 'logging', 'required': False, 'in': 'formData'}, 'minRelevance': {'name': 'min-relevance', 'required': False, 'in': 'formData'}, 'pipelineId': {'name': 'pipelineId', 'required': False, 'in': 'formData'}, 'stopAfterChunkNum': {'name': 'stopAfterChunkNum', 'required': False, 'in': 'formData'}, 'typeId': {'name': 'typeId', 'required': False, 'in': 'formData'}}
