...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.merging', 'pm4py.algo.merging.case_relations',
              ...
              'pm4py.algo.transformation.log_to_features.util', 'pm4py.algo.transformation.log_to_features.variants',
              ...
              'pm4py.objects.ocel.importer.jsonocel.variants', 'pm4py.objects.trie', 'pm4py.objects.petri',
