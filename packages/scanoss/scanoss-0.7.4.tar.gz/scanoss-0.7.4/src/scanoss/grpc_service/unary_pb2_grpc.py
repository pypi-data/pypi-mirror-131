...
import scanoss.grpc_service.unary_pb2 as unary__pb2

# from .unary_pb2 import Message, MessageResponse
...
def add_UnaryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadFile': grpc.stream_unary_rpc_method_handler(
                    servicer.UploadFile,
                    request_deserializer=unary__pb2.UploadFileRequest.FromString,
                    response_serializer=unary__pb2.UploadFileResponse.SerializeToString,
            ),
    }
...
class Unary(object):
    ...
    def UploadFile(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/unary.Unary/UploadFile',
            unary__pb2.UploadFileRequest.SerializeToString,
            unary__pb2.UploadFileResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
