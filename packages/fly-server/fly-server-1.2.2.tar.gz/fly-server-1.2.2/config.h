...
/* "Define to 1 if you have the all `epoll' function." */
#define HAVE_EPOLL 1
...
/* Define to 1 if you have the inotify. */
...
/* "Define to 1 if you have the all some `kqueue' function." */
/* #undef HAVE_KQUEUE */

/* "Define to 1 if you have the `brotlidec` library (-lbrotlidec)." */
#define HAVE_LIBBROTLIDEC 1

/* "Define to 1 if you have the `brotlienc` library (-lbrotlienc)." */
#define HAVE_LIBBROTLIENC 1
...
/* Define to 1 if you have the signalfd. */
...
#define PACKAGE_NAME "fly"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "fly 1.2.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fly"
