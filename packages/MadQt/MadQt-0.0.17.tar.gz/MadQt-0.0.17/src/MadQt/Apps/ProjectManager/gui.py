...
"	border-left:2px solid rgba(255,255,25"
...
" QAbstractSlider::add-line:verti"
...
"")
        ...
        self.ProjectsList.setSelectionMode(QAbstractItemView.MultiSelection)
...
"")
        ...
        self.verticalLayout_9 = QVBoxLayout(self.settPg)
        ...
        self.label_3 = QLabel(self.settPg)
        ...
        self.QtDesignerPathInput = QLineEdit(self.settPg)
        ...
        self.QtDesignerPathBtn = QPushButton(self.settPg)
        ...
        self.label_10 = QLabel(self.settPg)
        ...
        self.sublimePathInput = QLineEdit(self.settPg)
        ...
        self.sublimePathBtn = QPushButton(self.settPg)
        ...
        self.createMQEXEC = QPushButton(self.settPg)

        self.createMQEXEC.setObjectName(u"createMQEXEC")

        self.createMQEXEC.setIcon(icon6)



        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.createMQEXEC)
        ...
        self.MQExecPage = QWidget()

        self.MQExecPage.setObjectName(u"MQExecPage")

        self.verticalLayout_11 = QVBoxLayout(self.MQExecPage)
        ...
        self.label_5 = QLabel(self.MQExecPage)
        ...
        self.execArgs_2 = QLineEdit(self.MQExecPage)

        self.execArgs_2.setObjectName(u"execArgs_2")



        self.horizontalLayout_9.addWidget(self.execArgs_2)



        self.pyinstallerHelp_2 = QPushButton(self.MQExecPage)

        self.pyinstallerHelp_2.setObjectName(u"pyinstallerHelp_2")

        sizePolicy.setHeightForWidth(self.pyinstallerHelp_2.sizePolicy().hasHeightForWidth())

        self.pyinstallerHelp_2.setSizePolicy(sizePolicy)

        self.pyinstallerHelp_2.setMinimumSize(QSize(25, 0))

        self.pyinstallerHelp_2.setCursor(QCursor(Qt.PointingHandCursor))

        self.pyinstallerHelp_2.setIconSize(QSize(32, 32))



        self.horizontalLayout_9.addWidget(self.pyinstallerHelp_2)
        ...
        self.execOutput_2 = QTextEdit(self.MQExecPage)

        self.execOutput_2.setObjectName(u"execOutput_2")

        self.execOutput_2.setStyleSheet(u"")

        self.execOutput_2.setFrameShape(QFrame.NoFrame)

        self.execOutput_2.setReadOnly(True)



        self.verticalLayout_11.addWidget(self.execOutput_2)



        self.createExecBtn_2 = JumpButton(self.MQExecPage)

        self.createExecBtn_2.setObjectName(u"createExecBtn_2")

        self.createExecBtn_2.setCursor(QCursor(Qt.PointingHandCursor))

        self.createExecBtn_2.setIcon(icon5)

        self.createExecBtn_2.setIconSize(QSize(16, 16))



        self.verticalLayout_11.addWidget(self.createExecBtn_2)



        self.mainPage.addWidget(self.MQExecPage)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.logo.setStatusTip(QCoreApplication.translate("MainWindow", u"Visit github", None))
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"QtDesigner", None))
        ...
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Sublime Text", None))
        ...
        self.createMQEXEC.setStatusTip(QCoreApplication.translate("MainWindow", u"Creates an executable version of MadQt Project Manager in the selected path", None))

#endif // QT_CONFIG(statustip)

        self.createMQEXEC.setText(QCoreApplication.translate("MainWindow", u"Create Executable Version", None))
        ...
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Arguments:", None))

        self.execArgs_2.setText(QCoreApplication.translate("MainWindow", u"--onefile --windowed ", None))

#if QT_CONFIG(statustip)

        self.pyinstallerHelp_2.setStatusTip(QCoreApplication.translate("MainWindow", u"View pyinstaller help", None))

#endif // QT_CONFIG(statustip)

        self.pyinstallerHelp_2.setText(QCoreApplication.translate("MainWindow", u"?", None))

#if QT_CONFIG(statustip)

        self.createExecBtn_2.setStatusTip(QCoreApplication.translate("MainWindow", u"Create executable", None))

#endif // QT_CONFIG(statustip)

        self.createExecBtn_2.setText(QCoreApplication.translate("MainWindow", u"Create Executable", None))

#if QT_CONFIG(shortcut)

        self.createExecBtn_2.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+N", None))
