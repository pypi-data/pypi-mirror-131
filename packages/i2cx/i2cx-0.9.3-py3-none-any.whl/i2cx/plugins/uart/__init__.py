...
class Uart:
    ...
    def populateUI(self):
        ...
        #Port BaudRate
        self.ui.cbxBaudRate.addItem("1200",1200)
        self.ui.cbxBaudRate.addItem("2400",2400)
        self.ui.cbxBaudRate.addItem("4800",4800)
        self.ui.cbxBaudRate.addItem("9600",9600)
        self.ui.cbxBaudRate.addItem("19200",19200)
        self.ui.cbxBaudRate.addItem("38400",38400)
        self.ui.cbxBaudRate.addItem("57600",57600)
        self.ui.cbxBaudRate.addItem("115200",115200)
        self.ui.cbxBaudRate.addItem("230400",230400)
        self.ui.cbxBaudRate.addItem("460800",460800)
        self.ui.cbxBaudRate.addItem("921600",921600)
        self.ui.cbxBaudRate.addItem("1843200",1843200)
        ...
        self.ui.txtConsole.setFont({ "Courier" })
        self.ui.txtValue.setFont({ "Courier" })
