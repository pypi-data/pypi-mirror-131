...
class PortfolioInformation(object):
    ...
    def exchange_otr(self):
        ...
        The exchange order-to-trade-ratio for the timeframe of the particular contract. The scope is spanning across all portfolios and tenants for this exchange. Please note that the timeframe includes both XBID and LOCAL contracts.  # noqa: E501
    ...
    def tenant_otr(self):
        ...
        The tenant order-to-trade-ratio for the timeframe of the particular contract. The scope is spanning across all portfolios for this exchange and tenant. Please note that the timeframe includes both XBID and LOCAL contracts.  # noqa: E501
    ...
    def portfolio_otr(self):
        ...
        The portfolio order-to-trade-ratio for the timeframe of the particular contract. The scope is this portfolio for this exchange and tenant. Please note that the timeframe includes both XBID and LOCAL contracts.  # noqa: E501
    ...
    def abs_pos(self):
        ...
        The absolute position (Sum of all traded quantities) without standing orders for the timeframe of the particular contract, portfolio and exchange. Contracts with a timeframe that falls into the timeframe of this particular contract are not included (e.g., quarterhourly contracts do not affect the abs_pos of the hourly contract). Please note that the timeframe includes both XBID and LOCAL contracts.  # noqa: E501
