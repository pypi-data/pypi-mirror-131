...
class Trade(object):
    ...
    def buy_clearing_account_type(self):
        ...
        Defines if the order is entered on its own account, or as an agent. (M7 only)  # noqa: E501
    ...
    def buy_account_id(self):
        ...
        The account for which the order was entered. (M7 only)  # noqa: E501
