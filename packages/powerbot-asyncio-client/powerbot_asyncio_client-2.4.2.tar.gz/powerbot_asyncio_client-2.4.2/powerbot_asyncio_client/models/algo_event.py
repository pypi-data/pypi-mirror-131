...
class AlgoEvent(object):
    ...
    def __init__(self, message_class=None, algorithm_id=None, algo_name=None, require_heartbeat_every_seconds=None, instance_id=None, instance_parameters=None, portfolio_id=None, emitted_at=None, action=None, local_vars_configuration=None):  # noqa: E501
