...
class ReportApi(object):
    ...
    def get_report_csv_for_period_with_http_info(self, delivery_area, delivery_day_from, delivery_day_to, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('delivery_day_from' not in local_var_params or  # noqa: E501
                                                        local_var_params['delivery_day_from'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('delivery_day_to' not in local_var_params or  # noqa: E501
                                                        local_var_params['delivery_day_to'] is None):  # noqa: E501
        ...
        if 'delivery_day_from' in local_var_params and local_var_params['delivery_day_from'] is not None:  # noqa: E501
            query_params.append(('delivery_day_from', local_var_params['delivery_day_from']))  # noqa: E501
        if 'delivery_day_to' in local_var_params and local_var_params['delivery_day_to'] is not None:  # noqa: E501
        ...
        if 'column_separator' in local_var_params and local_var_params['column_separator'] is not None:  # noqa: E501
            query_params.append(('column_separator', local_var_params['column_separator']))  # noqa: E501
        if 'comma_separator' in local_var_params and local_var_params['comma_separator'] is not None:  # noqa: E501
    ...
    def get_report_for_period_with_http_info(self, delivery_area, delivery_day_from, delivery_day_to, **kwargs):  # noqa: E501
        ...
        if 'delivery_day_to' in local_var_params and local_var_params['delivery_day_to'] is not None:  # noqa: E501
            query_params.append(('delivery_day_to', local_var_params['delivery_day_to']))  # noqa: E501
        if 'delivery_day_from_starting_hour' in local_var_params and local_var_params['delivery_day_from_starting_hour'] is not None:  # noqa: E501
            query_params.append(('delivery_day_from_starting_hour', local_var_params['delivery_day_from_starting_hour']))  # noqa: E501
        if 'delivery_day_to_ending_hour' in local_var_params and local_var_params['delivery_day_to_ending_hour'] is not None:  # noqa: E501
            query_params.append(('delivery_day_to_ending_hour', local_var_params['delivery_day_to_ending_hour']))  # noqa: E501
        if 'cl_ordr_id' in local_var_params and local_var_params['cl_ordr_id'] is not None:  # noqa: E501
            query_params.append(('clOrdrId', local_var_params['cl_ordr_id']))  # noqa: E501
        if 'txt' in local_var_params and local_var_params['txt'] is not None:  # noqa: E501
            query_params.append(('txt', local_var_params['txt']))  # noqa: E501
        if 'with_trades' in local_var_params and local_var_params['with_trades'] is not None:  # noqa: E501
