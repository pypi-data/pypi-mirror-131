...
class CapacitiesApi(object):
    ...
    def get_capacities(self, delivery_area, delivery_from, delivery_to, **kwargs):  # noqa: E501
        ...
        The hub-to-hub matrix (capacity matrix) shows all combinations of the requested delivery-areas in Europe that are connected via SIDC (XBID) and their available transfer capacity (ATC). Updates get sent every 30 seconds, containing parts of the matrix in varying size. This feature needs to be explicitly activated by the system administrator, and the request may only be called up to 4 times an hour per delivery area for initialization, as traffic intensity is high. Please use the corresponding web socket subscription to receive further updates.  # noqa: E501
        ...
        :param delivery_area: The EIC codes of the delivery area(s). Filter is applied to \"from_delivery_area\". (required)
    ...
    def get_capacities_with_http_info(self, delivery_area, delivery_from, delivery_to, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('delivery_from' not in local_var_params or  # noqa: E501
                                                        local_var_params['delivery_from'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('delivery_to' not in local_var_params or  # noqa: E501
                                                        local_var_params['delivery_to'] is None):  # noqa: E501
