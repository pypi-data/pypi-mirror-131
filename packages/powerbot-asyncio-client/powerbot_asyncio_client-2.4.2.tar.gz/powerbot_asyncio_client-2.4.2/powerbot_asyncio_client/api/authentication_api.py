...
class AuthenticationApi(object):
    ...
    def update_api_key_portfolios_with_http_info(self, name, portfolio_ids, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('portfolio_ids' not in local_var_params or  # noqa: E501
                                                        local_var_params['portfolio_ids'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `portfolio_ids` when calling `update_api_key_portfolios`")  # noqa: E501
        ...
        body_params = None
        if 'portfolio_ids' in local_var_params:
            body_params = local_var_params['portfolio_ids']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
