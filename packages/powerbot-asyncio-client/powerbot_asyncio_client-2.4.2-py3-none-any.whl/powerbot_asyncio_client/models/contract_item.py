...
class ContractItem(object):
    ...
    def __init__(self, exchange=None, product=None, contract_id=None, type=None, revision_no=None, state=None, name=None, delivery_start=None, delivery_end=None, contract_details=None, delivery_areas=None, local_vars_configuration=None):  # noqa: E501
