...
from skdecide.discrete_optimization.rcpsp.solver import CP_MRCPSP_MZN, CP_RCPSP_MZN
...
def get_ressource_breaks(
    problem_calendar, problem_no_calendar, solution: RCPSPSolution
):
    ...
    for r in ressources:
        ...
        ressource_arrays_usage[r] = np.zeros(
            (len(problem_calendar.resources[r]), len(solution.rcpsp_schedule))
        )
