...
from skdecide.discrete_optimization.generic_tools.mutations.mutation_bool import (
    MutationBitFlip,
)
...
dictionnary_mutation[TypeAttribute.PERMUTATION] = {
...
dictionnary_mutation[TypeAttribute.PERMUTATION_RCPSP] = {
    "total_shuffle_rcpsp": (
        PermutationMutationRCPSP,
    ...
    "2opt_gen_rcpsp": (PermutationMutationRCPSP, {"other_mutation": TwoOptMutation}),
}
dictionnary_mutation[TypeAttribute.LIST_BOOLEAN] = {
    "bitflip": (MutationBitFlip, {"probability_flip": 0.1})
}
dictionnary_mutation[TypeAttribute.LIST_INTEGER_SPECIFIC_ARRITY] = {
