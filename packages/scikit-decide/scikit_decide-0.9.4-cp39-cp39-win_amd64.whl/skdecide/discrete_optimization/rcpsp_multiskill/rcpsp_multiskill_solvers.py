...
from skdecide.discrete_optimization.rcpsp_multiskill.solvers.calendar_solver_iterative import (
    SolverWithCalendarIterative,
)
from skdecide.discrete_optimization.rcpsp_multiskill.solvers.cp_solvers import (
    CP_MS_MRCPSP_MZN,
)
from skdecide.discrete_optimization.rcpsp_multiskill.solvers.lp_model import (
    LP_Solver_MRSCPSP,
    MilpSolverName,
)
...
solvers = {
    ...
    "lns": [
        (
            LNS_CP_MS_RCPSP_SOLVER,
            {"nb_iteration_lns": 20, "option_neighbor": OptionNeighbor.MIX_FAST},
        )
    ],
    "lns-cp": [
        (
