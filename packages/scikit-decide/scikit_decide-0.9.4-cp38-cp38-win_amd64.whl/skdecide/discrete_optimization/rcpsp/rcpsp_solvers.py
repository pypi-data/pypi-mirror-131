...
from skdecide.discrete_optimization.generic_tools.ea.ga_tools import (
    ParametersAltGa,
    ParametersGa,
)
...
from skdecide.discrete_optimization.rcpsp.solver.calendar_solver_iterative import (
    SolverWithCalendarIterative,
)
from skdecide.discrete_optimization.rcpsp.solver.cp_solvers import (
    CP_MRCPSP_MZN,
    CP_RCPSP_MZN,
    CPSolverName,
)
from skdecide.discrete_optimization.rcpsp.solver.ls_solver import (
    LS_SOLVER,
    LS_RCPSP_Solver,
)
from skdecide.discrete_optimization.rcpsp.solver.rcpsp_cp_lns_solver import (
    LNS_CP_RCPSP_SOLVER,
)
from skdecide.discrete_optimization.rcpsp.solver.rcpsp_ga_solver import (
    GA_MRCPSP_Solver,
    GA_RCPSP_Solver,
)
...
from skdecide.discrete_optimization.rcpsp.solver.rcpsp_lp_solver import (
    LP_MRCPSP,
    LP_RCPSP,
    LP_RCPSP_Solver,
)
from skdecide.discrete_optimization.rcpsp.solver.rcpsp_pile import (
    GreedyChoice,
    PileSolverRCPSP,
...
solvers = {
    ...
    "lns": [
        (
            LNS_LP_RCPSP_SOLVER,
            {"nb_iteration_lns": 500, "lp_solver": LP_RCPSP_Solver.GRB},
        ),
...
solvers_compatibility = {
    LP_RCPSP: [SingleModeRCPSPModel],
    LP_MRCPSP: [MultiModeRCPSPModel, SingleModeRCPSPModel, RCPSPModelCalendar],
    PileSolverRCPSP: [SingleModeRCPSPModel, MultiModeRCPSPModel],
    PileSolverRCPSP_Calendar: [
        SingleModeRCPSPModel,
        MultiModeRCPSPModel,
        RCPSPModelCalendar,
    ...
    CP_MRCPSP_MZN: [SingleModeRCPSPModel, MultiModeRCPSPModel, RCPSPModelCalendar],
    LNS_LP_RCPSP_SOLVER: [
        SingleModeRCPSPModel,
        MultiModeRCPSPModel,
        RCPSPModelCalendar,
    ...
    LS_RCPSP_Solver: [SingleModeRCPSPModel, MultiModeRCPSPModel, RCPSPModelCalendar],
