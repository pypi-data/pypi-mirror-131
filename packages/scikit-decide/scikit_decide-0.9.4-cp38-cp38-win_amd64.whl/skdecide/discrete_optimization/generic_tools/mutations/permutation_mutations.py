...
from skdecide.discrete_optimization.generic_tools.do_mutation import LocalMove, Mutation
...
class PermutationShuffleMutation(Mutation):
    ...
    def __init__(self, problem: Problem, solution: Solution, attribute: str = None):
    ...
    def mutate(self, solution: Solution) -> Tuple[Solution, LocalMove]:
        ...
        return sol, ShuffleMove(
            self.attribute, new_permutation=new, prev_permutation=previous
        )
