...
from dldtrainer.utils import log
from dldtrainer.engine import comm
...
def launch(main_func, num_gpus_per_machine, num_machines=1, machine_rank=0, dist_url=None, distributed=True, args=()):
    """
    ...
    Args:
        ...
        distributed: running Mode
                    True use DistributedDataParallel(DDP), multi-gpu-distributed training；
                    Fase use DataParallel(DDP), only multi-gpu training(DP)
