...
class RookDuplicatedModule(RookException):
    def __init__(self, module_key, module_path):
        super(RookDuplicatedModule, self).__init__("Rookout found duplicated occurrences of the same module.\n"
                                                   "module_key: %s,\nmodule_path: %s" % (module_key, module_path),
