...
def load_addons(plugin_name):
    if not plugin_name.startswith("__"):
        ...
        mod.asst = asst
        mod.tgbot = asst
        mod.beastx_bot = beastx_bot
        mod.ub = beastx_bot
        mod.bot = beastx_bot
        mod.ultroid = beastx_bot
        mod.borg = beastx_bot
        mod.telebot = beastx_bot
        mod.jarvis = beastx_bot
        mod.friday = beastx_bot
        mod.eod = eod
        mod.edit_delete = eod
        mod.LOGS = LOGS
        ...
        mod.beastx_cmd = beastx_cmd
        mod.on_cmd = beastx_cmd
