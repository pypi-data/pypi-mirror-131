...
from pyBeastx.misc._decorators import beastx_cmd
from pyBeastx.misc._wrappers import eod, eor
...
ALIVE_NAME = beastx_bot.me.first_name
BOTLOG_CHATID = BOTLOG = int(udB.get("LOG_CHANNEL"))


bot = borg = friday = jarvis = beastx_bot
