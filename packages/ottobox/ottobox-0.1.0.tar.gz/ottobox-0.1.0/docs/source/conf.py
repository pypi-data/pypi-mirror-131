...
# -*- coding: utf-8 -*-
#
# ottobox documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ottobox', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ottobox.tex', 'ottobox Documentation',
     'indresh', 'manual'),
]
