...
class Tokenizer:
    ...
    def _get_next_token_list(self) -> List[Token]:
        ...
        #     If next symbol is not one of the special characters (newline, space or tabulation)
        #       Initialize accumulative with an empty string
        #       While has next symbol <--------------------------------------------------------|
        #         If next symbol is not one of the special characters (newline, space or tab.) |
