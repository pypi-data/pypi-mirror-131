...
import xarray as xr
import orjson
from tethys_data_models.dataset import Dataset, S3ObjectKey, Station
...
def list_objects_s3(s3, bucket, prefix, start_after='', delimiter='', continuation_token=''):
    """
...
def put_remote_agg_stations(s3, bucket, dataset_id, threads=30, version=3):
    ...
    if not list2.empty:
        ...
        _ = put_object_s3(s3, bucket, ro_key, ro_obj, {'run_date': run_date_key}, 'application/json')
