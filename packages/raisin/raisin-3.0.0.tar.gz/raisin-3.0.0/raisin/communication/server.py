...
from raisin.communication.abstraction import SocketAbstractConn, ServerAbstractConn
...
class BaseServer(threading.Thread, ServerAbstractConn):
    """
    ** TCP server. **
    ...
    def __init__(self, port):
        ...
        self.daemon = True
        ServerAbstractConn.__init__(self)
        self.port = port
        self.handlers = []
    ...
    def _process(self, abstract_conn):
        ...
        ** Definitely adds the client to the server. **
        ...
        """
        extended_abstract_conn = self._conn_expansion(abstract_conn)
