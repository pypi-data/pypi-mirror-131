...
def serialize_int(obj, compact, **_):
    ...
    ** Serialize the integers. **
    ...
    b'\x03\x00'
    >>> b''.join(serialize_int(3**250, compact=False))
    b"/large int/\x12\xe7qO\x92Z\xe0'\xde\x89)0rQ\xed(\xe3f$\x17\xc4G0 \xc4\xa6\xfbn\xe7\xdc[\xc8\xa2%ggw\r\xa6\x1c\x914\x15\xb5\x93D\xe4\x9eqi"
    >>>
    """
...
def deserialize_null(**_):
    ...
    ** Deserialize None. **
    ...
    Examples
    --------
    >>> from raisin.serialization.atoms.small import deserialize_null
    >>> deserialize_null()
    >>>
    """
    return None
