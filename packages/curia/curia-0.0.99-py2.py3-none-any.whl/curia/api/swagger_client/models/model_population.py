...
class ModelPopulation(object):
    ...
    def __init__(self, id=None, name=None, organization_id=None, organization=None, cohorts=None, outcome=None, intervention=None, features=None, cohort_results=None, data_query_id=None, data_query=None, model_jobs=None, created_at=None, created_by=None, updated_at=None, last_updated_by=None, version=None):  # noqa: E501
