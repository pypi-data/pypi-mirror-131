...
def run_main_function(worker_modules = []):
    ...
    print("Starting Coinlib Factory")
    print("Modules: "+','.join(str(e) for e in worker_modules))
    print("Registry: "+str(os.getenv("REGISTRY")))
    print("Name: "+str(os.getenv("WORKERNAME")))
