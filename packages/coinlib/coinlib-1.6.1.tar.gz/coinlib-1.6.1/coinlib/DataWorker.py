...
class WorkerJobListener:
        ...
        try:
            ...
            for p in availablePlugins:
                ...
                if found == False:
                    ...
                    log.info("Deleting Plugin "+p["name"])
        except Exception as e:
            log.error("Error in download Plugins", e)
    ...
    def getDataWorkerEndpoint(self):
        ...
        try:
            ...
            log.info("Found Worker Server "+res.targetendpoint+":"+res.targetport)
        except Exception as e:
            log.error("Can not connect to registry, i will retry ", str(e))
            raise e
    ...
    def getWorkerBulkJobData(self, chartData):
        start = time.time()
        self.chipmunkDb = ChipmunkDb(chartData.chipmunkdbHost)
    ...
    def updateWorkerSettings(self, settings: statsModel.WorkerSettings):
        ...
        for mod in activeModules:
            try:
                ...
                log.error("Error loading module "+mod, e)
