...
class Cli:
    ...
    def init(
        ...
        """
        init_pyemr(project_name, target_cluster_name, s3_stage_dir, stage, region)
    ...
    def download_logs(
        ...
        """
        download_erm_step_logs(cluster_name, step_id, name, state, out_dir=out_dir)
