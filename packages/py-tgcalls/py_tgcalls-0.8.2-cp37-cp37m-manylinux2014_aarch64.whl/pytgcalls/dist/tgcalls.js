                ...
                if (connection_status != 'checking') {
                    if (connection_status == 'failed') {
                        if (this.iceRetries > 0) {
                            ...
                            __classPrivateFieldGet(this, _TGCalls_connection, "f")?.restartIce();
                            binding_1.Binding.log('WebRTC Connection failed! Retrying ' + ((this.defaultMaxIceRetries + 1) - this.iceRetries) + ' of ' + this.defaultMaxIceRetries, binding_1.Binding.INFO);
                            return;
                        }
                    }
