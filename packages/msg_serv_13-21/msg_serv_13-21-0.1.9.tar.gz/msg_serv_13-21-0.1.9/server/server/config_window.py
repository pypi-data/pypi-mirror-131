...
class ConfigWindow(QDialog):
    ...
    def __init__(self, config):
        ...
        self.db_path_label.move(15, 20)
        self.db_path_label.setFixedSize(300, 30)

        self.db_path = QLineEdit(self)
        self.db_path.setFixedSize(170, 25)
        self.db_path.move(300, 25)
        self.db_path.setReadOnly(True)

        self.choise_path_btn = QPushButton('Обзор...', self)
        self.choise_path_btn.move(500, 25)
        ...
        self.ip_address.move(300, 120)

        self.save_btn = QPushButton('Сохранить', self)
        self.save_btn.move(150, 230)
        self.save_btn.setShortcut('Ctrl+S')

        self.close_btn = QPushButton('Закрыть', self)
        self.close_btn.move(300, 230)
