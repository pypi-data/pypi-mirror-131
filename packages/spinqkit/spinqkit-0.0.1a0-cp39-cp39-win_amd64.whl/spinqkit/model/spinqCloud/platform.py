...
Gemini = Platform("gemini_vp", "2Qubit小型核磁共振量子计算机", 2, 0, [H, X, Y, Z, X90, Y90, Z90, Rx, Ry, Rz, CNOT, YCON, ZCON, Barrier, U], [(1, 2), (2, 1)])
NMR_4 = Platform("nmr_vp_4", "4Qubit超导核磁共振量子计算机", 4, 0, [H, X, Y, Z, X90, Y90, Z90, CNOT, YCON, ZCON, T, Td, Barrier], [(1, 2), (2, 1), (2, 3), (3, 2), (3, 4), (4, 3)])
NMR_6 = Platform("nmr_vp_6", "6Qubit超导核磁共振量子计算机", 6, 0, [H, X, Y, X90, Y90, CNOT, T, Td, Barrier], [(1, 2), (2, 1), (2, 3), (3, 2), (3, 4), (3, 6), (4, 3), (4, 5), (5, 4), (6, 3)])
Superconductor = Platform("superconductor_vp", "8Qubit超导芯片量子计算机", 8, 0, [H, X, Y, Z, X90, Y90, Z90, Rx, Ry, Rz, ZCON, T, S, Barrier, X90dg, Y90dg, Z90dg, I, U], [(1, 2), (2, 1), (2, 3), (3, 2), (3, 4), (4, 3), (4, 5), (5, 4), (5, 6), (6, 5), (6, 7), (7, 6), (7, 8), (8, 7)])

def find_platform(pcode):
    for p in [Gemini, NMR_4, NMR_6, Superconductor]:
