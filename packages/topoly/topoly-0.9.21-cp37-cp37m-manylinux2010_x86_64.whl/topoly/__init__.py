...
def alexander(chain, closure=Closure.TWO_POINTS, tries=200, chain_boundary=None,
              ...
              external_dictionary='', hide_trivial=True, hide_rare=True, chiral=False, minimal=False, matrix_calc_cutoff=0,
...
def translate_matrix_polynomial(matrix, polynomial_name='Alexander', chiral=False, minimal=False,
                                external_dictionary=''):
    """
...
def find_matching(data, invariant, chiral=False, minimal=False, external_dictionary=''):
    """
