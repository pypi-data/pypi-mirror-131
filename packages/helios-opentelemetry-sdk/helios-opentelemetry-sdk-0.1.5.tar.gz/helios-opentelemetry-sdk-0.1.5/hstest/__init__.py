...
def pytest_runtest_makereport(item, call):
    ...
    if result.when == 'call':
        if active_span:
            ...
            print('View complete test run in Helios >' if test_successful else 'Investigate test failure in Helios >')
            print('https://app.gethelios.dev?actionTraceId=%s' % active_span.context.trace_id)
