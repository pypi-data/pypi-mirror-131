...
setup(
    ...
    long_description="""Library for hash-based signatures using BLAKE2, salt, double WOTS chains, and Merkle-trees.

    Development of this library has been discontinued in favor of work on the new coinZdense project.
