...
class Askdata(SignUp):
    ...
    def load_dataset(self, workspace_slug, dataset_slug):
        all_fields = self.get_columns(workspace=workspace_slug, dataset=dataset_slug)["code"]
        limit = 1000
        ...
        if(len(df.index) < 1000):
            ...
            while(len(df.index) == 1000):
                df = self.query(workspace=workspace_slug, dataset=dataset_slug, fields=all_fields, limit=(limit+1000), offset=limit)
