...
class MLExperimentKeyClass(DictWrapper):
    """Key for an ML experiment"""
    
    RECORD_SCHEMA = get_schema_type("com.linkedin.pegasus2avro.metadata.key.MLExperimentKey")
    def __init__(self,
        platform: str,
        name: str,
        origin: Union[str, "FabricTypeClass"],
    ...
    @classmethod
    def construct_with_defaults(cls) -> "MLExperimentKeyClass":
        self = cls.construct({})
        self._restore_defaults()
    ...
    @property
    def name(self) -> str:
        """Getter: Name of the MLExperiment"""
        return self._inner_dict.get('name')  # type: ignore
    
    @name.setter
    def name(self, value: str) -> None:
        """Setter: Name of the MLExperiment"""
        self._inner_dict['name'] = value
    
    
    @property
    def origin(self) -> Union[str, "FabricTypeClass"]:
        """Getter: Fabric type where experiment belongs to or where it was generated"""
        return self._inner_dict.get('origin')  # type: ignore
    
    @origin.setter
    def origin(self, value: Union[str, "FabricTypeClass"]) -> None:
        """Setter: Fabric type where experiment belongs to or where it was generated"""
        self._inner_dict['origin'] = value
...
class MLExperimentSnapshotClass(DictWrapper):
    """MLExperiment Snapshot entity details."""
    
    RECORD_SCHEMA = get_schema_type("com.linkedin.pegasus2avro.metadata.snapshot.MLExperimentSnapshot")
    def __init__(self,
        urn: str,
        aspects: List[Union["MLExperimentKeyClass", "OwnershipClass", "MLExperimentPropertiesClass", "IntendedUseClass", "MetricsClass", "EvaluationDataClass", "TrainingDataClass", "QuantitativeAnalysesClass", "EthicalConsiderationsClass", "CaveatsAndRecommendationsClass", "InstitutionalMemoryClass", "SourceCodeClass", "StatusClass", "CostClass", "DeprecationClass", "BrowsePathsClass", "GlobalTagsClass", "DataPlatformInstanceClass"]],
    ):
        super().__init__()
    ...
    @classmethod
    def construct_with_defaults(cls) -> "MLExperimentSnapshotClass":
        self = cls.construct({})
        self._restore_defaults()
    ...
    @property
    def aspects(self) -> List[Union["MLExperimentKeyClass", "OwnershipClass", "MLExperimentPropertiesClass", "IntendedUseClass", "MetricsClass", "EvaluationDataClass", "TrainingDataClass", "QuantitativeAnalysesClass", "EthicalConsiderationsClass", "CaveatsAndRecommendationsClass", "InstitutionalMemoryClass", "SourceCodeClass", "StatusClass", "CostClass", "DeprecationClass", "BrowsePathsClass", "GlobalTagsClass", "DataPlatformInstanceClass"]]:
    ...
    @aspects.setter
    def aspects(self, value: List[Union["MLExperimentKeyClass", "OwnershipClass", "MLExperimentPropertiesClass", "IntendedUseClass", "MetricsClass", "EvaluationDataClass", "TrainingDataClass", "QuantitativeAnalysesClass", "EthicalConsiderationsClass", "CaveatsAndRecommendationsClass", "InstitutionalMemoryClass", "SourceCodeClass", "StatusClass", "CostClass", "DeprecationClass", "BrowsePathsClass", "GlobalTagsClass", "DataPlatformInstanceClass"]]) -> None:
...
class MLExperimentPropertiesClass(DictWrapper):
    """Properties associated with a ML Model"""
    
    RECORD_SCHEMA = get_schema_type("com.linkedin.pegasus2avro.ml.metadata.MLExperimentProperties")
    def __init__(self,
        customProperties: Optional[Dict[str, str]]=None,
        externalUrl: Union[None, str]=None,
        description: Union[None, str]=None,
        ...
        metrics: Union[None, List["MLMetricClass"]]=None,
        tags: Optional[List[str]]=None,
        trainingDatasets: Union[None, List[str]]=None,
    ):
        super().__init__()
    ...
    @classmethod
    def construct_with_defaults(cls) -> "MLExperimentPropertiesClass":
        self = cls.construct({})
        self._restore_defaults()
    ...
    def _restore_defaults(self) -> None:
        ...
        self.metrics = self.RECORD_SCHEMA.fields_dict["metrics"].default
        self.tags = list()
        self.trainingDatasets = self.RECORD_SCHEMA.fields_dict["trainingDatasets"].default
    ...
    @property
    def metrics(self) -> Union[None, List["MLMetricClass"]]:
        """Getter: Metrics of the MLModel used in training"""
        return self._inner_dict.get('metrics')  # type: ignore
    
    @metrics.setter
    def metrics(self, value: Union[None, List["MLMetricClass"]]) -> None:
    ...
    @property
    def trainingDatasets(self) -> Union[None, List[str]]:
        """Getter: List of dataset (if any) that use in experiment"""
        return self._inner_dict.get('trainingDatasets')  # type: ignore
    
    @trainingDatasets.setter
    def trainingDatasets(self, value: Union[None, List[str]]) -> None:
        """Setter: List of dataset (if any) that use in experiment"""
        self._inner_dict['trainingDatasets'] = value
...
class MLModelPropertiesClass(DictWrapper):
    ...
    def __init__(self,
        ...
        groups: Union[None, List[str]]=None,
        trainingExperiments: Union[None, List[str]]=None,
    ):
        super().__init__()
        ...
        self.groups = groups
        self.trainingExperiments = trainingExperiments
    ...
    def _restore_defaults(self) -> None:
        ...
        self.groups = self.RECORD_SCHEMA.fields_dict["groups"].default
        self.trainingExperiments = self.RECORD_SCHEMA.fields_dict["trainingExperiments"].default
    ...
    @property
    def trainingExperiments(self) -> Union[None, List[str]]:
        """Getter: List of Experiment"""
        return self._inner_dict.get('trainingExperiments')  # type: ignore
    
    @trainingExperiments.setter
    def trainingExperiments(self, value: Union[None, List[str]]) -> None:
        """Setter: List of Experiment"""
        self._inner_dict['trainingExperiments'] = value
...
__SCHEMA_TYPES = {
    ...
    'com.linkedin.pegasus2avro.metadata.key.MLExperimentKey': MLExperimentKeyClass,
    ...
    'com.linkedin.pegasus2avro.metadata.snapshot.MLExperimentSnapshot': MLExperimentSnapshotClass,
    ...
    'com.linkedin.pegasus2avro.ml.metadata.MLExperimentProperties': MLExperimentPropertiesClass,
    ...
    'MLExperimentSnapshot': MLExperimentSnapshotClass,
    ...
    'MLExperimentProperties': MLExperimentPropertiesClass,
