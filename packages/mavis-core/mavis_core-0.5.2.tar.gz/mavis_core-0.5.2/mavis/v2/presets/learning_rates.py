...
from tensorflow.python.keras.optimizer_v2.learning_rate_schedule import LearningRateSchedule, PolynomialDecay, \
    ExponentialDecay
from tensorflow_addons.optimizers import Triangular2CyclicalLearningRate

from v2.presets.base import BaseProperty, PropertyContainer, ExtendedEnum
