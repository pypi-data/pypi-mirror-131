...
# -- H5 loader
def h5_224_norm(sub_set='train', transform: Optional[Callable] = None, transform_target: Optional[Callable] = None, num_samples: int = 1):
...
def h5_224_norm_split_90_10(sub_set="train", transform: Optional[Callable] = None, transform_target: Optional[Callable] = None, num_samples: int = 1):
    assert sub_set in ("train", "valid", "test")
...
def h5_224_norm_split_old(sub_set="train", transform: Optional[Callable] = None, transform_target: Optional[Callable] = None, num_samples: int = 1):
    assert sub_set in ("train", "valid", "test")
...
def h5_96_norm_split_old(sub_set="train", transform: Optional[Callable] = None, transform_target: Optional[Callable] = None, num_samples: int = 1):
    assert sub_set in ("train", "valid", "test")
...
# -- ImageFolder loader
def if_224_norm(sub_set="train", transform: Optional[Callable] = None, transform_target: Optional[Callable] = None):
    assert sub_set in ("train", "test"), f"'sub_set' needs to be 'train' or 'test' for that set, not {sub_set} is no valid sub set."
