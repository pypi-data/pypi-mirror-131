...
class TimeSeriesClient:
    ...
    def classified_trades(self,
        ...
        req = partial(self._get_classified_trades_page, object_ids, start_date, end_date)
        table = paginate(req)
        df = to_pandas(table)
    ...
    def query(self,
        ...
        req = partial(self._get_page, object_ids, metric, frequency, start_date, end_date, pivot)
        table = paginate(req)
        df = to_pandas(table)
    ...
    def _get_page(self, object_ids, metrics, freq, start_date, end_date, pivot, token=None):
        payload = {
    ...
    def _get_classified_trades_page(self, object_ids, start_date, end_date, token=None):
        payload = {
            'objectId': [int(o) for o in object_ids],
