...
class AddressUpdate(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, city, country, postal_code, state, house_number_or_name, line1, line2, organization, *args, **kwargs):  # noqa: E501
        """AddressUpdate - a model defined in OpenAPI
