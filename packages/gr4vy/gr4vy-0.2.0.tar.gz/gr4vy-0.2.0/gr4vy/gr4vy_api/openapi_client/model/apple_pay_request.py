...
class ApplePayRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'token': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def __init__(self, token, *args, **kwargs):  # noqa: E501
        """ApplePayRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            method (str): `applepay`.. defaults to "applepay", must be one of ["applepay", ]  # noqa: E501
        ...
        method = kwargs.get('method', "applepay")
