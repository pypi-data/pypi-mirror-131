...
class TransactionsBatchCaptureRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, currency, transaction_id, *args, **kwargs):  # noqa: E501
        """TransactionsBatchCaptureRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            external_identifier (str): An external identifier that can be used to match the transaction against your own records.. [optional]  # noqa: E501
        """
