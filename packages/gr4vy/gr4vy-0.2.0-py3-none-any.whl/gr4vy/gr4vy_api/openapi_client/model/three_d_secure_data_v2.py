...
def lazy_import():
    from gr4vy.gr4vy_api.openapi_client.model.three_d_secure_data import ThreeDSecureData
    from gr4vy.gr4vy_api.openapi_client.model.three_d_secure_data_v2_all_of import ThreeDSecureDataV2AllOf
...
class ThreeDSecureDataV2(ModelComposed):
    ...
    validations = {
        ('eci',): {
            ...
            'min_length': 1,
            'regex': {
                'pattern': r'^0?\d$',  # noqa: E501
            },
        },
        ('version',): {
            'regex': {
                'pattern': r'^[1-2].?[\d+.?]{0,3}$',  # noqa: E501
            },
        },
        ('directory_response',): {
            'max_length': 1,
    ...
    def __init__(self, cavv, eci, version, directory_response, directory_transaction_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            authentication_response (str): The transaction status from the challenge result (not required for frictionless).. [optional]  # noqa: E501
        """
