...
def lazy_import():
    from gr4vy.gr4vy_api.openapi_client.model.payment_option_context import PaymentOptionContext
    globals()['PaymentOptionContext'] = PaymentOptionContext


class PaymentOption(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): `payment-option`.. [optional] if omitted the server will use the default value of "payment-option"  # noqa: E501
            method (object): [optional]  # noqa: E501
            icon_url (str, none_type): An icon to display for the payment option.. [optional]  # noqa: E501
