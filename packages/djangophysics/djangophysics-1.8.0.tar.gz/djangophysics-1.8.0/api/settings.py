...
MIDDLEWARE = [
    ...
    'apistats.middlewares.LoggingMiddleware',
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/var/log/physics/api-debug.log',
        },
    },
    'loggers': {
        'django': {
...
SERVICES = {
    ...
    'rates': {
        ...
        'currencylayer': 'djangophysics.rates.services.currencylayer.CurrencyLayerService'
    }
}
...
SENDFILE_ROOT = '/var/www/pysics/media'
STATIC_ROOT = '/var/www/physics/static'
MEDIA_ROOT = '/var/www/physics/media'
...
from efactors.settings import *
PHYSICS_ADDITIONAL_UNITS = ADDITIONAL_UNITS
PHYSICS_ADDITIONAL_UNITS.update(GHG_UNITS)
from geophysics_web.settings import *
try:
    from .local import *
except ImportError:
