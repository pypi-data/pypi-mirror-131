...
__all__ = \
    ...
    'RSessionHeader', 'RSnapEntry', 'R_ANAL_ACC_R',
    ...
    'c__EA_RAnalValueType', 'c__EA_RDebugPidState',
    'c__EA_RDebugReasonType', 'c__EA_RDebugRecoilMode',
    'c__EA_RDebugSignalMode', 'c__EA_RLinePromptType',
