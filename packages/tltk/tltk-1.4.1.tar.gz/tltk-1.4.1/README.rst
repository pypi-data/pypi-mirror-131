Thai Language Toolkit Project  version 1.4.1
============================================
...
>>tltk.corpus.Corpus() create an object which has three methods for a copus: x.frequency(Text) x.dispersion(C) x.totalword(C). C is created from Corpus_build
...
>>tltk.corpus.W2V_train(Corpus) create a model of Word2Vec

>>tltk.corpus.D2V_train(Corpus) create a model of Doc2Vec
