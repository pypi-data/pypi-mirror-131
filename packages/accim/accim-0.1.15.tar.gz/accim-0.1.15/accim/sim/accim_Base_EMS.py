...
def addGlobVarList(self, verboseMode: bool = True):
...
def addOutputVariablesBase(self, verboseMode: bool = True):
...
def addEMSSensorsBase(self, verboseMode: bool = True):
...
def addEMSActuatorsBase(self, verboseMode: bool = True):
