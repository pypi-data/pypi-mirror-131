...
def attr_fields_except(cls:type, fields_to_ignore: List[attr.Attribute]) -> List[attr.Attribute]:
    """
...
def keep_fields_for_attr_value(value:type, fields_to_keep: List[attr.Attribute]) -> Mapping[str, Any]:
    """
