...
def compare(class_uri, property_uri1, property_uri2, data=None, data_label="data", num_of_bins=0, endpoint=None,
            outfile=None):
    prob = True
    if endpoint is None:
...
if __name__ =="__main__":
    ...
    compare(class_uri, property_uri1, property_uri2, data=[1,2,3,4,5,6,7], data_label="data", num_of_bins=0, endpoint=endpoint)
