...
class Checkpoint(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"book_name_to_session_alias_to_direction_checkpoint",b"book_name_to_session_alias_to_direction_checkpoint",u"id",b"id",u"session_alias_to_direction_checkpoint",b"session_alias_to_direction_checkpoint"]) -> None: ...
