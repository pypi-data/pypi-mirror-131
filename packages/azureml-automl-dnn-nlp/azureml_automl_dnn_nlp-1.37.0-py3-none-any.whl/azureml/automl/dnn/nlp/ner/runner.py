...
from azureml.automl.dnn.nlp.ner._utils import log_metrics, create_unique_dir
...
def run(automl_settings):
    ...
    try:
        is_labeling_run = is_data_labeling_run(run)
        ...
        automl_settings_obj = initialize_log_server(run.id, automl_settings)
