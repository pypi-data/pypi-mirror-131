...
class AwsCdkConstructLibrary(
    ...
    def __init__(
        ...
        *,
        ...
        :param cdk_version: (experimental) Semantic version requirement for the the AWS CDK libraries. Default: "^2"
        :param cdk_assert: (deprecated) Install the @aws-cdk/assert library? Default: false
        :param cdk_assertions: (experimental) Install the @aws-cdk/assertions library? Only needed for CDK 1.x. If using CDK 2.x then assertions is already included in 'aws-cdk-lib' Default: true
        ...
        :param cdk_version_pinning: (deprecated) Use pinned version instead of caret version for CDK. You can use this to prevent yarn to mix versions for your CDK dependencies and to prevent auto-updates. If you use experimental features this will let you define the moment you include breaking changes.
        :param constructs_version: (experimental) Semantic version requirement for the ``constructs`` library. Default: - for CDK 1.x the default is "^3.2.27", for CDK 2.x the default is "^10.0.5".
...
class AwsCdkDeps(
    ...
    def cdk_major_version(self) -> jsii.Number:
        '''(experimental) The major version of the AWX CDK (e.g. 1, 2, ...).
    ...
    def constructs_version(self) -> builtins.str:
        '''(experimental) The semantic version requirement of ``constructs``.
...
class AwsCdkDepsCommonOptions:
    ...
    @builtins.property
    def cdk_version(self) -> builtins.str:
        '''(experimental) Semantic version requirement for the the AWS CDK libraries.
    ...
    def cdk_version_pinning(self) -> typing.Optional[builtins.bool]:
        '''(deprecated) Use pinned version instead of caret version for CDK.
    ...
    def constructs_version(self) -> typing.Optional[builtins.str]:
        '''(experimental) Semantic version requirement for the ``constructs`` library.

        :default:

        - for CDK 1.x the default is "^3.2.27", for CDK 2.x the default
        is "^10.0.5".
