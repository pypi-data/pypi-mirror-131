...
class AwsCdkConstructLibrary(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param cdk_version: (experimental) Minimum target version this library is tested against. Default: "2.0.0"
        ...
        :param constructs_version: (experimental) Minimum target version of constructs being tested against. If not provided, the default value depends on the configured ``cdkVersion``:. - For CDK 1.x, the default is "3.2.27" - For CDK 2.x, the default is "10.0.5" - Otherwise, the default is "*" Default: - When the default behavior is used, the dependency on ``constructs`` will be added as both a ``peerDependency`` and a ``devDependency``.
...
class AwsCdkConstructLibraryOptions(_ConstructLibraryOptions_dcd2adc0):
    def __init__(
        self,
        *,
        name: builtins.str,
    ...
    def constructs_version(self) -> typing.Optional[builtins.str]:
        ...
        - When the default behavior is used, the dependency on ``constructs`` will
...
class AwsCdkTypeScriptApp(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param cdk_version: (experimental) AWS CDK version to use. Default: "1.129.0"
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_TypeScriptProjectOptions_d10c83f7, CdkConfigCommonOptions],
    name_mapping={
        "name": "name",
        "logging": "logging",
        "outdir": "outdir",
