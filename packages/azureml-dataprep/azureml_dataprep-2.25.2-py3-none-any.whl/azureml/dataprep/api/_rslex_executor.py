...
class _RsLexExecutor:
    ...
    def execute_script(self, script, collect_results, fail_on_error, fail_on_mixed_types, fail_on_out_of_range_datetime, traceparent):
        '''
        ...
        (batches, num_partitions, stream_columns) = ex.execute(
            script,
            collect_results,
            fail_on_error,
            fail_on_mixed_types,
