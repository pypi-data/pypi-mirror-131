...
def parse_version(fpath='wbia_kaggle7/__init__.py'):
    """
...
URL = 'https://github.com/WildbookOrg/wbia-plugin-kaggle7'
LICENSE = 'Apache Version 2.0'
DESCRIPTION = 'wbia_kaggle7 - A plug-in for the Kaggle7 humpback fluke ID algorithm'
...
KWARGS = OrderedDict(
    ...
    use_scm_version={
        'write_to': 'wbia_kaggle7/_version.py',
        'write_to_template': '__version__ = "{version}"',
        'tag_regex': '^(?P<prefix>v)?(?P<version>[^\\+]+)(?P<suffix>.*)?$',
        'local_scheme': 'dirty-tag',
    },
    packages=find_packages(),
    package_dir={'wbia_kaggle7': 'wbia_kaggle7'},
