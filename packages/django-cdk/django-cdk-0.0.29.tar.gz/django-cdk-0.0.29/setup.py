    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cloudformation>=1.134.0, <2.0.0",
        "aws-cdk.aws-cloudfront-origins>=1.134.0, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.134.0, <2.0.0",
        "aws-cdk.aws-cloudwatch>=1.134.0, <2.0.0",
        "aws-cdk.aws-ec2>=1.134.0, <2.0.0",
        "aws-cdk.aws-ecr-assets>=1.134.0, <2.0.0",
        "aws-cdk.aws-ecr>=1.134.0, <2.0.0",
        "aws-cdk.aws-ecs-patterns>=1.134.0, <2.0.0",
        "aws-cdk.aws-ecs>=1.134.0, <2.0.0",
        "aws-cdk.aws-efs>=1.134.0, <2.0.0",
        "aws-cdk.aws-eks>=1.134.0, <2.0.0",
        "aws-cdk.aws-elasticache>=1.134.0, <2.0.0",
