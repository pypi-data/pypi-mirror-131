...
trade_period = ('2021-12-15','2021-12-15') #(last test date, yesterday's date)
today_date = '2021-12-16'
"""
...
while current_time < end_time and current_time > start_time:
    ...
    #     agent.close_all_day_trade_positions()
    #     break

    # agent.make_day_trade(actions)
