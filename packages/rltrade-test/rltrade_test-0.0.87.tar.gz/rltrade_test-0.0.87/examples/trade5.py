...
trade_period = ('2021-12-16','2021-12-16') #(last test date, yesterday's date)
today_date = '2021-12-17'
"""
...
async def run_loop():
    ...
    try:
        ...
        while current_time < end_time and current_time > start_time:
            ...
            await agent.make_day_trade(actions,rpc_connection,streaming_connection)
