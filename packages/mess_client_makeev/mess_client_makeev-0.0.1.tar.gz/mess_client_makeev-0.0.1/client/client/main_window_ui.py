""" Модуль дизайна графического интерфейса"""
# -*- coding: utf-8 -*-
...
class Ui_MainClientWindow(object):
    """
    Класс - дизайн графического интерфейса
    """
    def setupUi(self, MainClientWindow):
        ...
        self.text_message.setGeometry(QtCore.QRect(300, 340, 441, 91))
        self.text_message.setObjectName("text_message")
        self.label_new_message = QtWidgets.QLabel(self.centralwidget)
        self.label_new_message.setGeometry(QtCore.QRect(300, 320, 171, 16))
        ...
        self.list_messages.setGeometry(QtCore.QRect(300, 20, 441, 281))
        self.list_messages.setObjectName("list_messages")
        self.btn_send = QtWidgets.QPushButton(self.centralwidget)
        self.btn_send.setGeometry(QtCore.QRect(590, 450, 151, 41))
        self.btn_send.setObjectName("btn_send")
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(300, 440, 131, 31))
