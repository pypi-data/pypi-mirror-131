...
class Template(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        @keyword default_slot: Default slot name for the Simultan component
    ...
    def get_properties(self):
        ...
        for prop in self.content:
            ...
            prop_dict[syn] = add_properties(prop, param_type=self.types.get(prop, None), slot=slot)
...
def add_properties(prop_name: str, param_type: str, slot=None) -> property:
    """
    ...
    def getx(self):
        ...
        if obj is None:
            ...
            if full_slot_name is not None:
                ...
                if obj is None:
                    obj = next((x.get_Reference() for x in self._wrapped_obj.ReferencedComponents.Items
                                if ' '.join([str(x.ReferenceFunction.SlotBase),
                                             x.ReferenceFunction.SlotExtension]) == full_slot_name),
                               None)
            ...
            if idx.__len__() == 1:
                ...
                # if reference:
                    ...
                    if isinstance(value, SimComponent):
                        ...
                        ref.Reference = value._wrapped_obj
