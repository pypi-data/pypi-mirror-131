...
class APIServiceStatus(K8sObject):
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apiregistration.v1.APIServiceConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=optional_mlist_converter_APIServiceConditionItem, default=OMIT)


class APIServiceStatusTypedDict(TypedDict, total=(False)):
    conditions: Mapping[str, kdsl.apiregistration.v1.APIServiceConditionItem]
