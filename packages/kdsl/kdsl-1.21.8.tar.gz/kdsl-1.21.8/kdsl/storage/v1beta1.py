...
class CSINodeSpec(K8sObject):
    drivers: Mapping[str, kdsl.storage.v1beta1.CSINodeDriverItem] = attr.ib(metadata={'yaml_name': 'drivers', 'mlist_key': 'name'}, converter=required_mlist_converter_CSINodeDriverItem)


class CSINodeSpecTypedDict(TypedDict, total=(True)):
    drivers: Mapping[str, kdsl.storage.v1beta1.CSINodeDriverItem]
