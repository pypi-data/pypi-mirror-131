...
class CertificateSigningRequestSpec(K8sObject):
    ...
    signerName: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'signerName'}, default=OMIT)
...
class CertificateSigningRequest(K8sResource):
    ...
    spec: Union[None, OmitEnum, CertificateSigningRequestSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=optional_converter_CertificateSigningRequestSpec, default=OMIT)
