"""Модуль конфигурирования базы данных сервера"""
...
class ServerStorage:
    ...
    def user_login(self, username, ip_address, port, key):
        ...
        req = self.session.query(self.AllUsers).filter_by(name=username)
    ...
    def remove_user(self, name):
        ...
        user = self.session.query(self.AllUsers).filter_by(name=name).firest()
        self.session.query(self.ActiveUsers).filter_by(user=user.id).delete()
...
if __name__ == '__main__':
    ...
    # test_db.user_login('tester', '192.168.1.1', 88888)
    # test_db.user_login('tester33', '192.168.1.33', 88888)
    #
    # print(test_db.active_users_list())
    # test_db.user_logout('tester')
    # print(test_db.active_users_list())
    # print(test_db.login_history('tester'))
