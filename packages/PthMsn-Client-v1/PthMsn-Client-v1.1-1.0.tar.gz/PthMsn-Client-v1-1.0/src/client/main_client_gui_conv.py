...
class Ui_MainClientWindow(object):
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "Python-messenger. Client. Release candidate."))
        self.label_contacts.setText(_translate("MainClientWindow", "Friends list:"))
        self.btn_add_contact.setText(_translate("MainClientWindow", "Add friend"))
        self.btn_remove_contact.setText(_translate("MainClientWindow", "Remove Friend"))
        ...
        self.menu_2.setTitle(_translate("MainClientWindow", "Friends"))
        self.menu_exit.setText(_translate("MainClientWindow", "Exit"))
        self.menu_add_contact.setText(_translate("MainClientWindow", "Add friend"))
        self.menu_del_contact.setText(_translate("MainClientWindow", "Remove Friend"))
