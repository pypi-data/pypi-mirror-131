...
def test_singleline_ifdata():
    pre = Preprocessor()
    res = pre.process("singleline_ifdata.a2l")
...
def test_multiple_ifdatas_per_line():
    pre = Preprocessor()
    res = pre.process("multiple_ifdatas_per_line.a2l")
    '''
...
def test_clean_ifdata():
    pre = Preprocessor()
    res = pre.process("clean_ifdata.a2l")
    sections = res.if_data_sections
...
def test_notso_clean_ifdata1():
    pre = Preprocessor()
    res = pre.process("notso_clean_ifdata.a2l")
    sections = res.if_data_sections
    assert len(sections) == 1
    sec = sections[0]
    #print(res)
...
def test_notso_clean_ifdata2():
    pre = Preprocessor()
    res = pre.process("notso_clean_ifdata2.a2l")
    sections = res.if_data_sections
    assert len(sections) == 1
    sec = sections[0]
    #print(res)
