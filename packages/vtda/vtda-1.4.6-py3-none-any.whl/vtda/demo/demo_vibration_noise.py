...
dir_='C:/Users/ZSL/Desktop/16/北安河车辆段对比'
name='20210713北安河车辆段对比'
...
batch_noise_level(data=data,  #时域数据
                      ...
                      num_shiyan='all',#计算的试验号，num_shiyan='3,7,9,20-34'  #试验号，如需计算所有数据 num_shiyan='all'
                      num_tongdao='5-6',#计算的通道号，num_tongdao='3,7,9,20-34' #通道号，如需计算所有数据 num_tongdao='all'
                      )
