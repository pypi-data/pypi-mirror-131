...
class FunctionHandler(abc.ABC, metaclass=abc.ABCMeta):
    ...
    def apply(self, function_name: str, in_wires: Optional[Dict[str, Union[QuantumRegister, Wire]]] = ..., out_wires: Optional[Dict[str, Union[QuantumRegister, Wire]]] = ...) -> Dict[str, Wire]: ...
