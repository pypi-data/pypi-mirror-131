...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'serialhub', // API Namespace
    endPoint);
    let response;
    try {
...
/* harmony export */   "SerialHubModel": () => (/* reexport safe */ _widget__WEBPACK_IMPORTED_MODULE_2__.SerialHubModel),
/* harmony export */   "SerialHubView": () => (/* reexport safe */ _widget__WEBPACK_IMPORTED_MODULE_2__.SerialHubView),
/* harmony export */   "SerialHubPort": () => (/* reexport safe */ _webseriallink__WEBPACK_IMPORTED_MODULE_3__.SerialHubPort)
/* harmony export */ });
